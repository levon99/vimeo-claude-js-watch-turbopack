{
  ...
  _v0.s(["useIndividualEligibilityTracking", 0, _v4], 0);
  var _v5 = _v0.i(0),
    _v6 = _v0.i(0),
    _v7 = _v0.i(0),
    _v8 = _v0.i(0),
  ...
  function _v31(_v0, _v1) {
    ...
    return (0, _v29.default)(_v2 ? `/me/surveys/${_v2.where.surveyType}${(0, _v28.serializeQuery)(_v2)}` : () => null, _v2 ? () => (0, _v25.getMeSurvey)({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  "true" === _v27.default.env.STORYBOOK && (0, _v28.assignMswData)(_v31, {
    ...
    return [(0, _v1.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me/surveys/${_v0.where.surveyType}${(0, _v28.serializeQuery)(_v0)}`, (0, _v25.getMeSurvey)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    return [(0, _v1.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me/surveys/${_v0.where.surveyType}${(0, _v28.serializeQuery)(_v0)}`, (0, _v25.putMeSurvey)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  function _v41({
    ...
    let _v5 = _v3 ?? "step1_respondent_type",
      [_v6, _v7] = (0, _v1.useState)(_v5),
      [_v8, _v9] = (0, _v1.useState)(""),
      [_v10, _v11] = (0, _v1.useState)(""),
      [_v12, _v13] = (0, _v1.useState)(""),
      [_v14, _v15] = (0, _v1.useState)(""),
      [_v16, _v17] = (0, _v1.useState)(""),
      {
        data: _v18,
        isLoading: _v19
      } = _v31(() => _v0 ? {
    ...
    let _v39 = (0, _v1.useCallback)(() => {
      ...
      _v42 = (0, _v1.useCallback)(async (_v0, _v1) => {
        _v7("submitting");
        let _v2 = new Promise(_v0 => setTimeout(_v0, 0 + Math.floor(0 * Math.random())));
        try {
          let [_v0] = await Promise.all([(0, _v25.putMeSurvey)({
            baseUrl: _v20,
            select: ["outcome"],
            where: {
              surveyType: _v34
      ...
      _v47 = (0, _v1.useCallback)(() => {
        _v32({
          entryPoint: _v4,
          outcome: "qualified"
        }), _v2?.(), window.location.href = (0, _v33.buildUpgradePlanUrl)({
    ...
    return (0, _v5.jsxs)(_v10.Modal, {
      isOpen: _v0,
      onClose: _v50,
      size: ["full", "md"],
      children: [(0, _v5.jsx)(_v16.ModalOverlay, {}), (0, _v5.jsxs)(_v13.ModalContent, {
        borderRadius: "md",
        overflow: "hidden",
        children: [(0, _v5.jsx)(_v12.ModalCloseButton, {
          onClick: _v50,
          zIndex: 1
        }), "step1_respondent_type" === _v6 && (0, _v5.jsxs)(_v5.Fragment, {
          children: [(0, _v5.jsx)(_v15.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            children: (0, _v5.jsx)(_v8.Header, {
              as: "h3",
              size: "md",
              children: _v24.respondentType?.question ?? (0, _v32.translate)({
          ...
          }), (0, _v5.jsx)(_v11.ModalBody, {
            pt: 5,
            pb: 4,
            px: 6,
            children: (0, _v5.jsxs)(_v22.VStack, {
              align: "stretch",
              gap: 4,
              children: [(0, _v5.jsx)(_v20.Text, {
                variant: "body-md",
                color: "text-secondary",
                children: _v24.respondentType?.description ?? (0, _v32.translate)({
              ...
              }), _v49 && _v24.respondentType && (0, _v5.jsx)(_v18.RadioGroup, {
                value: _v8,
                onChange: _v0 => _v9(_v0),
                children: (0, _v5.jsx)(_v22.VStack, {
                  align: "stretch",
                  gap: 3,
                  children: _v24.respondentType.answers.map(_v0 => (0, _v5.jsx)(_v17.Radio, {
                    value: _v0.id,
        ...
        }), "step2_vimeo_usage" === _v6 && (0, _v5.jsxs)(_v5.Fragment, {
          children: [(0, _v5.jsx)(_v15.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            children: (0, _v5.jsx)(_v8.Header, {
              as: "h3",
              size: "md",
              children: _v24.usage?.question ?? (0, _v32.translate)({
                singular: "Tell us about yourself",
                dictionary: {
                  es: {
                    singular: "Cuéntenos sobre usted"
            ...
            children: (0, _v5.jsxs)(_v22.VStack, {
              ...
              children: [(0, _v5.jsx)(_v20.Text, {
                variant: "body-md",
                color: "text-secondary",
                children: _v24.usage?.description ?? (0, _v32.translate)({
              ...
              }), _v24.usage && (0, _v5.jsx)(_v18.RadioGroup, {
                value: _v10,
                onChange: _v0 => _v11(_v0),
                children: (0, _v5.jsx)(_v22.VStack, {
                  align: "stretch",
                  gap: 3,
                  children: _v24.usage.answers.map(_v0 => (0, _v5.jsx)(_v17.Radio, {
                    value: _v0.id,
        ...
        }), "step3_team_size" === _v6 && (0, _v5.jsxs)(_v5.Fragment, {
          children: [(0, _v5.jsx)(_v15.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            children: (0, _v5.jsx)(_v8.Header, {
              as: "h3",
              size: "md",
              children: _v24.teamSize?.question ?? (0, _v32.translate)({
                singular: "Tell us about yourself",
                dictionary: {
                  es: {
                    singular: "Cuéntenos sobre usted"
            ...
            children: (0, _v5.jsxs)(_v22.VStack, {
              ...
              children: [(0, _v5.jsx)(_v20.Text, {
                variant: "body-md",
                color: "text-secondary",
                children: _v24.teamSize?.description ?? (0, _v32.translate)({
              ...
              }), _v24.teamSize && (0, _v5.jsx)(_v18.RadioGroup, {
                value: _v12,
                onChange: _v0 => _v13(_v0),
                children: (0, _v5.jsx)(_v22.VStack, {
                  align: "stretch",
                  gap: 3,
                  children: _v24.teamSize.answers.map(_v0 => (0, _v5.jsx)(_v17.Radio, {
                    value: _v0.id,
        ...
        }), "step4_reason" === _v6 && (0, _v5.jsxs)(_v5.Fragment, {
          children: [(0, _v5.jsx)(_v15.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            children: (0, _v5.jsx)(_v8.Header, {
              as: "h3",
              size: "md",
              children: _v24.reason?.question ?? (0, _v32.translate)({
            ...
            children: (0, _v5.jsxs)(_v22.VStack, {
              ...
              children: [(0, _v5.jsx)(_v20.Text, {
                variant: "body-md",
                color: "text-secondary",
                children: _v24.reason?.description ?? (0, _v32.translate)({
              ...
              }), (0, _v5.jsx)(_v21.Textarea, {
                value: _v14,
                onChange: _v0 => _v15(_v0.target.value),
                placeholder: _v24.reason?.placeholder ?? (0, _v32.translate)({
        ...
        }), "submitting" === _v6 && (0, _v5.jsx)(_v11.ModalBody, {
          py: 14,
          px: 6,
          children: (0, _v5.jsxs)(_v22.VStack, {
            align: "center",
            gap: 4,
            children: [(0, _v5.jsx)(_v19.Spinner, {
              size: "lg"
            }), (0, _v5.jsx)(_v20.Text, {
              variant: "body-md",
              color: "text-secondary",
        ...
        }), "qualified" === _v6 && (0, _v5.jsxs)(_v5.Fragment, {
          children: [(0, _v5.jsx)(_v15.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            ...
            children: (0, _v5.jsxs)(_v22.VStack, {
              ...
              children: [(0, _v5.jsx)(_v6.Box, {
                ...
                children: (0, _v5.jsx)(_v23.CircleCheckFilled, {
                  boxSize: "72px",
        ...
        }), "not_qualified" === _v6 && (0, _v5.jsxs)(_v5.Fragment, {
          children: [(0, _v5.jsx)(_v15.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            ...
            children: (0, _v5.jsxs)(_v22.VStack, {
              ...
              children: [(0, _v5.jsx)(_v6.Box, {
                display: "flex",
                justifyContent: "center",
                children: (0, _v5.jsx)(_v24.CloseXCircleFilled, {
                  boxSize: "72px",
        ...
        }), "error" === _v6 && (0, _v5.jsxs)(_v5.Fragment, {
          children: [(0, _v5.jsx)(_v15.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
  ...
  _v0.s(["useIndividualEligibilityModal", 0, function (_v0 = {}) {
    let [_v1, _v2] = (0, _v1.useState)(!1),
      [_v3, _v4] = (0, _v1.useState)(null);
    return {
      open: _v0 => {
        _v4(_v0 ?? null), _v2(!0);
      },
      modal: (0, _v5.jsx)(_v41, {
        isOpen: _v1,
        onClose: () => _v2(!1),
