{
  ...
  _v19.Media = (0, _v3.forwardRef)(({
    ...
    let {
      ...
      [_v7] = (0, _v11.useToken)("space", ["space.200"]),
      _v8 = _v4 ? 0 : _v14.NAV_HEIGHT,
    ...
    return (0, _v3.useEffect)(() => {
      ...
      children: (0, _v1.jsx)(_v9.DrawerContent, {
        ...
        containerProps: {
          style: _v2,
          top: _v10 ? `calc(min(calc(${(0, _v12.rem)(_v11)} + ${_v7}), calc(100vh - 350px)))` : (0, _v12.rem)(_v11),
          bottom: 0
        },
        sx: {
