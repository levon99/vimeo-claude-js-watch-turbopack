{
  ...
  _v0.s(["withResponsiveValue", 0, _v24], 0);
  var _v25 = _v0.i(0),
    _v26 = _v0.i(0),
    _v27 = _v0.i(0);
  let _v28 = ({
    ...
    let {
      ...
      let _v3 = _v2 && "s" === _v0 ? "m" : _v0,
        _v4 = (_v2 ? _v26.playerGridSizeMap : _v26.thumbnailGridSizeMap)[_v3],
        _v5 = _v4.base,
        _v6 = (0, _v25.useBreakpointValue)(_v4);
      return {
    ...
    return {
      ...
      handleVideoCardClick: (0, _v2.useCallback)((_v0, _v1) => {
        (0, _v27.isModifierOrMiddleClick)(_v0) || (_v0.preventDefault(), _v3?.(_v2 ? _v1.uri : _v1.link, _v1.clipId || "", _v1.privacy.view, _v1.user.uri, _v1.live));
      }, [_v2, _v3]),
      numColumns: _v7
    };
  };
  ...
  let _v34 = 16 / 9,
    ...
    _v38 = ({
      ...
      let [_v9, _v10] = (0, _v2.useState)(!1),
        ...
        _v18 = (0, _v27.getEventIdFromClip)(_v0),
        _v19 = _v5 && !_v18 && !!_v4,
        _v20 = (0, _v2.useMemo)(() => _v33.EmbedPlayerUtility.createEmbedUrl(_v4, {
          autoplay: 1,
          muted: 1,
          controls: 0,
          autopause: 0,
        ...
        _v21 = (0, _v2.useMemo)(() => _v18 ? _v33.EmbedPlayerUtility.createEmbedUrl((0, _v27.getEventEmbedUrl)(_v0), {
          ..._v26.DEFAULT_SHOWCASE_PLAYER_EMBED_OVERRIDE_QUERY,
          autoplay: 0,
          muted: 1
        ...
        _v26 = (0, _v2.useMemo)(() => _v19 ? (0, _v1.jsxs)(_v1.Fragment, {
          children: [_v23 && _v8 && (0, _v1.jsx)(_v30.Box, {
            ..._v36,
            border: "0",
            zIndex: "0",
            opacity: _v16 && _v22 ? 1 : 0,
            children: (0, _v1.jsx)(_v32.EmbedPlayer, {
              title: _v3,
              src: _v20,
              style: {
                pointerEvents: "none"
        ...
        }) : _v18 ? (0, _v1.jsx)(_v32.EmbedPlayer, {
          src: _v21,
          disableAPI: !0
        }, `${_v18}-embed`) : _v2 ? (0, _v1.jsx)(_v32.EmbedPlayer, {
          title: _v3,
          src: _v4,
          configUrl: _v2
        }) : (0, _v1.jsx)(_v32.EmbedPlayer, {
          src: _v4,
          disableAPI: !0
        }, "fallback-embed"), [_v19, _v22, _v23, _v11, _v6, _v7, _v20, _v3, _v4, _v2, _v21, _v18, _v16, _v8, _v17]);
      return _v1 ? (0, _v1.jsx)(_v30.Box, {
        position: "relative",
        minW: "8rem",
        aspectRatio: _v34,
        outline: "0",
        ...
        children: (0, _v1.jsx)(_v29.AspectRatio, {
          ratio: _v34,
          children: _v26
        })
      }) : null;
    ...
    _v39 = _v24(({
      ...
      isMobilePreview: _v12,
      getResponsiveValue: _v13,
      ...
      let {
        ...
        _v19 = !!_v18.showcase_autoplay_video_preview && !_v17,
        _v20 = window?.playerAssetUrls?.player_api_js ?? null,
        [_v21, _v22] = (0, _v2.useState)(!!window?.Vimeo?.Player),
        {
          direction: _v23,
          effectiveGridSize: _v24,
          gridGap: _v25,
          handleVideoCardClick: _v26,
          numColumns: _v27
        } = _v28({
          gridSize: _v1,
          isMobilePreview: _v12,
        ...
        _v29 = (0, _v2.useMemo)(() => {
          ...
          return _v1(_v20), _v0?.forEach(_v0 => _v1(_v0.playerEmbedUrl)), Array.from(_v0);
        }, [_v0, _v20, _v19]);
      return _v0 && 0 !== _v0.length ? (0, _v1.jsxs)(_v1.Fragment, {
        children: [_v29.length > 0 && (0, _v1.jsx)(_v3.default, {
          children: _v29.map(_v0 => (0, _v1.jsx)("link", {
            rel: "preconnect",
            href: _v0,
            crossOrigin: ""
          }, `preconnect-${_v0}`))
        }), _v20 && (0, _v1.jsx)(_v4.default, {
          src: _v20,
          onReady: _v28,
          onLoad: _v28
        }), (0, _v1.jsxs)(_v18.Playlist, {
          children: [(0, _v1.jsx)(_v19.PlaylistHeader, {
            header: _v4 ? {
            ...
            children: (0, _v1.jsx)(_v17.AutoplayToggle, {
            ...
            children: _v0.map(_v0 => {
              let {
                  thumbnail: _v1,
                  thumbnail2x: _v2
                } = (0, _v27.getClipThumbnails)(_v0, _v24),
                _v3 = !!(0, _v27.getEventIdFromClip)(_v0),
                _v4 = _v17 || _v19 && !_v3;
              return (0, _v2.createElement)(_v21.VideoCard, {
                ...(_v4 && {
                  thumbnail: (0, _v1.jsx)(_v38, {
                    clip: _v0,
                    clipId: _v0.clipId || (0, _v27.getClipIdFromUri)(_v0.uri),
                    embedPlayerConfigUrl: _v0.embedPlayerConfigUrl,
                    name: _v0.name,
                    playerEmbedUrl: _v0.playerEmbedUrl,
                    thumbnailSrc: _v19 ? _v1 : void 0,
                    thumbnailSrcSet: _v19 ? _v2 : void 0,
                    playOnHover: _v19,
                    isScriptLoaded: _v21
                  })
                }),
              ...
              }, _v10 && _v0.privacy.download && (_v0.live && _v0.live?.status === "done" || !_v0.live) ? (0, _v1.jsx)(_v11.Tooltip, {
    ...
    _v40 = _v24(({
      ...
      return (0, _v1.jsx)(_v8.Flex, {
        ...
        children: (0, _v1.jsxs)(_v7.VStack, {
          ...
          children: [_v0 ? (0, _v1.jsx)(_v19.PlaylistHeader, {
            width: "100%",
            header: {
              text: (0, _v15.translate)({
                singular: "{total} video",
            ...
            children: Array.from({
              ...
              children: (0, _v1.jsx)(_v23.VideoCardSkeleton, {
                numOfLines: 2
              })
    ...
    _v41 = _v24(({
      ...
      h: "100%",
      gap: "4",
      children: [(0, _v1.jsx)(_v12.VideosStack, {
        boxSize: _v0({
          base: "sm",
          md: "lg"
        })
  ...
  _v0.s(["ShowcasePlaylist", 0, _v39, "ShowcasePlaylistEmptyView", 0, _v41, "ShowcasePlaylistErrorView", 0, ({
    onRetry: _v0
  }) => (0, _v1.jsxs)(_v7.VStack, {
    alignItems: "center",
    justifyContent: "center",
    ...
    gap: "4",
    children: [(0, _v1.jsx)(_v13.CircleExclamation, {
      boxSize: {
        base: "sm",
        md: "lg"
      }
  ...
  }), "ShowcasePlaylistSkeleton", 0, _v40], 0);
}