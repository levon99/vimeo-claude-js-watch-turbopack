{
  ...
  _v0.s(["ALBUM_CONFIG_DEFAULTS", 0, {
    ...
    alignItems: "center"
  }, "sidebarItems", 0, _v17, "sidebarItemsRouteMapping", 0, _v24, "sortOptions", 0, _v36, "videoFields", 0, ["createdTime", "modifiedTime", "description", "duration", "isColdStorage", "manageLink", "link", "live.archivedTime", "live.recurringEvent.album", "live.recurringEvent.link", "live.recurringEvent.preferredStreamMethod", "live.recurringEvent.metadata.connections.liveVideo.status", "live.status", "live.archivedTime", "live.scheduledStartTime", "name", "pictures.sizes.link", "pictures.sizes.width", "pictures.defaultPicture", "privacy.download", "privacy.embed", "privacy.view", "resourceKey", "type", "uri", "user.link", "user.name", "user.pictures.sizes.link", "user.pictures.sizes.width", "user.uri", "metadata.interactions.album", "embedPlayerConfigUrl", "playerEmbedUrl"]], 0), _v0.s(["handleRedirection", 0, _v0 => {
