{
  ...
  var _v1 = _v0.i(0),
    ...
    _v8 = _v0.i(0);
  let {
      MSTeamProduction: _v9,
      MSTeamDevelopment: _v10
    } = _v7.PARTNER_APP_ID,
    _v11 = ({
      appId: _v0,
      msTeamsParams: _v1
  ...
  (0, _v2.withPageSetup)(async ({
    ...
    let _v2 = Number(_v0?.appId),
      ...
      _v4 = ![_v9, _v10].includes(_v2) || (_v3.adminOnboarding ? !!_v3.msTeamsEncryptedTeamId : !!(_v3.msTeamsEncryptedTeamUserId && _v3.teamOwnerId));
    return _v2 && _v4 ? {
      props: {
        hasThemeSupport: !0,
        appId: _v2,
