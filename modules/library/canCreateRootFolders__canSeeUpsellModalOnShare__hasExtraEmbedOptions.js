{
  ...
  let _v61 = ({
    ...
    let _v5 = (0, _v17.useWayfinderPageName)(),
      _v6 = (0, _v4.useContext)(_v33.ViewerContext),
      _v7 = (0, _v47.useNotification)(),
      {
        notifyItemMoveFailure: _v8,
        notifyItemMoveSuccess: _v9,
        notifyItemMoveToWorkspaceSuccess: _v10
      } = (0, _v47.useNotifications)(),
      {
      ...
      {
        listingParams: _v23
      } = (0, _v26.usePrivateToMeFolderListingParams)(_v4),
      _v24 = (0, _v52.useTeamUploadClipProperties)(_v4),
      ...
      } = (0, _v43.useFolderSettingsModal)(),
      {
        openFolderDefaultsModal: _v27
      } = (0, _v44.useFolderDefaultsModal)(),
      {
        open: _v28,
        close: _v29
      ...
      } = (0, _v50.useShareFolderModal)(),
      _v31 = (0, _v41.useCopyFolderLinkToast)(),
      _v32 = (0, _v45.useManageShareActionBuilder)(),
      {
        openDeleteFolderModal: _v33
      } = (0, _v42.useDeleteFolderModal)(),
      {
        openMoveModal: _v34
      } = (0, _v46.useMoveModal)(),
      {
        openSlackIntegrationModal: _v35
      } = (0, _v51.useSlackIntegrationModal)(),
      {
        handleStarMenuState: _v36
      } = (0, _v60.useStarMenuItem)(),
      {
        sendEvent: _v37
      } = (0, _v40.useAnalyticsEvents)(),
      {
      ...
      _v42 = (0, _v49.useRevalidateVideoListCaches)(),
      _v43 = (0, _v31.useCanUpSell)(),
      _v44 = (0, _v54.useReviewLinkCopiedToast)(),
      _v45 = (0, _v53.useCreateAndCopyFolderReviewLink)((0, _v4.useCallback)((_v0, _v1) => {
        _v44(() => _v30?.(_v0, "sidebar", "CREATE_REVIEW_LINK_MODAL", _v1));
      }, [_v44, _v30])),
      _v46 = (0, _v57.useActivityCenterStore)(_v0 => _v0.handleNewTranslationJob),
      {
      ...
      } = (0, _v28.useLibraryTracking)(),
      {
        ...
        setSize: _v51,
        error: _v52
      } = (0, _v27.useGetUserProjectsInfinite)(() => !_v4 || _v21 ? null : {
        where: {
          userId: _v4
        },
      ...
      _v57 = (0, _v4.useCallback)(({
        ...
        _v39.BPAnalyticsV2.openFolderShare({
          location: "sidebar",
          element: "ellipses",
      ...
      _v58 = (0, _v4.useCallback)(({
        ...
        }), _v39.BPAnalyticsV2.copyFolderLink({
          location: "sidebar",
          element: "ellipses",
          teamUser: _v6?.teamUser,
          folder: _v0,
    ...
    return (0, _v1.jsxs)(_v6.Flex, {
      ...
      children: [(0, _v1.jsx)(_v15.MenuItem, {
        icon: _v22 ? (0, _v1.jsx)(_v22.TeamLibraryFilled, {}) : (0, _v1.jsx)(_v21.VideosStack, {}),
        label: _v25,
        href: `${_v18.Path.TeamLibrary}?library_referrer=sidebar`,
        active: _v3 === _v18.Path.TeamLibrary,
        action: !!_v16.canCreateRootFolders && (0, _v1.jsx)(_v37.NewFolderButton, {
          onClick: () => {
            _v26({
              userId: _v4,
        ...
        children: _v55 ? _v55.map(_v0 => {
          let {
              ...
              canEditSettings: _v3,
              canInvite: _v4
            } = (0, _v58.getFolderPermissions)(_v0),
            {
              name: _v5,
              uri: _v6,
              metadata: _v7,
            ...
            _v25 = (_v0, _v1, _v2, _v3) => {
              ...
              _v2 && _v3 ? _v10(_v1, {
                ...
                _v6 && (0, _v59.switchTeam)(_v2, _v6.xsrft).finally(() => {
          ...
          return (0, _v1.jsx)(_v34.FolderMenuItem, {
            action: (0, _v1.jsx)(_v29.FolderMenu, {
        ...
        }) : (0, _v1.jsx)(_v36.LoadingFolders, {})
      }), !!_v49 && !_v54 && !_v53 && (0, _v1.jsx)(_v35.InfiniteLoadingZone, {
        onVisible: _v59,
  ...
  var _v62 = _v0.i(0),
    _v63 = _v0.i(0);
  let _v64 = _v0 => (0, _v1.jsx)(_v63.Icon, {
    viewBox: "0 0 24 24",
    ..._v0,
    fill: "none",
  ...
  let _v66 = ({
      ...
      let _v6 = (0, _v17.useWayfinderPageName)(),
        _v7 = (0, _v4.useContext)(_v33.ViewerContext),
        ...
        {
          data: _v12
        } = (0, _v65.useGetUserFoldersPrivateToMe)({
          where: {
            ownerId: _v5
          },
      ...
      return (0, _v1.jsx)(_v1.Fragment, {
        children: _v12 ? (0, _v1.jsx)(_v34.FolderMenuItem, {
          hasSubfolders: _v12.hasSubfolder,
          action: _v13 && (0, _v1.jsx)(_v37.NewFolderButton, {
            onClick: () => {
              _v10({
                userId: _v5,
                parentFolderUri: null,
          ...
          closeSideNav: _v0,
          label: _v3,
          icon: _v1 ? (0, _v1.jsx)(_v64, {}) : (0, _v1.jsx)(_v62.PersonUser, {}),
          isMobile: _v2,
          isOpen: _v8,
          onClick: () => {
        ...
        }, "private_to_me") : (0, _v1.jsx)(_v36.LoadingFolders, {})
      });
    },
    _v67 = () => {
      let _v0,
        ...
        {
          capabilities: _v6
        } = (0, _v10.useCapability)(["hasSharedWithMe"], _v4),
        {
          contentSpaceEnabled: _v7
        } = (0, _v9.useContentSpaceEnabled)(_v4),
        _v8 = (0, _v3.useRouter)(),
        _v9 = (0, _v17.useWayfinderPageName)(),
        {
          isPrivate: _v10
        } = _v8.query,
        [_v11, _v12] = (0, _v4.useState)("true" === _v10),
        [_v13, _v14] = (0, _v4.useState)("false" === _v10),
        _v15 = (0, _v13.useWindowSize)().width <= _v14.BreakPoints.sm,
        _v16 = (_v0 = _v18.Path.SharedWithMe, _v8.pathname === _v0),
        _v17 = window.location.pathname,
        _v18 = (_v1 = _v18.Path.MVV, _v8.pathname === _v1) ? (0, _v19.getFolderIdFromFolderUri)(_v17) : 0,
        {
          data: _v19,
          isLoading: _v20,
          error: _v21
        } = (0, _v11.useGetUserProject)(() => _v4 && _v18 ? {
          where: {
            userId: _v4,
            projectId: _v18
          },
      ...
      (0, _v4.useEffect)(() => {
        (void 0 !== _v10 || _v8.pathname === _v18.Path.TeamLibrary) && ("true" === _v10 ? (_v12(!0), _v14(!1)) : (_v14(!0), _v12(!1)));
      }, [_v10, _v8.pathname]);
      let _v26 = _v11 || _v13 || _v8.pathname === _v18.Path.TeamLibrary;
      return (0, _v1.jsx)(_v1.Fragment, {
        children: (0, _v1.jsxs)(_v6.Flex, {
          ...
          children: [(0, _v1.jsx)(_v15.MenuItem, {
            ...
            children: _v26 ? _v11 ? (0, _v1.jsx)(_v66, {
              closeSideNav: _v5,
  ...
  _v0.s(["LibrarySideNavContent", 0, _v67], 0), _v0.s(["SideNavContent", 0, ({
    surface: _v0
  }) => "home" === _v0 ? (0, _v1.jsx)(_v2.HomeSideNavContent, {}) : (0, _v1.jsx)(_v67, {})], 0);
}