  ...
  _v0.s(["VideoMenu", 0, function ({
    ...
    let _v18 = (0, _v5.rem)(24),
      ...
      _v90 = (0, _v2.useCallback)(() => {
        _v64?.(_v37, "VL_grid_view_overflow", void 0, void 0, void 0, {
          pageSource: "library",
          entryPoint: "share_menu"
        }), _v41.BPAnalyticsV2.openVideoShare({
      ...
      _v105 = !!_v104?.bi_expiring_links_ux_enabled,
      {
        ...
        replaceInput: _v107,
        replaceModal: _v108
      } = (0, _v34.useReplaceWithModal)(_v38, !!_v104?.new_replace_feature, _v0.metadata?.connections?.versions?.hasInteractive, _v34.navigateToUpgrade, (0, _v44.idFromUri)(_v0.user.uri), "library"),
    ...
    return isNaN((0, _v44.idFromUri)(_v37)) ? (0, _v1.jsx)(_v1.Fragment, {}) : _v0.isColdStorage ? (0, _v1.jsxs)(_v21.ActionsMenu, {
      ...
      children: [(0, _v1.jsx)(_v22.VideoMenu, {
        ...
        canUseBulkTranslation: _v54 && !!_v42.hasEnterprise,
