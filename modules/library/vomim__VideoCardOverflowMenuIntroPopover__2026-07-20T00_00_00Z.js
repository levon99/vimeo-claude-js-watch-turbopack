{
  ...
  _v0.s(["VideoCardOverflowMenuIntroPopover", 0, function ({
    ...
    let {
      ...
      let _v1 = (0, _v8.useOptionalViewer)(),
        _v2 = _v1?.user?.id ?? null,
        _v3 = _v1?.user?.createdTime,
        {
          data: _v4,
          mutate: _v5
        } = (0, _v6.useGetUserPreferences)(() => _v2 ? {
          where: {
            userId: _v2
          },
          select: [_v12]
        ...
        _v7 = (0, _v2.useMemo)(() => () => _v11.isDismissed(_v2), [_v2]),
        _v8 = (0, _v2.useSyncExternalStore)(_v11.subscribe, _v7, () => !1),
        _v9 = !!_v3 && new Date(_v3) > new Date("2026-07-20T00:00:00Z"),
        _v10 = void 0 !== _v4,
        _v11 = !!_v4?.[_v12],
        _v12 = _v10 && !_v11 && !_v8 && !_v9,
        _v13 = _v0 && _v12,
        _v14 = (0, _v2.useCallback)(() => {
          !_v11.isDismissed(_v2) && (_v11.dismiss(_v2), _v2 && _v6({
            where: {
              userId: _v2
            },
            select: [_v12],
        ...
        _v15 = (0, _v2.useRef)(_v0);
      return (0, _v2.useEffect)(() => {
        let _v0 = _v15.current && !_v0;
        _v15.current = _v0, _v0 && _v12 && _v14();
      }, [_v0, _v12, _v14]), {
        isOpen: _v13,
        acknowledge: _v14
      };
