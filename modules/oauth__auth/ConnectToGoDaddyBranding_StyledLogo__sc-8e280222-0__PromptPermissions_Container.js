...
`,
  ...
  var _v29 = _v0.i(0),
    _v30 = _v0.i(0),
    _v31 = _v0.i(0);
  let _v32 = (0, _v6.default)(_v11.Button).withConfig({
...
`,
    _v34 = (0, _v6.default)(_v14.Paragraph).withConfig({
...
`,
  ...
  function _v38() {
    let [_v0, _v1] = (0, _v5.useState)(!1),
      ...
      _v7 = _v5?.state,
      _v8 = _v5?.auth_action,
      _v9 = (0, _v30.getSingleRedirectUri)(_v4.query.redirect_uri),
    ...
    if (void 0 === _v14 && ("godaddy_create" === _v13 || "godaddy_upload" === _v13) && (_v15 = "godaddy"), (0, _v5.useEffect)(() => {
      ...
      if (_v2) {
        ...
        if ("0" !== _v12 && _v10 === _v29.TransferStatus.TRANSFER_COMPLETED && _v6) return void window.location.replace((0, _v31.transformLink)(_v6, _v5));
      }
  ...
  var _v39 = _v0.i(0),
    ...
    _v42 = _v0.i(0),
    _v43 = _v0.i(0);
  let _v44 = (0, _v6.default)(_v11.Button).withConfig({
  ...
  margin-top: ${(0, _v4.rem)(4)};
`,
    _v45 = _v6.default.div.withConfig({
  ...
  margin-bottom: ${(0, _v4.rem)(24)};
`,
    _v46 = (0, _v6.default)(_v14.Paragraph).withConfig({
  ...
  margin-bottom: 0;
`,
    _v47 = (0, _v6.default)(_v13.ChevronDown).withConfig({
...
`,
    _v48 = (0, _v6.default)(_v11.Button).attrs({
      variant: "hyperminimal"
    }).withConfig({
...
`,
  ...
  function _v50({
    ...
    let _v1,
      {
        setTheme: _v2
      } = (0, _v5.useContext)(_v39.ThemeDispatchContext),
      [_v3, _v4] = (0, _v5.useState)(!1),
      [_v5, _v6] = (0, _v5.useState)(!1),
      [_v7, _v8] = (0, _v5.useState)((0, _v43.getCopyForApp)(0)),
      ...
      _v18 = (0, _v30.getSingleRedirectUri)(_v11.query.redirect_uri),
      ...
      _v24 = _v23 ?? (0, _v43.getTrackingName)(_v0?.app_id, _v22),
      _v25 = _v22 ?? _v24,
      _v26 = !!_v17;
    ...
    let _v27 = async (_v0 = []) => {
      ...
      },
      {
        data: _v29,
        loading: _v30
      } = (0, _v40.useQuery)(`/apps/${_v0.app_id}?fields=name,thumbnail,callbacks`);
    (0, _v5.useEffect)(() => {
      if (!_v30 && _v29 && _v0 && (!_v18 || _v18.match(/\/apps\/[0-9]+\/create.*/)?.index !== 0 && _v18.match(/\/apps\/[0-9]+\/preview.*/)?.index !== 0)) {
        ...
        _v8((0, _v43.getCopyForApp)(_v0.app_id ?? "0", _v29));
      }
      ...
      if (_v9 && _v0) {
        ...
        if (_v0.managed_user?.id && _v0.managed_user?.transfer_status === _v29.TransferStatus.TRANSFER_COMPLETED && _v13) return void window.location.replace((0, _v31.transformLink)(_v13, _v12));
      }
    ...
    if ((0, _v5.useEffect)(() => {
      _v0.app_id && (0, _v43.canSkipGrantStep)(_v0.app_id) ? (_v2(_v42.themes.dark), _v6(!0), _v9 && _v32()) : _v6(!1);
    ...
    return (0, _v1.jsxs)(_v1.Fragment, {
      children: [(0, _v1.jsxs)(_v23.Layout, {
        ...
        }), _v35 && _v36 && _v37 && _v37.length > 0 && !_v37.includes(_v36) && (0, _v1.jsx)(_v41.Notice, {
          format: "negative",
          children: (0, _v43.getPartnerEmailWarningCopy)(_v35, _v37.join(", "), _v36)
        }), (0, _v1.jsx)(_v23.PromptMessage, {
          size: "2",
          style: {
            textAlign: "left"
  ...
  (0, _v3.withPageSetup)(async _v0 => {
    ...
    let _v0 = (0, _v2.useRouter)(),
      ...
      } = _v0.query,
      {
        isLoading: _v3,
        userInfo: _v4
      } = (0, _v51.useManagedUserOauthInfo)((0, _v51.decodeOAuthQuery)(_v0.query));
    return _v1 ? (0, _v1.jsx)(_v23.Layout, {
      children: (0, _v1.jsx)(_v23.Loader, {})
    }) : parseInt(_v2, 10) === _v43.PartnerAppIds.GoDaddyProductionApp ? (0, _v1.jsx)(_v38, {}) : !_v3 && _v4.app_id ? (0, _v1.jsx)(_v50, {
      userInfo: _v4
