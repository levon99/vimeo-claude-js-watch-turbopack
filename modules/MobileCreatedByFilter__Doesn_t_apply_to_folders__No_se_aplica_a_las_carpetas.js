  ...
  _v0.s(["MobileCreatedByFilter", 0, ({
    ...
    let _v11,
      ...
      _v19 = _v16.map(_v0 => (0, _v1.jsx)(_v3.Box, {
        ...
        children: (0, _v1.jsx)(_v5.Checkbox, {
          borderRadius: "sm",
          width: "100%",
          size: "md",
    ...
    return (0, _v1.jsxs)(_v17.MobileFilter, {
      label: (_v11 = (0, _v13.translate)({
        singular: "Created by",
        dictionary: {
          es: {
            singular: "Creado por"
      ...
      children: [(0, _v1.jsx)(_v16.FilterSearch, {
        searchTerm: _v3,
        setSearchTerm: _v6,
        placeholderText: (0, _v13.translate)({
      ...
      }) : (0, _v1.jsx)(_v10.Stack, {
        maxHeight: (0, _v8.rem)(400),
        overflowY: "scroll",
        overflowX: "hidden",
        marginTop: "sm",
        children: (0, _v1.jsxs)(_v3.Box, {
          ...
          children: [_v19, (0, _v1.jsxs)(_v6.Flex, {
            alignItems: "center",
            justifyContent: "center",
            children: [!_v10 && !_v7 && !_v17 && (0, _v1.jsx)(_v4.Button, {
              variant: "tertiary",
