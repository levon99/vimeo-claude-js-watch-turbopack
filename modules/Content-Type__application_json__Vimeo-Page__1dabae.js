{
  ...
  function _v36({
    ...
    let _v4 = _v3 ?? "step1_respondent_type",
      ...
      _v23 = (0, _v2.useMemo)(() => {
        let _v0 = new Map();
        return _v17?.questions?.forEach(_v0 => _v0.set(_v0.id, _v0)), {
          respondentType: _v0.get(_v32),
          usage: _v0.get(_v33),
          teamSize: _v0.get(_v34),
          reason: _v0.get(_v35)
        };
      }, [_v17]),
      _v24 = _v13.trim().length,
      _v25 = _v24 >= 50,
      _v26 = (0, _v2.useCallback)(() => {
        _v6(_v4), _v8(""), _v10(""), _v12(""), _v14(""), _v16("");
      }, [_v4]),
      _v27 = (0, _v2.useCallback)(() => {
        _v26(), _v1();
      }, [_v1, _v26]),
      _v28 = (0, _v2.useCallback)(() => {
        _v3 ? _v27() : window.location.reload();
      }, [_v27, _v3]),
      _v29 = (0, _v2.useCallback)(async (_v0, _v1) => {
        _v6("submitting");
        ...
        try {
          let [_v0] = await Promise.all([(0, _v22.putMeSurvey)({
            ...
            headers: {
              "Content-Type": "application/json",
              Authorization: _v20 ? `jwt ${_v20}` : "",
              "Vimeo-Page": `${_v21}`,
              "Accept-Language": _v22 ?? "en"
            }
          }), _v2]);
          _v1(_v0?.outcome);
        } catch (_v0) {
          _v16(_v0 instanceof Error ? _v0.message : String(_v0)), _v6("error");
        }
      }, [_v19, _v20, _v22, _v21]),
      _v30 = (0, _v2.useCallback)(() => {
        _v7 && _v6("step2_vimeo_usage");
      }, [_v7]),
      _v31 = (0, _v2.useCallback)(() => {
        _v9 && _v6("step3_team_size");
      }, [_v9]),
      _v32 = (0, _v2.useCallback)(() => {
        _v11 && _v6("step4_reason");
      }, [_v11]),
      _v33 = (0, _v2.useCallback)(() => {
        ...
        }], _v0 => _v6("qualified" === _v0 ? "qualified" : "not_qualified"));
      }, [_v25, _v13, _v7, _v29, _v11, _v9]),
    ...
    if (!_v0) return null;
    let _v35 = !_v18 && !!(_v23.respondentType && _v23.usage && _v23.teamSize && _v23.reason),
      _v36 = "qualified" === _v5 || "not_qualified" === _v5 ? _v28 : _v27;
    return (0, _v1.jsxs)(_v7.Modal, {
      ...
      children: [(0, _v1.jsx)(_v13.ModalOverlay, {}), (0, _v1.jsxs)(_v10.ModalContent, {
        ...
        children: [(0, _v1.jsx)(_v9.ModalCloseButton, {
          onClick: _v36,
          zIndex: 1
        }), "step1_respondent_type" === _v5 && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsx)(_v12.ModalHeader, {
            ...
            children: (0, _v1.jsx)(_v5.Header, {
              as: "h3",
              size: "md",
              children: _v23.respondentType?.question ?? (0, _v29.translate)({
            ...
            children: (0, _v1.jsxs)(_v19.VStack, {
              ...
              children: [(0, _v1.jsx)(_v17.Text, {
                ...
                children: _v23.respondentType?.description ?? (0, _v29.translate)({
              ...
              }), _v35 && _v23.respondentType && (0, _v1.jsx)(_v15.RadioGroup, {
                value: _v7,
                onChange: _v0 => _v8(_v0),
                children: (0, _v1.jsx)(_v19.VStack, {
                  align: "stretch",
                  gap: 3,
                  children: _v23.respondentType.answers.map(_v0 => (0, _v1.jsx)(_v14.Radio, {
                    value: _v0.id,
        ...
        }), "step2_vimeo_usage" === _v5 && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsx)(_v12.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            children: (0, _v1.jsx)(_v5.Header, {
              as: "h3",
              size: "md",
              children: _v23.usage?.question ?? (0, _v29.translate)({
                singular: "Tell us about yourself",
                dictionary: {
                  es: {
                    singular: "Cuéntenos sobre usted"
            ...
            children: (0, _v1.jsxs)(_v19.VStack, {
              ...
              children: [(0, _v1.jsx)(_v17.Text, {
                variant: "body-md",
                color: "text-secondary",
                children: _v23.usage?.description ?? (0, _v29.translate)({
              ...
              }), _v23.usage && (0, _v1.jsx)(_v15.RadioGroup, {
                value: _v9,
                onChange: _v0 => _v10(_v0),
                children: (0, _v1.jsx)(_v19.VStack, {
                  align: "stretch",
                  gap: 3,
                  children: _v23.usage.answers.map(_v0 => (0, _v1.jsx)(_v14.Radio, {
                    value: _v0.id,
        ...
        }), "step3_team_size" === _v5 && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsx)(_v12.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            children: (0, _v1.jsx)(_v5.Header, {
              as: "h3",
              size: "md",
              children: _v23.teamSize?.question ?? (0, _v29.translate)({
                singular: "Tell us about yourself",
                dictionary: {
                  es: {
                    singular: "Cuéntenos sobre usted"
            ...
            children: (0, _v1.jsxs)(_v19.VStack, {
              ...
              children: [(0, _v1.jsx)(_v17.Text, {
                variant: "body-md",
                color: "text-secondary",
                children: _v23.teamSize?.description ?? (0, _v29.translate)({
              ...
              }), _v23.teamSize && (0, _v1.jsx)(_v15.RadioGroup, {
                value: _v11,
                onChange: _v0 => _v12(_v0),
                children: (0, _v1.jsx)(_v19.VStack, {
                  align: "stretch",
                  gap: 3,
                  children: _v23.teamSize.answers.map(_v0 => (0, _v1.jsx)(_v14.Radio, {
                    value: _v0.id,
        ...
        }), "step4_reason" === _v5 && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsx)(_v12.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
            children: (0, _v1.jsx)(_v5.Header, {
              as: "h3",
              size: "md",
              children: _v23.reason?.question ?? (0, _v29.translate)({
            ...
            children: (0, _v1.jsxs)(_v19.VStack, {
              ...
              children: [(0, _v1.jsx)(_v17.Text, {
                variant: "body-md",
                color: "text-secondary",
                children: _v23.reason?.description ?? (0, _v29.translate)({
                ...
                placeholder: _v23.reason?.placeholder ?? (0, _v29.translate)({
                ...
                children: [(0, _v1.jsx)(_v17.Text, {
                  ...
                  variant: "body-sm",
                  color: _v25 ? "status-positive-primary" : "text-tertiary",
                  children: `${_v24} / 50`
                })]
              })]
            })
        ...
        }), "submitting" === _v5 && (0, _v1.jsx)(_v8.ModalBody, {
          py: 14,
          px: 6,
          children: (0, _v1.jsxs)(_v19.VStack, {
            align: "center",
        ...
        }), "not_qualified" === _v5 && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsx)(_v12.ModalHeader, {
            pt: 6,
            pb: 0,
            px: 6,
