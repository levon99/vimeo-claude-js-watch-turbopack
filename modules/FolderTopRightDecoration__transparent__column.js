{
  ...
  _v0.s(["FolderTopRightDecoration", 0, ({
    ...
    let {
      ...
      _v8 = (0, _v14.useNotification)(),
      _v9 = (0, _v17.usePageName)(),
      _v10 = (0, _v16.useFolderShareClick)({
        folder: _v0,
        analytics: {
      ...
      _v11 = (0, _v11.useViewer)(),
      {
        getFolderShareLoopTrackingParams: _v12
      } = (0, _v15.useShareLoopTrackingParams)(),
      _v13 = _v7?.hasLibrarySidePanel ? null : (0, _v1.jsx)(_v19.StarredIconContainer, {
        type: "folder",
        uri: _v0.uri,
        entity: _v0,
      ...
      _v14 = _v10 ? (0, _v1.jsx)(_v4.Tooltip, {
        ...
        children: (0, _v1.jsx)(_v3.IconButton, {
          ...
          onClick: _v0 => {
            _v0.currentTarget.blur(), _v10(), _v0.preventDefault(), _v0.stopPropagation();
          }
        })
      }) : null;
    return (0, _v1.jsxs)(_v2.Flex, {
      ...
      direction: _v4,
      zIndex: 10,
      children: ["column" === _v4 ? _v13 : _v14, _v6 && (0, _v1.jsx)(_v4.Tooltip, {
        label: (0, _v9.translate)({
          singular: "Rename",
          dictionary: {
            es: {
        ...
        children: (0, _v1.jsx)(_v3.IconButton, {
          ...
          onClick: _v0 => {
            let _v1 = _v0.uri.split("/"),
              _v2 = _v12(_v9, !!_v0.isPrivateToUser),
              _v3 = `${window.location.protocol}//${window.location.hostname}/user/${_v1[2]}/folder/${_v1[4]}${_v2}`;
            (0, _v10.default)(_v3) ? _v8({
              content: _v18.linkCopySuccess
            }) : _v8({
