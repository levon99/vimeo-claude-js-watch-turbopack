    ...
    _v62 = ({
      ...
      let _v1,
        ...
        } = (0, _v10.useCapability)(["hasSharedWithMe"], _v5),
        {
          ...
          notTeamGatedContentSpaceEnabled: _v9,
          loading: _v10
        } = (0, _v9.useContentSpaceEnabled)(_v5),
        _v11 = (0, _v3.useRouter)(),
        _v12 = (0, _v17.useWayfinderPageName)(),
        {
          isPrivate: _v13
        } = _v11.query,
        [_v14, _v15] = (0, _v4.useState)("true" === _v13),
        [_v16, _v17] = (0, _v4.useState)("false" === _v13),
        _v18 = (0, _v13.useWindowSize)().width <= _v14.BreakPoints.sm,
        _v19 = (_v1 = _v18.Path.SharedWithMe, _v11.pathname === _v1),
        _v20 = (_v2 = _v18.Path.MVV, _v11.pathname === _v2) ? (0, _v19.getFolderIdFromFolderUri)(_v11.asPath) : 0,
        {
          data: _v21,
          isLoading: _v22,
          error: _v23
        } = (0, _v11.useGetUserProject)(() => _v5 && _v20 ? {
          where: {
            userId: _v5,
            projectId: _v20
          },
        ...
        _v24 = _v21?.metadata?.connections?.ancestorPath ?? [],
        _v25 = _v24.length > 0 ? _v24[_v24.length - 1] : null,
        _v26 = !_v22 && !_v23 && _v25?.name === _v18.SHARED_WITH_ME_DIR_NAME,
        _v27 = _v7.hasSharedWithMe && (_v19 || _v26);
      (0, _v4.useEffect)(() => {
        (void 0 !== _v13 || _v11.pathname === _v18.Path.TeamLibrary) && ("true" === _v13 ? (_v15(!0), _v17(!1)) : (_v17(!0), _v15(!1)));
      }, [_v13, _v11.pathname]);
      let _v28 = !_v10 && _v9 && !_v8,
        _v29 = _v14 || _v16 || _v11.pathname === _v18.Path.TeamLibrary;
      return (0, _v1.jsx)(_v1.Fragment, {
        children: (0, _v1.jsxs)(_v6.Flex, {
          ...
          children: [!_v0 && (0, _v1.jsx)(_v15.MenuItem, {
            ...
            children: _v29 ? _v28 || !_v14 || _v10 ? (0, _v1.jsx)(_v59, {
              closeSideNav: _v6,
              isMobile: _v18,
              loadingSideNavFolderURIs: _v3,
