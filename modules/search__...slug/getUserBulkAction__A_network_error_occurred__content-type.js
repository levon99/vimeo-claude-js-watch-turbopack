{
  ...
  async function _v4({
    ...
    return (0, _v2.measureLatency)("getUserBulkAction", "GET", async () => {
  ...
  function _v10(_v0, _v1) {
    ...
    return (0, _v5.default)(_v2 ? `/users/${_v2.where.userId}/bulk_actions/${_v2.where.batchId}${(0, _v7.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v4({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v7.assignMswData)(_v10, {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/users/${_v0.where.userId}/bulk_actions/${_v0.where.batchId}${(0, _v7.serializeQuery)(_v0)}`, _v4({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/users/:userId/bulk_actions/:batchId",
    method: "GET"
  }), _v0.s(["useGetUserBulkAction", 0, _v10], 0);
}