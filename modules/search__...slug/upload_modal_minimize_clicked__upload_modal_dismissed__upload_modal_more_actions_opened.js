{
    ...
    _v44 = ({
      ...
      let _v1 = (0, _v31.useRouter)(),
        ...
        _v7 = (({
          ...
          }, [_v10?.name, _v10?.manageLink, _v10?.isPrivateToUser, _v7, _v8, _v1, _v9, _v11?.manageLink]);
        })({
          upload: _v2.find(({
            state: _v0
        ...
        _v12 = (0, _v2.useMemo)(() => _v6 ? (0, _v1.jsx)(_v34.Checkmark, {
          boxSize: "xs"
        }) : _v5 ? (0, _v1.jsx)(_v36.CloseXCircle, {
          boxSize: "xs"
        }) : _v4 && 0 === _v3 ? (0, _v1.jsx)(_v35.CircleExclamationFilled, {
      ...
      return (0, _v1.jsxs)(_v8.Flex, {
        ...
        children: [_v12, (0, _v1.jsxs)(_v33.VStack, {
          gap: "xs",
  ...
  let _v81 = ({
    ...
    _v82 = /\.(mp4|avi|mov|wmv|flv|MP4|AVI|MOV|WMV|FLV)$/;
  var _v83 = _v0.i(0),
    _v84 = _v0.i(0),
    _v85 = _v0.i(0);
  ...
  let _v88 = (0, _v2.forwardRef)(({
      ...
      switch (_v1.state) {
        ...
        case _v4.STATES.CANCELED:
          break;
        default:
          if (_v2) _v12 = (0, _v1.jsx)(_v86, {
            boxSize: "xs"
          });else {
            let _v0 = Math.floor(100 * _v1.bytesUploaded / _v1.initialSize);
            _v12 = (0, _v1.jsx)(_v83.CircularProgress, {
              size: "sm",
              value: _v0,
              color: "text-primary",
              ..._v11
    ...
    _v91 = "changes-saved-toast",
    _v92 = "changes-could-not-be-saved-toast",
    _v93 = ({
      upload: _v0,
      isPaused: _v1,
      isCanceled: _v2,
      ...
      let {
        ...
        _v17 = (0, _v2.useRef)(null),
        {
          ...
          let {
            ...
            } = (0, _v78.useViewPrivacyChangeTracking)(),
            [_v2, {
              data: _v3,
              called: _v4,
              loading: _v5,
              error: _v6
            }] = (0, _v77.usePatchVideo)(),
            {
              data: _v7,
              mutate: _v8
            } = (0, _v77.useGetVideo)(() => _v0 ? {
            ...
            _v9 = async (_v0, _v1) => {
              ...
              await _v2({
                ...
                previousPrivacy: _v2,
                newPrivacy: _v0,
                entryPoint: "upload_privacy_selector"
              }), _v8(_v0 => _v0 ? {
                ..._v0,
                privacy: {
                  ..._v0.privacy,
      ...
      (0, _v2.useEffect)(() => {
        _v22 && !_v21 && (_v24 ? _v16.current.isActive(_v92) || _v16.current({
          id: _v92,
          duration: 0,
        ...
        }) : _v23 && !_v16.current.isActive(_v91) && _v16.current({
          id: _v91,
          title: (0, _v17.translate)({
            ...
            case _v4.STATES.UPLOADING:
              if (void 0 !== _v4) {
                ...
                if (_v4 < 2) _v0 = _v0 > 75 ? (0, _v17.translate)({
                  ...
                  let _v0 = _v89(_v0.bytesUploaded, 1, !0),
                    _v1 = _v89(_v0.initialSize, 1, !0);
      ...
      return (0, _v1.jsx)(_v8.Flex, {
        ...
        children: (0, _v1.jsxs)(_v8.Flex, {
          as: _v70.motion.div,
          onClick: !_v3 && (0, _v71.default)(_v12) ? _v25 : void 0,
          alignItems: "center",
          cursor: "pointer",
          gap: "sm",
          ...
          transition: {
            transform: !_v3 && (0, _v71.default)(_v12) ? "100ms ease-in-out" : void 0
          },
          sx: {
            ...(_v3 ? _v90 : {})
          },
          ...
          children: [(0, _v1.jsx)(_v81, {
            ...
            overflow: "hidden",
            width: "100%",
            children: [(0, _v1.jsx)(_v74.Header, {
              className: "embeddable-uploader-file-name",
              overflow: "hidden",
              textOverflow: "ellipsis",
              whiteSpace: "nowrap",
              size: "xs",
              children: _v0.file.name.replace(_v82, "")
            }), (0, _v1.jsxs)(_v8.Flex, {
              display: "flex",
              ...
              margin: "0 auto",
              flexWrap: "wrap",
              children: [_v0.state !== _v4.STATES.FAILED ? _v21 ? (0, _v1.jsx)(_v75.Skeleton, {
                mt: "xs",
                width: (0, _v12.rem)(50),
                ...
                children: _v0.state === _v4.STATES.COMPLETED ? (0, _v1.jsxs)(_v11.Text, {
                  ...
                  textOverflow: "ellipsis",
                  whiteSpace: "nowrap",
                  children: [(0, _v1.jsx)(_v76.CircleCheckFilled, {
                    color: "text-primary",
                    boxSize: "2xs",
                    flexShrink: 0
                  }), _v30]
  ...
  function _v94({
    ...
    return (0, _v1.jsx)(_v8.Flex, {
      ...
      paddingBottom: "md",
      children: _v0.map(_v0 => (0, _v1.jsx)(_v93, {
  ...
  let _v95 = "UPLOADER_STATE_UPDATE",
    _v96 = "SET_HIDE_ROWS",
    _v97 = "SET_IS_CANCELING",
    _v98 = "SET_SHOW_UPLOAD_CONTROLS",
    _v99 = "RESET",
    _v100 = {
      hideRows: !1,
      isCanceling: !1,
  ...
  let _v104 = {
    ...
    _v106 = ({
      ...
      return (0, _v1.jsx)(_v1.Fragment, {
        children: _v1 && (0, _v1.jsx)(_v103.default, {
          apiUrl: _v3?.apiUrl,
          userConfig: {
            jwt: _v3?.jwt,
            userId: _v3?.user?.id
    ...
    let {
      ...
      } = (0, _v3.useClipPrivacyOptions)(_v2),
      {
        ...
        let _v0 = (0, _v20.useViewer)(),
          ...
          {
            data: _v2
          } = (0, _v107.useGetUserFoldersDefault)(() => _v1 ? {
            where: {
              userId: _v1
            },
            select: ["uri"]
  ...
  _v0.s(["useUploadEmbeddable", 0, function ({
    ...
    let {
      ...
      [_v5] = (0, _v108.usePatchUserItems)(),
      _v6 = _v4.find(_v0 => _v0.clipId)?.clipId,
      _v7 = (0, _v109.useEmbeddable)(_v6) ?? (!_v2 || "private" !== _v2);
    return {
      showEmbedToggle: _v1,
      isEmbeddable: _v7,
      onEmbedToggle: () => {
        ...
        let _v0 = !_v7;
        return _v109.embeddableStore.set(_v6, _v0), _v5({
          where: {
            userId: _v0
          },
          query: {
          ...
          _v109.embeddableStore.set(_v6, !_v0);
        });
      },
      clearEmbeddable: () => {
        _v6 && _v109.embeddableStore.delete(_v6);
      }
    };
  }], 0);
}