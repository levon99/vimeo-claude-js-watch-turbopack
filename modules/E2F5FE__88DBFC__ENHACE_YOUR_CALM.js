{
  ...
  let _v18 = {
    ...
    _v20 = ["uri", "title", "userUri", "uri", "unbounded", "position", "clip_uris", "videos.total"].concat(_v19.map(_v0 => `videos.data.${_v0}`)),
    _v21 = {
      ..._v18,
      fields: _v19,
      page: 1,
