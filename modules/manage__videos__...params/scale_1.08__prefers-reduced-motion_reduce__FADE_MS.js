{
  ...
  _v0.s(["FADE_MS", 0, 0, "GLOW_BLUR_RATIO", 0, .06, "GLOW_OPACITY", 0, .45, "GLOW_SATURATE", 0, 1.6, "GLOW_TRANSFORM", 0, _v4, "SAMPLE_H", 0, 18, "SAMPLE_W", 0, 32], 0);
  let _v6 = (0, _v2.forwardRef)(function ({
    ...
    let _v4 = (0, _v2.useRef)(null),
      ...
      _v10 = _v5(),
      _v11 = `blur(${_v7 ? .06 * _v7 : 0}px) saturate(1.6)`;
