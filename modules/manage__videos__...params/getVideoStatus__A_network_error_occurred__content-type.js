{
  ...
  async function _v4({
    ...
    return (0, _v2.measureLatency)("getVideoStatus", "GET", async () => {
      let _v0 = await fetch(`${_v0}/videos/${_v2}/status?fields=${_v1.map(_v3.intoSnakeCase).join(",")}`, {
        ..._v3,
        method: "GET"
      });
  ...
  function _v10(_v0, _v1) {
    ...
    return (0, _v5.default)(_v2 ? `/videos/${_v2.where.videoId}/status${(0, _v7.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v4({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v7.assignMswData)(_v10, {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/status${(0, _v7.serializeQuery)(_v0)}`, _v4({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/videos/:videoId/status",
    method: "GET"
  }), _v0.s(["useGetVideoStatus", 0, _v10], 0);
}