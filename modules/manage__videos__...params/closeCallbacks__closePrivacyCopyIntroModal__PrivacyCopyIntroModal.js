{
  ...
  var _v1 = _v0.i(0),
    ...
    _v15 = _v0.i(0);
  let _v16 = new Set();
  _v0.s(["closeCallbacks", 0, _v16, "closePrivacyCopyIntroModal", 0, function () {
    _v16.forEach(_v0 => _v0());
    ...
    let {
      ...
      let _v0 = (0, _v15.useViewer)(),
        _v1 = _v0?.user?.id,
        {
          data: _v2,
          mutate: _v3
        } = (0, _v13.useGetUserPreferences)(() => _v1 ? {
          where: {
            userId: _v1
          },
          select: ["pcim"]
        ...
        [_v6] = (0, _v13.usePatchUserPreferences)(),
        _v7 = void 0 !== _v2,
        _v8 = !!_v2?.pcim,
        _v9 = (0, _v2.useCallback)(() => _v5(!0), []),
      ...
      return (0, _v2.useEffect)(() => (_v16.add(_v9), () => {
        _v16.delete(_v9);
      }), [_v9]), {
        isOpen: _v7 && !_v8 && !_v4,
        acknowledge: _v10,
