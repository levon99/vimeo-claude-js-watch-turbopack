{
  ...
  _v0.s(["useRestoreVersion", 0, () => {
    ...
    return (0, _v1.useEffect)(() => {
      _v7 && _v2.length > 0 && (0, _v14.idFromUri)(_v2[0].uri) < (0, _v14.idFromUri)(_v7.uri) && _v1(_v7);
      ...
      restoreVersion: (_v0, _v1) => _v3({
        ...
        headers: {
          Accept: _v13.API_ACCEPT_HEADER
        },
        select: _v13.VIDEO_VERSION_FIELDS
      }),
