{
  ...
  _v0.s(["HeaderContent", 0, ({
    ...
    children: [_v1 && (0, _v1.jsx)(_v7.IconButton, {
      "aria-label": "Back",
      variant: "tertiary",
      size: "sm",
      ...
      children: (0, _v1.jsx)(_v7.IconButton, {
        ...
        variant: "tertiary",
        size: "sm",
        icon: (0, _v1.jsx)(_v12.Plus, {}),
        isDisabled: _v7,
        onClick: _v6
      })
    }), _v2 && (0, _v1.jsx)(_v7.IconButton, {
      "aria-label": "Close",
      variant: "tertiary",
      size: "sm",
      icon: (0, _v1.jsx)(_v11.CloseX, {}),
      onClick: _v5
    })]
  })], 0);
  var _v13 = _v0.i(0),
    _v14 = _v0.i(0);
  _v0.s(["LoadingSpinner", 0, _v0 => (0, _v1.jsx)(_v13.Center, {
    h: "100%",
    flex: "1",
    ..._v0,
  ...
  let _v27 = ({
    ...
    children: [(0, _v1.jsx)(_v7.IconButton, {
      ...
      isDisabled: _v1,
      width: (0, _v17.rem)(62),
      height: `${(0, _v17.rem)(62)} !important`,
      ..._v2
    }), (0, _v1.jsx)(_v8.Text, {
      variant: "body-sm",
      textAlign: "center",
  ...
  _v0.s(["RoundIconButton", 0, _v27], 0), _v0.s(["ButtonsNavigation", 0, ({
    onClick: _v0,
    hasReviewLinks: _v1 = !1
  }) => {
    let _v2 = (0, _v25.useGlobalStore)(({
        util: _v0
      ...
      _v8 = (0, _v15.useMemo)(() => {
        ...
        return _v0 = {
          ...
          icon: (0, _v1.jsx)(_v19.PersonUserAdd, {})
        }, {
    ...
    return (0, _v1.jsx)(_v13.Center, {
      children: (0, _v1.jsx)(_v16.Box, {
        display: "grid",
        minWidth: "0",
        width: `calc(100% + ${(0, _v17.rem)(24)})`,
        mx: `${(0, _v17.rem)(-12)}`,
        gridTemplateColumns: `
          repeat(
            auto-fit,
            minmax(${(0, _v17.rem)(84)}, ${_v8.length > 3 ? (0, _v17.rem)(84) : (0, _v17.rem)(96)}
          ))`,
        justifyItems: "center",
        justifyContent: "center",
        rowGap: (0, _v17.rem)(24),
        children: _v8.map(_v0 => (0, _v1.jsx)(_v27, {
          label: _v0.label,
          icon: _v0.icon,
          isDisabled: _v2,
  ...
  var _v28 = _v0.i(0),
    _v29 = _v0.i(0);
  let _v30 = () => (0, _v1.jsxs)(_v26.VStack, {
    h: "100%",
    minH: "200px",
    justify: "center",
    children: [(0, _v1.jsx)(_v28.InfoCircle, {}), (0, _v1.jsx)(_v8.Text, {
      variant: "body-xl",
  ...
  _v0.s(["PanelErrorBoundary", 0, ({
    children: _v0
  }) => (0, _v1.jsx)(_v29.ErrorBoundary, {
    errorPage: _v30,
    children: _v0
  })], 0);
  var _v31 = _v0.i(0),
    _v32 = _v0.i(0);
  _v0.s(["SharePanelBundlePromo", 0, () => {
    let _v0 = (0, _v4.useViewer)();
    return (0, _v1.jsx)(_v31.BundlePromoTile, {
      trigger: "share_panel",
      hasSubscription: "paid" === (0, _v32.deriveViewerAuthStatus)(_v0)
    });
  }], 0), _v0.s(["useCreatePanelTitles", 0, function (_v0) {
    return (0, _v15.useMemo)(() => ({
  ...
  }], 0), _v0.s(["useInitGlobalStore", 0, ({
    clipId: _v0,
    clipHash: _v1,
    trackingContextConfig: _v2
  }) => {
    let _v3 = (0, _v25.useGlobalStore)(({
        clip: _v0
      }) => _v0.actions.setClipParams),
      _v4 = (0, _v25.useGlobalStore)(({
        util: _v0
      }) => _v0.actions.setTrackingContextConfig),
      _v5 = (0, _v25.useGlobalStore)(({
        clip: _v0
      }) => _v0.actions.resetClip),
      _v6 = (0, _v15.useRef)(_v2);
    _v6.current = _v2, (0, _v15.useEffect)(() => {
  ...
  var _v33 = _v0.i(0),
    ...
    _v37 = _v0.i(0),
    _v38 = _v0.i(0);
  let _v39 = ["url", "expiresOn", "createdOn", "uri", "intervalDays", "hasExpiration"];
  _v0.s(["formatIntervalLabel", 0, function _v0(_v1) {
    ...
    let {
      ...
      } : null, [_v1, _v2]),
      {
        ...
        mutate: _v5,
        isLoading: _v6
      } = (0, _v34.useGetVideoSharingLink)(_v3 ? () => _v3 : () => null),
      {
        data: _v7
      } = (0, _v36.useGetVideoSharingData)(),
      _v8 = _v7?.user?.uri ? (0, _v37.idFromUri)(_v7.user.uri) : null,
      _v9 = (0, _v4.useViewer)(),
      _v10 = !!_v9?.user?.uri && _v9.user.uri === _v7?.user?.uri,
      {
        data: _v11,
        isLoading: _v12
      } = (0, _v33.useGetUser)(() => _v1 && _v8 ? {
        where: {
          userId: _v8
        },
      ...
      [_v15, {
        ...
        loading: _v17,
        error: _v18
      }] = (0, _v34.usePostVideoSharingLink)(),
      [_v19, {
        loading: _v20,
        error: _v21
      }] = (0, _v34.usePatchVideoSharingLink)(),
      [_v22, _v23] = (0, _v15.useState)(null);
    (0, _v15.useEffect)(() => {
      _v16?.url && _v23(_v16);
    }, [_v16]), (0, _v15.useEffect)(() => {
      _v23(null);
    }, [_v2]);
    let _v24 = (0, _v15.useRef)(_v4);
    _v24.current = _v4;
    let _v25 = (0, _v15.useCallback)((_v0 = {}) => {
        if (!_v2) return;
      ...
      _v26 = (0, _v15.useCallback)((_v0, _v1, _v2) => {
        _v5(_v0 => _v0 ? {
          ..._v0,
          expiresOn: _v0,
          intervalDays: _v1,
      ...
      _v27 = (0, _v15.useCallback)(async (_v0, _v1, _v2) => {
        _v2 && (await _v19({
          where: {
            videoId: Number(_v2)
          },
      ...
      _v28 = (0, _v15.useCallback)(async _v0 => {
        _v2 && (await _v19({
          where: {
            videoId: Number(_v2)
          },
  ...
  let _v41 = () => {
    let _v0 = (0, _v4.useViewer)(),
      ...
      _v2 = _v1?.user?.uri,
      _v3 = _v2 ? (0, _v37.idFromUri)(_v2) : null,
      {
        data: _v4
      } = (0, _v40.useGetUserTeamRole)(() => _v3 && _v0 ? {
        where: {
          userId: _v3
        },
  ...
  _v0.s(["useGetTeamPermissionLevel", 0, _v41], 0), _v0.s(["useVideoContextData", 0, () => {
    let {
        clipId: _v0
      } = (0, _v25.useGlobalStore)(({
        clip: _v0
      }) => _v0),
      {
        data: _v1
