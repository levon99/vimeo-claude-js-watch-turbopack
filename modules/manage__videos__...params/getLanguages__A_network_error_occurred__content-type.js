{
  ...
  async function _v4({
    ...
    return (0, _v2.measureLatency)("getLanguages", "GET", async () => {
      let _v0 = await fetch(`${_v0}/languages?${(0, _v3.searchQueryString)(_v2)}&fields=${_v1.map(_v3.intoSnakeCase).join(",")}`, {
        ..._v3,
        method: "GET"
      });
  ...
  function _v11(_v0, _v1) {
    ...
    return (0, _v5.default)(_v2 ? `/languages${(0, _v7.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v4({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v7.assignMswData)(_v11, {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/languages${(0, _v7.serializeQuery)(_v0)}`, _v4({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    return (0, _v9.default)((_v0, _v1) => {
      ...
      return [`/languages?page=${_v0 + 1}&perPage=${_v2}&fields=${_v5}&${_v6}`, _v0];
    ...
    endpoint: "/languages",
    method: "GET"
  }), _v0.s(["useGetLanguages", 0, _v11], 0);
}