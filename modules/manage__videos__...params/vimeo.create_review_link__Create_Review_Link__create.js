{
  ...
  var _v1 = _v0.i(0),
    ...
    _v5 = _v0.i(0),
    _v6 = _v0.i(0);
  let _v7 = "vimeo.create_review_link",
    _v8 = "Create_Review_Link",
    _v9 = "create";
  _v0.s(["usePostReviewLink", 0, ({
    ...
    let [_v1, {
      ...
      {
        isValidating: _v5
      } = (0, _v4.useGetVideoReviewLinks)(_v0),
      _v6 = (0, _v1.useRef)(!1),
      {
        trackReviewLinkBpEvent: _v7
      } = (0, _v5.useReviewLinkAnalytics)({
        resourceId: _v0,
        resourceType: "clip",
        location: _v8,
        mode: _v9
      ...
      {
        trackReviewLinkCreated: _v8
      } = (0, _v2.useReviewTracking)();
    return (0, _v1.useEffect)(() => {
      _v6.current && _v4?.uri && (window.open((0, _v6.getVideoReviewPageUrl)(_v4.uri, _v0), "_blank"), _v6.current = !1);
    }, [_v4?.uri, _v0]), {
    ...
    let [_v1, {
      ...
      {
        isValidating: _v4
      } = (0, _v4.useGetFolderReviewLinks)(_v0),
      {
        trackReviewLinkBpEvent: _v5
      } = (0, _v5.useReviewLinkAnalytics)({
        resourceId: _v0,
        resourceType: "folder",
        location: _v8,
