{
  ...
  let _v38 = ({
    ...
    (0, _v22.useInitVersionsStore)({
      videoId: _v0,
      enabled: 0 === _v23.length,
      fields: _v34.VIDEO_VERSION_FIELDS,
      acceptHeader: _v34.API_ACCEPT_HEADER,
      itemsPerPage: 50,
      reviewId: _v14,
      password: (0, _v35.getReviewPasswordHashFromCookie)(_v14)
    });
    let {
        canLoadMore: _v25,
        ...
        let [_v7, _v8] = (0, _v5.useState)(void 0),
          ...
          {
            data: _v11
          } = (0, _v23.useGetVideoVersions)(() => _v1 && _v0 && void 0 !== _v7 ? {
            where: {
              videoId: _v0
            },
            select: _v2,
      ...
      _v28 = (0, _v25.useViewer)(),
      [_v29] = (0, _v31.useInfiniteScrollVersion)(_v25 || _v23.length < _v11, _v26),
      [_v30, _v31] = (0, _v5.useState)(null),
      [_v32, _v33] = (0, _v5.useState)(!1),
      {
        userQuota: _v34
      } = (0, _v32.useReplace)(_v0, _v14),
      {
        upload: _v35
      } = (0, _v21.useUploader)(),
      _v36 = (0, _v4.useRouter)(),
      _v37 = (0, _v5.useRef)(null),
      _v38 = (0, _v5.useRef)(null),
      _v39 = (0, _v5.useRef)(null),
      _v40 = (0, _v28.getVersionNumber)(_v9 || _v34.DEFAULT_VERSION_NUMBER),
      _v41 = _v23?.reduce((_v0, _v1) => Math.max(_v0, _v1.sequenceNumber?.toString().length ?? 0), 1) ?? 1,
      _v42 = _v34.MIN_WIDTH_FOR_SEQUENCE_NUMBER + _v41 * _v34.SEQUENCE_NUMBER_WIDTH_FOR_EACH_DIGIT,
      _v43 = _v14 ? !!_v15 : !_v4,
      _v44 = () => {
        _v37.current && (_v22(!1), _v37.current.click(), _v5 && (0, _v33.bpStartUploadVersion)({
          videoId: _v0,
          viewer: _v28,
          currentVersion: _v40,
          analyticsProps: _v5
      ...
      _v48 = (0, _v5.useCallback)(() => {
        0 !== _v23.length && (0, _v16.getVideo)({
          headers: {
            Accept: _v34.API_ACCEPT_HEADER,
            Authorization: _v47 ? `jwt ${_v47}` : ""
          },
          baseUrl: _v46,
          where: {
            videoId: _v0
          ...
          let _v1 = (0, _v35.idFromUri)(_v0?.metadata?.connections?.versions?.currentUri);
          (0, _v35.idFromUri)(_v23.at(0)?.uri) < _v1 && (0, _v17.getVideoVersion)({
            headers: {
              Accept: _v34.API_ACCEPT_HEADER,
              Authorization: _v47 ? `jwt ${_v47}` : ""
            },
            ...
            select: _v34.VIDEO_VERSION_FIELDS
          }).then(_v0 => _v24(_v0));
        });
      }, [_v24, _v46, _v23, _v47, _v0]);
    return ((0, _v5.useEffect)(() => {
      _v4 || _v6 ? _v4 && _v45.current && (_v45.current = !1, _v48()) : _v45.current = !0;
    }, [_v4, _v48, _v6]), (0, _v12.useOutsideClick)({
      enabled: _v21,
      ref: _v39,
      handler: _v0 => {
        _v38.current && _v0.target && (_v38.current == _v0.target || _v38.current?.contains(_v0.target)) || _v22(!1);
      }
    }), (0, _v20.useUploadLifecycle)((_v0, _v1) => {
      _v32 && (0, _v28.isUploadActiveOrComplete)(_v1) && _v1.clipId && (_v3 ? _v36.replace({
        pathname: `/manage/videos/${_v1.clipId}`
      }) : (_v12?.(), _v33(!1), _v31(null)));
    }, [_v32, _v3, _v36, _v12]), _v2) ? (0, _v1.jsx)(_v13.Text, {
      ...
      children: [(0, _v1.jsxs)(_v8.Menu, {
        ...
        children: [(0, _v1.jsx)(_v9.MenuButton, {
          ...
          onClick: () => {
            let _v0 = !_v21;
            _v22(_v0), _v0 && _v5 && (0, _v33.bpOpenVersionList)({
              videoId: _v0,
              viewer: _v28,
              currentVersion: _v40,
              analyticsProps: _v5
          ...
          children: (0, _v1.jsx)(_v1.Fragment, {
            children: _v11 < 2 ? (0, _v1.jsx)(_v27.EmptyVersionList, {
              isDisabled: !_v4,
              openFileUpload: _v44
            }) : (0, _v1.jsxs)(_v6.Box, {
              width: "440px",
              ...
              children: [(0, _v1.jsx)(_v6.Box, {
                ...
                p: "sm",
                pb: "0",
                children: 0 === _v23.length || _v6 ? (0, _v1.jsx)(_v30.VersionsSkeleton, {
                  width: `${_v42}px`
                }) : (0, _v1.jsxs)(_v11.MenuOptionGroup, {
                  defaultValue: _v40,
                  children: [_v43 && (0, _v1.jsx)(_v30.VersionSkeleton, {
                    width: `${_v42}px`
                  }), _v23?.map((_v0, _v1) => {
                    let _v2 = _v1 === _v23?.length - 1;
                    return _v0.isDeleted ? (0, _v1.jsx)(_v26.DeletedVersion, {
                      index: _v1,
                      isLastElement: _v2,
                      sequenceNumber: _v0.sequenceNumber ?? _v34.DEFAULT_VERSION_NUMBER,
                      isLoadingMoreVersion: _v27,
                      ref: _v29,
                      uri: (0, _v35.formVersionRedirectUri)((0, _v35.idFromUri)(_v0.uri), _v0.toString(), _v1, _v14),
                      setIsVersionMenuActive: _v22,
                      sequenceNumberWidth: _v42
                    }, `${_v0.uri}-deleted`) : (0, _v1.jsx)(_v29.VersionListItem, {
                      uri: _v0.uri,
                      videoId: _v0,
                      clipHash: _v1,
                      reviewId: _v14,
      ...
      }), !_v14 && (0, _v1.jsx)(_v37.FileUpload, {
        ...
        quota: _v34,
        clipHash: _v1
      }, `file-upload-${_v30?.[0].name}-new-version`), (0, _v1.jsx)(_v36.ConfirmUploadModal, {
        onCancel: () => {
          _v32 || _v31(null);
        },
  ...
  _v0.s(["VersionListPicker", 0, _v0 => {
    ...
    return _v1.new_replace_feature ? (0, _v1.jsx)(_v38, {
      ..._v0
