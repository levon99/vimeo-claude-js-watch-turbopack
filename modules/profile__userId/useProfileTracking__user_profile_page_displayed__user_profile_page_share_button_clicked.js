{
  ...
  _v0.s(["useProfileTracking", 0, () => {
    let _v0 = (0, _v2.usePico)(),
      ...
      _v6 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_page_follow_clicked", {
        user_profile_page_user_id: _v0.userProfilePageUserId,
        user_profile_page_follow_effect: _v0.userProfilePageFollowEffect
      }), !0), [_v0]),
      _v7 = (0, _v1.useCallback)(() => null !== _v0 && (_v0.track("user_profile_add_video_clicked", {}), !0), [_v0]),
      _v8 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_cover_video_action_clicked", {
        user_profile_cover_video_action: _v0.userProfileCoverVideoAction
      }), !0), [_v0]),
      _v9 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_edit_field_clicked", {
        user_profile_page_user_id: _v0.userProfilePageUserId,
        user_profile_edit_field: _v0.userProfileEditField
      }), !0), [_v0]),
      _v10 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_join_experts_clicked", {
        user_profile_page_user_id: _v0.userProfilePageUserId
      }), !0), [_v0]),
      _v11 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_layout_changed", {
        user_profile_layout: _v0.userProfileLayout
      }), !0), [_v0]),
      _v12 = (0, _v1.useCallback)(() => null !== _v0 && (_v0.track("user_profile_preview_clicked", {}), !0), [_v0]),
      _v13 = (0, _v1.useCallback)(() => null !== _v0 && (_v0.track("user_profile_reorder_content_clicked", {}), !0), [_v0]),
      _v14 = (0, _v1.useCallback)(() => null !== _v0 && (_v0.track("user_profile_reorder_saved", {}), !0), [_v0]),
      _v15 = (0, _v1.useCallback)(() => null !== _v0 && (_v0.track("user_profile_section_created", {}), !0), [_v0]),
      ...
      _v17 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_video_added", {
        user_profile_video_source_tab: _v0.userProfileVideoSourceTab,
        user_profile_video_count: _v0.userProfileVideoCount
      }), !0), [_v0]),
      _v18 = (0, _v1.useCallback)(() => null !== _v0 && (_v0.track("user_profile_video_reordered", {}), !0), [_v0]),
      _v19 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_video_thumbnail_resized", {
        user_profile_resize_action: _v0.userProfileResizeAction
      }), !0), [_v0]),
      _v20 = (0, _v1.useCallback)(_v0 => null !== _v0 && (_v0.track("user_profile_automatic_add_video_toggled", {
        user_profile_automatic_add_video_value: _v0.userProfileAutomaticAddVideoValue
      }), !0), [_v0]),
      _v21 = (0, _v1.useCallback)(() => null !== _v0 && (_v0.track("user_profile_cover_add_clicked", {}), !0), [_v0]);
    return {
      ...
      trackUserProfileCoverVideoActionClicked: _v8,
      trackUserProfileEditFieldClicked: _v9,
      trackUserProfileJoinExpertsClicked: _v10,
      trackUserProfileLayoutChanged: _v11,
      trackUserProfilePreviewClicked: _v12,
      trackUserProfileReorderContentClicked: _v13,
      trackUserProfileReorderSaved: _v14,
      trackUserProfileSectionCreated: _v15,
      trackUserProfileShareActionClicked: _v16,
      trackUserProfileVideoAdded: _v17,
      trackUserProfileVideoReordered: _v18,
      trackUserProfileVideoThumbnailResized: _v19,
      trackUserProfileAutomaticAddVideoToggled: _v20,
      trackUserProfileCoverAddClicked: _v21,
