{
  ...
  _v0.s(["default", 0, function ({
    ...
    let [_v5, _v6] = (0, _v3.useState)(!1),
      ...
      _v15 = _v14.enable_granular_user_flagging_modal,
      _v16 = (0, _v3.useContext)(_v19.NotificationDispatchContext),
      _v17 = `users/${_v13}/report`,
      _v18 = (0, _v21.default)(),
      _v19 = (0, _v3.useCallback)((_v0, _v1) => {
        ...
        _v18(_v17, void 0, _v18.HTTPMethods.POST, _v2).then(() => {
          _v10(!0), _v8(!1);
        }).catch(_v0 => {
          _v0 && _v0.json && _v0.json().then(_v0 => _v16({
            content: _v0.error,
            status: "negative"
          })), _v8(!1);
        });
    ...
    return (0, _v3.useEffect)(() => {
      ...
      children: [(0, _v1.jsx)(_v11.Tooltip, {
      ...
      }), _v15 ? (0, _v1.jsx)(_v15.ReportUserModal, {
        userId: _v13,
        isOpen: _v5,
        onClose: () => _v6(!1)
        ...
        children: [(0, _v1.jsx)(_v10.ModalOverlay, {}), (0, _v1.jsx)(_v9.ModalContent, {
          children: _v9 ? (0, _v1.jsx)(_v16.default, {
            onDismiss: () => _v6(!1)
