{
  ...
  async function _v97(_v0, _v1, _v2, _v3, _v4, _v5 = _v49.HTTPMethods.GET, _v6, _v7) {
    let _v8 = `//${_v0}/${_v3}${_v4 ? _v96((0, _v29.decamelizeDeep)(_v4)) : ""}`,
      _v9 = {
        method: _v5,
        headers: {
    ...
    (_v5 === _v49.HTTPMethods.PUT || _v5 === _v49.HTTPMethods.PATCH || _v5 === _v49.HTTPMethods.POST) && (_v9.body = JSON.stringify(_v6));
    let _v10 = await fetch(_v8, _v9);
    return _v10.ok ? _v5 === _v49.HTTPMethods.DELETE ? Promise.resolve() : _v10.json().then(_v0 => function (_v0) {
      if ((0, _v95.isRecord)(_v0) && Array.isArray(_v0.data)) {
        let _v0 = _v0.data;
        delete _v0.data, Object.assign(_v0, {
          items: _v0
        });
      }
      return (0, _v94.camelize)(_v0);
    }(_v0)).catch(() => {}) : Promise.reject(_v10);
  }
  function _v98() {
    let _v0 = (0, _v92.useViewer)(),
      _v1 = _v0?.apiUrl,
      _v2 = _v0?.jwt,
      _v3 = _v0?.locale,
      _v4 = (0, _v16.useRef)(new Map());
    return _v1 && _v2 && _v3 && (_v4.current.set("apiUrl", _v1), _v4.current.set("jwt", _v2), _v4.current.set("locale", _v3)), (0, _v16.useCallback)((_v0, _v1, _v2 = _v93.HTTPMethods.GET, _v3, _v4) => {
      let _v5 = _v4.current.get("apiUrl"),
        _v6 = _v4.current.get("jwt"),
        _v7 = _v4.current.get("locale");
      return _v5 && _v6 && _v7 ? _v97(_v5, _v6, _v7, _v0, _v1, _v2, _v3, _v4) : Promise.reject(Error("not ready yet"));
    }, [_v4, _v2, _v1, _v3]);
  }
  var _v99 = _v0.i(0);
  let _v100 = _v16.default.createContext({
      showing: !1
    }),
    _v101 = _v16.default.createContext(() => Promise.reject(Error("not implemented yet")));
  function _v102({
    children: _v0
  }) {
    let _v1 = (0, _v99.useToast)(),
      _v2 = (0, _v16.useCallback)(_v0 => {
        let _v1 = _v0 ?? {
          content: (0, _v6.jsx)(_v6.Fragment, {
            children: _v51.default.SavedChanges
          })
        };
        _v1({
          title: _v1.content,
  ...
  function _v103(_v0, _v1, _v2, _v3 = !0, _v4) {
    let {
        cache: _v5,
        mutate: _v6
      } = (0, _v90.useSWRConfig)(),
      ...
      _v26 = (0, _v16.useCallback)((_v0, _v1) => `${_v0.substring(1)}/videos${_v96((0, _v29.decamelizeDeep)({
  ...
  function _v141({
    ...
    return (0, _v16.useEffect)(() => {
      ...
      children: [(0, _v6.jsx)(_v107.ModalHeader, {
        ...
        display: "flex",
        flexDirection: "column",
        children: (0, _v6.jsxs)(_v110.Tabs, {
          variant: "underline",
          isLazy: !0,
          display: "flex",
          flexDirection: "column",
          ...
          children: [(0, _v6.jsxs)(_v111.TabList, {
            paddingX: "6",
            children: [(0, _v6.jsx)(_v109.Tab, {
              children: _v51.default.MyPublicVideos
            }), (0, _v6.jsx)(_v109.Tab, {
              children: _v51.default.CreditedVideos
            }), (0, _v6.jsx)(_v110.TabIndicator, {})]
          }), (0, _v6.jsxs)(_v113.TabPanels, {
            flex: 1,
            minH: 0,
            overflow: "hidden",
            children: [(0, _v6.jsx)(_v112.TabPanel, {
              h: "100%",
              overflow: "hidden",
              p: 0,
              display: "flex",
        ...
        children: (0, _v6.jsxs)(_v33.Flex, {
          ...
          children: [(0, _v6.jsxs)(_v33.Flex, {
            ...
            flex: "1",
            minW: 0,
            children: [(0, _v6.jsx)(_v108.Switch, {
              size: "sm",
              isChecked: _v12,
              onChange: () => {
                let _v0 = !_v12;
  ...
  function _v206({
    ...
    return (0, _v6.jsxs)(_v6.Fragment, {
      children: [(0, _v6.jsx)(_v170.ModalCloseButton, {}), (0, _v6.jsx)(_v107.ModalHeader, {
        ...
        children: [(0, _v6.jsx)(_v105.ModalBody, {
          padding: 0,
          overflow: "hidden",
          flex: 1,
          display: "flex",
  ...
  function _v351({
    ...
    let {
      ...
      [_v16, _v17] = (0, _v16.useState)(!1),
      {
        ...
        videoLoading: _v29
      } = _v103(_v0.uri, _v0.videos.data, _v0.videos.total),
...
`;
  ...
  function _v373({
    ...
    let [_v2, _v3] = (0, _v16.useState)(!1),
      _v4 = (0, _v92.useViewer)(),
      _v5 = _v4?.facebookAppId ?? "",
      {
        userId: _v6
      } = (0, _v16.useContext)(_v50.default),
      _v7 = (0, _v16.useContext)(_v101),
      {
    ...
    let {
      ...
      _v18 = (_v5 = _v98(), (0, _v91.default)(_v0 => {
        let _v1 = {
          ...
          _v2 = _v96((0, _v29.decamelizeDeep)(_v1));
