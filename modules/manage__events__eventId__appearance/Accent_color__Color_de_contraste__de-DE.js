...
`,
    _v153 = /^#([a-fA-F0-9]{3}|[a-fA-F0-9]{4}|[a-fA-F0-9]{6}|[a-fA-F0-9]{8})$/;
  function _v154({
    payloadKey: _v0,
    label: _v1,
    color: _v2,
    ...
    let [_v5, _v6] = (0, _v14.useState)(!1),
      ...
      _v8 = _v153.test(_v7) ? _v7 : "#000000",
      _v9 = (0, _v77.default)(_v4, 100);
  ...
  var _v155 = _v0.i(0),
    ...
    _v159 = _v0.i(0),
    _v160 = _v0.i(0);
  let _v161 = (0, _v67.default)(_v160.Card).withConfig({
  ...
  overflow: hidden;
`,
    _v162 = _v67.default.div.withConfig({
...
`,
    _v163 = (0, _v67.default)(_v150).withConfig({
  ...
  width: 100%;
`,
    _v164 = (0, _v67.default)(_v86.Input).withConfig({
...
`,
    _v167 = /\b((?:https?:\/\/|www\d{0,3}[.])([a-z0-9\-]+[.])(?:[a-z0-9\-]+[.])?([a-z]{2,4}(\/)?)((?:[^\s()<>]+|\(([^\s()<>]+|(\([^\s()<>]+\)))*\))+)?(?:\(([^\s()<>]+|(\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:'".,<>?«»“”‘’])?)/i;
  function _v168(_v0) {
...
`,
    _v175 = _v67.default.div.withConfig({
...
`,
    _v178 = (0, _v67.default)(_v71.Button).withConfig({
...
`;
  function _v179({
    ...
    return (0, _v12.jsxs)(_v173, {
      children: [(0, _v12.jsx)(_v174, {
        currentLogoIndex: _v1,
        children: _v0.map((_v0, _v1) => {
          let _v2 = _v168(_v0.baseLink),
            _v3 = _v2 !== (_v2 ? _v168(_v2.url) : -1);
          return (0, _v12.jsx)(_v175, {
            isCurrent: _v1 === _v1,
            src: _v0.baseLink,
            children: _v3 ? (0, _v12.jsx)(_v171.Tip, {
              content: _v26.remove,
              children: (0, _v12.jsx)(_v178, {
                icon: (0, _v12.jsx)(_v170.CloseX, {}),
                size: "xs",
                format: "secondary",
                onClick: _v0 => {
        ...
        pill: !0,
        format: "secondary",
        icon: (0, _v12.jsx)(_v169.ChevronRightSmall, {}),
        onClick: () => {
          let _v0 = _v1 - 1;
  ...
  function _v180({
    ...
    let _v8,
      _v9 = _v2.length,
      _v10 = (0, _v14.useMemo)(() => _v3?.url ? _v2.findIndex(_v0 => _v168(_v0.baseLink) === _v168(_v3.url)) : 0, [_v2, _v3?.url]),
      _v11 = (0, _v14.useCallback)(_v0 => {
        _v5({
          url: _v0
        });
      }, [_v5]),
      _v12 = _v3?.link && (_v8 = _v3?.link, !_v167.test(_v8));
    return (0, _v12.jsxs)(_v161, {
      children: [(0, _v12.jsxs)(_v76.Header, {
        ...
        children: _v1 || _v0 ? (0, _v12.jsx)(_v166, {
          children: (0, _v12.jsx)(_v156.Spinner, {})
        }) : (0, _v12.jsx)(_v12.Fragment, {
          children: _v2.length > 0 ? (0, _v12.jsx)(_v179, {
            logos: _v2,
      ...
      }), (0, _v12.jsx)(_v165, {}), (0, _v12.jsx)(_v158.FileUpload, {
        accept: _v29,
        disabled: _v0,
        onChange: _v0 => {
  ...
  let _v181 = _v67.default.div.withConfig({
...
`,
  ...
  right: ${(0, _v66.rem)(36)};
`,
    _v183 = (0, _v67.default)(_v145.Toggle).withConfig({
      displayName: "CustomLogoOption.styles__StyledToggle",
      componentId: "sc-46170472-2"
    })`
  width: ${(0, _v66.rem)(32)};
`,
    _v184 = (0, _v67.default)(_v150).withConfig({
  ...
  function _v188({
    ...
    let {
            ...
            if (_v0 && _v1) {
              ...
              try {
                (0, _v185.deleteUserCustomlogo)({
                  ...
                  let _v0 = _v7.filter(_v0 => _v168(_v0.baseLink) !== _v0);
                  _v8(_v0), _v2({
                    url: _v0[0]?.baseLink ?? ""
                  }), _v4(!1);
                });
      ...
      _v12 = (0, _v14.useCallback)(() => {
        let _v0;
        _v0 = _v3.link, _v167.test(_v0) || _v5({
          link: ""
        });
      }, [_v5, _v3.link]),
      _v13 = (0, _v12.jsx)(_v180, {
        isUploading: _v7,
        isLoading: _v6,
        logos: _v8,
        selectedLogo: _v3,
...
`,
  ...
  background-color: ${(0, _v159.red)(500)};
  position: absolute;
  visibility: hidden;
  right: 0;
  top: 0;
      ...
      children: [(0, _v12.jsx)(_v197, {
        ...
        children: [_v2.map(_v0 => {
          ...
          return (0, _v12.jsx)(_v202, {
            ...
            children: _v3 ? (0, _v12.jsx)(_v170.CloseX, {
      ...
      children: _v57.map(_v0 => (0, _v12.jsxs)(_v146, {
        ...
        children: [(0, _v12.jsx)(_v76.Header, {
          ...
          children: _v0.options.map(_v0 => {
            ...
            return _v0.type === _v32 ? (0, _v12.jsx)(_v154, {
              payloadKey: _v0.payloadKey,
              label: _v0.label,
              disabled: !1,
            ...
            }, _v0.payloadKey) : _v0.type === _v34 ? (0, _v12.jsx)(_v188, {
              payloadKey: _v0.payloadKey,
              label: _v0.label,
