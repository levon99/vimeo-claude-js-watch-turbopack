{
  ...
  _v0.s(["RegistrationInfo", 0, ({
    emailDefaultsHref: _v0
  }) => {
    let [_v1, _v2] = (0, _v11.useState)(!1),
      {
        settings: _v3
      } = (0, _v18.useOrionSettings)(),
      _v4 = !!_v0 && _v3.enable_email_defaults;
      ...
      children: [(0, _v1.jsxs)(_v13.Card, {
        ...
        children: [(0, _v1.jsx)(_v7.Text, {
          ...
          children: [(0, _v1.jsxs)(_v7.Text, {
            ...
            variant: "secondary",
            leftIcon: (0, _v1.jsx)(_v17.FileExport, {}),
            marginTop: "md",
            marginLeft: "md",
            onClick: () => _v2(!0),
            fontWeight: "medium",
          ...
          children: [(0, _v1.jsx)(_v14.Divider, {
            borderColor: "stroke",
            marginY: "200"
          }), (0, _v1.jsxs)(_v3.Flex, {
            justifyContent: "space-between",
            ...
            children: [(0, _v1.jsxs)(_v7.Text, {
              ...
              children: [(0, _v1.jsx)(_v4.Header, {
                size: "sm",
                children: _v10.default.EmailDefaults
              }), _v10.default.EmailDefaultsDesc]
            }), (0, _v1.jsx)(_v15.IconButton, {
              as: "a",
              href: _v0,
              "aria-label": _v10.default.EmailDefaults,
              icon: (0, _v1.jsx)(_v16.ChevronRightSmall, {}),
              variant: "secondary",
              marginTop: "md",
              marginLeft: "md",
              "data-id": "registration-email-defaults-link"
            })]
          })]
        })]
      }), (0, _v1.jsx)(_v19.DownloadRegistrantModal, {
        isOpen: _v1,
        onClose: () => _v2(!1)
      })]
    });
