{
  ...
  let _v12 = ({
    ...
    let {
      ...
      } = (0, _v6.useGetWsSettings)({
        wsUuid: _v0,
        settings: ["reviewPagePreferences", "orgReviewPagePreferences"]
      }),
      {
        teamSettingsUpdateError: _v3,
        teamSettingsUpdateLoading: _v4,
        onUpdateSetting: _v5
      } = (0, _v7.useUpdateWsSettings)({
        wsUuid: _v0
      });
    return _v2 || !_v1 ? (0, _v1.jsx)(_v8.LoadSpinner, {}) : (0, _v1.jsxs)(_v3.VStack, {
      ...
      children: [(0, _v1.jsx)(_v10.SecurityAndDataBreadcrumbs, {}), (0, _v1.jsx)(_v2.Box, {
        ...
        children: (0, _v1.jsx)(_v5.ReviewPageSettingsComponent, {
          redirectPath: "/manage/workspace/security-and-data",
          teamSettingsResult: _v1,
          teamSettingsUpdateError: _v3,
          teamSettingsUpdateLoading: _v4,
          onUpdateSetting: _v5,
  ...
  (0, _v4.withPageSetup)(_v11.getWspServerSideProps, {
    requireLogin: !0,
    inlineViewer: !0,
    noIndex: !0
