    ...
    let {
      ...
      _v4 = _v0 ? (0, _v10.translate)({
        ...
        dictionary: {
          ...
          "de-DE": {
            singular: "Treten Sie VideoJi bei und erhalten Sie alles, was Sie brauchen, um brillante Videos zu erstellen, zu verwalten und zu teilen."
          },
          "fr-FR": {
            singular: "Rejoignez VideoJi pour tout ce dont vous avez besoin pour créer, gérer et partager d'excellentes vidéos."
          },
          "ja-JP": {
            singular: "素晴らしい動画を作成、管理、共有するために必要なすべてが揃う VideoJi に参加しましょう."
          },
          "ko-KR": {
            singular: "멋진 동영상을 만들고, 관리하고, 공유하는 데 필요한 모든 것을 위해 VideoJi에 가입하세요."
          },
          "pt-BR": {
            singular: "Junte-se ao VideoJi para ter tudo o que você precisa para criar, gerenciar e compartilhar vídeos incríveis."
          },
          "zh-CN": {
        ...
        dictionary: {
          ...
          "de-DE": {
            singular: "Treten Sie Vimeo bei und erhalten Sie alles, was Sie brauchen, um brillante Videos zu erstellen, zu verwalten und zu teilen."
          },
          "fr-FR": {
            singular: "Rejoignez Vimeo pour tout ce dont vous avez besoin pour créer, gérer et partager d'excellentes vidéos."
          },
          "ja-JP": {
            singular: "素晴らしい動画を作成、管理、共有するために必要なすべてが揃う Vimeo に参加しましょう."
          },
          "ko-KR": {
            singular: "멋진 동영상을 만들고, 관리하고, 공유하는 데 필요한 모든 것을 위해 Vimeo에 가입하세요."
          },
          "pt-BR": {
            singular: "Junte-se ao Vimeo para ter tudo o que você precisa para criar, gerenciar e compartilhar vídeos incríveis."
          },
          "zh-CN": {
