{
  ...
  let _v18 = ({
    ...
    let _v3 = (0, _v17.useVideoReport)({
        clipId: _v0,
        onClose: _v1,
        onSubmitted: _v2,
        confirmationMode: "delegate"
      }),
      _v4 = _v3.showCommsOptOut ? (0, _v1.jsx)(_v15.CommsOptOutCheckbox, {
        isChecked: _v3.optOutOfCommunications,
        onChange: _v3.setOptOutOfCommunications
      }) : null;
    return (0, _v1.jsxs)(_v5.Flex, {
      ...
      }), _v3.showFooter ? (0, _v1.jsx)(_v8.Box, {
        pt: "300",
        children: (0, _v1.jsx)(_v13.ReportFooter, {
          submitLabel: _v3.submitLabel,
          submitDisabled: _v3.submitDisabled,
          onSubmit: _v3.onSubmit,
          help: _v3.help
        })
      }) : null]
    });
