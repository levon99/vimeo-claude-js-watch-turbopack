{
  ...
  var _v13 = _v0.i(0),
    ...
    _v31 = _v0.i(0),
    _v32 = _v0.i(0);
  let _v33 = _v0 => (0, _v1.jsx)(_v11.Icon, {
    viewBox: "0 0 24 24",
    ..._v0,
    fill: "none",
    children: (0, _v1.jsx)("path", {
  ...
  function _v36({
    ...
    let [_v5, _v6] = (0, _v8.useState)(!1),
      ...
      _v9 = "dark" === _v7 ? _v28.LightMode : _v28.DarkMode;
    return (0, _v1.jsx)(_v9, {
      children: (0, _v1.jsx)(_v34.BulkActionsBar.ActionBar, {
        ...
        children: (0, _v1.jsxs)(_v9.Flex, {
          ...
          }), (0, _v1.jsx)(_v30.Tooltip, {
            label: _v4 ? (0, _v14.translate)({
  ...
  var _v37 = _v0.i(0),
    ...
    _v40 = _v0.i(0),
    _v41 = _v0.i(0);
  let _v42 = _v0 => (0, _v1.jsx)(_v11.Icon, {
    viewBox: "0 0 24 24",
    ..._v0,
    fill: "none",
  ...
  var _v48 = _v0.i(0),
    ...
    _v53 = _v0.i(0),
    _v54 = _v0.i(0);
  let _v55 = _v0 => (0, _v1.jsx)(_v11.Icon, {
    viewBox: "0 0 24 24",
    ..._v0,
    fill: "none",
    children: (0, _v1.jsx)("path", {
  ...
  function _v63({
    ...
    let [_v8, _v9] = (0, _v8.useState)(!1),
      ...
      _v11 = _v4 && 1 === _v3 ? _v7 ? (0, _v14.translate)({
  ...
  function _v68({
    ...
    return (0, _v1.jsxs)(_v9.Flex, {
      ...
      children: [(0, _v1.jsx)(_v30.Tooltip, {
        label: _v2 ? (0, _v14.translate)({
          singular: "Your storage is full. Permanently delete files to free up space.",
          dictionary: {
            es: {
              singular: "Tu almacenamiento está lleno. Elimina archivos de forma permanente para liberar espacio."
  ...
  function _v70({
    ...
    return (0, _v1.jsx)(_v1.Fragment, {
      children: _v0.map(_v0 => {
        let _v1,
          _v2 = _v0.filesSize && _v0.filesSize.totalSize > 0 ? (0, _v17.bytesToSize)(_v0.filesSize.totalSize) : "—",
          _v3 = _v0.deletedBy?.uri ? (0, _v26.idFromUri)(_v0.deletedBy.uri) : null,
          _v4 = _v0.modifiedTime ? (_v1 = Math.min(Math.ceil((new Date(_v0.modifiedTime).getTime() + 0 - Date.now()) / 0), 30)) <= 0 ? (0, _v14.translate)({
            singular: "< 1 day",
            dictionary: {
              es: {
                singular: "< 1 día"
  ...
  function _v74({
    ...
    let _v9;
    return _v2 > 0 ? _v9 = (0, _v14.translate)({
    ...
    }) : _v0 > 0 && (_v9 = _v1 ? _v5 ? (0, _v14.translate)({
      count: _v0,
  ...
  function _v76({
    ...
    return (0, _v1.jsx)(_v75.UpsellModal, {
      ...
      modalConfig: {
        ...
        subHeaderText: (0, _v14.translate)({
  ...
  function _v92() {
    let _v0,
      ...
      _v6,
      _v7,
      _v8 = (0, _v27.useViewer)(),
      _v9 = _v8?.teamUser?.ownerId ?? _v8?.user?.id,
      {
        data: _v10,
        mutate: _v11
      } = (0, _v13.useGetUser)(() => _v9 ? {
        where: {
          userId: _v9
        },
      ...
      [_v18, _v19] = (0, _v8.useState)(_v21.DEFAULT_RECENTLY_DELETED_SORT),
      ...
      _v31 = (_v8?.teamUser?.ownerIsSuperUser ?? _v8?.user?.isSuperUser ?? !1) && _v25 >= 0,
      {
        ...
        setSize: _v36,
        size: _v37
      } = (0, _v25.useUserTeamMembers)(_v22),
    ...
    let _v54 = (0, _v8.useCallback)(_v0 => {
        ...
        _v45(_v1 ? _v38.size + 1 : _v38.size - 1, _v1, (0, _v26.idFromUri)(_v0)), _v39(_v0 => {
          let _v1 = new Set(_v0);
      ...
      }, [_v38, _v45]),
      {
        ...
        return {
          handleRestore: async (_v0, _v1) => {
            ...
            _v3.forEach(_v0 => {
              _v11(_v1, _v0.restoreDestination ?? "root_originally_root", _v0.length, [(0, _v26.idFromUri)(_v0.uri)]);
            });
      ...
      _v69 = (0, _v1.jsx)(_v22.FilterSortBar, {
        ...
        sort: _v18,
        setSort: _v59,
        sortOptions: _v21.RECENTLY_DELETED_SORT_OPTIONS,
        layout: "LIST_LAYOUT",
        setLayout: () => {},
      ...
      _v70 = _v63 ? {
        ...
        bodyText: _v20.length > 0 || _v31 ? _v8?.teamUser ? (0, _v14.translate)({
          ...
          replacements: {
            STORAGE: (0, _v17.bytesToSize)(_v65, 1)
          },
          dictionary: {
            es: {
        ...
        storageSize: (0, _v17.bytesToSize)(_v68, 1)
      };
    return (0, _v1.jsx)(_v19.Page, {
      children: (0, _v1.jsxs)(_v19.Page.Main, {
        children: [(0, _v1.jsxs)(_v19.Page.StickyTop, {
          children: [(0, _v1.jsx)(_v20.PageHeader, {
            bottomBar: _v69,
            title: (0, _v14.translate)({
          ...
          title: _v20.length > 0 ? (0, _v14.translate)({
        ...
        })), !_v28 && !_v27 && (0, _v1.jsx)(_v18.InfiniteScrollTrigger, {
          isLoading: !!_v27,
          onLoadMore: _v29
        }), (0, _v1.jsx)(_v59, {
          isOpen: _v51,
          ...
          isRestoreDisabled: _v66 && !_v67,
          onDelete: () => {
            _v43("ask", "bulk_toast", _v38.size, Array.from(_v38).map(_v26.idFromUri)), _v13("bulk_toast"), _v62(Array.from(_v38));
          },
          onRestore: () => {
            if (_v66 && _v67) {
  ...
  let _v95 = () => {
    let _v0 = (0, _v27.useViewer)();
    return _v0 ? !_v0?.teamUser || _v0.teamUser.permissionLevel <= _v21.RECENTLY_DELETED_MAX_PERMISSION_LEVEL ? (0, _v1.jsxs)(_v1.Fragment, {
