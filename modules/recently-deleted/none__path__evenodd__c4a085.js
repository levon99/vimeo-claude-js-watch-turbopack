{
  ...
  function _v76({
    ...
    return (0, _v1.jsx)(_v75.CheckboxItemCount, {
      ...
      subtitle: _v1 > 0 ? (0, _v16.translate)({
  ...
  function _v94() {
    ...
    let _v53 = (0, _v10.useCallback)(_v0 => {
        ...
        _v44(_v1 ? _v37.size + 1 : _v37.size - 1, _v1, (0, _v28.idFromUri)(_v0)), _v38(_v0 => {
          let _v1 = new Set(_v0);
        ...
        return {
          ...
          handleEmptyTrashConfirm: async () => {
            ...
            try {
              ...
              void 0 !== _v20.current && _v12.close(_v20.current), _v11({
                content: (0, _v16.translate)({
                  singular: "Error deleting files",
                  dictionary: {
                    es: {
            ...
            await _v1(), void 0 !== _v20.current && _v12.close(_v20.current), _v2();
          },
      ...
      _v64 = (0, _v10.useMemo)(() => !_v26 && _v28 && _v24.length <= 25 && 0 === _v20.length ? _v24.filter(_v0 => _v0.filesSize?.fileSizeType === "UPLOAD" || _v0.filesSize?.fileSizeType === "PROCESSING").reduce((_v0, _v1) => _v0 + (_v1.filesSize?.totalSize ?? 0), 0) : _v10?.uploadQuota?.recentlyDeletedDiskSpace ?? 0, [_v20.length, _v28, _v26, _v10, _v24]),
      _v65 = (_v10?.uploadQuota?.space?.free ?? 0) <= 0,
      _v66 = (0, _v26.isPerSeatSelfServeTier)(_v8?.user?.account),
      _v67 = _v60.reduce((_v0, _v1) => {
        let _v2 = _v24.find(_v0 => _v0.uri === _v1);
        return _v0 + (_v2?.filesSize?.totalSize ?? 0);
      }, 0),
      _v68 = (0, _v1.jsx)(_v24.FilterSortBar, {
      ...
      _v69 = _v62 ? {
        ...
        bodyText: _v20.length > 0 ? _v8?.teamUser ? (0, _v16.translate)({
          ...
          replacements: {
            STORAGE: (0, _v19.bytesToSize)(_v64, 1)
          },
          dictionary: {
            es: {
        ...
        storageSize: (0, _v19.bytesToSize)(_v67, 1)
      };
    return (0, _v1.jsx)(_v21.Page, {
      children: (0, _v1.jsxs)(_v21.Page.Main, {
        children: [(0, _v1.jsxs)(_v21.Page.StickyTop, {
          ...
          isRestoreDisabled: _v65 && !_v66,
          onDelete: () => {
            _v42("ask", "bulk_toast", _v37.size, Array.from(_v37).map(_v28.idFromUri)), _v13("bulk_toast"), _v61(Array.from(_v37));
          },
          onRestore: () => {
            if (_v65 && _v66) {
            ...
            _v43("bulk_toast", _v37.size, Array.from(_v37).map(_v28.idFromUri)), _v54(Array.from(_v37));
          },
          onClear: _v39
        }), (0, _v1.jsx)(_v11.Flex, {
          id: _v37,
