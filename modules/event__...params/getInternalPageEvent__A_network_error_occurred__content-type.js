...
`,
  ...
  let _v282 = ({
    ...
    let {
        data: _v1
      } = (0, _v280.useGetLiveEventSpeakerProfiles)(() => _v0 ? {
    ...
    return 0 === _v2.length ? null : (0, _v7.jsxs)(_v122.Flex, {
      ...
      children: [(0, _v7.jsx)(_v125.Text, {
        ...
        gap: "md",
        overflow: "auto",
        children: _v2.map(_v0 => (0, _v7.jsx)(_v281.SpeakerProfileCard, {
  ...
  function _v283({
    ...
    let {
      ...
      _v37 = (0, _v9.useMemo)(() => _v66(), []),
      _v38 = (0, _v117.useIsPortraitScreenOrientation)(),
      _v39 = (0, _v109.useAnalyticsEvent)(),
      _v40 = _v6?.contentRating,
      _v41 = !!_v40?.includes(_v47),
      _v42 = !!_v40?.includes(_v46),
      _v43 = !!_v40?.includes(_v48),
      _v44 = null === _v33 && _v34 && (_v14?.view === _v50 || _v14?.view === _v51 || _v14?.view === _v52) && !_v41,
      _v45 = _v6 ? `${window.location.origin}/event/${_v4}${_v6.uri}` : window.location.href,
      _v46 = _v1 ? _v25.PREVIEW_TYPE.CONFIRMATION : _v8,
      {
        registrant: _v47,
        liveStatus: {
          data: {
          ...
          initialDataLoaded: _v49
        }
      } = _v85(),
      _v50 = (_v47.data.isBlocked && _v47.called || !_v47.initialDataLoaded) && _v48 !== _v54,
      _v51 = _v48 === _v54 || _v48 === _v53 && _v1 || _v1 && [4, 2].includes(_v5),
      _v52 = _v31.asPath.split("?")[0].replace(/\/+$/, "").split("/").pop() ?? "",
      _v53 = Object.values(_v55).includes(_v52),
      _v54 = _v0 => {
    ...
    return (0, _v9.useEffect)(() => {
      !_v47.loading && _v47.called && !_v47.data.isValidRegistrant && (_v0?.(""), _v2 && (0, _v116.deleteCookie)(_v2));
    }, [_v47, _v2]), (0, _v9.useEffect)(() => {
      ...
      _v39(_v158("workflow.visit_svv_recipient", 7, {
        customizations: null,
    ...
    }, [_v13, _v9.embed?.speed, _v3.streamPrivacy?.embed, _v3.streamPrivacy?.view, _v4, _v37, _v39]), (0, _v7.jsxs)(_v7.Fragment, {
      children: [(0, _v7.jsx)(_v172, {}), _v35 && !_v20 && (0, _v7.jsx)(_v271, {
        href: _v15
      }), (0, _v7.jsx)(_v173, {
          ...
          children: [(0, _v7.jsx)(_v163, {}), (0, _v7.jsxs)(_v175, {
            ...
            children: [(0, _v7.jsxs)(_v176, {
              ...
              children: [(0, _v7.jsxs)(_v177, {
                isMobile: _v20,
                isPortrait: _v38,
                children: [(!_v51 || _v50) && _v7 ? (0, _v7.jsx)(_v279, {
                  isSmallScreen: _v20,
                  isPortrait: _v38,
                  isLoading: !_v49,
                  title: _v10,
                  ...
                  entityId: _v2,
                  setLeadUuid: _v0,
                  onPreviewTypeChanged: _v54,
                  onMount: () => {
                    _v54(_v46);
                  },
                  onUnmount: _v55,
                  isMobileFormOpen: _v25 || _v53,
                  onOpenMobileForm: () => _v26(!0),
                  onCloseMobileForm: () => {
                    _v26(!1), _v55();
                  }
                }) : _v44 ? (0, _v7.jsx)(_v268, {
                  isUnrated: _v42,
                  redirectUrl: _v45
                }) : (0, _v7.jsx)(_v267, {
                  ref: _v36,
                  ...
                  children: (0, _v7.jsxs)(_v178, {
                    isFullWidth: !1,
                    children: [_v30 && (0, _v7.jsxs)(_v179, {
              ...
              }), _v18.enable_event_series_in_dev_features && _v4 ? (0, _v7.jsx)(_v282, {
                eventId: _v4
              }) : null, _v32 ? (0, _v7.jsx)(_v185, {
  ...
  async function _v288(_v0, _v1) {
    ...
    if (_v2.ok) return (0, _v287.camelize)(await _v2.json()).chatEnabled;
    throw Error("Failed to fetch chat status data.");
  }
  let _v289 = _v16.default.div.withConfig({
  ...
  border-left: 1px solid ${_v284.core.color.stroke};
`,
  ...
  ${({
      ...
      isKeyboardOpened: _v2
          ...
          left: 0;
          z-index: 5;
          border-top: 1px solid ${_v284.core.color.stroke};
        ` : _v16.css`
          position: relative;
          z-index: 5;
          flex-shrink: 0;
...
`,
      ...
      let [_v2, _v3] = (0, _v9.useState)(420),
        ...
        _v10 = function (_v0 = 300) {
          ...
          return (0, _v9.useLayoutEffect)(() => {
            if (_v286.browserConfig.BROWSER?.isMobile && "visualViewport" in window) {
              let _v0 = (0, _v285.default)(() => {
                _v2(_v0 => {
        ...
        _v14 = (0, _v9.useMemo)(() => _v11 ? _v290 : _v289, [_v11]),
    ...
    _v293 = ({
      ...
      }, [_v8?.accentColor, _v0]), _v5) return (0, _v7.jsx)(_v295, {
        children: (0, _v7.jsx)(_v151.Header, {
    ...
    _v294 = (0, _v16.default)(_v153.HeaderMinimalWrapper).withConfig({
...
`,
  ...
  ${({
      ...
      isPortrait: _v1
        ...
        `};
`,
    _v301 = _v16.default.div.withConfig({
...
`,
    _v302 = (0, _v16.default)(_v99).withConfig({
...
`;
  let _v303 = _v16.default.div.withConfig({
...
`;
  let _v304 = _v16.default.div.withConfig({
...
`, (0, _v16.default)(_v171.Paragraph).withConfig({
  ...
  color: white;
`;
  let _v305 = _v16.default.div.withConfig({
  ...
  padding: ${(0, _v31.rem)(5)};
`,
    _v306 = _v16.default.span.withConfig({
  ...
  color: #496073;
`,
    _v307 = (0, _v16.default)(_v170.CircleInfoSmall).withConfig({
...
`;
    ...
    return ((0, _v9.useEffect)(() => {
      ...
      children: [_v20 && !_v22 && (0, _v7.jsx)(_v271, {
        ...
        children: (0, _v7.jsxs)(_v297, {
          isMobile: _v22,
          children: [(0, _v7.jsx)(_v293, {}), (0, _v7.jsxs)(_v298, {
            isMobile: _v22,
            isPortrait: _v23,
            children: [(0, _v7.jsxs)(_v299, {
              isMobile: _v22,
              isPortrait: _v23,
              children: [(0, _v7.jsxs)(_v300, {
                isMobile: _v22,
                isPortrait: _v23,
                children: [_v29 ? (0, _v7.jsx)(_v268, {
                  ...
                  children: (0, _v7.jsxs)(_v301, {
                    ...
                    children: [(0, _v7.jsx)(_v302, {
                      ...
                      contentEditable: !1,
                      text: _v11
                    }), _v28 && (0, _v7.jsxs)(_v305, {
                      children: [(0, _v7.jsx)(_v307, {}), (0, _v7.jsx)(_v306, {
                        children: _v37.thisVideoContainsAdvertisment
                      })]
                    })]
                  })
  ...
  let _v310 = _v0 => {
      ...
      return ((0, _v9.useEffect)(() => {
        ...
        children: (0, _v7.jsx)(_v84, {
          leadUuid: _v5,
          children: _v9.enable_single_event_new_ux || _v10.hasEventSeriesEnabled ? (0, _v7.jsx)(_v283, {
            setLeadUuid: _v6,
            leadUuid: _v5
          }) : (0, _v7.jsx)(_v309, {
            setLeadUuid: _v6,
    ...
    _v311 = _v0 => (0, _v7.jsx)(_v16.ThemeProvider, {
  ...
  (0, _v10.withPageSetup)(async _v0 => {
    ...
    return (0, _v11.useEnterpriseSiteRedirect)(_v3?.teamUser?.enterpriseSiteDomain), (0, _v7.jsxs)(_v7.Fragment, {
      ...
      }), _v3 && _v2.playerAssetUrls ? (0, _v7.jsx)(_v311, {
        ..._v2
      }) : null]
    });
  }], 0);
