{
  ...
  var _v38 = _v0.i(0),
    _v39 = _v0.i(0);
  let _v40 = _v39.default.div.withConfig({
  ...
  display: flex;
  align-items: center;
  border-width: ${(0, _v38.rem)(2)};
  border-color: var(--vimeo-colors-text-primary);
  padding: ${(0, _v38.rem)(8)} 0;
  transition: all 250ms ease-in-out 0s;
  position: relative;
  border-radius: 3rem;
  margin: 0 ${(0, _v38.rem)(8)} 0 ${(0, _v38.rem)(8)};
  background: ${({
      theme: _v0
  ...
  &::after {
    ...
    transition: all 250ms ease-in-out 0s;
    width: 50%;
    height: ${(0, _v38.rem)(30)};
    border-radius: ${(0, _v38.rem)(20)};
  }
`,
    _v41 = _v39.default.div.withConfig({
...
`,
    _v42 = _v39.default.input.withConfig({
...
`,
    _v43 = _v39.default.p.withConfig({
      displayName: "styles__ToggleLabel",
      componentId: "sc-c583c415-3"
    })`
  z-index: 1;
  font-size: ${(0, _v38.rem)(16)};
  letter-spacing: ${(0, _v38.rem)(-.48)};
  white-space: nowrap;
  text-align: center;
  padding: 0 ${(0, _v38.rem)(20)};
  width: ${({
      width: _v0
    }) => _v0 && (0, _v38.rem)(_v0)};
  ${({
...
`,
  ...
  var _v45 = _v0.i(0),
    _v46 = _v0.i(0);
  let _v47 = _v39.default.div.withConfig({
      displayName: "styles__TagContainer",
      componentId: "sc-2420be19-0"
    })`
  background: ${_v0 => (0, _v46.getTagBackgroundColor)(_v0.showYearly, _v0.theme.name)};
  padding: ${(0, _v38.rem)(4)} ${(0, _v38.rem)(6)} ${(0, _v38.rem)(4)} ${(0, _v38.rem)(8)};
  border-radius: ${(0, _v38.rem)(12)};
  color: ${_v0 => (0, _v46.getTagColor)(_v0.showYearly, _v0.theme.name)};
  font-size: ${(0, _v38.rem)(16)};
  font-weight: 400;
  line-height: 130%;
  letter-spacing: ${(0, _v38.rem)(-.32)};
  position: relative;
  margin-left: ${(0, _v38.rem)(9)};
  margin-bottom: 0px;
  &:before {
    content: '';
    position: absolute;
    width: 0;
    height: 0;
    border-right: ${(0, _v38.rem)(6)} solid
      ${_v0 => (0, _v46.getTagBackgroundColor)(_v0.showYearly, _v0.theme.name)};
    border-top: ${(0, _v38.rem)(4)} solid transparent;
    border-bottom: ${(0, _v38.rem)(4)} solid transparent;
    border-left: 0px;
    top: ${(0, _v38.rem)(10)};
    left: ${(0, _v38.rem)(-6)};
  }
`,
    _v48 = ({
      showYearly: _v0
    }) => ((0, _v45.useIsBokeh)(), (0, _v1.jsx)(_v1.Fragment, {
  ...
  var _v50 = _v0.i(0),
    ...
    _v52 = _v0.i(0);
  let _v53 = _v0 => {
    let _v1 = (0, _v7.useContext)(_v23.ViewerContext),
      _v2 = (0, _v7.useContext)(_v25.OverridesContext),
    ...
    return (0, _v1.jsxs)(_v11.Box, {
      ...
      children: [(0, _v1.jsx)(_v11.Box, {
        ...
        children: (0, _v1.jsx)(_v50.Header, {
          ...
          fontWeight: 500,
          children: _v2?.title ? _v2.title : _v52.PRIMARY_HEADERS.theUltimateAdFreePlayer
        })
        ...
        children: (0, _v1.jsx)(_v50.Header, {
          size: "sm",
          fontWeight: 400,
          children: _v52.SECONDARY_HEADERS.getStartedWithFreeConcise(_v5)
        })
        ...
        children: (0, _v1.jsx)(_v50.Header, {
          size: _v4 ? "sm" : "md",
          fontWeight: 400,
          children: _v2?.description !== void 0 && _v2?.description !== null ? _v2.description : _v52.SECONDARY_HEADERS.getStartedWithBasic
        })
      })]
    });
  };
  var _v54 = _v0.i(0),
    ...
    _v59 = _v0.i(0),
    _v60 = _v0.i(0);
  let _v61 = _v39.default.div.withConfig({
  ...
  color: white;
  border-radius: ${(0, _v38.rem)(20)} ${(0, _v38.rem)(20)} 0 0;
  height: ${(0, _v38.rem)(70)};
  width: 100%;
  text-align: center;

  @media (width > ${_v59.breakpoints.TABLET}) {
    top: ${(0, _v38.rem)(-37)};
    min-height: ${(0, _v38.rem)(36)};
    height: ${(0, _v38.rem)(70)};
    padding: ${(0, _v38.rem)(6)} ${(0, _v38.rem)(24)};
  }

  > h2 {
    ${(0, _v60.addTypography)(12, 18)}
    color: #f0f4f6;
    font-weight: 500;
    line-height: ${(0, _v38.rem)(24)};
    margin: 0;
    letter-spacing: unset;
    @media (width > ${_v59.breakpoints.TABLET}) {
      line-height: ${(0, _v38.rem)(26)};
    }
  }
`,
    _v62 = _v39.default.div.withConfig({
  ...
  padding: ${(0, _v38.rem)(8)} ${(0, _v38.rem)(2)};
  display: flex;
  justify-content: center;
  align-items: center;
  margin: auto 0;
  @media (max-width: ${_v59.breakpoints.DESKTOP_LARGE}) {
    padding: ${(0, _v38.rem)(6)} ${(0, _v38.rem)(1)};
  }
  .currentPlanText {
    ${(0, _v60.addTypography)(7, 14)}
    color: var(--vimeo-colors-text-secondary);
    font-weight: 400;
    padding: 0 ${(0, _v38.rem)(10)};
    margin: auto;
    line-height: 13.3px;
...
`,
    ...
    _v64 = ({
      ...
      let _v2 = (0, _v7.useContext)(_v25.OverridesContext);
      if (_v2?.noBadge) return null;
      let {
        tier: _v3
      } = _v0;
      return _v2?.badgeType && _v2?.badgePlan === _v3 ? (0, _v1.jsx)(_v63, {
        color: "#8A5EE8",
        text: _v2.badgeType
      }) : _v1 ? (0, _v1.jsx)(_v63, {
        color: "#8A5EE8",
  ...
  let _v80 = ({
    ...
    let {
      ...
      } = _v2?.params,
      {
        ...
        usageCheckData: _v11
      } = (0, _v7.useContext)(_v26.PlansDataContext),
      _v12 = _v0 => {
        switch (_v0) {
          case "free":
          default:
    ...
    if (_v10) {
      ...
      return (0, _v1.jsxs)(_v11.Box, {
        ...
        children: [(0, _v1.jsxs)(_v13, {
          children: [(_v4 ?? 0) === 1 ? (0, _v1.jsx)(_v79.PersonUser, {}) : (0, _v1.jsx)(_v78.Users, {}), (0, _v1.jsx)(_v14, {
          ...
          children: [(0, _v1.jsx)(_v11.Box, {
            ...
            alignItems: "center",
            flexShrink: 0,
            children: (0, _v1.jsx)(_v72.CircleExclamationFilled, {
          ...
          children: [(0, _v1.jsx)(_v77.Database, {}), (0, _v1.jsx)(_v14, {
            children: (_v0 => {
          ...
          children: [(0, _v1.jsx)(_v75.Speedometer, {}), (0, _v1.jsx)(_v14, {
    ...
    return (0, _v1.jsxs)(_v11.Box, {
      ...
      children: [_v0?.tier === "customSelfServe" && (0, _v1.jsxs)(_v13, {
        children: [(0, _v1.jsx)(_v74, {}), (0, _v1.jsx)(_v14, {
          children: (0, _v16.translate)({
        ...
        children: [(0, _v1.jsx)(_v78.Users, {}), (0, _v1.jsx)(_v14, {
          marginLeft: (0, _v13.rem)(4),
          children: _v12(_v0?.tier)
        })]
      })), (0, _v1.jsxs)(_v13, {
        children: ["video_count" === _v6 ? (0, _v1.jsx)(_v76.VideosStack, {}) : (0, _v1.jsx)(_v77.Database, {}), (0, _v1.jsx)(_v14, {
  ...
  var _v81 = _v0.i(0),
    _v82 = _v0.i(0);
  _v39.default.div.withConfig({
    displayName: "styles__FeatureSubhead",
    componentId: "sc-dc427937-0"
  })`
  margin-bottom: ${_v0 => _v0?.bottomSpacing || (0, _v38.rem)(12)};
  line-height: ${(0, _v38.rem)(18)};

  p {
    font-weight: 900;
  }
`;
  let _v83 = _v39.default.ul.withConfig({
  ...
  li {
    margin-bottom: ${(0, _v38.rem)(8)};
    position: relative;
    @media (width > ${_v59.breakpoints.TABLET}) {
      margin-bottom: ${(0, _v38.rem)(12)};
    }
  }
  ...
  > li {
    ...
    @media (width > ${_v59.breakpoints.TABLET}) {
      &:last-child {
        padding-bottom: ${(0, _v38.rem)(48)} !important;
        margin-bottom: 0;
      }
    }
  }
  ...
  @media (width > ${_v59.breakpoints.TABLET}) {
    margin-bottom: ${(0, _v38.rem)(19)};
  }
`;
  (0, _v39.default)(_v82.Checkmark).withConfig({
    displayName: "styles__FeatureCheck",
    componentId: "sc-dc427937-2"
  })`
  ${(0, _v60.addWidth)(18, 24)};
  position: absolute;
  left: 0;
`;
  let _v84 = (0, _v39.default)(_v82.Checkmark).withConfig({
    displayName: "styles__StyledCheckmark",
    componentId: "sc-dc427937-3"
  })`
  margin-right: ${(0, _v38.rem)(4)};
  max-width: ${(0, _v38.rem)(16)};
  position: relative;
  width: 100%;
  top: ${(0, _v38.rem)(2)};

  @media (width > ${_v59.breakpoints.TABLET}) {
    margin-right: ${(0, _v38.rem)(8)};
  }
  path {
...
`;
  ...
  let _v86 = {
      ...
      starter: [(0, _v16.translate)({
        ...
        replacements: {
          NEW_BADGE: (0, _v1.jsx)(() => (0, _v1.jsx)(_v85.Badge, {
            size: "xs",
            variant: "new",
            children: (0, _v16.translate)({
              singular: "New",
    ...
    _v87 = {
      plus: [(0, _v16.translate)({
        ...
        replacements: {
          NEW_BADGE: () => (0, _v1.jsx)(_v85.Badge, {
            size: "sm",
            variant: "new",
            children: (0, _v16.translate)({
              singular: "New",
    ...
    _v89 = (_v0, _v1, _v2, _v3, _v4, _v5) => {
      ...
      return _v1 ? _v87[_v0] : _v2 ? _v88[_v0] : _v86[_v0];
    },
    _v90 = (_v0, _v1, _v2, _v3, _v4, _v5) => {
  ...
  var _v91 = _v0.i(0);
  let _v92 = _v0 => (0, _v1.jsx)(_v81.Paragraph, {
      fontWeight: 400,
      children: _v0.children
    }),
    _v93 = ({
      ...
      let {
        ...
        _v9 = !!_v7 && (0, _v91.isCreatorV2)(_v8),
        _v10 = _v89(_v4, _v5, _v6, _v7, _v9, _v0?.metadata?.entitlements?.params),
        _v11 = _v90(_v8, _v4, _v5, _v6, _v7, _v3),
      ...
      return (0, _v1.jsxs)(_v11.Box, {
        ...
        children: [_v11 && (0, _v1.jsx)(_v11.Box, {
          marginBottom: 12,
          lineHeight: 18,
          children: (0, _v1.jsx)(_v81.Paragraph, {
            fontWeight: 500,
            children: _v11
          })
        }), _v10 && _v10.length > 0 && (_v12 || _v7) && (0, _v1.jsxs)(_v83, {
          children: [_v5 && (0, _v1.jsxs)("li", {
            children: [(0, _v1.jsx)(_v84, {}), (0, _v1.jsx)(_v92, {
              children: _v12
            })]
  ...
  var _v94 = _v0.i(0),
    _v95 = _v0.i(0),
    _v96 = _v0.i(0);
  (0, _v39.default)(_v96.ReviewCheck).withConfig({
    displayName: "styles__ReviewIcon",
    componentId: "sc-d95ef56-0"
  })`
  ${(0, _v60.addWidth)(16, 20)};
  margin-top: ${(0, _v38.rem)(4)};
...
`, _v39.default.div.withConfig({
  ...
  min-height: ${(0, _v38.rem)(120)};
  margin-bottom: ${(0, _v38.rem)(20)};
  svg {
    margin: ${(0, _v38.rem)(8)} 0;
  }
  p {
    color: ${_v95.bokehTheme.colors.gray["900"]};
    max-width: ${(0, _v38.rem)(180)};
    font-size: 22px;
    font-style: normal;
    font-weight: 400;
    line-height: 100%;
...
`;
  let _v97 = _v39.default.ul.withConfig({
...
`,
    _v98 = ({
      ...
      let _v1 = (0, _v7.useContext)(_v25.OverridesContext),
        _v2 = _v1?.subHeadingType?.[_v0];
      return (0, _v1.jsx)(_v81.Paragraph, {
        fontSize: "18",
        children: _v2
      });
    },
    _v99 = _v0 => (0, _v1.jsx)(_v97, {
      children: _v0.map(_v0 => (0, _v1.jsxs)("li", {
        children: [(0, _v1.jsx)(_v84, {}), (0, _v1.jsx)(_v81.Paragraph, {
          children: _v0
        })]
    ...
    _v100 = ({
      ...
      let _v2 = (0, _v7.useContext)(_v26.PlansDataContext),
        _v3 = (0, _v7.useContext)(_v25.OverridesContext),
        {
          isFlatRateData: _v4,
          isSolutionData: _v5,
          plansData: _v6
        } = _v2,
        _v7 = _v6 && _v6.length > _v24.maxVerticalCards,
        _v8 = _v89(_v0.tier, _v4, _v5) ?? [],
          ...
          children: [(0, _v1.jsx)(_v120, {
            ...
            children: [(0, _v1.jsxs)(_v10, {
              children: [(0, _v1.jsx)(_v11.Box, {
                ...
                children: (0, _v1.jsx)(_v81.Paragraph, {
                  fontWeight: 500,
                  children: _v90(_v6, _v0.tier, _v4, _v5)
                })
              }), (0, _v1.jsx)(_v11, {
                children: _v99(_v8.slice(0, _v9))
              })]
            }), (0, _v1.jsx)(_v10, {
              children: (0, _v1.jsx)(_v11, {
                children: _v99(_v8.slice(_v9, _v8.length))
              })
            })]
          })]
        })]
  ...
  var _v101 = _v0.i(0),
    ...
    _v105 = _v0.i(0),
    _v106 = _v0.i(0);
  let _v107 = _v39.default.div.withConfig({
  ...
  ${({
    ...
    `}
`,
    _v108 = _v39.default.div.withConfig({
  ...
  color: #566;
  &:hover {
    background: ${_v95.bokehTheme.colors.gray["100"]};
    border-radius: ${(0, _v38.rem)(4)};
    cursor: pointer;
  }
  > div {
...
`,
    _v109 = (0, _v39.default)(_v106.ChevronDown).withConfig({
      displayName: "styles__ChevronDownStyled",
      componentId: "sc-f1e205c8-2"
    })`
  margin-top: ${(0, _v38.rem)(-2)};
  width: ${(0, _v38.rem)(20)};
  height: ${(0, _v38.rem)(20)};

  path {
    fill: #566;
  }
`,
    _v110 = _v39.default.span.withConfig({
      displayName: "styles__Accent",
      componentId: "sc-f1e205c8-3"
    })`
  padding-left: ${(0, _v38.rem)(4)};
  color: #4ec437;
`,
    _v111 = _v39.default.div.withConfig({
  ...
  span {
    ${(0, _v60.addTypography)(12, 14)};
  }
`,
    _v112 = _v39.default.div.withConfig({
      displayName: "styles__PriceFrequency",
      componentId: "sc-f1e205c8-5"
    })`
  font-weight: normal;
  ${(0, _v60.addTypography)(14, 16)};
  color: #566;
  letter-spacing: unset;
`,
    _v113 = (0, _v39.default)(_v112).withConfig({
...
`;
  let _v114 = _v0 => {
      ...
      (0, _v105.useOutsideClick)([_v3], () => {
        _v1 && _v2(!1);
      });
      let _v8 = (0, _v1.jsx)(_v111, {
          children: (0, _v1.jsxs)(_v104.Pop.List, {
            children: [(0, _v1.jsx)(_v104.Pop.Item, {
              onClick: () => {
                _v7({
                  plan: "starter",
                  periodicity: "yearly",
      ...
      return _v5 ? _v4 ? (0, _v1.jsx)(_v112, {
        children: (0, _v16.translate)({
          singular: "billed monthly",
          dictionary: {
            es: {
      ...
      }) : (0, _v1.jsx)(_v9, {}) : (0, _v1.jsxs)(_v101.Popover, {
        onOpen: () => (0, _v32.emitBPEvent)({
        ...
        placement: "bottom",
        children: [(0, _v1.jsx)(_v102.PopoverTrigger, {
          children: (0, _v1.jsx)(_v107, {
            disabled: _v6,
            children: (0, _v1.jsxs)(_v108, {
              id: "plus-monthly-dropdown",
              children: [(0, _v1.jsx)(_v9, {}), (0, _v1.jsx)(_v109, {})]
            })
          })
        }), (0, _v1.jsx)(_v103.PopoverContent, {
          children: _v8
        })]
      });
    },
    _v115 = _v0 => (0, _v1.jsx)(_v12.Text, {
      variant: "heading-sm",
      fontSize: "48",
      marginRight: "4",
      float: "left",
    ...
    _v119 = ({
      ...
      let {
        ...
        _v15 = (0, _v7.useContext)(_v25.OverridesContext),
        _v16 = (0, _v7.useContext)(_v23.ViewerContext),
      ...
      return ((0, _v7.useLayoutEffect)(() => {
        ...
        children: [_v5 ? (0, _v1.jsx)(_v94.Building, {
          height: 48,
          width: 40
        }) : (0, _v1.jsx)(_v11.Box, {
          height: 48,
        ...
        children: [(0, _v1.jsxs)(_v11.Box, {
          ...
          overflow: "hidden",
          ref: _v20,
          children: [_v4 && _v12?.monthly && (0, _v1.jsx)(_v117, {
          ...
          children: "free" !== _v10 && (0, _v1.jsxs)(_v1.Fragment, {
            children: [(0, _v1.jsxs)(_v116, {
              children: [_v118(_v0, _v14), _v5 && `, ${_v1 ? (0, _v16.translate)({
                singular: "billed annually",
                dictionary: {
                  es: {
                    singular: "facturados anualmente"
            ...
            }), (_v7?.monthly || _v13?.isMonthly) && !_v2 && !_v5 && !1 !== _v15.showMonthlyDropdown ? (0, _v1.jsx)(_v114, {
              price: _v7,
              ...
              currency: _v6,
              disabled: _v3
            }) : _v7?.monthly === void 0 || _v1 ? (0, _v1.jsx)(_v116, {
    ...
    _v124 = ({
      ...
      let {
        ...
        _v12 = (0, _v7.useContext)(_v26.PlansDataContext),
        _v13 = (0, _v7.useContext)(_v25.OverridesContext),
        {
          isFlatRateData: _v14,
          isSolutionData: _v15,
        ...
        _v26 = (0, _v58.getEffectiveShowYearly)(_v0, _v2),
        ...
        children: [(0, _v1.jsx)(_v64, {
          ...
          children: (0, _v1.jsxs)(_v11.Box, {
            ...
            children: [(0, _v1.jsxs)(_v11.Box, {
              ...
              children: [(0, _v1.jsxs)(_v122, {
              ...
              }), !_v15 && _v13?.subHeadingType?.[_v9] && (0, _v1.jsx)(_v123, {
                children: (0, _v1.jsx)(_v11.Box, {
                  opacity: _v30,
                ...
                opacity: _v29 ? .5 : 1,
                children: "free" === _v9 ? (0, _v1.jsx)(_v69.default, {
                  location: "vertical"
                }) : (0, _v1.jsx)(_v68.default, {
                  planData: _v0,
                  showYearly: _v26,
    ...
    _v125 = ({
      ...
      let _v9 = (0, _v7.useContext)(_v25.OverridesContext),
        {
          plansData: _v10,
        ...
        _v15 = (0, _v7.useMemo)(() => _v10 ? _v9?.plans ? _v10.filter(_v0 => _v9.plans?.includes(_v0.tier)) : _v9?.excludedPlans ? _v10.filter(_v0 => !_v9.excludedPlans?.includes(_v0.tier)) : _v4 ? _v10 : _v10.length > _v24.maxVerticalCards ? _v10.slice(0, -1) : _v10 : [], [_v10, _v9, _v4]),
        _v16 = (0, _v7.useMemo)(() => _v10 && _v11 ? _v24.REPACKAGING_INDIVIDUAL_TIERS.reduce((_v0, _v1) => {
      ...
      (0, _v7.useEffect)(() => {
        let _v0 = (0, _v56.default)(_v20, 300);
      ...
      let _v21 = (0, _v7.useCallback)(_v0 => {
        ...
        _v22 = (0, _v7.useCallback)((_v0, _v1) => _v0.map(_v0 => (0, _v1.jsx)(_v124, {
      ...
      if (_v11 && _v6) {
        ...
        return _v4 ? (0, _v1.jsx)(_v11.Box, {
          ...
          children: (0, _v1.jsxs)(_v11.Box, {
            ...
            width: "100%",
            ref: _v14,
            children: [_v22(_v19, _v5), _v8 && (0, _v1.jsx)(_v71, {
          ...
          children: (0, _v1.jsx)(_v11.Box, {
            ...
            children: (0, _v1.jsxs)(_v11.Box, {
              ...
              children: [(0, _v1.jsxs)(_v11.Box, {
                ...
                children: [_v22(_v16, "individual"), _v8 && (0, _v1.jsx)(_v71, {
                  targetView: "business",
                  onSwitch: _v6,
                  isMobileBreakpoint: _v4
                })]
      ...
      return _v15.length ? (0, _v1.jsxs)(_v11.Box, {
        ...
        children: [(0, _v1.jsx)(_v11.Box, {
          ...
          ref: _v14,
          children: _v22(_v15)
        }), _v10 && _v10?.length > _v24.maxVerticalCards && !_v9?.plans && !_v9?.excludedPlans?.includes("enterprise") && !_v4 && (0, _v1.jsx)(_v11.Box, {
          margin: "0 auto",
          maxWidth: "1440px",
  ...
  var _v126 = _v0.i(0);
  let _v127 = (0, _v5.default)(async () => await _v0.A(0), {
      loadableGenerated: {
        modules: [0]
      }
    }),
    _v128 = (0, _v5.default)(async () => await _v0.A(0), {
      loadableGenerated: {
        modules: [0]
      }
    }),
    _v129 = (0, _v5.default)(async () => await _v0.A(0), {
      loadableGenerated: {
        modules: [0]
      }
    }),
    _v130 = (0, _v5.default)(() => _v0.A(0), {
      loadableGenerated: {
        modules: [0]
      }
    }),
    ...
    _v132 = _v0 => {
      let {
        ...
        _v9 = (0, _v7.useContext)(_v23.ViewerContext),
        ...
        } = (0, _v8.useB2BRepackagingContext)(),
        {
          open: _v16,
          modal: _v17
        } = (0, _v54.useIndividualEligibilityModal)({
        ...
        _v26 = (0, _v17.useCampaignIdOverride)() ?? _v2,
        {
          ...
          let _v1 = (0, _v7.useContext)(_v23.ViewerContext),
            ...
            _v4 = _v28.RepackagedTiers.includes(_v3),
            _v5 = "free" === _v3,
            _v6 = !_v0 && !!_v2 && (_v4 || _v5),
            {
              data: _v7,
              isLoading: _v8,
              error: _v9
            } = (0, _v27.useGetUserSettingsBillingMembership)(() => _v6 ? {
              select: ["productId"],
              where: {
                userId: Number(_v2)
              }
        ...
        _v37 = _v36 <= 0,
        [_v38, _v39] = (0, _v7.useState)(""),
        _v40 = (0, _v14.useColorMode)(),
        {
          trackPricingPagePeriodicityToggled: _v41
        } = (0, _v19.usePricingTracking)(),
        _v42 = () => {
          ...
          let _v0 = ["advanced", "business", "enterprise", "live_business", "live_premium", "live_pro", "plus", "pro", "pro_custom", "pro_unlimited", "producer", "standard", "starter"].includes(_v53) ? _v53 : null,
            _v1 = ["advanced", "plus", "pro", "standard", "starter", "ondemand", "stock", "live", "seat_subscription"].includes(_v53) ? _v53 : "seat_subscription";
      ...
      (0, _v7.useEffect)(() => {
        ...
        _v0 && ("/welcome" !== _v0 ? _v39(_v0) : _v39("/"));
      }, []);
      let _v43 = {
        bypassTierHierarchy: !0
      };
      _v20 && (_v43.promos = JSON.stringify({
        extole: _v20
      })), _v29 && (_v43.campaignId = _v29, _v43.usePaymentsService = !0), _v21 && (_v43.promoCodeId = _v21);
      let _v44 = (0, _v20.useGetSubscriptionPlansData)(_v5?.customSelfServeComapreTable ? _v5?.plans : void 0, void 0, void 0, _v43),
        {
          data: _v45
        } = function (_v0) {
          let _v1 = (0, _v7.useContext)(_v23.ViewerContext),
        ...
        }(_v30 ? _v24.REPACKAGING_ALL_SHOWN_TIERS.filter(_v0 => "free" !== _v0) : []);
      (0, _v18.usePaywallTracking)({
        paywallTrigger: _v23,
        paywallLocation: _v24,
        paywallType: "page",
        paywallFeature: _v25,
        isVisible: void 0 !== _v44 && void 0 !== _v5
      });
      let _v46 = (_v0, _v1, _v2, _v3) => "plus" !== _v3 && "purchased" === _v0 && _v1 && _v2 ? "available" : _v0,
        _v47 = _v44?.find(_v0 => _v0.metadata?.interactions?.purchase?.status === "purchased")?.tier,
        _v48 = (0, _v9.useUpcomingTier)(),
        _v49 = _v30 ? _v48 : void 0,
        _v50 = _v30 ? _v49 ?? _v47 : void 0,
        _v51 = "studio" === _v50 || "production" === _v50,
        _v52 = _v12 && !_v13 && _v51,
        _v53 = (_v0 => {
          if (!_v0) return;
          let _v1 = _v5?.plans ? [..._v0] : _v44 ? [..._v44] : [],
            _v2 = ["free", "starter", "basic", "plus", "customSelfServe", "proSolution"];
          _v30 && _v2.push("creator");
          let _v3 = _v50 ? _v24.TIER_RANK[_v50] ?? 0 : -1;
          for (let _v0 of _v1) {
            let {
              metadata: _v0,
              tier: _v1
            } = _v0;
            if ("available" === _v46(_v0?.interactions?.purchase?.status, _v10, _v0?.purchasedProduct?.isMonthly, _v1) && !_v2.includes(_v1) && (!_v30 || (_v24.TIER_RANK[_v1] ?? 0) > _v3)) return _v1;
          }
        })(_v44),
        _v54 = (0, _v7.useMemo)(() => "studio" === _v49 ? "business" : _v13 ? "individual" : "studio" === _v50 || "production" === _v50 ? "business" : "individual", [_v50, _v13, _v49]),
        [_v55, _v56] = (0, _v7.useState)(null),
        _v57 = _v52 ? "business" : _v55 ?? _v54,
        _v58 = () => {
          _v56("individual" === _v57 ? "business" : "individual");
        },
        _v59 = (0, _v7.useMemo)(() => "production" === _v50 ? ["studio", "production", "enterprise"] : _v12 && _v51 ? ["studio", "enterprise"] : ["professional", "studio", "enterprise"], [_v50, _v12, _v51]),
        _v60 = !_v52 && (_v12 || "studio" !== _v50 && "production" !== _v50 || "individual" === _v57),
        _v61 = void 0 !== _v50 && _v24.REPACKAGING_PAID_PLANS.includes(_v50);
      (0, _v7.useEffect)(() => {
        _v49 && _v34 ? _v11(!_v35) : _v44?.some(_v0 => _v0.metadata?.purchasedProduct?.isMonthly === !1) ? _v11(!0) : _v34 && _v32 && _v35 && _v11(!1);
      }, [_v44, _v49, _v34, _v35, _v32]), (0, _v7.useEffect)(() => {
        _v19 && ["review", "copy_review_link"].includes(_v19) && _v9 && _v44 && (0, _v32.logViewUpsell)(_v19, _v9);
      }, [_v19, _v44, _v9]), (0, _v7.useEffect)(() => {
        !_v22 && _v5?.redirectLoggedOut && (window.location.href = "/log_in"), void 0 !== _v44 && (_v4((_v0 => {
          let _v1 = !1;
      ...
      }, [_v44, _v7, _v5, _v22]), (0, _v7.useEffect)(() => {
        !_v22 && _v9?.location && _v131.includes(_v9.location.toUpperCase()) && (window.location.href = "/log_in");
      }, [_v22, _v9?.location]), (0, _v7.useEffect)(() => {
        void 0 === _v5 && (async _v0 => {
          _v6((0, (await _v0.A(0)).default)(_v0));
        })(_v1);
      }, [_v1, _v5]);
      let _v62 = !!(_v44 && _v44.some(_v0 => void 0 !== _v0.promotion) && _v10 && _v3 && !_v37);
      return null === _v9 || void 0 === _v44 || _v28 || !_v22 && _v5?.redirectLoggedOut ? (0, _v1.jsx)(_v55.default, {}) : (0, _v1.jsxs)(_v126.default, {
        isMobileBreakpoint: _v37,
        children: [void 0 !== _v5 && _v44 && (0, _v1.jsx)(_v25.OverridesContextProvider, {
          showYearly: _v10,
          viewer: _v9,
          overrides: _v5,
          children: (0, _v1.jsx)(_v26.PlansDataProvider, {
            overrides: _v5,
            plansData: _v44,
            isLoggedIn: _v22,
            ...
            children: (0, _v1.jsxs)(_v1.Fragment, {
              children: [(0, _v1.jsx)(_v11.Box, {
              ...
              }), _v3 && !(_v32 && !_v35) && !_v49 && (_v30 || !_v37) && (0, _v1.jsx)(_v11.Box, {
                width: "100%",
                display: "inline-flex",
                justifyContent: "center",
                marginTop: (0, _v13.rem)(40),
                alignItems: "center",
                children: _v30 ? (0, _v1.jsx)(_v37, {
                  checked: _v10,
                  onClick: _v42,
                  isMobile: _v37
                ...
                showYearly: !!_v37 && !_v49 || _v10,
                isBillingFreqToggleAvailable: _v3 && !_v37,
                badgePlan: _v53,
                showStrikePrice: _v62,
                isMobileBreakpoint: _v37,
                planView: _v57,
                onSwitchView: _v58,
                businessTiers: _v59,
                showCrossSellCard: _v60
              }), _v30 && !_v37 && (0, _v1.jsxs)(_v1.Fragment, {
                children: [_v52 && _v15 && (0, _v1.jsx)(_v49, {
                  onRequestEligibility: _v16
                }), !_v52 && (0, _v1.jsx)(_v49, {
                  planView: _v57,
                  onSwitchView: _v58
                })]
                ...
                padding: _v37 ? `${(0, _v13.rem)(0)} ${(0, _v13.rem)(24)}` : `${(0, _v13.rem)(75)} ${(0, _v13.rem)(28)}`,
                minHeight: _v37 ? "" : (0, _v13.rem)(240),
                children: [_v37 && (0, _v1.jsx)(_v12.Text, {
                  textAlign: "center",
              ...
              }), !_v37 && (0, _v1.jsx)(_v127, {
                showYearly: _v10,
                badgePlan: _v53,
                theme: _v40.colorMode,
                filteredTiers: _v30 ? [...("individual" !== _v57 || _v52 ? _v59 : _v24.REPACKAGING_INDIVIDUAL_TIERS.filter(_v0 => "free" !== _v0 || !_v61))] : void 0
              ...
              }), !_v5.hideFaq && (0, _v1.jsx)(_v128, {
                isMobileBreakpoint: _v37
              })]
            })
          })
        }), _v33 && (0, _v1.jsx)(_v130, {}), _v17]
      });
    };
  var _v133 = _v0.i(0),
    _v134 = _v0.i(0);
  function _v135() {
    let [_v0] = (0, _v3.useQueryParams)({
      v: _v2.NumberParam,
      context: (0, _v2.createEnumParam)(Object.values(_v133.CONTEXT)),
  ...
  _v135.getLayout = _v0 => (0, _v1.jsxs)(_v134.QueryParamProvider, {
    children: [_v0, (0, _v1.jsx)(_v4.StandardFooterLayout, {})]
  }), _v0.s(["__N_SSG", 0, !0, "default", 0, _v135], 0);
}