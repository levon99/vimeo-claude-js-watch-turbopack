{
  ...
  var _v1 = _v0.i(0),
    ...
    _v21 = _v0.i(0),
    _v22 = _v0.i(0);
  let _v23 = "request_a_refund",
    _v24 = ["request_a_refund", "cancel_my_subscription"];
  function _v25(_v0) {
  ...
  let _v28 = () => {
    let _v0 = (0, _v21.usePico)(),
      ...
      [_v6, _v7] = (0, _v3.useState)(_v23),
      _v8 = (0, _v3.useRef)(!1),
      _v9 = (0, _v3.useRef)(null),
      _v10 = (0, _v3.useCallback)(_v0 => {
        null === _v9.current && (_v9.current = _v0, window.parent.postMessage({
      ...
      _v11 = (0, _v3.useCallback)(async _v0 => {
        ...
        try {
          ...
          if (_v1 = await _v0.json(), !_v25(_v1) || !0 !== _v1.success) throw Error("Invalid refund offer redemption response");
          _v3({
            type: "accepted",
            offer: _v0
          }), _v0.track("refund_offer_contact_accepted", _v26(_v0, _v6));
        } catch {
          _v3({
            type: "error",
            retry: "accept",
            offer: _v0
          }), _v0.track("refund_offer_contact_error", _v26(_v0, _v6));
        }
      }, [_v6, _v0, _v1]);
    (0, _v3.useEffect)(() => {
      let _v0 = _v0 => {
        ...
        let _v4 = {
          ...
          _v5 = (_v3 = _v0.data, _v24.find(_v0 => _v0 === _v3.entry_point) ?? _v23);
        _v7(_v5), _v3({
          type: "offer",
          offer: _v4
        }), _v0.track("refund_offer_contact_modal_displayed", _v26(_v4, _v5));
      };
    ...
    let _v12 = (0, _v3.useCallback)(() => {
        if ("accepting" === _v2.type) return;
        let _v0 = "accepted" === _v2.type ? "accepted" : "error" === _v2.type ? "error" : "declined";
        "offer" === _v2.type && _v0.track("refund_offer_contact_declined", _v26(_v2.offer, _v6)), _v10(_v0), _v3({
          type: "closed"
        });
      }, [_v6, _v0, _v10, _v2]),
      _v13 = (0, _v3.useCallback)(() => {
        "offer" === _v2.type && _v11(_v2.offer);
      }, [_v11, _v2]),
      _v14 = (0, _v3.useCallback)(() => {
        "offer" === _v2.type && (_v0.track("refund_offer_contact_declined", _v26(_v2.offer, _v6)), _v10("continue_to_ticket"), _v3({
          type: "closed"
        }));
      }, [_v6, _v0, _v10, _v2]),
      _v15 = (0, _v3.useCallback)(() => {
        "error" === _v2.type && _v11(_v2.offer);
      }, [_v11, _v2]);
    if ("closed" === _v2.type || "waiting" === _v2.type) return null;
    let _v16 = "accepting" === _v2.type,
      _v17 = "error" === _v2.type,
      _v18 = "offer" === _v2.type || "accepting" === _v2.type || "accepted" === _v2.type ? _v2.offer : null,
      _v19 = null === _v18 ? "" : function (_v0) {
        switch (_v0) {
          case "core":
      ...
      _v20 = null === _v18 ? null : function (_v0) {
        switch (_v0) {
          case "core":
            return [(0, _v20.translate)({
      ...
      _v21 = _v18?.billingPeriodMonths === 12,
      _v22 = null === _v18 ? "" : _v27(_v18.targetPriceFormatted),
      _v23 = null === _v18 ? "" : _v27(_v18.currentPaymentFormatted),
      _v24 = null === _v18 ? "" : _v27(_v18.targetMonthlyPriceFormatted),
      _v25 = null === _v18 ? "" : _v27(_v18.currentMonthlyPriceFormatted),
      _v26 = null === _v18 ? "" : _v27(_v18.refundAmountFormatted);
    return (0, _v1.jsxs)(_v8.Modal, {
      ...
      children: [(0, _v1.jsx)(_v14.ModalOverlay, {
        ...
        children: [(0, _v1.jsx)(_v10.ModalCloseButton, {
          ...
          isDisabled: _v16
        }), null !== _v18 && null !== _v20 && "accepted" !== _v2.type && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsxs)(_v13.ModalHeader, {
            ...
            children: [(0, _v1.jsx)(_v17.Text, {
              ...
              children: (0, _v20.translate)({
                ...
                replacements: {
                  currentTier: _v19,
                  refundPercentage: _v18.refundPercentage
                },
                dictionary: {
                  es: {
              ...
              children: (0, _v20.translate)({
                ...
                replacements: {
                  refundPercentage: _v18.refundPercentage,
                  refundAmountFormatted: _v26,
                  currentPaymentFormatted: _v23,
                  currentTier: _v19
                },
                dictionary: {
                  es: {
          ...
          children: [(0, _v1.jsx)(_v13.ModalHeader, {
            ...
            children: (0, _v1.jsx)(_v17.Text, {
              ...
              children: (0, _v20.translate)({
                ...
                replacements: {
                  refundAmountFormatted: _v27(_v2.offer.refundAmountFormatted)
                },
                dictionary: {
                  es: {
