{
  ...
  _v0.s(["MAX_LOST_FEATURES", 0, 5, "getLostFeatures", 0, (_v0, _v1) => {
    let _v2 = _v4(_v1),
      _v3 = _v3.find(_v0 => _v0.includes(_v2));
    if (!_v3) return [];
    let _v4 = _v3.indexOf(_v2),
      _v5 = _v0 ? _v3.indexOf(_v4(_v0)) : -1,
      _v6 = Math.min(_v5 > _v4 ? _v5 : _v4 + 1, _v3.length - 1),
      _v7 = [],
      _v8 = new Set();
    for (let _v0 = _v6; _v0 > _v4; _v0--) for (let _v0 of _v2[_v3[_v0]] ?? []) _v8.has(_v0) || (_v8.add(_v0), _v7.push(_v0));
    return _v7;
  }]);
}