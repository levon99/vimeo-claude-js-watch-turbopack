{
  ...
  let _v31 = {
    ...
    _v32 = [["creator", "core", "professional", "studio", "production"], ["starter", "standard", "advanced"], ["plus", "pro", "business", "livePremium"]],
    _v33 = _v0 => _v0.replace(/_([a-z])/g, (_v0, _v1) => _v1.toUpperCase()),
    _v34 = (_v0, _v1) => {
      let _v2 = _v33(_v1),
        _v3 = _v32.find(_v0 => _v0.includes(_v2));
      if (!_v3) return [];
      let _v4 = _v3.indexOf(_v2),
        _v5 = _v0 ? _v3.indexOf(_v33(_v0)) : -1,
        _v6 = Math.min(_v5 > _v4 ? _v5 : _v4 + 1, _v3.length - 1),
        _v7 = [],
        _v8 = new Set();
      for (let _v0 = _v6; _v0 > _v4; _v0--) for (let _v0 of _v31[_v3[_v0]] ?? []) _v8.has(_v0) || (_v8.add(_v0), _v7.push(_v0));
      return _v7;
    };
  _v0.s(["MAX_LOST_FEATURES", 0, 5, "getLostFeatures", 0, _v34], 0);
  var _v35 = _v0.i(0);
  let _v36 = {
    ...
    _v37 = ({
      ...
      let _v1 = _v36[_v0.toLowerCase().replace(/[^a-z]/g, "")] || _v17.CreditCard;
  ...
  _v0.s(["AutoRenewRetentionModal", 0, ({
    ...
    let {
      ...
      _v20 = (0, _v30.useViewer)(),
      _v21 = _v20?.user?.id,
      _v22 = _v20?.teamUser?.ownerId ?? _v21,
      {
        data: _v23
      } = (0, _v25.useGetMePaymentMethods)(() => !_v0 || _v19 ? null : {
      ...
      {
        data: _v24
      } = (0, _v26.useGetUser)(() => _v0 && _v19 && null != _v22 ? {
      ...
      {
        data: _v25
      } = (0, _v27.useGetUserSettingsBillingMembership)(() => _v0 && _v19 && null != _v22 ? {
        select: ["seatCount"],
        where: {
          userId: Number(_v22)
        }
      ...
      _v29 = (0, _v35.getPaymentsServiceCardBrandLabel)(_v26),
      _v30 = _v24?.uploadQuota?.space?.max ? (0, _v29.formatBytes)(_v24.uploadQuota.space.max, !1) : "",
      _v31 = _v25?.seatCount,
      _v32 = _v34(_v6, _v7).slice(0, 3),
      _v33 = (0, _v35.daysUntil)(_v8),
      _v34 = (0, _v35.formatSuspensionDate)(_v8),
      ...
      _v37 = (0, _v2.useCallback)(async () => {
        _v11?.(), _v18(!0);
        try {
          await (0, _v23.patchMeSubscription)({
            select: [],
            where: {
              subscriptionId: _v4
            },
        ...
        children: [_v12 && (0, _v1.jsx)(_v10.ModalCloseButton, {}), (0, _v1.jsxs)(_v3.Box, {
          ...
          children: (0, _v1.jsxs)(_v15.VStack, {
            ...
            children: [(0, _v1.jsxs)(_v7.HStack, {
              ...
              children: [(0, _v1.jsx)(_v14.Text, {
                ...
                title: "number" == typeof _v31 ? (0, _v28.translate)({
                  singular: "{COUNT} seat",
                  plural: "{COUNT} seats",
                  count: _v31,
                  replacements: {
          ...
          children: _v19 ? (0, _v1.jsxs)(_v6.Flex, {
            ...
            children: [(0, _v1.jsx)(_v4.Button, {
              ...
              onClick: _v1,
              isDisabled: _v17,
              children: _v10 ?? (0, _v28.translate)({
