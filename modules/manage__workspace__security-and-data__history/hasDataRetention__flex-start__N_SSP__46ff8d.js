{
  ...
  let _v12 = ({
    ...
    let {
      loading: _v1,
      capabilities: _v2
    } = (0, _v4.useCapability)(["hasDataRetention"], _v0);
    if (_v1) return (0, _v1.jsx)(_v7.Spinner, {});
    if (_v2?.hasDataRetention === !1) throw new _v5.UnauthorizedError();
    return (0, _v1.jsxs)(_v3.VStack, {
      ...
      children: [(0, _v1.jsx)(_v9.SecurityAndDataBreadcrumbs, {}), (0, _v1.jsx)(_v2.Box, {
        ...
        pt: 0,
        w: "100%",
        children: (0, _v1.jsx)(_v10.HistoryPage, {
          userId: _v0
        })
      })]
    });
