            ...
            children: (0, _v1.jsx)("span", {
              children: (0, _v7.translate)({
                ...
                dictionary: {
                  ...
                  "ja-JP": {
                    singular: "読み込まれた{BOLD}{NUM_ITEMS}件のビデオ{/BOLD}が選択されています。",
                    plural: "読み込まれた{BOLD}{NUM_ITEMS}件のビデオ{/BOLD}が選択されています。"
                  },
                  "ko-KR": {
                  ...
                  "zh-CN": {
                    singular: "{BOLD}{NUM_ITEMS} 个已加载的视频{/BOLD} 已被选中。",
                    plural: "{BOLD}{NUM_ITEMS} 个已加载的视频{/BOLD} 已被选中。"
                  }
                }
              })
            })
