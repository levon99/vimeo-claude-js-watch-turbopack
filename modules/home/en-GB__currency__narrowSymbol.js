{
  ...
  _v0.s(["PlansComparisonPaywallModal", 0, function ({
    ...
    let _v9,
      _v10,
      [_v11, _v12] = (0, _v2.useState)(_v3),
      [_v13, _v14] = (0, _v2.useState)(!1),
      _v15 = _v4 && _v13,
      _v16 = (0, _v21.useGetSubscriptionPlansData)([_v1], void 0, !1),
      _v17 = (0, _v22.useViewer)(),
      _v18 = (_v9 = _v17?.location, _v9?.toUpperCase() === "GB"),
      _v19 = _v16?.find(_v0 => _v0.tier === _v1) ?? _v16?.[0],
      _v20 = _v19?.currency?.currencyCode || "USD",
      _v21 = _v18 ? _v23(_v19?.price.annualMonthly, _v20) : _v19?.priceFormatted.annualMonthly,
      _v22 = _v18 ? _v23(_v19?.price.monthly, _v20) : _v19?.priceFormatted.monthly,
      _v23 = void 0 === _v16,
      _v24 = (0, _v16.useColorModeValue)("https://i.vimeocdn.com/custom_asset/4a6f0f615c4cf9d30b48f79df970438e", "https://i.vimeocdn.com/custom_asset/edb2ec4f5620a90adb065894bbb08419"),
      {
        trackDisplayed: _v25,
        trackDismissed: _v26,
        ...
        children: [(0, _v1.jsx)(_v9.ModalCloseButton, {
          ...
          children: [(0, _v1.jsx)(_v4.Box, {
            ...
            children: [(0, _v1.jsxs)(_v6.Flex, {
              ...
              width: "100%",
              height: "78px",
              borderColor: _v15 ? "fill-brand" : "input-stroke",
              borderRadius: "16px",
              borderWidth: "1px",
              borderStyle: "solid",
              cursor: "pointer",
              bg: _v15 ? "var(--vimeo-colors-vimeoBlue-50)" : "surface",
              _hover: {
                bg: _v15 ? "var(--vimeo-colors-vimeoBlue-50)" : "input-fill-hover"
              },
              transition: "background-color 0.15s ease, border-color 0.15s ease",
              sx: {
                width: "100% !important"
              ...
              alignItems: "center",
              height: _v15 ? "20px" : "0px",
              opacity: +!!_v15,
              transition: _v15 ? "height 0.3s ease, opacity 0.3s ease 0.1s" : "height 0.3s ease 0.1s, opacity 0.3s ease",
              overflow: "hidden",
              children: [(0, _v1.jsx)(_v15.Text, {
                variant: "heading-2xs",
                color: "text-secondary",
                children: (0, _v18.translate)({
                  ...
                  replacements: {
                    amount: (_v10 = (0, _v18.getCurrentLocale)(), new Intl.NumberFormat(_v10, {
                      style: "currency",
                      currency: _v20,
            ...
            width: "100%",
            flexShrink: 0,
            children: [_v23 ? (0, _v1.jsx)(_v14.Skeleton, {
              width: "100%",
              height: "64px",
              borderRadius: "16px"
            }) : (0, _v1.jsx)(_v24, {
              ...
              selected: "monthly" === _v11,
              onClick: () => _v12("monthly")
            }), !_v23 && (0, _v1.jsx)(_v15.Text, {
              variant: "body-sm",
              color: "text-tertiary",
              textAlign: "center",
          ...
          children: (0, _v1.jsxs)(_v6.Flex, {
            ...
            children: [(0, _v1.jsx)(_v5.Button, {
              ...
              variant: "primary",
              onClick: () => {
                let _v0 = "monthly" === _v11 ? `${_v1}/monthly` : _v1,
