{
  ...
  _v0.s(["isCorporateScheduledTier", 0, _v19, "useCorporateUpgradeModalState", 0, function (_v0) {
    let {
      scheduledOrder: _v1,
      hasScheduledDowngrade: _v2
    } = (0, _v18.useScheduledOrder)(_v0?.subscriptionId, _v0?.tier, _v0?.hasAutorenew);
    return {
      shouldRender: _v2 && _v19(_v1?.productName),
