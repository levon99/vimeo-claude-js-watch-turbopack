{
  ...
  _v0.s(["HoverActions", 0, ({
    ...
    let _v7 = (0, _v15.useViewer)(),
      ...
      _v14 = (0, _v22.useCopyVideoLinkToast)(),
      _v15 = (0, _v21.useCopyFolderLinkToast)(),
      _v16 = "video" === _v0 && !!_v1.metadata?.interactions?.edit?.uri,
      _v17 = "folder" === _v0 && (0, _v29.getFolderPermissions)(_v1).canEditSettings,
      _v18 = (0, _v25.useManageShareAction)({
        canEdit: _v16,
        entityUri: _v1.uri,
        location: _v16.SHARE_RESOURCE_FOLDER_CARD_HOVER_ENTRY_POINT,
        panel: "COPY_LINK_PANEL"
      }),
      _v19 = (0, _v25.useManageShareAction)({
        canEdit: _v17,
        entityUri: _v1.uri,
        location: _v16.SHARE_RESOURCE_FOLDER_CARD_HOVER_ENTRY_POINT,
        panel: "INVITE_PANEL"
      ...
      _v21 = !!_v20?.bi_expiring_links_ux_enabled,
      _v22 = (0, _v23.useCreateAndCopySharingLink)("hover_icon", _v1, () => _v9({
        content: _v28.linkCopyFailed,
        status: "error"
      })),
      _v23 = _v3 ?? !!_v1.metadata?.interactions?.invite?.uri,
      _v24 = _v4 || !!_v11?.hasLibrarySidePanel || !!_v8,
      _v25 = "video" === _v0 && _v1.isColdStorage,
      {
        isLocked: _v26,
        renderLocked: _v27
      } = (0, _v26.useVideoMetadataLock)("video" === _v0 ? _v1 : void 0);
    if (_v25) return (0, _v1.jsx)(_v1.Fragment, {});
    let _v28 = (0, _v24.useFolderShareClick)({
        folder: _v1,
        analytics: {
      ...
      _v29 = (0, _v27.useVideoShareClick)({
        video: _v1,
        analytics: {
          feature: _v2?.feature || _v16.AnalyticsFeatures.VIDEO_LIBRARY,
    ...
    return (0, _v1.jsxs)(_v9.ContentCard.HoverActions, {
      children: [_v4 && (0, _v1.jsx)(_v9.ContentCard.HoverAction, {
        ...
        isAlwaysVisible: !0,
        children: (0, _v1.jsx)(_v31.StarredIconContainer, {
          type: _v0,
          uri: _v1.uri,
          entity: _v1,
          buttonVariant: "blur",
      ...
      }), _v23 && ("folder" === _v0 || "video" === _v0) && (0, _v1.jsx)(_v9.ContentCard.HoverAction, {
        children: "video" === _v0 && _v26 ? _v27((0, _v1.jsx)(_v3.IconButton, {
          "aria-label": _v32.share,
          ...
          children: (0, _v1.jsx)(_v3.IconButton, {
            ...
            variant: "blur",
            size: "xs",
            onClick: "folder" === _v0 ? () => _v28?.() : "video" === _v0 ? () => {
              _v6?.("share"), _v29?.();
            } : void 0
          })
        })
            ...
            onClick: () => {
              _v6?.("copy_link"), (() => {
                if ("folder" === _v0) {
                  ...
                  if (_v21 && _v1 && !_v8) {
                    let _v0 = (0, _v30.idFromUri)(_v1.uri),
                      _v1 = /http/.test(_v1?.link) ? `${_v1?.link}${_v0}` : `${_v7?.vimeoHttpsUrl}${_v1?.link}${_v0}`;
                    _v22(_v0, _v0, _v1), _v17.BPAnalyticsV2.copyVideoShareLink({
                      location: "card",
                      element: "icon",
                      teamUser: _v7?.teamUser,
                      video: _v1,
                  ...
                  let _v2 = "";
                  _v2 = _v8 ? `${_v7?.vimeoHttpsUrl}/reviews/${_v8}${_v1.uri}${_v0}` : /http/.test(_v1?.link) ? `${_v1?.link}${_v0}` : `${_v7?.vimeoHttpsUrl}${_v1?.link}${_v0}`, _v14({
                    video: _v1,
                    isSuccess: (0, _v14.default)(_v2),
                    onManage: _v18
