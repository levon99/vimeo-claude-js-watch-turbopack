{
  ...
  var _v1 = _v0.i(0),
    ...
    _v5 = _v0.i(0),
    _v6 = _v0.i(0);
  let _v7 = _v0 => _v5.SEAT_TIER_PLANS.includes(_v0);
  _v0.s(["appendExtraQueryParams", 0, (_v0, _v1) => {
    ...
    let _v2 = _v0?.planOverrides?.[_v1.tier]?.featuresList,
      _v3 = (_v0 => {
        ...
        return "lifetime" !== _v3 || _v7(_v1) ? "pro" === _v1 || "plus" === _v1 ? (0, _v1.translate)({
    ...
    let _v3 = _v5.SEAT_TIER_PLANS.includes(_v1.tier);
    if (_v2 > 0) return _v0[_v2 - 1].tier;
    let _v4 = [],
      _v5 = (_v4 = _v3 ? _v5.DEFAULT_SEAT_PLANS : (0, _v4.isSolutionTier)(_v1.tier) ? _v5.SOLUTION_PLANS : _v5.LEGACY_PLANS).findIndex(_v0 => _v1.tier === _v0);
    return _v4[_v5 - 1];
  }, "getUkVatDisplayPrice", 0, (_v0, _v1, _v2) => {
    let _v3,
      _v4 = _v0.currency?.currencyCode;
    return _v4 ? (_v3 = _v2 ? _v0.price.annual : _v1 ? _v0.price.monthly : _v0.price.annualMonthly, (0, _v2.formatUkVatPrice)(_v3, _v4) ?? null) : null;
  }, "getVuid", 0, () => {
