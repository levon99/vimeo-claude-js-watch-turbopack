{
  ...
  _v0.s(["PlansComparisonPaywallModal", 0, function ({
    ...
    let _v8,
      ...
      _v12,
      _v13,
      [_v14, _v15] = (0, _v2.useState)(_v3),
      [_v16, _v17] = (0, _v2.useState)(!1),
      _v18 = _v4 && _v16,
      _v19 = (0, _v23.useGetSubscriptionPlansData)([_v1], void 0, !1),
      _v20 = (0, _v24.useViewer)(),
      _v21 = (_v8 = _v20?.location, _v8?.toUpperCase() === "GB"),
      _v22 = _v19?.find(_v0 => _v0.tier === _v1) ?? _v19?.[0],
      _v23 = _v22?.currency?.currencyCode || "USD",
      _v24 = _v21 ? _v25(_v22?.price.annualMonthly, _v23) : _v22?.priceFormatted.annualMonthly,
      _v25 = _v21 ? _v25(_v22?.price.monthly, _v23) : _v22?.priceFormatted.monthly,
      _v26 = void 0 === _v19,
      _v27 = (0, _v16.useColorModeValue)("https://i.vimeocdn.com/custom_asset/4a6f0f615c4cf9d30b48f79df970438e", "https://i.vimeocdn.com/custom_asset/edb2ec4f5620a90adb065894bbb08419"),
      {
        trackDisplayed: _v28,
        trackDismissed: _v29,
        trackCtaClicked: _v30
      } = (_v9 = (0, _v21.usePico)(), _v10 = (0, _v2.useRef)(null), _v11 = (0, _v2.useCallback)(_v0 => {
        if (null === _v9) return;
        let _v1 = (0, _v20.v4)();
        _v10.current = _v1, _v9.track("paywall_displayed", _v22(_v1, _v0));
      }, [_v9]), _v12 = (0, _v2.useCallback)((_v0, _v1) => {
        let _v2 = _v10.current;
        null !== _v9 && null !== _v2 && (_v10.current = null, _v9.track(_v0, _v22(_v2, _v1)));
      }, [_v9]), {
        trackDisplayed: _v11,
        trackDismissed: (0, _v2.useCallback)(_v0 => _v12("paywall_dismissed", _v0), [_v12]),
        trackCtaClicked: (0, _v2.useCallback)(_v0 => _v12("paywall_cta_clicked", _v0), [_v12])
      }),
      _v31 = (0, _v2.useRef)(_v28),
      _v32 = (0, _v2.useRef)(_v2);
    (0, _v2.useEffect)(() => {
      _v31.current = _v28, _v32.current = _v2;
    }), (0, _v2.useEffect)(() => {
      _v0 && _v31.current(_v32.current);
    }, [_v0]);
    let _v33 = (0, _v18.translate)({
        singular: "Join Vimeo",
        dictionary: {
          es: {
        ...
        children: [(0, _v1.jsx)(_v9.ModalCloseButton, {
          ...
          children: [(0, _v1.jsx)(_v4.Box, {
            ...
            children: [(0, _v1.jsxs)(_v6.Flex, {
              ...
              width: "100%",
              height: "78px",
              borderColor: _v18 ? "fill-brand" : "input-stroke",
              borderRadius: "16px",
              borderWidth: "1px",
              borderStyle: "solid",
              cursor: "pointer",
              bg: _v18 ? "var(--vimeo-colors-vimeoBlue-50)" : "surface",
              _hover: {
                bg: _v18 ? "var(--vimeo-colors-vimeoBlue-50)" : "input-fill-hover"
              },
              transition: "background-color 0.15s ease, border-color 0.15s ease",
              sx: {
                width: "100% !important"
              ...
              children: [(0, _v1.jsxs)(_v6.Flex, {
                ...
                children: [(0, _v1.jsx)(_v15.Text, {
                  ...
                  fontWeight: "medium",
                  color: "text-primary",
                  children: _v18 ? (0, _v18.translate)({
              ...
              alignItems: "center",
              height: _v18 ? "20px" : "0px",
              opacity: +!!_v18,
              transition: _v18 ? "height 0.3s ease, opacity 0.3s ease 0.1s" : "height 0.3s ease 0.1s, opacity 0.3s ease",
              overflow: "hidden",
              children: [(0, _v1.jsx)(_v15.Text, {
                variant: "heading-2xs",
                color: "text-secondary",
                children: (0, _v18.translate)({
                  ...
                  replacements: {
                    amount: (_v13 = (0, _v18.getCurrentLocale)(), new Intl.NumberFormat(_v13, {
                      style: "currency",
                      currency: _v23,
            ...
            width: "100%",
            flexShrink: 0,
            children: [_v26 ? (0, _v1.jsx)(_v14.Skeleton, {
              width: "100%",
              height: "64px",
              borderRadius: "16px"
            }) : (0, _v1.jsx)(_v26, {
              ...
              price: _v24 ? `${_v24}${(0, _v18.translate)({
                singular: "/month",
                dictionary: {
                  es: {
                    singular: "/mes"
              ...
              price: _v25 ? `${_v25}${(0, _v18.translate)({
                singular: "/month",
                dictionary: {
                  es: {
                    singular: "/mes"
              ...
              selected: "monthly" === _v14,
              onClick: () => _v15("monthly")
            }), !_v26 && (0, _v1.jsx)(_v15.Text, {
              variant: "body-sm",
              color: "text-tertiary",
              textAlign: "center",
              children: _v21 ? (0, _v18.translate)({
          ...
          children: (0, _v1.jsx)(_v5.Button, {
            ...
            variant: "primary",
            onClick: () => {
              let _v0 = "monthly" === _v14 ? `${_v1}/monthly` : _v1,
              ...
              if (_v30(_v2), "_blank" === _v6) {
                window.open(_v1, "_blank", "noopener,noreferrer"), _v7("checkout");
                return;
              }
