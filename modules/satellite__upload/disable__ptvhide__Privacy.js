{
  ...
  _v0.s(["default", 0, ({
    ...
    let _v3 = (0, _v2.useRouter)(),
      ...
      _v6 = (0, _v14.useDefaultPrivacyOptions)(_v4, !1).find(_v0 => _v0.privacy === _v2),
      _v7 = (0, _v11.useMediaQueryVisibility)(`screen and (min-width: ${(0, _v7.rem)(_v17.BREAKPOINTS.large)})`),
      {
        icon: _v8,
        label: _v9
      } = (0, _v3.useMemo)(() => ({
        icon: _v5.privacy_settings_new_copy && "disable" === _v2 ? (0, _v1.jsx)(_v10.Code, {
          boxSize: "xs"
        }) : _v15.VIDEO_PRIVACY_ICON_MAP[_v2]?.icon ?? ("ptv" === _v2 || "ptvhide" === _v2 ? (0, _v1.jsx)(_v8.OnDemand, {}) : (0, _v1.jsx)(_v9.Lock, {})),
    ...
    return (0, _v1.jsx)(_v6.Tooltip, {
      ...
      children: (0, _v1.jsx)(_v1.Fragment, {
        children: _v7 ? (0, _v1.jsx)(_v5.Button, {
          isDisabled: _v0,
          leftIcon: _v8,
          onClick: _v1,
  ...
  var _v18 = _v0.i(0),
    ...
    _v21 = _v0.i(0),
    _v22 = _v0.i(0);
  let _v23 = `${_v22.Duration.xl}s cubic-bezier(${_v22.Easing["basic-entrance"].join(", ")})`;
  _v0.s(["SideDrawer", 0, ({
    children: _v0,
    side: _v1 = "left",
    isTwoColumn: _v2,
    ...
    let _v6,
      ...
      _v11 = (0, _v1.jsx)(_v19.Drawer, {
        isOpen: _v4,
        placement: _v7,
        onClose: _v5,
        blockScrollOnMount: !1,
        trapFocus: !1,
        children: (0, _v1.jsx)(_v20.DrawerContent, {
          maxW: _v2 ? (0, _v7.rem)(720) : (0, _v7.rem)(360),
          sx: _v10,
          transition: `max-width ${_v23}`,
          containerProps: {
    ...
    return _v3 && _v3.current ? (0, _v1.jsx)(_v21.Portal, {
      containerRef: _v3,
      children: _v11
    }) : _v11;
  }], 0);
