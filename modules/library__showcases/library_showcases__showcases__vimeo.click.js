{
  ...
  let _v41 = "library_showcases",
    ...
    _v53 = ({
      ...
      let _v8 = (0, _v35.buildTeamBpContextFromTeamUser)(_v7),
        _v9 = (0, _v36.buildThirdPartyIntegrationBpContext)({
          is_integration: !1,
          integration_id: null,
          is_partner: null,
        ...
        _v10 = {
          ...(_v2 ? (0, _v34.buildActionBpContext)(_v2) : {}),
          ...(_v4 ? (0, _v39.buildViewBpContext)(_v4) : {}),
          ...(0, _v33.buildProductAnalyticsBpContext)(_v3),
          ...(0, _v37.buildWebBpContext)(_v5),
          ..._v8,
          ..._v9
        };
      (0, _v38.sendBpEventWithContexts)(_v0, _v10, _v1, _v6);
    };
  var _v54 = _v0.i(0),
    _v55 = _v0.i(0),
    _v56 = _v0.i(0),
        ...
        children: (0, _v1.jsx)(_v59.EmptyState, {
          cta: (0, _v1.jsxs)(_v4.Flex, {
            ...
            children: [(0, _v1.jsx)(_v54.Button, {
              variant: "secondary",
              leftIcon: (0, _v1.jsx)(_v57.PlayCircle, {}),
              onClick: () => {
                _v3({
                  eventName: _v43,
                  version: 110,
              ...
              variant: "primary",
              leftIcon: (0, _v1.jsx)(_v56.PlusSmall, {}),
              disabled: _v0,
              isLoading: _v0,
              onClick: () => {
                let _v0;
          ...
          header: _v64,
          icon: (0, _v1.jsx)(_v55._3GridLeftLayout, {
            height: "2xl",
            width: "2xl",
            gap: "md"
          }),
  ...
  var _v81 = _v0.i(0),
    _v82 = _v0.i(0),
    _v83 = _v0.i(0);
  let _v84 = _v82.default.div.withConfig({
      displayName: "LoadMoreButton__Wrapper",
      componentId: "sc-8adbeaa5-0"
    })`
  margin: ${(0, _v81.rem)(40)} 0 ${(0, _v81.rem)(48)};
  padding: 0 1.25rem;
`,
    _v85 = ({
      isLoading: _v0 = !1,
  ...
  let _v88 = ({
    ...
    children: [(0, _v1.jsx)(_v86.IconButton, {
      ...
      icon: (0, _v1.jsx)(_v87.PlusCircle, {}),
      isDisabled: _v0,
      isLoading: _v1,
      onClick: _v2,
      variant: "secondary"
  ...
  var _v89 = _v0.i(0),
    ...
    _v91 = _v0.i(0);
  let _v92 = {
      [`@media screen and (min-width: ${_v90.bokehTheme.breakpoints.lg})`]: {
        gridTemplateColumns: `${(0, _v89.rem)(150)} 8fr 2fr 0.2fr`
      },
      [`@media screen and (min-width: ${_v90.bokehTheme.breakpoints.xl})`]: {
        gridTemplateColumns: `${(0, _v89.rem)(150)} 6fr 2fr 2fr 0.2fr`
      }
    },
    _v93 = ({
      sort: _v0
    }) => (0, _v1.jsxs)(_v91.ContentRow, {
      listGridColumns: `${(0, _v89.rem)(150)} 10fr 0.2fr`,
      disableHover: !0,
      sx: {
        ..._v92,
        display: {
      ...
      top: "",
      zIndex: "1",
      children: [(0, _v1.jsx)(_v91.ContentRow.Column, {
      ...
      }), (0, _v1.jsx)(_v91.ContentRow.Column, {
        children: "-"
      }), (0, _v1.jsx)(_v91.ContentRow.Column, {
        hideAtWidth: _v90.bokehTheme.breakpoints.xl,
        children: (0, _v1.jsx)(_v5.Text, {
          variant: "heading-xs",
          color: "text-secondary",
          children: _v73
        ...
        hideAtWidth: _v90.bokehTheme.breakpoints.lg,
        children: (0, _v1.jsx)(_v5.Text, {
          variant: "heading-xs",
          color: "text-secondary",
          children: (() => {
  ...
  let _v101 = (_v0, _v1) => {
    ...
    _v102 = ({
      ...
      let _v2,
        _v3 = _v100.BPAnalyticsV2.useContentManagamentHoverEvent(),
        _v4 = _v1.pictures.map((_v0, _v1) => 0 === _v1 ? (0, _v99.stripPadding)(_v0.sizes[3].link) : (0, _v99.stripPadding)(_v0.sizes[1].link)),
    ...
    _v103 = ({
      ...
      let _v7 = (0, _v13.useAnalyticsEvent)(),
        _v8 = "showcase_grid";
      return (0, _v1.jsx)(_v97.ContentGrid, {
        children: (0, _v1.jsxs)(_v97.ContentGrid.Body, {
          children: [_v6?.map(_v0 => (0, _v1.jsx)(_v102, {
            overflowMenu: (0, _v1.jsx)(_v96.ShowcaseMenu, {
              ...
              onCopyLink: () => {
                _v3(_v0.link), _v7(_v47({
                  location: _v8
                }));
              },
              onCopyEmbed: () => {
                _v0.embed?.html && (_v2(_v0.embed?.html), _v7(_v48({
                  location: _v8
                })));
              },
              onCopyShowcase: () => {
              ...
              onClickViewShowcase: () => {
                window.open(_v0.link, "_blank"), _v7(_v49({
                  location: _v8
                }));
              },
              onDelete: () => {
            ...
            showcase: _v0
          }, _v0.uri)), _v0 && (0, _v1.jsx)(_v95.LoadingCardsGrid, {})]
        })
      });
    };
  var _v104 = _v0.i(0),
  ...
  let _v110 = ({
    ...
    let _v9 = _v100.BPAnalyticsV2.useContentManagamentHoverEvent();
    return (0, _v1.jsxs)(_v91.ContentRow, {
      href: _v5,
      listGridColumns: `${(0, _v89.rem)(150)} 10fr 0.2fr`,
      cursor: "pointer",
      sx: _v92,
      ...
      children: [(0, _v1.jsx)(_v91.ContentRow.Column, {
        ...
        children: (0, _v1.jsxs)(_v4.Flex, {
          ...
          flexDir: "column",
          width: "100%",
          children: [_v7 && _v8 ? (0, _v1.jsx)(_v104.Box, {
            onClick: _v0 => {
  ...
  let _v112 = ({
      thumbnails: _v0
    }) => _v0 && _v0[0] ? (0, _v1.jsx)(_v91.ContentRow.Thumbnail, {
      src: _v0[0],
      alt: "showcase thumbnail"
    }) : (0, _v1.jsx)(_v91.ContentRow.DefaultThumbnail, {
      minWidth: (0, _v89.rem)(130),
    ...
    _v113 = ({
      ...
      let {
        ...
        _v25 = _v12.slice(0, 3).map(_v0 => {
          ...
          return _v1 ? (0, _v99.stripPadding)(_v1) : "";
        }),
        _v26 = _v101(_v13, !!_v8);
      return (0, _v1.jsx)(_v110, {
        ...
        editableTitle: _v18.enable_rename_showcase_and_events && _v19 ? (0, _v1.jsx)(_v107.ShowcaseEditableTitle, {
          albumId: _v23,
          isEditing: _v19,
        ...
        menuButton: (0, _v1.jsx)(_v96.ShowcaseMenu, {
          ...
          onCopyLink: () => {
            _v2(_v5.link), _v16(_v47({
              location: _v17
            }));
          },
          onCopyEmbed: () => {
            _v5.embed?.html && (_v1(_v5.embed?.html), _v16(_v48({
              location: _v17
            })));
          },
          onCopyShowcase: () => {
          ...
          onClickViewShowcase: () => {
            window.open(_v5.link, "_blank"), _v16(_v49({
              location: _v17
            }));
          },
          onDelete: () => {
    ...
    _v115 = ({
      ...
      children: [_v6?.map(_v0 => (0, _v1.jsx)(_v113, {
        ...
        children: (0, _v1.jsx)(_v105.LoadingStateList, {})
      })]
    }),
    _v116 = ({
      isLoading: _v0,
    ...
    _v117 = ({
      ...
      sort: _v1,
      ..._v2
    }) => _v0 === _v94.Layout.List ? (0, _v1.jsx)(_v116, {
      ..._v2,
      sort: _v1
    }) : (0, _v1.jsx)(_v103, {
      ..._v2
