{
  ...
  let _v20 = "unselected",
    _v21 = ({
      ...
      children: [(0, _v1.jsx)(_v13.ModalOverlay, {}), (0, _v1.jsxs)(_v11.ModalContent, {
        ...
        children: [(0, _v1.jsx)(_v19.ModalHeader, {
          children: _v0
        }), (0, _v1.jsx)(_v10.ModalCloseButton, {}), (0, _v1.jsxs)(_v9.ModalBody, {
          flex: "1 1 0%",
          overflow: "auto",
          children: [(0, _v1.jsx)(_v15.Text, {
            ...
            mb: "200",
            children: _v1
          }), (0, _v1.jsx)(_v17.RadioGroup, {
            onChange: _v6,
            value: _v5,
            children: (0, _v1.jsx)(_v14.Stack, {
              spacing: 200,
              children: _v2.map(_v0 => (0, _v1.jsxs)(_v18.Box, {
                children: [(0, _v1.jsx)(_v16.Radio, {
                  value: _v0.value,
                  children: (0, _v1.jsx)(_v15.Text, {
                    variant: "body-md",
                    children: _v0.title
  ...
  _v0.s(["REASON_UNSELECTED", 0, _v20, "ReportModal", 0, _v21], 0);
  let _v23 = [{
  ...
  async function _v28({
    ...
    return (0, _v26.measureLatency)("postVideoReport", "POST", async () => {
      let _v0 = await fetch(`${_v0}/videos/${_v2}/report`, {
        ..._v3,
        method: "POST",
        body: JSON.stringify((0, _v27.deepSnakeCase)(_v1))
      });
  ...
  function _v31() {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/report${(0, _v25.serializeQuery)(_v0)}`, _v28({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v24.default.env.STORYBOOK && (0, _v25.assignMswData)(_v31, {
    ...
    let [_v4, _v5] = (0, _v2.useState)(_v20),
      _v6 = (0, _v6.translate)({
      ...
      _v8 = (0, _v3.useToast)(),
      {
        ...
        clipId: _v0,
        onFailure: (0, _v2.useCallback)(() => _v8({
          title: _v7,
          status: "error",
          icon: (0, _v1.jsx)(_v5.CircleExclamationFilled, {})
        }), [_v7, _v8]),
        onSuccess: (0, _v2.useCallback)(() => _v8({
          title: _v6,
          status: "success",
          icon: (0, _v1.jsx)(_v4.CircleCheckFilled, {})
        }), [_v6, _v8])
      }),
      _v11 = () => {
        _v5(_v20), _v2();
