{
  ...
  (0, _v7.withPageSetup)(async _v0 => (await _v12(_v0)) ? (function (_v0) {
    if ("1" === _v0.query.iframe) {
      var _v1;
      (_v0.res.setHeader("Cache-Control", "private, no-store"), _v0.res.setHeader("CDN-Cache-Control", "no-store"), (_v1 = _v0.req.headers.referer) && ["vimeo.com", "vimeows.com", "vimeo.dev", "vimeows.dev"].includes(function (_v0) {
        let _v1;
        try {
          _v1 = new URL(_v0);
        } catch {
      ...
      }(_v1))) ? _v0.res.removeHeader("x-frame-options") : _v0.res.setHeader("Cross-Origin-Opener-Policy", "same-origin-allow-popups");
      return;
    }
    _v0.res.setHeader("Cross-Origin-Opener-Policy", "same-origin-allow-popups");
  }(_v0), {
    props: {
