{
  ...
  function _v11(_v0, _v1) {
    return Array.isArray(_v0.hash) ? _v0.hash.includes(_v1) : _v0.hash === _v1;
  }
  _v0.s(["extractHash", 0, _v10], 0);
  var _v12 = _v0.i(0),
    _v13 = _v0.i(0),
    _v14 = _v0.i(0),
    _v15 = _v0.i(0),
    ...
    _v22 = _v0.i(0);
  function _v23({
    id: _v0 = (0, _v19.createDomName)("left-panel-controls"),
    className: _v1 = (0, _v19.createDomName)("left-panel-controls"),
    isLoading: _v2,
    defaultValue: _v3,
    value: _v4,
    panels: _v5,
    ...
    return !function ({
      ...
      isLoading: _v2,
      onPanelChange: _v7
    }), _v9 = (0, _v17.useLogger)("🪲LTPL"), _v10 = (0, _v3.useScope)(), (0, _v4.useEffect)(() => _v10.subscribeToSignals(_v0 => {
      if (_v0.type === _v18.ELiveSignal.LEFT_PANEL_TAB_CHANGE_REQUEST || _v0.type === _v18.ELiveSignal.LIVE_PANEL_TAB_CHANGE_REQUEST) {
      ...
      children: [(0, _v1.jsx)(_v5.Flex, {
        id: (0, _v19.createDomName)(_v0, "panels"),
        className: (0, _v19.createDomName)(_v1, "panels"),
        direction: "column",
        ...
        grow: 1,
        minWidth: "max-content",
        children: _v2 ? (0, _v20.range)(5).map(_v0 => (0, _v1.jsx)(_v21.BokehSkeleton, {
          className: (0, _v19.createDomName)(_v1, "item-loader"),
          width: (0, _v8.rem)(48),
          ...
          className: (0, _v19.createDomName)(_v1, `item-${_v0.id}`),
          direction: "column",
          gap: (0, _v8.rem)(4),
          alignItems: "center",
          height: "auto",
          children: [(0, _v1.jsxs)(_v13.Box, {
            ...
            children: [(0, _v1.jsx)(_v14.IconButton, {
              ...
              className: (0, _v19.createDomName)(_v1, `item-button-${_v0.id === _v4 ? "active" : "inactive"}-${_v0.id}`),
              variant: "secondary",
              isActive: _v0.id === _v4,
              size: "lg",
              icon: _v0.icon,
              borderRadius: "50%",
              onClick: _v11(_v0)
            }), _v0.isNew ? (0, _v1.jsx)(_v12.Badge, {
              size: "xs",
              variant: "new",
              height: (0, _v8.rem)(16),
              paddingY: 0,
            ...
            className: (0, _v19.createDomName)(_v1, `item-label-${_v0.id}`),
            size: "xs",
      ...
      }), (0, _v1.jsx)(_v22.LiveErrorBoundary, {
        component: "LeftPanelControlsFooter",
        isDetailed: !1,
        children: _v6 && !_v2 ? (0, _v1.jsx)(_v5.Flex, {
          id: (0, _v19.createDomName)(_v0, "footer"),
          className: (0, _v19.createDomName)(_v1, "footer"),
          children: _v6
        }) : null
      })]
    });
  ...
  _v0.s(["LeftPanel", 0, function ({
    ...
    footer: _v5 = null,
    maxHeight: _v6 = "100%",
    onUserActivateLeftPanel: _v7 = _v25,
    panelsContext: {
      leftPanel: _v8,
      panelActions: _v9
    } = (0, _v3.useManager)(_v24.PanelsManager, ({
      leftPanel: _v0
    }) => [_v0])
  }) {
    let _v10 = (0, _v4.useMemo)(() => _v4.find(_v0 => _v0.id === _v8), [_v8, _v4]),
      ...
      _v12 = function ({
        ...
        return (0, _v4.useMemo)(() => {
          ...
          return null !== _v1 && (!_v1 || !!_v2.find(_v0 => _v11(_v0, _v0)));
        }, [_v0, _v1, _v2]);
      }({
        isLoading: _v2,
        items: _v4,
    ...
    return (0, _v1.jsx)(_v5.Flex, {
      id: (0, _v19.createDomName)(_v0, "panel-wrapper"),
      className: (0, _v19.createDomName)(_v1, "panel-wrapper"),
      direction: "column",
      justifyContent: "center",
      alignItems: "center",
      zIndex: 201,
      children: (0, _v1.jsxs)(_v6.Grid, {
        id: (0, _v19.createDomName)(_v0, "panel-grid"),
        className: (0, _v19.createDomName)(_v1, "panel-grid"),
        transition: "300ms",
        alignItems: "center",
        height: "100%",
        ...
        children: [(0, _v1.jsx)(_v23, {
          id: (0, _v19.createDomName)(_v0, "controls"),
          className: (0, _v19.createDomName)(_v1, "controls"),
          isLoading: _v2,
          defaultValue: _v3,
          value: _v8,
          panels: _v4,
          ...
          children: (0, _v1.jsx)(_v7.PanelBody, {
            className: (0, _v19.createDomName)(_v1, "panel-body"),
            overflowX: "hidden",
            overflowY: "auto",
            display: "flex",
            ...
            children: (0, _v1.jsx)(_v22.LiveErrorBoundary, {
              additionalInfo: _v8,
              component: "LeftPanel",
              children: _v12 ? (0, _v1.jsx)(_v21.BokehSkeleton, {
                width: "100%",
                height: "100%",
                borderRadius: 0
              }) : _v11
