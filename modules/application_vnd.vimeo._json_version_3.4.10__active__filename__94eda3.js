{
  ...
  _v8.getLayout = _v0 => (0, _v1.jsx)(_v1.Fragment, {
    ...
    if ((0, _v4.isLoggedOut)(_v0.req)) return {
      redirect: {
        destination: `/log_in?redirect=/videos/${_v0.query.clipId}/versions/${_v0.query.versionId}`,
        statusCode: 302
      }
    };
    ...
    try {
      ...
      if (_v1.privacy?.view === "unlisted") {
        let _v0 = _v1.metadata.interactions.edit.uri.split(":").pop();
        return {
          redirect: {
            destination: _v0.active ? `/manage/videos/${_v1}/${_v0}` : `/videos/${_v1}/${_v0}/versions/${_v2}`,
            statusCode: 302
          }
        };
      }
