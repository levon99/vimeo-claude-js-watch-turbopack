{
  ...
  _v0.s(["DestinationsManager", () => _v58], 0);
  var _v1,
    _v2,
    _v3,
    _v4,
    ...
    _v23 = _v0.i(0);
  function _v24(_v0) {
    return (0, _v22.withConnectionSupport)(_v23.ERequestMethod.GET, _v0, ({
      userId: _v0
    }) => ({
  ...
  function _v25({
    ...
    return (0, _v21.sendApiRequest)({
      method: _v23.ERequestMethod.PATCH,
  ...
  var _v26 = _v0.i(0),
    _v27 = ((_v1 = {}).PAGE = "page", _v1.PROFILE = "profile", _v1.CHANNEL = "channel", _v1.ORGANIZATION = "organization", _v1),
    _v28 = ((_v2 = {}).CUSTOM = "custom", _v2.TIK_TOK = "tik_tok", _v2.INSTAGRAM = "instagram", _v2.TWITTER_X = "twitter_x", _v2),
    _v29 = ((_v3 = {}).CUSTOM_RTMP = "custom_rtmp", _v3.YOUTUBE = "youtube", _v3.FACEBOOK = "facebook", _v3.LINKEDIN = "linkedin", _v3),
    _v30 = ((_v4 = {}).PROFILE = "profile", _v4.ORGANIZATION = "organization", _v4),
    _v31 = ((_v5 = {}).PUBLIC = "public", _v5.PRIVATE = "private", _v5.UNLISTED = "unlisted", _v5.SELF = "self", _v5.FRIENDS = "all_friends", _v5.EVERYONE = "everyone", _v5.LINKEDIN_PUBLIC = "PUBLIC", _v5),
    _v32 = ((_v6 = {})[_v6.OK = 0] = "OK", _v6[_v6.HAS_ERROR = 1] = "HAS_ERROR", _v6),
    _v33 = ((_v7 = {}).ACCOUNT_CREATED_LESS_THEN_60_DAYS_AGO = "1363120", _v7.ACCOUNT_HAS_LESS_THEN_100_FOLLOWERS = "1363144", _v7),
    _v34 = ((_v8 = {}).PROFILE = "profile", _v8.ORGANIZATION = "organization", _v8),
    _v35 = ((_v9 = {}).USER_LIVESTREAMING_ERROR = "The user is not enabled for live streaming.", _v9),
    _v36 = ((_v10 = {}).NONE = "none", _v10.YOUTUBE_SETTINGS = "youtubeSettings", _v10.FACEBOOK_SETTINGS = "facebookSettings", _v10.LINKEDIN_CONNECT = "linkedinConnect", _v10.LINKEDIN_SETTINGS = "linkedinSettings", _v10.CUSTOM_RTMP_SETTINGS = "customRtmpSettings", _v10.OTT_SETTINGS = "ottSettings", _v10);
  _v0.s(["ECustomRtmpType", () => _v28, "EDestinationErrorStateMessage", () => _v33, "EDestinationModal", () => _v36, "EDestinationPrivacy", () => _v31, "EDestinationServiceName", () => _v29, "EDestinationState", () => _v32, "ELinkedinConnectionType", () => _v30, "ESocialConnectionScopeType", () => _v34, "ESocialType", () => _v27, "EYoutubeError", () => _v35], 0);
  var _v37 = _v0.i(0),
    _v38 = _v0.i(0),
    _v39 = _v0.i(0);
  ...
  async function _v41(_v0, _v1) {
    ...
    try {
      let _v0 = await _v24({
        ...
        gctlConfig: (0, _v20.queryManagerGctlConfig)(_v0),
        fields: _v1
      });
  ...
  async function _v42(_v0) {
    ...
    try {
      ...
      Object.values(_v29).forEach(_v0 => {
        let _v1 = (0, _v19.camelizeString)(_v0);
      ...
      let _v1 = await (_v1 = {
        ...
        fields: _v58.REQUIRED_DESTINATION_FIELDS
      }, (0, _v22.withConnectionSupport)(_v23.ERequestMethod.GET, _v1, ({
        userId: _v0,
        eventId: _v1
      }) => ({
        path: `/users/${_v0}/live_events/${_v1}/destinations`
      })));
      _v0.log.info("Loaded destinations:", _v1), Object.values(_v29).forEach(_v0 => {
        let _v1 = (0, _v19.camelizeString)(_v0),
    ...
    try {
      ...
      let {
        ...
        _v1 = await (_v2 = {
          ...
          gctlConfig: (0, _v20.queryManagerGctlConfig)(_v0),
          fields: _v58.REQUIRED_DESTINATION_FIELDS
        }, (0, _v22.withConnectionSupport)(_v23.ERequestMethod.POST, _v2, ({
          userId: _v0,
          eventId: _v1
        }) => ({
          path: `/users/${_v0}/live_events/${_v1}/destinations`
      ...
      let _v2 = (0, _v19.camelizeString)(_v1.serviceName),
        _v3 = _v0[_v2].value ?? [];
      if (_v3.push(_v1), _v0.setContext({
        destinations: _v0.context.destinations.asMerged({
          [_v2]: _v0[_v2].asReady(_v3)
        })
      }), _v2 === _v29.LINKEDIN && _v1.scheduledAt) {
        _v0.log.info("Detected scheduled linkedIn event:", _v2, _v1);
        let _v0 = await _v24({
          connection: _v0.connections.availableDestinations,
          gctlConfig: (0, _v20.queryManagerGctlConfig)(_v0),
          fields: [_v29.LINKEDIN]
        });
        _v0.log.info("Got updated destinations list [linkedIn]:", _v0), _v0.setContext({
          connections: _v0.context.connections.asMerged({
            [_v29.LINKEDIN]: _v0.context.connections[_v29.LINKEDIN].asReady(_v0[_v29.LINKEDIN])
          })
        });
      }
    } catch (_v0) {
      _v0.log.error("Failed to create destination:", _v0), _v1.serviceName && _v40(_v0, _v1.serviceName, _v0);
    }
  }
  async function _v44(_v0, _v1) {
    if (_v0.log.info("Update destination:", _v1), _v0.assertIsInitialized(), !_v1.id || !_v1.serviceName) throw new _v39.LiveError("Missed destination ID or service name.", {
      code: _v37.ELiveErrorCode.INVALID_PARAMETERS,
      data: {
        destination: _v1
      }
    });
    let {
      ...
      _v3 = (0, _v19.camelizeString)(_v1.serviceName),
    ...
    try {
      ...
      }), _v1.serviceName && _v40(_v0, _v1.serviceName, _v0);
    }
  }
  async function _v45(_v0, _v1) {
    if (_v0.log.info("Remove destination:", _v1), _v0.assertIsInitialized(), !_v1.id || !_v1.serviceName) throw new _v39.LiveError("Missed destination ID or service name.", {
      code: _v37.ELiveErrorCode.INVALID_PARAMETERS,
      data: {
        destination: _v1
      }
    ...
    try {
      let _v0 = _v0.queryDataSync({
        type: _v26.ELiveQuery.INGEST_STATUS
      });
      _v0?.data === _v38.EIngestStatus.STREAMING && (_v0.log.info("Toggle off destination during live:", _v1), await _v25({
        destinationId: _v1.id,
        gctlConfig: (0, _v20.queryManagerGctlConfig)(_v0)
      }, !1)), await function ({
        destinationId: _v0,
        ...
        return (0, _v21.sendApiRequest)({
          method: _v23.ERequestMethod.DELETE,
          path: `/destination/${_v0}`,
          fields: _v1,
          gctlConfig: _v2
        });
      ...
      _v0.log.error("Failed to delete destination:", _v0), _v1.serviceName && _v40(_v0, _v1.serviceName, _v0);
    }
  }
  async function _v46(_v0, _v1) {
    if (_v0.log.info("Toggling destination:", _v1), _v0.assertIsInitialized(), !_v1.id || !_v1.serviceName) throw new _v39.LiveError("Missed destination ID or service name.", {
      code: _v37.ELiveErrorCode.INVALID_PARAMETERS,
      data: {
        destination: _v1
      }
    ...
    try {
      ...
      _v0.log.error("Failed to toggle destination:", _v0), _v5[_v6].isEnabled = !1, _v5[_v6].state = _v32.HAS_ERROR, _v5[_v6].stateMessage = String((0, _v18.default)(_v0.message.split(": ")));
    }
    _v0.setContext({
      destinations: _v0.context.destinations.asMerged({
  ...
  async function _v48(_v0, _v1) {
    ...
    try {
      ...
      }, (0, _v22.withConnectionSupport)(_v23.ERequestMethod.GET, _v3, ({
        userId: _v0
      }) => ({
        path: `/users/${_v0}/ott`
      })));
      if (_v0) {
        ...
        }, "uri" in _v4 && _v4.uri ? (0, _v21.sendApiRequest)({
          method: _v23.ERequestMethod.GET,
          path: _v4.uri,
          gctlConfig: _v4.gctlConfig,
          fields: _v4.fields
        }) : (0, _v22.withConnectionSupport)(_v23.ERequestMethod.GET, _v4, ({
          userId: _v0,
          uri: _v1
        }) => ({
  ...
  async function _v50(_v0, _v1) {
    ...
    try {
      ...
      let _v0 = await (_v3 = {
        ...
        gctlConfig: (0, _v20.queryManagerGctlConfig)(_v0),
        fields: ["uri", "ott_channel_id", "ott_channel_name", "ott_channel_subdomain", "ott_event_id"]
      }, (0, _v22.withConnectionSupport)(_v23.ERequestMethod.POST, _v3, ({
        userId: _v0,
        eventId: _v1
      }) => ({
        path: `/users/${_v0}/live_events/${_v1}/ott_destinations`
  ...
  async function _v51(_v0, _v1) {
    if (_v0.log.info("Removing ott destination:", _v1), _v0.assertIsInitialized(), !_v1.uri) throw new _v39.LiveError("Missed destination URI.", {
      code: _v37.ELiveErrorCode.INVALID_PARAMETERS,
      data: {
        destination: _v1
      }
    });
    let _v2 = (0, _v47.parseLastIdFromUri)(_v1.uri);
    if (!_v2) throw new _v39.LiveError("Failed to parse destination URI.", {
      data: {
        id: _v2,
        destination: _v1
      }
    ...
    try {
      var _v4;
      await (_v4 = {
        connection: (0, _v22.specifyConnectionId)(_v0.connections.ottDestination, _v2),
        gctlConfig: (0, _v20.queryManagerGctlConfig)(_v0)
      }, (0, _v22.withConnectionSupport)(_v23.ERequestMethod.DELETE, _v4, ({
        userId: _v0,
        eventId: _v1,
        destinationId: _v2
      }) => ({
  ...
  var _v52 = _v0.i(0),
    ...
    _v56 = _v0.i(0),
    _v57 = _v0.i(0);
  class _v58 extends _v15.ContextManager {
    ...
    context = {
      destinationsActions: (0, _v15.createActions)({
        openActiveModal: (_v0, _v1) => this.openActiveModal(_v0, _v1),
        closeActiveModal: () => this.openActiveModal(_v36.NONE),
      ...
      destinationsConnectionActions: (0, _v15.createActions)({
      ...
      sessionType: _v54.EComposerSessionType.UNKNOWN,
      sessionId: -1,
      isHydrated: !1,
      postConnectUrl: new URL("/", _v52.environmentConfig.URL_BASE),
      connectWindow: null,
      connections: (0, _v15.createNested)({
        youtube: (0, _v15.createLoadable)({
          isConnected: !1,
          isConnectionBroken: !1,
          destinations: []
        }, !1),
        facebook: (0, _v15.createLoadable)({
          isConnected: !1,
          isConnectionBroken: !1,
          destinations: []
        }, !1),
        linkedin: (0, _v15.createLoadable)({
          isConnected: !1,
          isConnectionBroken: !1,
          destinations: []
        }, !1),
        ott: (0, _v15.createLoadable)({
          isConnected: !1,
          destinations: [],
          paging: {}
        }, !1)
      }),
      destinations: (0, _v15.createNested)({
        youtube: (0, _v15.createLoadable)([], !1),
        facebook: (0, _v15.createLoadable)([], !1),
        linkedin: (0, _v15.createLoadable)([], !1),
        customRtmp: (0, _v15.createLoadable)([], !1),
        ott: (0, _v15.createLoadable)([], !1)
      }),
      activeModal: _v36.NONE,
      hasValidConnection: _v0 => this.hasValidConnection(_v0),
      hasAnyDestinationsCreated: (0, _v15.createComputed)(({
        destinations: {
          facebook: _v0,
          linkedin: _v1,
          youtube: _v2
    ...
    constructor(_v0) {
      ...
      if (!_v0?.sessionId || !_v0.sessionType) throw new _v39.LiveError("Cannot initialize destination context.", {
        code: _v37.ELiveErrorCode.INITIALIZATION
      });
      this.context.sessionId = _v0.sessionId, this.context.sessionType = _v0.sessionType, this.context.postConnectUrl = new URL(`live/destination_connected/${_v0.sessionType}/${_v0.sessionId}`, _v52.environmentConfig.URL_BASE);
    }
    onProvisionStarted() {
    ...
    assertIsInitialized() {
      if (!this.context.sessionId || !this.connections) throw new _v39.LiveError("Destinations manager is not initialized.", {
        code: _v37.ELiveErrorCode.INITIALIZATION
      });
    }
    async loadSocialConnections(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v41(this, _v0 ?? []), {
        method: "loadSocialConnections",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async loadOttConnections(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v48(this, _v0), {
        method: "loadOttConnections",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async loadOttDestinations() {
      return (0, _v57.withLiveErrorTracking)(() => _v49(this), {
        method: "loadOTTDestinations",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async loadSocialDestinations() {
      return (0, _v57.withLiveErrorTracking)(() => _v42(this), {
        method: "loadSocialDestinations",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async createSocialDestination(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v43(this, _v0), {
        method: "createSocialDestination",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async updateSocialDestination(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v44(this, _v0), {
        method: "updateSocialDestination",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async removeSocialDestination(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v45(this, _v0), {
        method: "removeSocialDestination",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async toggleSocialDestination(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v46(this, _v0), {
        method: "toggleSocialDestination",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async createOttDestination(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v50(this, _v0), {
        method: "createOttDestination",
        category: _v56.ELiveErrorCategory.LIVE
      });
    }
    async removeOttDestination(_v0) {
      return (0, _v57.withLiveErrorTracking)(() => _v51(this, _v0), {
    ...
    disconnectApp(_v0) {
      return fetch("/settings/apps?action=disconnect", {
        ...
        body: JSON.stringify({
          service: _v0,
          token: (0, _v55.queryCurrentViewerSync)(this).xsrft
        })
      });
    }
    ...
    hasValidConnection(_v0) {
      ...
      switch (_v0) {
        case _v29.LINKEDIN:
          return _v2 && !_v3 && !(!_v4.length && _v5 === _v34.ORGANIZATION);
        case _v29.FACEBOOK:
        case _v29.YOUTUBE:
          return _v2 && !_v3;
        case _v29.CUSTOM_RTMP:
          return !0;
        default:
          return !1;
      }
    ...
    async onBroadcastChannelMessage(_v0) {
      ...
      if (this.log.info("Social provider connected:", _v0), "connected" === _v1.action) {
        ...
        switch (_v2 && _v2.close(), await this.loadSocialConnections([_v1.social]), await this.loadSocialDestinations(), _v1.social) {
          case _v29.YOUTUBE:
            _v0 = _v36.YOUTUBE_SETTINGS;
            break;
          case _v29.FACEBOOK:
            _v0 = _v36.FACEBOOK_SETTINGS;
            break;
          case _v29.LINKEDIN:
            _v0 = this.hasValidConnection(_v29.LINKEDIN) ? _v36.LINKEDIN_SETTINGS : _v36.LINKEDIN_CONNECT;
            break;
          default:
            _v0 = _v36.NONE;
        }
    ...
    onLiveEventStatusUpdated(_v0) {
      let _v1 = _v0.data;
      if (this.isModuleActive && _v1 === _v38.EIngestStatus.STREAMING) return setTimeout(() => this.loadSocialDestinations(), _v58.DESTINATION_RELOAD_TIMEOUT), this.loadSocialDestinations();
    }
    async onComposerSessionReady({
      ...
      }, this.log.info("Initializing destinations for composer session:", _v0, _v1, this.connections), await Promise.all([this.loadSocialConnections([_v29.YOUTUBE]), this.loadSocialConnections([_v29.LINKEDIN]), this.loadSocialConnections([_v29.FACEBOOK]), this.loadOttConnections(), this.loadSocialDestinations(), this.loadOttDestinations()]).finally(() => {
        this.setContext({
          isHydrated: !0
        });
      }));
            ...
            children: [(0, _v62.jsxs)(_v82.Flex, {
              ...
              children: [(0, _v62.jsxs)(_v82.Flex, {
                ...
                children: [(0, _v62.jsx)(_v83.Header, {
                  ...
                  display: "flex",
                  flexWrap: "nowrap",
                  href: `https://facebook.com/${_v0.type === _v27.PROFILE ? "me" : _v0.providerDestinationId}`,
                  fontSize: "text-sm",
                  color: "text-secondary",
                  target: "_blank",
                  as: "a",
    ...
    (0, _v63.useEffect)(() => {
      _v2?.value && _v3?.value?.destinations && null === _v6 && _v7(_v3.value.destinations.map(_v0 => {
        ...
        return {
          ...
          type: _v0.type,
          serviceName: _v29.FACEBOOK,
          privacy: _v1?.privacy ?? (_v0.type === _v27.PROFILE ? _v31.EVERYONE : void 0)
        };
      }));
  ...
  function _v144({
    ...
    let _v6 = _v3?.value?.destinations[0],
      ...
      _v18 = (0, _v63.useCallback)(() => {
        ...
        }), _v5.loadSocialConnections([_v29.LINKEDIN]), _v4.openActiveModal(_v36.NONE);else if (_v16) {
          let _v0 = {
            ..._v16,
            providerDestinationId: _v16.destinationId,
            serviceName: _v29.LINKEDIN,
            isEnabled: !1,
            privacy: _v31.LINKEDIN_PUBLIC,
            scheduledAt: _v11,
...
`;
  ...
  var _v165 = _v0.i(0);
  let _v166 = _v0 => (0, _v62.jsx)(_v165.Icon, {
      viewBox: "0 0 24 24",
      ..._v0,
      fill: "none",
    ...
    _v167 = _v0 => (0, _v62.jsxs)(_v165.Icon, {
      viewBox: "0 0 24 24",
      ..._v0,
      fill: "none",
