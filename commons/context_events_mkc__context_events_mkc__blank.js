...
`,
  ...
  _v7.Header, _v0.s(["AttendeeHeader", 0, ({
    response: _v0,
    isLoading: _v1,
      ...
      children: (0, _v1.jsxs)(_v6.Flex, {
        ...
        children: [(0, _v1.jsxs)(_v6.Flex, {
          children: [(0, _v1.jsx)(_v7.Header, {
            variant: "heading-md",
            size: "xl",
            children: _v2 ? _v2.isUnlimited ? (0, _v15.translate)({
              singular: "Registrants {COUNT}",
              replacements: {
                COUNT: (0, _v15.humanize)(_v0.total)
              },
              dictionary: {
                es: {
...
`;
  ...
  let _v92 = ({
    ...
    _v93 = ({
      ...
      return (0, _v1.jsx)(_v3.Box, {
        borderRadius: "sm",
        mb: "sm",
        p: `${(0, _v9.rem)(30)} ${(0, _v9.rem)(24)} ${(0, _v9.rem)(12)}`,
        overflow: "hidden",
  ...
  let _v117 = ({
    ...
    return (0, _v2.useEffect)(() => {
      ...
      mt: "lg",
      mb: "sm",
      children: (_v8.length ?? 0) > 1 ? (0, _v1.jsxs)(_v6.Flex, {
        justifyContent: "space-between",
        children: [(0, _v1.jsx)(_v7.Header, {
          variant: "heading-md",
          size: "xl",
