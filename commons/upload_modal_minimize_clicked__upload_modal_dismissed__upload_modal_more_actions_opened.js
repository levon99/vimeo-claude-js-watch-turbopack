{
  ...
  var _v109 = _v0.i(0),
    ...
    _v117 = _v0.i(0),
    _v118 = _v0.i(0);
  let _v119 = (0, _v2.createContext)({
      openReviewModal: () => {}
    }),
    _v120 = _v0 => !1 !== _v0.isEnabled && (!_v0.expiresOn || new Date(_v0.expiresOn).getTime() > Date.now()),
    _v121 = ({
      clipId: _v0
    }) => ((0, _v116.useInitGlobalStore)({
      clipId: String(_v0),
      trackingContextConfig: {
        pageName: "video_library",
        location: "modal"
      }
    }), (0, _v1.jsx)(_v115.ReviewLinksPanel, {})),
    _v122 = ({
      clipId: _v0,
      onClose: _v1
    }) => (0, _v1.jsxs)(_v24.Modal, {
      ...
      children: [(0, _v1.jsx)(_v28.ModalOverlay, {}), (0, _v1.jsxs)(_v25.ModalContent, {
        ...
        children: [(0, _v1.jsx)(_v27.ModalHeader, {
          ...
          gap: "2",
          pb: "4",
          children: (0, _v1.jsx)(_v114.HeaderContent, {
            showBackButton: !1,
            showPlusButton: !1,
            disablePlusButton: !0,
          ...
          children: (0, _v1.jsx)(_v117.VideoShareViewStoreProvider, {
    ...
    _v123 = ({
      ...
      let {
        ...
        } = (0, _v112.useGetReviewLinks)(_v0, "clip"),
        [_v6, {
          data: _v7,
          error: _v8
        }] = (0, _v109.usePostVideoReviewLinks)(),
        _v9 = (0, _v2.useRef)(!1),
        _v10 = (0, _v2.useRef)(!1),
        _v11 = (0, _v2.useCallback)(_v0 => {
          _v10.current || (_v10.current = !0, window.location.assign((0, _v118.getVideoReviewPageUrl)(_v0, _v0)));
        }, [_v0]);
      return (0, _v2.useEffect)(() => {
        if (_v4 || _v9.current) return;
        _v9.current = !0;
        let _v0 = _v3.find(_v120);
    ...
    _v124 = ({
      ...
      return _v9 && null !== _v7 ? (0, _v1.jsx)(_v122, {
        clipId: _v7,
        onClose: () => {
          _v2("review_links_panel"), _v5();
        }
      }) : _v6 ? null !== _v7 ? (0, _v1.jsx)(_v123, {
        clipId: _v7,
        onError: _v15,
        onManageLinks: _v16
      }) : null : (0, _v1.jsxs)(_v1.Fragment, {
        children: [(0, _v1.jsx)(_v113.VideoListModal, {
          closeVideoModal: () => {
  ...
  _v0.s(["ReviewModalProvider", 0, ({
    ...
    let _v1 = (0, _v20.useViewer)(),
      ...
      } = (0, _v110.useMaximizeReviewAdoptionTracking)(),
    ...
    return (0, _v1.jsxs)(_v119.Provider, {
      value: {
        openReviewModal: _v12
      },
      children: [_v0, _v3 && (0, _v1.jsx)(_v124, {
        teamOwnerId: _v2,
        presetVideoId: _v7,
        trackDismissal: _v13,
        onDisplayed: _v14,
  ...
  }, "useReviewModal", 0, () => (0, _v2.useContext)(_v119)], 0);
}