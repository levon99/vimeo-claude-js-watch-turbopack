{
  ...
  _v0.s(["QuestionContextProvider", 0, ({
    ...
    (0, _v7.useGetVideoQuestions)(() => _v0 && _v18 ? {
      ...
      onSuccess: _v0 => {
        if (_v0) {
          let _v0 = !!_v0.status,
            _v1 = !!_v0.data;
          (!_v0 || "NONE_EXISTING" !== _v0.status || !_v16) && (_v1 && _v0.data && 0 === _v0.data.length || (_v1 && _v0.data ? (_v25(_v0.data), _v17(!1), _v27(null)) : "qna" === _v9 && _v17(!0)));
        } else _v43();
      },
      onError: _v0 => {
        _v43(_v0);
    ...
    let _v37 = (0, _v3.useCallback)(_v0 => {
        _v35(!1), _v33(null), _v0 && _v0.answer && (_v21(_v0.answer), _v23(_v0?.relevantQuotes ?? []), _v31(_v0.relatedQuestions ?? []));
      }, []),
      _v38 = (0, _v3.useCallback)(_v0 => {
        _v33(_v0), _v35(!1), (0, _v15.handleError)(_v0, _v11.failedToAskTheVimeoAi, _v4), _v0?.status >= 500 && _v18(_v0);
      }, [_v4]),
      _v39 = (0, _v3.useCallback)(async _v0 => {
        if (!_v0) return null;
        let _v1 = (0, _v9.getPasswordHashFromCookie)(_v0);
        _v35(!0), _v36.current = !0;
        try {
        ...
        return null;
      }, [_v0, _v5, _v2, _v13, _v6, _v7, _v8, _v37, _v38]),
      _v40 = (0, _v3.useCallback)(_v0 => {
        _v33(null), _v15(_v0), _v21(""), _v23([]), _v31([]), _v39(_v0);
      }, [_v39]),
      _v41 = (0, _v3.useCallback)((_v0, _v1, _v2, _v3) => {
        _v15(_v0), _v21(_v1), _v23(_v2 ?? []), _v31(_v3 ?? []);
      }, []),
    ...
    let _v43 = (0, _v3.useCallback)(_v0 => {
      _v17(!1), _v27(_v0 ?? _v11.failedToAskTheVimeoAi), (0, _v15.handleError)(_v0 ?? _v11.failedToAskTheVimeoAi, _v11.failedToAskTheVimeoAi, _v4);
    }, [_v4]);
    return (0, _v2.jsx)(_v19.Provider, {
      value: {
        answer: _v20,
        askNewQuestion: _v40,
        askPredefinedQuestion: _v41,
        errorData: _v26,
        generateVideoQnA: () => {
          !_v16 && _v0 && (_v29(!0), _v10({
            where: {
              videoId: _v0
            }
          }), _v17(!0));
        },
        isGeneratedInSession: _v28,
        isLoading: _v16,
        moments: _v22,
        predefinedQuestions: _v24,
        question: _v14,
        questionResponseError: _v32,
        questionResponseLoading: _v34,
        relatedQuestions: _v30,
        resetQuestionData: _v42,
        setCanCall: _v19,
        setIsGeneratedInSession: _v29,
        setQuestion: _v15
      },
      children: _v1
    });
