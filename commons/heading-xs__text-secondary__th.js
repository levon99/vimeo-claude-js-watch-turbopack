{
  ...
  let _v27 = ({
      ...
      if (_v2 && !_v1) return (0, _v1.jsx)(_v25.Skeleton, {
        borderRadius: "sm",
        height: "2rem",
        variant: "text"
      });
      ...
      if (!_v4 || _v3) return (0, _v1.jsxs)(_v24.HStack, {
        children: [(0, _v1.jsx)(_v23.Avatar, {
          shape: "full",
          size: "sm",
          alt: "",
          nameProps: {
      ...
      if (/^user\d+$/i.test(_v4)) return (0, _v1.jsxs)(_v24.HStack, {
        children: [(0, _v1.jsx)(_v23.Avatar, {
          shape: "full",
          size: "sm",
          alt: "",
    ...
    _v29 = ({
      ...
      return (0, _v1.jsxs)(_v16.Tr, {
        ...
        children: [(0, _v1.jsx)(_v20.Td, {
          paddingY: "sm",
          paddingX: "sm",
          children: (0, _v1.jsx)(_v28, {
            value: _v22(_v0.occurredAt)
          })
        }), (0, _v1.jsx)(_v20.Td, {
          paddingY: "sm",
          paddingX: "sm",
          width: (0, _v7.rem)(240),
          children: (0, _v1.jsx)(_v28, {
            value: _v21(_v0.consumerService),
            secondary: !0
          })
        }), (0, _v1.jsx)(_v20.Td, {
          paddingY: "sm",
  ...
  function _v31(_v0, _v1, _v2 = "ai-credits-usage.csv") {
    let _v3 = [["Date", "Action performed", "Affected object", "Affected object ID", "User ID", "Language", "Workspace ID", "Credits used", "Status"], ..._v0.map(_v0 => [_v22(_v0.occurredAt), _v21(_v0.consumerService), null !== _v0.clipId ? _v1[_v0.clipId] ?? "" : "", null !== _v0.clipId ? String(_v0.clipId) : "", null !== _v0.triggeringUserId ? String(_v0.triggeringUserId) : "", _v0.targetLang ?? "", null !== _v0.workspaceId ? String(_v0.workspaceId) : "", String(_v0.creditsUsed), "Done"])].map(_v0 => _v0.map(_v30).join(",")).join("\n"),
  ...
  async function _v35({
    ...
    return (0, _v33.measureLatency)("getOrganizationEnterpriseCreditsUsageOperations", "GET", async () => {
  ...
  async function _v37({
    ...
    return (0, _v33.measureLatency)("getWorkspaceEnterpriseCreditsUsageOperations", "GET", async () => {
  ...
  var _v38 = _v0.i(0);
  let _v39 = ["data.operationKey", "data.creditsUsed", "data.occurredAt", "data.clipId", "data.targetLang", "data.consumerService", "data.triggeringUserId", "data.workspaceId", "paging.next"];
  var _v40 = _v0.i(0),
    _v41 = _v0.i(0),
    _v42 = _v0.i(0),
    _v43 = _v0.i(0);
  function _v44(_v0, _v1) {
    ...
    return (0, _v41.default)(_v2 ? `/organizations/${_v2.where.orgUuid}/enterprise_credits/usage_operations${(0, _v43.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v35({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  function _v45(_v0, _v1) {
    ...
    return (0, _v41.default)(_v2 ? `/workspaces/${_v2.where.workspaceUuid}/enterprise_credits/usage_operations${(0, _v43.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v37({
      ..._v2,
      headers: {
        ..._v2.headers,
        "Content-Type": "application/json",
  ...
  "true" === _v40.default.env.STORYBOOK && (0, _v43.assignMswData)(_v44, {
    endpoint: "/organizations/:orgUuid/enterprise_credits/usage_operations",
    method: "GET"
  }), "true" === _v40.default.env.STORYBOOK && (0, _v43.assignMswData)(function () {
    let {
        mutate: _v0
      } = (0, _v42.useSWRConfig)(),
      {
      ...
      [_v5, _v6] = (0, _v43.useInternalState)();
    return [(0, _v2.useCallback)(async _v0 => {
      _v6({
        type: "REQUEST"
      });
      try {
        let _v0 = await _v0(`/organizations/${_v0.where.orgUuid}/enterprise_credits/usage_operations${(0, _v43.serializeQuery)(_v0)}`, _v35({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/organizations/:orgUuid/enterprise_credits/usage_operations",
    method: "GET"
  }), "true" === _v40.default.env.STORYBOOK && (0, _v43.assignMswData)(_v45, {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/workspaces/${_v0.where.workspaceUuid}/enterprise_credits/usage_operations${(0, _v43.serializeQuery)(_v0)}`, _v37({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  let _v46 = ["data.operationKey", "data.creditsUsed", "data.occurredAt", "data.clipId", "data.targetLang", "data.consumerService", "data.triggeringUserId", "data.workspaceId", "paging.next"];
    ...
    let {
          ...
          fetchAllOperations: async () => {
            ...
            try {
              ...
              for (let _v0 = 0; _v0 < _v6.length; _v0 += 50) {
                ...
                try {
                  let _v0 = await (0, _v36.getVideos)({
                    select: ["name", "uri"],
                    query: {
      ...
      _v11 = function (_v0) {
        let _v1 = Array.from(new Set(_v0.filter(_v0 => Number.isFinite(_v0)))),
          {
            data: _v2
          } = (0, _v32.useGetVideos)(() => _v1.length > 0 ? {
            select: ["name", "uri"],
            query: {
      ...
      _v12 = (0, _v2.useMemo)(() => {
        let _v0 = _v9.trim().toLowerCase();
        return _v0 ? _v2.filter(_v0 => {
          let _v1 = null !== _v0.clipId ? _v11[_v0.clipId] ?? "" : "";
          return [_v21(_v0.consumerService), _v1, _v0.targetLang ?? "", null !== _v0.clipId ? String(_v0.clipId) : "", null !== _v0.triggeringUserId ? String(_v0.triggeringUserId) : ""].join(" ").toLowerCase().includes(_v0);
        }) : _v2;
      }, [_v9, _v2, _v11]);
        ...
        children: [(0, _v1.jsxs)(_v6.Flex, {
          ...
          children: [(0, _v1.jsx)(_v3.Box, {
            ...
            onClick: async () => {
              try {
                let _v0 = await _v7();
                if (_v0.operations.length > 0) return void _v31(_v0.operations, _v0.clipNames, _v0.isTruncated ? "ai-credits-usage-truncated.csv" : "ai-credits-usage.csv");
              } catch {}
              _v31(_v2, _v11);
            },
            children: (0, _v13.translate)({
          ...
          children: [(0, _v1.jsx)(_v18, {}), (0, _v1.jsx)(_v10.Tbody, {
            children: _v12.map(_v0 => (0, _v1.jsx)(_v29, {
              operation: _v0,
              clipName: null !== _v0.clipId ? _v11[_v0.clipId] : void 0
            }, _v0.operationKey))
          })]
        })]
  ...
  let _v47 = [{
    ...
    _v48 = ({
      ...
      let _v2 = Math.max(_v0 && _v0 > 0 ? _v0 : 0, _v47.reduce((_v0, _v1) => _v0 + Math.max(0, _v1[_v1.key]?.used ?? 0), 0)),
        _v3 = _v47.map(_v0 => {
          let _v1 = _v1[_v0.key],
      ...
      return (0, _v1.jsxs)(_v6.Flex, {
        ...
        children: [(0, _v1.jsx)(_v6.Flex, {
          ...
          gap: "md",
          flexWrap: "wrap",
          children: _v4.map(_v0 => (0, _v1.jsxs)(_v24.HStack, {
            align: "center",
            gap: "xs",
            children: [(0, _v1.jsx)(_v3.Box, {
  ...
  let _v53 = ({
    ...
    return (0, _v1.jsxs)(_v49.Alert, {
      status: _v0,
      borderRadius: "0",
      alignItems: "center",
      width: "100%",
      "data-testid": `ai-credits-usage-banner-${_v0}`,
      children: [(0, _v1.jsx)(_v50.AlertIcon, {}), (0, _v1.jsx)(_v51.AlertTitle, {
        children: _v1
      }), (0, _v1.jsx)(_v52.Spacer, {}), (0, _v1.jsx)(_v4.Button, {
        variant: "secondary",
        size: "sm",
  ...
  let _v57 = ({
    ...
    _v59 = ({
      ...
      return (0, _v1.jsx)(_v54.Progress, {
    ...
    _v60 = ({
      ...
      if (void 0 === _v0 || void 0 === _v1) return (0, _v1.jsx)(_v25.Skeleton, {
        borderRadius: "sm",
        height: (0, _v7.rem)(28),
        variant: "text",
        width: "100%"
  ...
  _v0.s(["StorageTotalCount", 0, ({
    ...
    let _v3 = (0, _v61.bytesToSize)(_v0 || 0, 1),
      _v4 = (0, _v61.bytesToSize)(_v1 || 0, 1);
