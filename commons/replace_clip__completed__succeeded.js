{
  ...
  let _v39 = ({
    ...
    let [_v21, _v22] = (0, _v5.useState)(!1),
      {
        ...
        setIsReverted: _v0.setIsReverted
      }));
    ...
    let {
      ...
      _v29 = (0, _v26.useViewer)(),
      [_v30] = (0, _v32.useInfiniteScrollVersion)(_v26 || _v23.length < _v11, _v27),
      [_v31, _v32] = (0, _v5.useState)(null),
      [_v33, _v34] = (0, _v5.useState)(!1),
      {
        userQuota: _v35
    ...
    let _v39 = (0, _v4.useRouter)(),
      ...
      _v47 = (_v14 ? !!_v15 : !_v4) && !_v46,
      _v48 = () => {
        _v40.current && (_v22(!1), _v40.current.click(), _v5 && (0, _v34.bpStartUploadVersion)({
          videoId: _v0,
          viewer: _v29,
          currentVersion: _v43,
          analyticsProps: _v5
      ...
      }, [_v24, _v50, _v23, _v51, _v0]);
    return ((0, _v5.useEffect)(() => {
      _v4 || _v6 ? _v4 && _v49.current && (_v49.current = !1, _v52()) : _v49.current = !0;
    }, [_v4, _v52, _v6]), (0, _v12.useOutsideClick)({
      enabled: _v21,
      ref: _v42,
      handler: _v0 => {
      ...
      _v33 && (0, _v29.isUploadActiveOrComplete)(_v1) && _v1.clipId && (_v3 ? _v39.replace({
        pathname: `/manage/videos/${_v1.clipId}`
      }) : (_v12?.(), _v34(!1), _v32(null)));
    }, [_v33, _v3, _v39, _v12]), _v2) ? (0, _v1.jsx)(_v13.Text, {
      ...
      children: [(0, _v1.jsxs)(_v8.Menu, {
          ...
          children: (0, _v1.jsx)(_v1.Fragment, {
            children: _v11 < 2 ? (0, _v1.jsx)(_v28.EmptyVersionList, {
              ...
              children: [(0, _v1.jsx)(_v6.Box, {
                ...
                p: "sm",
                pb: "0",
                children: 0 === _v23.length || _v6 && !_v46 ? (0, _v1.jsx)(_v31.VersionsSkeleton, {
                  width: `${_v45}px`
                }) : (0, _v1.jsxs)(_v11.MenuOptionGroup, {
                  defaultValue: _v43,
                  children: [_v47 && (0, _v1.jsx)(_v31.VersionSkeleton, {
                    width: `${_v45}px`
                  }), _v23?.map((_v0, _v1) => {
        ...
        quota: _v35,
        clipHash: _v1
      }, `file-upload-${_v31?.[0].name}-new-version`), (0, _v1.jsx)(_v37.ConfirmUploadModal, {
        onCancel: () => {
          _v33 || _v32(null);
        },
        onConfirm: () => void (_v31 && (_v25(!1), _v34(!0), _v36(_v31, {
