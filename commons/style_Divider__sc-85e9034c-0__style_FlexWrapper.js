{
  ...
  background-color: ${_v5.core.color.stroke};
  height: ${(0, _v1.rem)(1)};
`, _v2.default.div.withConfig({
  ...
  gap: 0 ${(0, _v1.rem)(8)};
`;
  let _v6 = (0, _v2.default)(_v3.Button).withConfig({
  ...
  right: ${(0, _v1.rem)(24)};
`,
    _v7 = (0, _v2.default)(_v4.Modal.Header).withConfig({
      displayName: "style__ModalHeader",
      componentId: "sc-85e9034c-3"
    })`
  margin-bottom: ${(0, _v1.rem)(28)};
...
`,
  ...
  `}
`;
  _v0.s(["CloseIconStyle", 0, _v6, "Column", 0, _v9, "ModalHeader", 0, _v7, "Row", 0, _v8]);
}