  ...
  _v0.s(["useVideoPrivacy", 0, (_v0, _v1, _v2) => {
    ...
    let _v6,
      ...
      _v11 = (0, _v9.useViewer)(),
      {
        data: _v12,
        isLoading: _v13
      } = (_v3 = _v0, _v4 = _v1, _v5 = _v2, _v6 = (0, _v9.useViewer)(), _v7 = ["privacy"], _v8 = (0, _v2.useGetVideo)(() => {
        if (!_v6 || !_v3 || !_v5 || _v4) return null;
        let _v0 = (0, _v8.getReviewPasswordHashFromCookie)(_v5);
        return {
          where: {
            videoId: _v3
          },
        ...
        revalidateOnFocus: !1
      }), _v9 = (0, _v4.useGetAlbumVideoData)(_v4 || null, Number((0, _v8.getVideoIdFromClipRequestId)(_v3)), (0, _v8.mapToClipFields)(_v7)), _v10 = (0, _v5.useGetUnlockedVideo)(() => !_v6 || _v4 || _v5 ? null : {
        where: {
          videoId: _v3
        },
        select: _v7
        ...
        data: (0, _v8.extractClipData)(_v9.data),
      ...
      _v16 = async _v0 => {
        await _v15({
          ...
          (0, _v7.bpAllowViewerComments)(_v0, "Allow Viewer Comments", _v0, !1, _v12?.privacy?.view, {
            webContextFields: {
