  ...
  class _v11 extends _v9.AbstractAgoraManager {
    ...
    async loadInitialAgoraConfig() {
      ...
      let {
        ...
        media: _v4,
        screen: _v5
      } = await (0, _v3.getBroadcasterAgoraCredentials)({
        connection: this.connections.getRtcCredentials,
        gctlConfig: (0, _v4.queryManagerGctlConfig)(this),
        fields: ["media", "uid", "cloud_proxy", "screen", "channel", "app_id"]
      });
      return {
        appid: _v3,
        uid: _v0,
    ...
    async loadRefreshedAgoraConfig() {
      ...
      if (!_v0?.uid) throw new _v7.LiveError("Cannot refresh tokens for not fetched credentials.");
      let {
        uid: _v1,
        channel: _v2,
        cloudProxy: _v3,
    ...
    onConnectionTypeChanged({
      ...
      this.changeRole(_v0 === _v6.EEventConnectionType.BROADCASTER ? _v5.EClientRole.HOST : _v5.EClientRole.AUDIENCE, "event-connection-type-changed");
    }
  }
  (0, _v1._)([(0, _v2.OnSignal)(_v8.ELiveBroadcasterSignal.EVENT_CONNECTION_TYPE_CHANGED)], _v11.prototype, "onConnectionTypeChanged", null), _v0.s(["BroadcasterAgoraManager", 0, _v11]);
}