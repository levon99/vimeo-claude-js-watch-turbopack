{
  ...
  let _v9 = ({
    ...
    return _v5 ? [_v7] : [_v7, (0, _v1.jsx)(_v7.ChevronRightSmall, {
      color: "text-secondary"
    }, `${_v2}-chevron`)];
  };
  _v0.s(["default", 0, ({
    ...
    let {
      ...
      _v4 = (0, _v4.useMemo)(() => {
        let _v0 = {
          ...
          TeamManagement: (0, _v8.translate)({
          ...
          TeamMembersAccess: (0, _v8.translate)({
          ...
          HistoryAndRecovery: (0, _v8.translate)({
          ...
          PrivacyRestrictionsByRole: (0, _v8.translate)({
          ...
          ReviewPagePrivacy: (0, _v8.translate)({
      ...
      _v6 = (0, _v4.useMemo)(() => {
        ...
        return _v1 ? _v0.some(_v0 => _v0.priority >= _v1) ? _v0.map(_v9) : [] : _v0.map(_v9);
      }, [_v4, _v1, _v5, _v0]);
