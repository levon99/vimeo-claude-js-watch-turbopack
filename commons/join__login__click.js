{
  ...
  _v0.s(["clickToCloseSignupLoginPpModal", 0, (_v0, _v1, _v2, _v3, _v4) => {
  ...
  }, "getCommonAttributesV2", 0, _v19, "trackClickGOT", 0, _v0 => {
    ...
    (0, _v7.sendBpEventWithContexts)("vimeo.finish_auth_flow", (({
      copy: _v0,
      flow: _v1,
      pageName: _v2 = "other",
      product: _v3 = "general",
    ...
    _v2.BigPictureClient.sendEvent(new _v2.Event(_v16, 11, {
    ...
    _v2.BigPictureClient.sendEvent(new _v2.Event(_v16, 11, {
      ...
      action_type: _v13,
      is_final_action: !1,
      location: _v0 ? `${_v14}_step_1` : _v14,
      copy: null,
      target: null,
      target_path: null,
      feature: "join",
    ...
    _v2.BigPictureClient.sendEvent(new _v2.Event(_v16, 13, {
    ...
    _v2.BigPictureClient.sendEvent(new _v2.Event(_v16, 12, {
      path: (0, _v8.getPathName)(),
      referrer: document.referrer,
      referrer_path: document.referrer ? document.referrer.replace(/^.*\/\/[^\/]+/, "") : null,
      is_final_action: !1,
    ...
    _v2.BigPictureClient.sendEvent(new _v2.Event(_v16, 11, {
      ...
      action_type: _v12,
      is_final_action: !0,
      location: _v0 ? `${_v14}_step_2` : _v14,
    ...
    _v2.BigPictureClient.sendEvent(new _v2.Event(_v16, 11, {
      ...
      action_type: "select",
      is_final_action: !1,
      location: _v1 ? `${_v14}_step_2` : _v14,
