{
  ...
  let _v25 = _v0 => (0, _v1.jsx)(_v24.Icon, {
    ...
    _v26 = _v0 => (0, _v1.jsx)(_v24.Icon, {
      ...
      children: (0, _v1.jsxs)("g", {
        fill: "currentColor",
        children: [(0, _v1.jsx)("path", {
          d: "M5 19V4a1 1 0 0 0-2 0v16a1 1 0 0 0 1 1h16a1 1 0 0 0 0-2H5Z"
        }), (0, _v1.jsx)("path", {
          d: "M7 8a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H8a1 1 0 0 1-1-1ZM7 12a1 1 0 0 1 1-1h6a1 1 0 0 1 0 2H8a1 1 0 0 1-1-1ZM7 16a1 1 0 0 1 1-1h2a1 1 0 0 1 0 2H8a1 1 0 0 1-1-1Z"
        })]
      })
    }),
    _v27 = _v0 => (0, _v1.jsx)(_v24.Icon, {
      viewBox: "0 0 24 24",
      ..._v0,
      fill: "none",
      children: (0, _v1.jsxs)("g", {
  ...
  var _v28 = _v0.i(0);
  let _v29 = _v0 => (0, _v1.jsx)(_v24.Icon, {
    viewBox: "0 0 24 24",
    ..._v0,
    fill: "none",
    children: (0, _v1.jsx)("path", {
  ...
  let _v46 = function (_v0, _v1 = 0) {
    ...
    _v47 = _v0 => {
      if ("/manage/team/manage-ai" === _v0 || _v0.startsWith("/manage/team/manage-ai/")) return _v42.TAB_IDS["manage-ai"];
      let _v1 = _v0.substring(_v0.lastIndexOf("/") + 1);
      return _v1 in _v42.TAB_IDS ? _v42.TAB_IDS[_v1] : _v42.TAB_IDS.settings;
    },
    _v48 = {
      height: (0, _v8.rem)(28),
    ...
    _v49 = ({
      children: _v0,
      ..._v1
    }) => (0, _v33.useIsBokeh)() ? (0, _v1.jsx)(_v7.Badge, {
      ..._v1,
      children: _v0
    }) : (0, _v1.jsx)(_v5.Box, {
      as: "span",
  ...
  _v0.s(["ManageTeamSideNavContent", 0, () => {
    let {
        ...
        teamInfo: _v15
      } = (0, _v3.useContext)(_v41.ManageTeamStateCtx),
      {
        data: _v16
      ...
      } = (0, _v32.useContentSpaceEnabled)(_v19),
      {
        trackManageTeamPageView: _v21
      } = (0, _v3.useContext)(_v41.ManageTeamAnalytics),
      {
        updateTeamInfoTeamMembersCount: _v22
      } = (0, _v3.useContext)(_v41.ManageTeamDispatchCtx),
      ...
      _v25 = (0, _v40.useSideNavCollapsed)(),
    ...
    let _v28 = 2 + (_v6 && _v18.show_ai_credits_revamp ? 1 : 0) + +!!_v11 + (_v10 && _v15.untranslatedUserRole === _v44.TeamRole.Owner ? 1 : 0) + +!!_v7,
      _v29 = () => _v10 ? _v15.untranslatedUserRole === _v44.TeamRole.Owner ? _v13 && (_v3 || _v1 || _v0 || _v2) : _v1 || _v2 : _v2,
      {
        count: _v30
      } = (0, _v37.useGetTeamGroupsCount)(_v19),
      _v31 = (0, _v3.useCallback)(_v0 => {
        _v23.push(`/manage/team/${_v0}`);
      }, [_v23]),
      _v32 = (0, _v3.useMemo)(() => {
        let _v0 = _v10 ? !_v2 && !_v1 : !_v2;
        return [{
          key: _v42.TAB_IDS.members,
          icon: (0, _v1.jsx)(_v10.PersonUserAdd, {}),
          activeIcon: (0, _v1.jsx)(_v11.PersonUserAddFilled, {}),
          label: `${_v45.T.Members}`,
          active: _v24 === _v42.TAB_IDS.members,
          dataId: "manage_team_side_nav_members_menu_item",
          visible: _v0,
          onClick: () => _v31(_v42.TAB_IDS.members),
          action: (0, _v1.jsx)(_v49, {
            size: "sm",
            children: _v46(_v15.currentTeamSize)
          })
        }, {
          key: _v42.TAB_IDS.groups,
          icon: (0, _v1.jsx)(_v18.Users, {}),
          activeIcon: (0, _v1.jsx)(_v19.UsersFilled, {}),
          label: `${_v45.T.Groups}`,
          active: _v24 === _v42.TAB_IDS.groups,
          dataId: "manage_team_side_nav_groups_menu_item",
          visible: !!_v11,
          onClick: () => {
            _v31(_v42.TAB_IDS.groups), _v4.GoogleTagManager.trackEvent(_v43.GTMEvent.SWITCH_TAB, {
              tab_type: _v43.TAB_NAME.GROUP
            });
          },
          action: _v30 ? (0, _v1.jsx)(_v49, {
            size: "sm",
            children: _v46(_v30)
          }) : void 0
        }, {
          key: _v42.TAB_IDS.basics,
          icon: (0, _v1.jsx)(_v28.InfoCircle, {}),
          activeIcon: (0, _v1.jsx)(_v29, {}),
          label: _v45.T.Basics,
          active: _v24 === _v42.TAB_IDS.branding || _v24 === _v42.TAB_IDS.basics,
          dataId: "manage_team_side_nav_branding_menu_item",
          visible: _v0,
          onClick: () => {
            _v31(_v42.TAB_IDS.basics), _v4.GoogleTagManager.trackEvent(_v43.GTMEvent.SWITCH_TAB, {
              tab_type: _v43.TAB_NAME.SETTING
            });
          }
        }, {
          key: _v42.TAB_IDS["brand-kits"],
          icon: (0, _v1.jsx)(_v12.LogoBrand, {}),
          activeIcon: (0, _v1.jsx)(_v13.LogoBrandFilled, {}),
          label: _v45.T.Brandkits,
          active: _v24 === _v42.TAB_IDS["brand-kits"],
          dataId: "manage_team_side_nav_brandkits_menu_item",
          visible: _v0,
          onClick: () => _v31(_v42.TAB_IDS["brand-kits"])
        }, {
          key: _v42.TAB_IDS["custom-metadata"],
          icon: (0, _v1.jsx)(_v14.CreateVideo, {}),
          activeIcon: (0, _v1.jsx)(_v15.CreateVideoFilled, {}),
          label: _v45.T.CustomMetadata,
          active: _v24 === _v42.TAB_IDS["custom-metadata"],
          dataId: "manage_team_side_nav_custom_metadata_menu_item",
          visible: !!(_v6 && _v18.show_custom_metadata),
          onClick: () => _v31(_v42.TAB_IDS["custom-metadata"])
        }, {
          key: _v42.TAB_IDS.billing,
          icon: (0, _v1.jsx)(_v16.CreditCard, {}),
          activeIcon: (0, _v1.jsx)(_v17.CreditCardFilled, {}),
          label: _v45.T.Billing,
          active: _v24 === _v42.TAB_IDS.billing,
          dataId: "manage_team_side_nav_billing_menu_item",
          visible: !!(_v13 && _v12 && _v15.untranslatedUserRole === _v44.TeamRole.Owner),
          onClick: () => _v31(_v42.TAB_IDS.billing)
        }, {
          key: _v42.TAB_IDS.settings,
          icon: (0, _v1.jsx)(_v21.SettingsGear, {}),
          activeIcon: (0, _v1.jsx)(_v22.SettingsGearFilled, {}),
          label: _v45.T.Settings,
          active: _v24 === _v42.TAB_IDS.settings,
          dataId: "manage_team_side_nav_settings_menu_item",
          visible: !!(_v7 || _v5 || _v20 || _v9 || _v14),
          onClick: () => _v31(_v42.TAB_IDS.settings)
        }, {
          key: _v42.TAB_IDS.usage,
          icon: (0, _v1.jsx)(_v26, {}),
          ...
          active: _v24 === _v42.TAB_IDS.usage,
          dataId: "manage_team_side_nav_usage_menu_item",
          visible: !!(_v6 && _v18.show_ai_credits_revamp && _v0),
          onClick: () => _v31(_v42.TAB_IDS.usage)
        }, {
          key: _v42.TAB_IDS["manage-ai"],
          icon: (0, _v1.jsx)(_v23.AiSparkles, {}),
          activeIcon: (0, _v1.jsx)(_v25, {}),
          label: _v45.T.ManageAi,
          active: _v24 === _v42.TAB_IDS["manage-ai"],
          dataId: "manage_team_side_nav_manage_ai_menu_item",
          visible: !!(_v8 && !_v17),
          onClick: () => _v31(_v42.TAB_IDS["manage-ai"])
        }].filter(_v0 => _v0.visible);
      }, [_v24, _v10, _v2, _v1, _v15.currentTeamSize, _v15.untranslatedUserRole, _v30, _v11, _v6, _v18.show_ai_credits_revamp, _v18.show_custom_metadata, _v13, _v12, _v7, _v5, _v20, _v9, _v14, _v8, _v17, _v31]);
    return _v25 ? (0, _v1.jsxs)(_v6.Flex, {
      flexDirection: "column",
      gap: (0, _v8.rem)(2),
      alignItems: "center",
      paddingTop: (0, _v8.rem)(8),
      children: [(0, _v1.jsx)(_v39.PrimaryNavItem, {
        variant: "icons",
        item: {
          key: "back",
          icon: (0, _v1.jsx)(_v20.ArrowLeft, {}),
          label: _v45.T.BackToHome,
        ...
        bg: _v26,
        marginY: (0, _v8.rem)(8)
      }), _v29() ? [...Array(_v28)].map((_v0, _v1) => (0, _v1.jsx)(_v31.LoadingBlock, {
        style: {
          width: (0, _v8.rem)(40),
          height: (0, _v8.rem)(40),
          borderRadius: (0, _v8.rem)(12)
        }
      }, _v1)) : _v32.map(_v0 => (0, _v1.jsx)(_v39.PrimaryNavItem, {
        variant: "icons",
        item: {
          key: _v0.key,
      ...
      children: [(0, _v1.jsx)(_v30.ResizableSideNav.Section, {
      ...
      }), (0, _v1.jsx)(_v30.ResizableSideNav.Divider, {
        my: (0, _v8.rem)(2)
      }), (0, _v1.jsx)(_v30.ResizableSideNav.Section, {
        children: (0, _v1.jsx)(_v30.ResizableSideNav.MenuItems, {
          customStyles: {
            gap: (0, _v8.rem)(2)
          },
          children: _v29() ? (0, _v1.jsx)(_v1.Fragment, {
            children: [...Array(_v28)].map((_v0, _v1) => (0, _v1.jsx)(_v31.LoadingBlock, {
              style: {
                ..._v48,
                width: "70%"
              }
  ...
  _v0.s(["default", 0, ({
    ...
    let _v8 = !!_v4 && _v4 !== _v44.TeamRole.Viewer && _v6;
    return (0, _v1.jsxs)(_v54.Modal, {
      ...
      children: [(0, _v1.jsx)(_v60.ModalOverlay, {}), (0, _v1.jsxs)(_v57.ModalContent, {
        ...
        children: [(0, _v1.jsxs)(_v59.ModalHeader, {
          children: [(0, _v1.jsxs)(_v53.Header, {
            size: "md",
            as: "h2",
            children: [_v7 ? _v45.T.RemoveLastCollaborator : _v45.T.RemoveTeamMember, "?"]
          }), (0, _v1.jsx)(_v61.Text, {
            variant: "body-md",
            color: "text-primary",
            mt: "sm",
            children: _v45.T.LooseAcess(_v2, _v5)
          })]
        }), (0, _v1.jsx)(_v56.ModalCloseButton, {
          onClick: _v1
        }), _v7 && (0, _v1.jsx)(_v55.ModalBody, {
          pb: "sm",
          children: (0, _v1.jsx)(_v50.Alert, {
            status: "warning",
            size: "md",
            children: (0, _v1.jsx)(_v51.AlertDescription, {
              children: _v45.T.LastCollaboratorWarning
            })
          })
          ...
          gap: "md",
          pt: "md",
          children: [_v8 && (0, _v1.jsx)(_v61.Text, {
            variant: "body-sm",
            color: "text-secondary",
            children: _v45.T.ReassignSeats
          }), (0, _v1.jsxs)(_v6.Flex, {
            gap: 3,
            ...
            children: [(0, _v1.jsx)(_v52.Button, {
              ...
              size: "md",
              onClick: _v1,
              children: _v45.T.Cancel
            }), (0, _v1.jsx)(_v52.Button, {
              variant: "destructive",
              size: "md",
              onClick: _v3,
              children: _v45.T.RemoveMember
            })]
          })]
        })]
      })]
