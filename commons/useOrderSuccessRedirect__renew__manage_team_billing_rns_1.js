{
  ...
  _v0.s(["useOrderSuccessRedirect", 0, () => {
    let _v0 = (0, _v2.useRouter)(),
      _v1 = (0, _v16.useViewer)(),
      _v2 = (0, _v1.useSearchParams)(),
      [, _v3] = (0, _v4.default)(_v18.ORDER_ID_LOCAL_STORAGE_KEY, void 0),
      [_v4, _v5] = (0, _v4.default)(_v14.SELECTED_BILLING_PLAN_ID_STORAGE_KEY, void 0),
      {
        state: {
          checkoutType: _v6,
      ...
      } = (0, _v23.useApiStateContext)(),
      [_v16, _v17] = (0, _v8.usePatchMePreferences)(),
      {
        trackUserConverted: _v18
      } = (0, _v12.useCheckoutTracking)(_v14),
      _v19 = (0, _v3.useRef)(!1);
    (0, _v3.useEffect)(() => {
      _v15.called && _v15.data && _v16({
        select: [],
        variables: {
          ue: _v9 ? _v18.USER_ENTITY_BUSINESS : _v18.USER_ENTITY_PERSONAL
        }
      });
    }, [_v15, _v9, _v16]), (0, _v3.useEffect)(() => {
      if (!_v19.current && _v15.called && _v15.data && _v17.called && _v17.data && !_v17.loading && _v7) if (_v19.current = !0, (0, _v22.clearCachedToken)(), _v3(null), _v4 && _v5(void 0), "renew" === _v6) window.location.href = "/manage/team/billing?rns=1";else if (_v13) window.opener ? window.location.href = `/store/ondemand/popup/${_v11}?ssl=1&player=1` : parent.location.reload();else {
        let _v0 = _v2 ? `&${_v2.toString()}` : "",
          _v1 = _v15.data.orderId,
          _v2 = (0, _v21.getCheckoutPeriodicity)(_v7.isCreatorProduct, _v10, _v8),
        ...
        if (_v7.isCreatorProduct) window.location.href = _v12 || "/home";else {
          let _v0 = _v15.postCheckoutUrl.read();
          if (_v0) {
            _v15.postCheckoutUrl.clear();
    ...
    let _v0 = (0, _v16.useViewer)(),
      ...
      _v18 = _v9 && (0, _v21.isCreatorProductTier)(_v9),
      {
        state: {
          submitOrder: _v19
        },
      ...
      } = (0, _v12.useCheckoutTracking)(_v16),
      _v22 = (0, _v13.usePico)(),
      _v23 = (0, _v21.getCheckoutPeriodicity)(_v8?.isCreatorProduct, _v13, _v10),
      _v24 = (0, _v3.useCallback)(_v0 => {
        null !== _v22 && void 0 !== _v9 && (0, _v19.acquireCheckoutFailedLatch)() && _v21({
          tier: _v9,
          periodicity: _v23,
          isFreeTrial: _v11,
          ..._v0
      ...
      _v25 = (0, _v3.useEffectEvent)(_v0 => {
        _v0?.provider === "zuora_hpm" && _v0 && (0, _v17.trackZuoraOrderStep)({
    ...
    (0, _v3.useEffect)(function () {
      ...
      if (_v27.called ? _v0 = _v27 : _v29.called && (_v0 = _v29), _v0) {
        ...
        if (_v20({
          type: _v20.ApiActionTypes.SUBMIT_ORDER,
          payload: _v0
        }), _v0.error) {
          let _v0 = _v0.error;
          (async () => {
            let _v0 = await _v24(_v0);
            if (!_v2) {
              if (_v0 && "string" == typeof _v0.decline_category) {
                let _v0 = (0, _v19.isDeclineCategory)(_v0.decline_category) ? (0, _v19.canonicalMessageForCategory)(_v0.decline_category) : _v0.canonical_message || (0, _v10.getErrorMessage)();
                _v17({
                ...
                let _v0 = _v0?.error ?? _v0.message,
                  _v1 = (0, _v10.parseGatewayDeclineCode)(_v0);
                _v17({
                  type: _v20.ActionTypes.PAYMENT_ALERT,
                  payload: {
                    status: "error",
                    message: (0, _v10.getDeclineMessage)(_v1)
                  }
                });
          ...
          if (_v0) {
            ...
            let _v0 = (0, _v10.parseGatewayDeclineCode)(_v0),
              _v1 = (0, _v10.getDeclineMessage)(_v0);
            _v17({
              type: _v20.ActionTypes.PAYMENT_ALERT,
              payload: {
                status: "error",
            ...
            let _v0 = (0, _v10.getErrorMessage)(_v10.ERROR_TYPE.SIFT_ERROR);
            _v20({
              type: _v20.ApiActionTypes.SUBMIT_ORDER,
              payload: {
                ..._v0,
                data: null,
                error: Error(_v10.ERROR_TYPE.SIFT_ERROR)
              }
            }), _v17({
              type: _v20.ActionTypes.PAYMENT_ALERT,
              payload: {
            ...
            type: _v20.ActionTypes.ORDER_SUBMIT,
            payload: _v0.data
          }), _v17({
            type: _v20.ActionTypes.PAYMENT_ALERT,
            payload: void 0
    ...
    let _v30 = _v0 => {
      _v1.current = _v0 ?? null, _v0?.provider === "zuora_hpm" && ((0, _v17.trackAddPaymentMethodSuccess)(!1), _v0 && (0, _v17.trackZuoraOrderStep)({
        hpm_session_id: _v0.xsrft,
        user_id: `${_v0.user?.id}`,
    ...
    return "renew" === _v6 && _v7 ? [(_v0, _v1) => {
      (0, _v19.resetCheckoutFailedLatch)(), _v30(_v1), _v28({
        select: [],
        where: {
        ...
        variables: {
          ...
          orderId: _v0.id,
          userEntity: _v12 ? _v18.USER_ENTITY_BUSINESS : _v18.USER_ENTITY_PERSONAL
        }
      });
    }, _v19] : "upgrade" === _v6 && _v7 && _v5 ? [(_v0, _v1) => {
      (0, _v21.isUpgradeToPlanAlreadyOnSubscription)(_v5.id, _v7) ? _v17({
        type: _v20.ActionTypes.PAYMENT_ALERT,
        payload: {
          status: "error",
      ...
      _v0.firstName && _v0.lastName && _v0.billingAddress && _v0.paymentMethodId && ((0, _v19.resetCheckoutFailedLatch)(), _v30(_v1), _v26({
        variables: {
          useJuno: !_v18 && _v3,
