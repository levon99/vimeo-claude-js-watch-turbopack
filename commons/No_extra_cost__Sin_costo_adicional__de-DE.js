{
  ...
  var _v1 = _v0.i(0),
    ...
    _v9 = _v0.i(0),
    _v10 = _v0.i(0);
  let _v11 = _v0 => null === _v0 ? String((0, _v9.translate)({
  ...
  })) : String((0, _v9.translate)({
    singular: "{PRICE} per month",
    replacements: {
      PRICE: (0, _v10.formatBundlePrice)(_v0)
    },
    dictionary: {
      es: {
        singular: "{PRICE} por mes"
      },
      "de-DE": {
        singular: "{PRICE} pro Monat"
      },
      "fr-FR": {
        singular: "{PRICE} par mois"
      },
      "ja-JP": {
        singular: "{PRICE} 月額"
      },
  ...
  _v0.s(["getBundleOfferAddCtaLabel", 0, _v0 => null === _v0 ? String((0, _v9.translate)({
    singular: "Add premium access for free",
    dictionary: {
      es: {
        singular: "Añadir acceso premium sin coste adicional"
      },
      "de-DE": {
        singular: "Premiumzugang kostenlos hinzufügen"
      },
      "fr-FR": {
        singular: "Ajouter l'accès premium gratuitement"
      },
      "ja-JP": {
        singular: "プレミアムアクセスを無料で追加"
      },
      "ko-KR": {
        singular: "프리미엄 액세스를 무료로 추가"
      },
      "pt-BR": {
        singular: "Adicionar acesso premium gratuitamente"
      },
      "zh-CN": {
        singular: "免费添加高级访问权限"
      }
  ...
  })), "getBundleOfferDismissCtaLabel", 0, () => String((0, _v9.translate)({
    singular: "Continue without additional products",
    dictionary: {
      es: {
        singular: "Continuar sin productos adicionales"
      },
      "de-DE": {
        singular: "Ohne zusätzliche Produkte fortfahren"
      },
      "fr-FR": {
        singular: "Continuer sans produits supplémentaires"
      },
      "ja-JP": {
        singular: "追加の製品なしで続行"
      },
      "ko-KR": {
        singular: "추가 상품 없이 계속"
      },
      "pt-BR": {
        singular: "Continuar sem produtos adicionais"
      },
      "zh-CN": {
        singular: "继续，不添加额外产品"
      }
    }
  })), "getBundleOfferModalTitle", 0, (_v0, _v1) => null === _v0 ? String((0, _v9.translate)({
    singular: "Add premium access to {count} product at no extra cost.",
    plural: "Add premium access to {count} products at no extra cost.",
    count: _v1,
    replacements: {
      count: `${_v1}`
    },
    dictionary: {
      es: {
        singular: "Añadir acceso premium a {count} producto sin coste adicional.",
        plural: "Añadir acceso premium a {count} productos sin coste adicional."
      },
      "de-DE": {
        singular: "Premiumzugang für {count} Produkt ohne zusätzliche Kosten hinzufügen.",
        plural: "Premiumzugang für {count} Produkte ohne zusätzliche Kosten hinzufügen."
      },
      "fr-FR": {
        singular: "Ajouter l'accès premium à {count} produit sans frais supplémentaires.",
        plural: "Ajouter l'accès premium à {count} produits sans frais supplémentaires."
      },
      "ja-JP": {
        singular: "追加料金なしでプレミアムアクセスを{count}件の製品に追加.",
        plural: "追加料金なしでプレミアムアクセスを{count}件の製品に追加."
      },
      "ko-KR": {
        singular: "추가 비용 없이 프리미엄 액세스를 {count}개 상품에 추가.",
        plural: "추가 비용 없이 프리미엄 액세스를 {count}개 상품에 추가."
      },
      "pt-BR": {
        singular: "Adicionar acesso premium a {count} produto sem custo adicional.",
        plural: "Adicionar acesso premium a {count} produtos sem custo adicional."
      },
      "zh-CN": {
        singular: "为 {count} 个产品免费添加高级访问权限.",
        plural: "为 {count} 个产品免费添加高级访问权限."
      }
    }
  })) : String((0, _v9.translate)({
    singular: "Add premium access to {count} product.",
    plural: "Add premium access to {count} products.",
    count: _v1,
    replacements: {
      count: `${_v1}`
    },
    dictionary: {
      es: {
        singular: "Añadir acceso premium a {count} producto.",
        plural: "Añadir acceso premium a {count} productos."
      },
      "de-DE": {
        singular: "Premiumzugang für {count} Produkt hinzufügen.",
        plural: "Premiumzugang für {count} Produkte hinzufügen."
      },
      "fr-FR": {
        singular: "Ajouter l'accès premium à {count} produit.",
        plural: "Ajouter l'accès premium à {count} produits."
      },
      "ja-JP": {
        singular: "プレミアムアクセスを{count}件の製品に追加.",
        plural: "プレミアムアクセスを{count}件の製品に追加."
      },
      "ko-KR": {
        singular: "프리미엄 액세스를 {count}개 상품에 추가.",
        plural: "프리미엄 액세스를 {count}개 상품에 추가."
      },
      "pt-BR": {
        singular: "Adicionar acesso premium a {count} produto.",
        plural: "Adicionar acesso premium a {count} produtos."
      },
      "zh-CN": {
        singular: "为 {count} 个产品添加高级访问权限.",
        plural: "为 {count} 个产品添加高级访问权限."
      }
    }
  })), "getBundlePriceBadgeLabel", 0, _v11, "getBundleToggleBannerHeading", 0, (_v0, _v1) => null === _v0 ? String((0, _v9.translate)({
    singular: "Add premium access to {count} product, free of charge",
    plural: "Add premium access to {count} products, free of charge",
    count: _v1,
    replacements: {
      count: `${_v1}`
    },
    dictionary: {
      es: {
        singular: "Añadir acceso premium a {count} producto, sin coste",
        plural: "Añadir acceso premium a {count} productos, sin coste"
      },
      "de-DE": {
        singular: "Premiumzugang für {count} Produkt kostenlos hinzufügen",
        plural: "Premiumzugang für {count} Produkte kostenlos hinzufügen"
      },
      "fr-FR": {
        singular: "Ajouter l'accès premium à {count} produit, gratuit",
        plural: "Ajouter l'accès premium à {count} produits, gratuits"
      },
      "ja-JP": {
        singular: "プレミアムアクセスを{count}件の製品に無料で追加",
        plural: "プレミアムアクセスを{count}件の製品に無料で追加"
      },
      "ko-KR": {
        singular: "프리미엄 액세스를 {count}개 상품에 무료로 추가",
        plural: "프리미엄 액세스를 {count}개 상품에 무료로 추가"
      },
      "pt-BR": {
        singular: "Adicionar acesso premium a {count} produto, sem custo",
        plural: "Adicionar acesso premium a {count} produtos, sem custo"
      },
      "zh-CN": {
        singular: "为 {count} 个产品添加高级访问权限, 免费提供",
        plural: "为 {count} 个产品添加高级访问权限, 免费提供"
      }
    }
  })) : String((0, _v9.translate)({
    singular: "Add premium access to {count} product",
  ...
  _v0.s(["default", 0, ({
    ...
    let {
      ...
      } = _v2?.params,
      {
        ...
        usageCheckData: _v11
      } = (0, _v13.useContext)(_v25.PlansDataContext),
      {
        compact: _v12
      } = (0, _v13.useContext)(_v24.OverridesContext),
      _v13 = _v0 => {
        switch (_v0) {
          case "free":
          default:
            return (0, _v23.translate)({
    ...
    if (_v10) {
      ...
      return (0, _v1.jsxs)(_v3.Box, {
        ...
        children: [(0, _v1.jsxs)(_v14, {
          children: [(_v4 ?? 0) === 1 ? (0, _v1.jsx)(_v22.PersonUser, {}) : (0, _v1.jsx)(_v21.Users, {}), (0, _v1.jsx)(_v15, {
            children: "enterprise" === _v0 ? (0, _v23.translate)({
              singular: "More users",
              dictionary: {
                es: {
                  singular: "Más usuarios"
            ...
            }) : "professional" === _v0 ? (0, _v23.translate)({
            ...
            }) : "production" === _v0 ? (0, _v23.translate)({
              singular: "{AMOUNT} users (up to {ADD_USERS})",
              replacements: {
                AMOUNT: _v4,
                ADD_USERS: (0, _v23.translate)({
                  singular: "Unlimited",
                  dictionary: {
                    es: {
                      singular: "Ilimitado"
          ...
          children: [(0, _v1.jsx)(_v20.Database, {}), (0, _v1.jsx)(_v15, {
            children: (_v0 => {
              if ("enterprise" === _v0) return (0, _v23.translate)({
          ...
          children: [(0, _v1.jsx)(_v18.Speedometer, {}), (0, _v1.jsx)(_v15, {
            children: _v7?.quotaPeriod === "year" ? (0, _v23.translate)({
    ...
    return (0, _v1.jsxs)(_v3.Box, {
      ...
      children: [_v0?.tier === "customSelfServe" && (0, _v1.jsxs)(_v14, {
        children: [(0, _v1.jsx)(_v17, {}), (0, _v1.jsx)(_v15, {
          children: (0, _v23.translate)({
        ...
        children: [(0, _v1.jsx)(_v21.Users, {}), (0, _v1.jsx)(_v15, {
          marginLeft: (0, _v5.rem)(4),
          children: _v13(_v0?.tier)
        })]
      })), (0, _v1.jsxs)(_v14, {
        children: ["video_count" === _v6 ? (0, _v1.jsx)(_v19.VideosStack, {}) : (0, _v1.jsx)(_v20.Database, {}), (0, _v1.jsx)(_v15, {
          children: (_v1 = _v0?.tier, "enterprise" === _v1 ? _v3 ? (0, _v23.translate)({
          ...
          }) : "video_count" === _v6 ? (0, _v23.translate)({
        ...
        children: [(0, _v1.jsx)(_v18.Speedometer, {}), (0, _v1.jsx)(_v15, {
          children: "enterprise" === _v0?.tier ? (0, _v23.translate)({
  ...
  margin-bottom: ${_v0 => _v0?.bottomSpacing || (0, _v27.rem)(12)};
  line-height: ${(0, _v27.rem)(18)};

  p {
    font-weight: 900;
  }
`;
  let _v32 = _v28.default.ul.withConfig({
  ...
  li {
    margin-bottom: ${_v0 => _v0.$compact ? (0, _v27.rem)(12) : (0, _v27.rem)(8)};
    position: relative;
    @media (width > ${_v30.breakpoints.TABLET}) {
      margin-bottom: ${_v0 => (_v0.$compact, (0, _v27.rem)(12))};
    }
  }
  ...
  > li {
    ...
    display: flex;
    line-height: ${_v0 => _v0.$compact ? (0, _v27.rem)(20) : (0, _v27.rem)(24)};
    @media (width > ${_v30.breakpoints.TABLET}) {
      &:last-child {
        padding-bottom: ${_v0 => _v0.$compact ? "0" : (0, _v27.rem)(48)} !important;
        margin-bottom: 0;
      }
    }
  }
  ...
  @media (width > ${_v30.breakpoints.TABLET}) {
    margin-bottom: ${_v0 => _v0.$compact ? "0" : (0, _v27.rem)(19)};
  }
`;
  (0, _v28.default)(_v29.Checkmark).withConfig({
    displayName: "styles__FeatureCheck",
    componentId: "sc-dc427937-2"
  })`
  ${(0, _v31.addWidth)(18, 24)};
  position: absolute;
  left: 0;
`;
  let _v33 = (0, _v28.default)(_v29.Checkmark).withConfig({
    displayName: "styles__StyledCheckmark",
    componentId: "sc-dc427937-3"
  })`
  margin-right: ${(0, _v27.rem)(4)};
  max-width: ${(0, _v27.rem)(16)};
  position: relative;
  width: 100%;
  top: ${(0, _v27.rem)(2)};

  @media (width > ${_v30.breakpoints.TABLET}) {
    margin-right: ${(0, _v27.rem)(8)};
  }
  path {
    fill: var(--vimeo-colors-text-primary);
  }
`;
  _v0.s(["FeatureList", 0, _v32, "StyledCheckmark", 0, _v33], 0);
  let _v34 = {
      free: [(0, _v23.translate)({
      ...
      customSelfServe: [(0, _v23.translate)({
    ...
    _v37 = (_v0, _v1, _v2, _v3, _v4, _v5, _v6) => {
      if (_v3) switch (_v0) {
        case "free":
          return [(0, _v23.translate)({
            singular: "Ad-free video player",
        ...
        case "creator":
          return _v4 || _v6 ? [(0, _v23.translate)({
      ...
      return _v1 ? _v35[_v0] : _v2 ? _v36[_v0] : _v34[_v0];
    },
    _v38 = (_v0, _v1 = !1, _v2, _v3) => _v0 && _v1 ? "enterprise" === _v0 ? (0, _v23.translate)({
      singular: "More storage and bandwidth",
      dictionary: {
        es: {
          singular: "Más almacenamiento y ancho de banda"
    ...
    }) : "pro" === _v0 || "plus" === _v0 ? (0, _v23.translate)({
    ...
    })}` : "enterprise" === _v0 ? (0, _v23.translate)({
    ...
    }) : "free" === _v0 && 2 == _v3 ? (0, _v23.translate)({
    ...
    _v39 = (_v0, _v1, _v2, _v3, _v4, _v5) => {
      let _v6 = !!Array.isArray(_v0) && !_v0.some(_v0 => "free" === _v0.tier);
      return "free" === _v1 || "customSelfServe" === _v1 || "starter" === _v1 && _v6 || _v4 && "professional" === _v1 && (_v6 || "business" === _v5) ? (0, _v23.translate)({
  ...
  _v0.s(["CARD_FEATURE_LIST_MAP", 0, _v34, "getCardFeatureSubhead", 0, _v39, "getCardVideoQuota", 0, _v38, "getFeatureListByTier", 0, _v37], 0);
  var _v40 = _v0.i(0);
  let _v41 = _v0 => {
    let {
      compact: _v1
    } = (0, _v13.useContext)(_v24.OverridesContext);
    return (0, _v1.jsx)(_v26.Paragraph, {
  ...
  _v0.s(["default", 0, ({
    ...
    let {
      ...
      _v10 = !!_v7 && (0, _v40.isCreatorV2)(_v8),
      _v11 = !!_v7 && (0, _v40.isCreatorJuly2026)(_v8),
      _v12 = _v37(_v4, _v5, _v6, _v7, _v10, _v0?.metadata?.entitlements?.params, _v11),
      _v13 = _v39(_v8, _v4, _v5, _v6, _v7, _v3),
      _v14 = _v38(_v4, _v5, _v2, _v1);
    return (0, _v1.jsxs)(_v3.Box, {
      ...
      }), _v12 && _v12.length > 0 && (_v14 || _v7) && (0, _v1.jsxs)(_v32, {
        $compact: _v9,
        children: [_v5 && (0, _v1.jsxs)("li", {
          children: [(0, _v1.jsx)(_v33, {}), (0, _v1.jsx)(_v41, {
            children: _v14
          })]
  ...
  var _v42 = _v0.i(0),
    _v43 = _v0.i(0);
  let _v44 = (0, _v28.default)(_v29.Checkmark).withConfig({
...
`;
  (0, _v28.default)(_v43.ReviewCheck).withConfig({
    displayName: "styles__ReviewIcon",
    componentId: "sc-d95ef56-1"
  })`
  ${(0, _v31.addWidth)(16, 20)};
  margin-top: ${(0, _v27.rem)(4)};
...
`, _v28.default.div.withConfig({
  ...
  min-height: ${(0, _v27.rem)(120)};
  margin-bottom: ${(0, _v27.rem)(20)};
  svg {
    margin: ${(0, _v27.rem)(8)} 0;
  }
  p {
    color: ${_v42.bokehTheme.colors.gray["900"]};
    max-width: ${(0, _v27.rem)(180)};
    font-size: 22px;
    font-style: normal;
    font-weight: 400;
    line-height: 100%;
...
`;
  let _v45 = _v28.default.ul.withConfig({
...
`;
  _v0.s(["EnterpriseFeatureList", 0, _v45, "FeatureCheckIcon", 0, _v44], 0);
  let _v46 = _v28.default.div.withConfig({
      displayName: "styles__BadgeContainer",
      componentId: "sc-2c69964a-0"
    })`
  position: absolute;
  top: ${_v0 => _v0.$compact ? (0, _v27.rem)(-22) : (0, _v27.rem)(-24)};
  left: 0;
  background: ${({
      bgColor: _v0
    }) => _v0};
  color: white;
  border-radius: ${(0, _v27.rem)(20)} ${(0, _v27.rem)(20)} 0 0;
  height: ${_v0 => _v0.$compact ? (0, _v27.rem)(44) : (0, _v27.rem)(70)};
  width: 100%;
  text-align: center;

  @media (width > ${_v30.breakpoints.TABLET}) {
    top: ${_v0 => _v0.$compact ? (0, _v27.rem)(-22) : (0, _v27.rem)(-37)};
    min-height: ${_v0 => _v0.$compact ? (0, _v27.rem)(24) : (0, _v27.rem)(36)};
    height: ${_v0 => _v0.$compact ? (0, _v27.rem)(44) : (0, _v27.rem)(70)};
    padding: ${_v0 => _v0.$compact ? `${(0, _v27.rem)(4)} ${(0, _v27.rem)(24)}` : `${(0, _v27.rem)(6)} ${(0, _v27.rem)(24)}`};
  }

  > h2 {
    ${(0, _v31.addTypography)(12, 18)}
    color: #f0f4f6;
    font-weight: 500;
    line-height: ${(0, _v27.rem)(24)};
    margin: 0;
    ...
    @media (width > ${_v30.breakpoints.TABLET}) {
      line-height: ${(0, _v27.rem)(26)};
    }
  }
`,
    _v47 = _v28.default.div.withConfig({
      displayName: "styles__CurrentPlanBadgeContainer",
      componentId: "sc-2c69964a-1"
    })`
  border-radius: ${(0, _v27.rem)(20)};
  background: var(--vimeo-colors-button-secondary-default);
  padding: ${(0, _v27.rem)(8)} ${(0, _v27.rem)(2)};
  display: flex;
  justify-content: center;
  align-items: center;
  margin: auto 0;
  @media (max-width: ${_v30.breakpoints.DESKTOP_LARGE}) {
    padding: ${(0, _v27.rem)(6)} ${(0, _v27.rem)(1)};
  }
  .currentPlanText {
    ${(0, _v31.addTypography)(7, 14)}
    color: var(--vimeo-colors-text-secondary);
    font-weight: 400;
    padding: 0 ${(0, _v27.rem)(10)};
    margin: auto;
    line-height: 13.3px;
...
`,
  ...
  _v0.s(["default", 0, ({
    ...
    let _v2 = (0, _v13.useContext)(_v24.OverridesContext);
    if (_v2?.noBadge) return null;
    let {
      tier: _v3
    } = _v0;
    return _v2?.badgeType && _v2?.badgePlan === _v3 ? (0, _v1.jsx)(_v48, {
      color: "#8A5EE8",
      text: _v2.badgeType,
      compact: _v2?.compact
    }) : _v1 ? (0, _v1.jsx)(_v48, {
      color: "#8A5EE8",
      text: (0, _v23.translate)({
    ...
    showUpcoming: _v1,
    label: _v2
  }) => _v0 || _v1 ? (0, _v1.jsx)(_v47, {
    children: (0, _v1.jsx)(_v14.Text, {
      as: "div",
      variant: "body-md",
      size: "6",
      className: "currentPlanText",
      children: _v2 ?? (0, _v23.translate)({
        singular: "Your plan",
        dictionary: {
          es: {
            singular: "Su plan"
