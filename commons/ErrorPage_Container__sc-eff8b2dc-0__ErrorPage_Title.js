{
  ...
  var _v1,
    ...
    _v15 = _v0.i(0),
    _v16 = _v0.i(0);
  let _v17 = _v5.default.div.withConfig({
  ...
  text-align: center;
`,
    _v18 = (0, _v5.default)(_v11.Header).attrs({
      size: "1"
    }).withConfig({
...
`,
    _v20 = (0, _v5.default)(_v12.Paragraph).attrs({
      size: "1"
    }).withConfig({
...
`,
    _v21 = ({
      ...
      console.error(`[Vimeo Error Page] ${_v0}: ${_v1}`);
    }, [_v0, _v1]), (0, _v2.jsxs)(_v17, {
      id: "vimeo-error-page-view",
      children: [(0, _v2.jsx)(_v18, {
        children: _v0
      }), (0, _v2.jsxs)(_v19, {
        children: [(0, _v2.jsx)(_v20, {
          children: _v1
        }), _v2 && (0, _v2.jsx)(_v16.SearchField, {
  ...
  var _v23 = ((_v1 = _v23 || {}).VISIT_ERROR_PAGE = "vimeo_com.visit_error_page", _v1);
  _v0.s(["ErrorPage", 0, function (_v0) {
    ...
    let _v7 = _v1 instanceof _v9.RateLimitError ? {
