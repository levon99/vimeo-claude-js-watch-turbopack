{
  ...
  function _v24({
    ...
    let {
        ...
        hasEnterprise: _v7
      } = (0, _v17.useVideoData)((0, _v18.getClipRequestId)(_v0, _v1)),
      {
        data: _v8,
        isLoading: _v9
      } = (0, _v15.useGetVideoVersion)({
        versionId: Number(_v2),
        videoId: Number(_v0)
      }),
      _v10 = (0, _v6.usePathname)(),
      _v11 = (0, _v23.useViewer)(),
      [_v12, _v13] = (0, _v7.useState)(!1),
      _v14 = _v9 || !_v8?.downloadConfig,
      [_v15, _v16] = (0, _v7.useState)(!0),
      [_v17, _v18] = (0, _v7.useState)(!1),
      _v19 = (0, _v11.useIsMobile)(),
      _v20 = (0, _v7.useMemo)(() => ({
        webContextFields: {
      ...
      _v21 = (0, _v19.idFromUri)(_v5?.user.uri)?.toString() ?? null,
      _v22 = _v0 => {
        _v16(_v0 => !_v0), (0, _v10.sendCommentBPEvent)({
    ...
    return _v6 || _v9 ? (0, _v1.jsx)(_v3.default, {}) : _v5 && _v23 ? (0, _v1.jsxs)(_v1.Fragment, {
      children: [(0, _v1.jsxs)(_v8.Flex, {
        direction: "column",
        children: [(0, _v1.jsx)(_v14.ReviewHeader, {
          videoName: _v5?.name ?? "",
          videoId: Number(_v0),
          clipHash: _v1,
          onDownload: () => {
          ...
          analyticsProps: _v20,
          toggleDrawer: _v22,
          currentVersionSequenceNumber: _v8?.sequenceNumber ?? _v16.DEFAULT_VERSION_NUMBER,
          setIsReplaceOverQuota: _v18,
          totalVersionsCount: _v5?.metadata?.connections?.versions?.totalIncludingDeleted ?? 0,
          isDeleted: _v4,
          versionId: (0, _v19.idFromUri)(_v8?.uri),
          redirectUri: (0, _v19.formClipManageUri)(_v0, _v1),
          showComments: !0
        }), (0, _v1.jsx)(_v9.CommentContextProvider, {
          children: (0, _v1.jsx)(_v20.ReviewPlayerContainer, {
            ...
            clipHash: _v1,
            closeDrawer: _v22,
            videoVersionUri: (0, _v19.formVersionRedirectUri)(Number(_v2), _v0, _v1),
            showComments: _v15,
            videoName: _v5.name || "",
        ...
        }), !_v14 && (0, _v1.jsx)(_v13.DownloadVersionModal, {
          isOpen: _v12,
          onClose: () => _v13(!1),
          videoId: Number(_v0),
      ...
      }), !_v19 && (0, _v1.jsx)(_v21.ReviewFooter, {})]
    }) : (0, _v1.jsx)(_v22.ErrorPage, {
  ...
  let _v25 = ({
    ...
    isDeleted: _v5
  }) => (0, _v1.jsx)(_v4.PlayerContextProvider, {
