{
  ...
  _v0.s(["ComparisonPaywallHeader", 0, _v9], 0);
  var _v10 = _v0.i(0),
    _v11 = _v0.i(0),
    _v12 = _v0.i(0),
    _v13 = _v0.i(0);
  function _v14({
    ...
    let _v17 = () => {
        if (!_v15 || !_v14) return;
        let _v0 = (0, _v13.buildCheckoutUrl)({
          ..._v14,
          tier: _v15,
          isTrial: _v16
        });
    ...
    return (0, _v1.jsxs)(_v1.Fragment, {
      children: [(0, _v1.jsxs)(_v4.Flex, {
        ...
        children: [(0, _v1.jsx)(_v4.Flex, {
          ...
          gap: "sm",
          pt: "sm",
          children: _v10 ? (0, _v1.jsx)(_v11.Button, {
            size: "md",
            variant: "primary",
            width: "100%",
            onClick: _v14,
          ...
          children: [(0, _v1.jsxs)(_v4.Flex, {
            ...
            children: [(0, _v1.jsx)(_v3.Box, {
              ...
              alignItems: "center",
              justifyContent: "center",
              children: (0, _v1.jsx)(_v12.Checkmark, {
                width: 16,
                height: 16
              })
            }), (0, _v1.jsx)(_v5.Text, {
  ...
  function _v24(_v0) {
    let _v1 = (_v0 && ("free" === _v0 || "starter" === _v0 || "standard" === _v0 || "advanced" === _v0) ? _v22[_v0] : []).slice(0, 4).map(_v0 => ({
      text: _v0
    }));
  ...
  function _v25({
    ...
    return [{
      ...
      currentValue: _v32(_v19, _v2),
      targetValue: _v32(_v19, _v3)
    }, {
      key: "virtual_events",
      name: (0, _v6.translate)({
      ...
      currentValue: _v32(_v20, _v2),
      targetValue: _v32(_v20, _v3)
    }, {
      key: "bandwidth",
      name: (0, _v6.translate)({
        singular: "Bandwidth",
      ...
      currentValue: _v31(_v0),
      targetValue: _v31(_v1)
    }];
  }
  ...
  function _v30(_v0) {
    let _v1 = _v0?.metadata?.entitlements?.params,
      _v2 = (0, _v18.selectStorageQuota)({
        restrictedVideoStorageLimit: _v1?.restrictedVideoStorageLimit,
        videoStoragePeriodicQuota: _v1?.videoStoragePeriodicQuota,
        videoStorageQuotaPeriod: _v1?.videoStorageQuotaPeriod,
        videoStorageQuotaUnit: _v1?.videoStorageQuotaUnit
      });
    return null == _v2.quantity ? "" : String(_v2.quantity);
  }
  function _v31(_v0) {
    let _v1 = _v0?.metadata?.entitlements?.params?.bandwidth,
      _v2 = (0, _v18.selectBandwidthQuota)({
        periodicQuota: _v1?.periodicQuota,
        quotaPeriod: _v1?.quotaPeriod
      });
    if (_v2.quantity) {
      let _v0 = "year" === _v2.period ? (0, _v6.translate)({
        singular: "year",
        dictionary: {
          es: {
            singular: "año"
  ...
  _v0.s(["getCardEntitlementsForTier", 0, _v24, "getComparisonFeatures", 0, _v25, "getFeatureValue", 0, _v26, "getSeatCountLabel", 0, _v27, "getStorageLabel", 0, _v28, "getSubtitleForTier", 0, _v23], 0), _v0.s(["CardComparisonPaywall", 0, function ({
    tier: _v0,
    currentTier: _v1,
    paywallTracking: _v2,
    ...
    let _v5,
      ...
      _v9 = (0, _v8.hasFreeTrialPurchasePath)(_v8) && _v3,
      _v10 = !!_v8,
      ...
      _v21 = _v27(_v26(_v20, "seats", "currentValue")),
      _v22 = _v27(_v26(_v20, "seats", "targetValue")),
      _v23 = _v28(_v26(_v20, "storage", "currentValue")),
      _v24 = _v28(_v26(_v20, "storage", "targetValue")),
      _v25 = _v24(_v8?.tier ?? _v0),
      _v26 = _v24(_v7?.tier);
    return (0, _v1.jsxs)(_v4.Flex, {
      direction: "column",
      alignItems: "center",
      ...
      children: [(0, _v1.jsx)(_v9, {
        ...
        children: (0, _v1.jsx)(_v17.OtherPlansButton, {
          paywallTracking: _v2
        })
      })]
    });
  ...
  _v0.s(["GenericLimitPaywall", 0, function ({
    ...
    let _v4 = (0, _v7.useGetSubscriptionPlansData)([_v0], void 0, !1),
      ...
      _v7 = (0, _v8.hasFreeTrialPurchasePath)(_v5),
      _v8 = (0, _v6.translate)({
        singular: "Join Vimeo",
        dictionary: {
          es: {
      ...
      _v11 = (0, _v36.useColorModeValue)("https://i.vimeocdn.com/custom_asset/4a6f0f615c4cf9d30b48f79df970438e", "https://i.vimeocdn.com/custom_asset/edb2ec4f5620a90adb065894bbb08419");
    return (0, _v1.jsxs)(_v4.Flex, {
      direction: "column",
      alignItems: "center",
      width: "100%",
      ...
      children: [(0, _v1.jsxs)(_v4.Flex, {
        ...
        }), (0, _v1.jsx)(_v35.VStack, {
          gap: "md",
          alignItems: "start",
          width: "100%",
          pt: "16px",
          children: (0, _v40.getFeatures)(_v6).map((_v0, _v1) => (0, _v1.jsx)(_v37.FeatureRow, {
            ..._v0
          }, `row${_v1}`))
        })]
      }), (0, _v1.jsxs)(_v38.PaywallCTAsWrapper, {
        children: [(0, _v1.jsx)(_v39.PurchaseButton, {
          subscriptionTier: _v0,
          isTrial: _v7 && _v3,
          planName: _v10,
          paywallTracking: _v2
        }), (0, _v1.jsx)(_v17.OtherPlansButton, {
          paywallTracking: _v2
        })]
      })]
    });
  ...
  function _v43({
    ...
    return (0, _v1.jsxs)(_v4.Flex, {
      ...
      children: [(0, _v1.jsx)(_v3.Box, {
        ...
        opacity: _v3,
        children: (0, _v1.jsx)(_v41.ChevronDownSmall, {})
      }), _v5 && (0, _v1.jsx)(_v42.CircleExclamationFilled, {
  ...
  _v0.s(["PrivacyOptionsPreview", 0, function ({
    options: _v0,
    marginBottom: _v1
  }) {
    return (0, _v1.jsx)(_v35.VStack, {
      "data-testid": "privacy-options-preview",
      width: "100%",
      alignItems: "stretch",
      position: "relative",
      pt: "24px",
      ...
      gap: "0",
      marginBottom: _v1,
      children: _v0.map((_v0, _v1) => (0, _v1.jsx)(_v43, {
        icon: _v0.icon,
        title: _v0.title,
        ...
        showAlert: 0 === _v1,
        isLast: _v1 === _v0.length - 1
      }, _v0.key))
    });
  }], 0), _v0.s(["StorageLimitMeter", 0, function ({
    currentLimit: _v0,
    targetLimit: _v1,
    planName: _v2,
    marginTop: _v3,
    ...
    return (0, _v1.jsxs)(_v3.Box, {
      "data-testid": "storage-limit-meter",
      border: "1px solid",
      ...
      }), (0, _v1.jsx)(_v42.CircleExclamationFilled, {
        color: "upsell-primary",
        width: "40px",
        height: "40px",
        transform: "rotate(15deg)",
  ...
  var _v44 = _v0.i(0),
    _v45 = _v0.i(0);
  _v0.s(["useCurrentStorageLimit", 0, function () {
    let {
        data: _v0,
        ..._v1
      } = (0, _v44.useGetMe)({
      ...
      _v6 = "",
      _v7 = "";
    return null != _v2 && _v2 > 0 && ("video_count" === _v3 ? _v6 = `${_v2}` : "video_size" === _v3 && (_v6 = (0, _v45.formatBytes)(_v2, !1))), null != _v4 && _v4 > 0 && ("video_size" === _v5 || void 0 === _v5) && (_v7 = (0, _v45.formatBytes)(_v4, !1)), {
      currentStorageLimit: _v6,
      currentRestrictedStorageLimit: _v7,
      hasRestrictedStorageLimit: null != _v4,
      ..._v1
    };
  }], 0);
}