{
  ...
  var _v1 = _v0.i(0),
    ...
    _v10 = _v0.i(0),
    _v11 = _v0.i(0);
  let _v12 = (0, _v2.forwardRef)((_v0, _v1) => (0, _v1.jsxs)("svg", {
      ref: _v1,
      width: "33",
      height: "32",
      viewBox: "0 0 33 32",
    ...
    _v13 = (0, _v2.forwardRef)((_v0, _v1) => (0, _v1.jsxs)("svg", {
      ref: _v1,
      width: "33",
      height: "32",
      viewBox: "0 0 33 32",
    ...
    _v14 = (0, _v2.forwardRef)((_v0, _v1) => (0, _v1.jsxs)("svg", {
      ref: _v1,
      width: "32",
      height: "32",
      viewBox: "0 0 32 32",
  ...
  var _v15 = _v0.i(0),
    ...
    _v20 = _v0.i(0);
  let _v21 = () => {
      let _v0 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.isEventDateVisible),
        _v1 = (0, _v16.useGlobalStore)(_v0 => _v0.entity.schedule),
        _v2 = (0, _v19.fromISO)(_v1?.startTime),
        _v3 = (0, _v19.fromISO)(_v1?.endTime),
        _v4 = (0, _v19.isSameDate)(new Date(_v1?.startTime || ""), new Date(_v1?.endTime || "")),
        _v5 = navigator.language || "en-US",
        _v6 = (0, _v16.useGlobalStore)(_v0 => _v0.setSelectedNonEditableField);
      return _v0 && _v2.isValid && _v1 ? (0, _v1.jsx)(_v20.StylableNonEditText, {
        fieldName: _v15.NON_EDIT_FIELDS.EVENT_DATE,
        children: _v4 ? (0, _v1.jsxs)(_v22, {
          size: "6",
          onClick: () => _v6(_v15.NON_EDIT_FIELDS.EVENT_DATE),
          children: [`${_v2.toFormat("cccc, MMMM d, yyyy")} `, (0, _v1.jsxs)("div", {
            children: [(0, _v1.jsxs)("span", {
              ...
              children: [(0, _v1.jsx)("span", {
                ...
                children: ` ${(0, _v19.getTimeZone)(_v5)}`
              })]
            }) : (0, _v1.jsx)("span", {
              children: ` ${(0, _v19.getTimeZone)(_v5)}`
            })]
    ...
    _v22 = _v0 => (0, _v1.jsx)(_v18.Header, {
      mb: "sm",
      fontSize: "body-lg",
      fontWeight: "bold",
      size: "xl",
  ...
  _v0.s(["EventDate", 0, _v21], 0);
  var _v23 = _v0.i(0);
  let _v24 = _v23.Mark.create({
    name: "textStyle",
    priority: 101,
    addOptions: () => ({
      HTMLAttributes: {},
    ...
    renderHTML({
      ...
      return ["span", (0, _v23.mergeAttributes)(this.options.HTMLAttributes, _v0), 0];
    },
    addCommands() {
      return {
  ...
  let _v25 = _v23.Extension.create({
    name: "fontFamily",
    addOptions: () => ({
      types: ["textStyle"]
    }),
  ...
  let _v42 = ({
    ...
    return ((0, _v2.useEffect)(() => {
      ...
      children: [(0, _v1.jsxs)(_v4.Flex, {
        ...
        borderRadius: "sm",
        opacity: +!!_v4,
        children: [(0, _v1.jsx)(_v32.Input, {
          mr: "sm",
          fontSize: "body-lg",
          ref: _v10,
          onChange: _v0 => {
            let _v1 = _v0.target.value;
            _v7((0, _v41.isValidUrl)((0, _v41.appendProtocol)(_v1)) ? (0, _v41.appendProtocol)(_v1) : _v1);
          },
          value: _v6,
          placeholder: _v17.default.AddALink,
          size: "sm",
          onFocus: () => _v9(!0),
          onBlur: () => _v9(!1),
          isInvalid: _v6?.length && !(0, _v41.isValidUrl)(_v6) && !_v8
        }), _v6 !== _v3 || void 0 == _v3 ? (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsx)(_v31.IconButton, {
            onClick: () => _v5(!1),
            size: "sm",
            variant: "tertiary",
            icon: (0, _v1.jsx)(_v35.CloseXSmall, {}),
            "aria-label": "Close"
            ...
            isDisabled: !(0, _v41.isValidUrl)(_v6),
            size: "sm",
            variant: "tertiary",
            icon: (0, _v1.jsx)(_v34.Checkmark, {}),
            "aria-label": "Link"
          })]
          ...
          children: [(0, _v1.jsx)(_v31.IconButton, {
            ...
            size: "sm",
            "aria-label": "Unlink",
            icon: (0, _v1.jsx)(_v38.LinkBroken, {})
          }), (0, _v1.jsx)(_v31.IconButton, {
            onClick: () => {
  ...
  let _v44 = ({
    children: _v0,
    padding: _v1 = (0, _v43.rem)(4),
    lineHeight: _v2 = 1.2,
    borderRadius: _v3 = (0, _v43.rem)(5),
    border: _v4 = `${(0, _v43.rem)(2)} solid`,
    borderColor: _v5,
    onKeyDown: _v6,
    editor: _v7,
    ..._v8
  }) => (0, _v1.jsx)(_v3.Box, {
    as: _v27.EditorContent,
    sx: {
      "> div": {
        outline: "none",
        padding: _v1,
  ...
  _v0.s(["StyledEditorContent", 0, _v44], 0);
  var _v45 = _v15,
    _v46 = _v0.i(0),
    _v47 = _v0.i(0);
  let _v48 = _v23.Extension.create({
      name: "pasteHandler",
      addOptions: () => ({
        stripStyles: !1
      }),
      addProseMirrorPlugins() {
        return [new _v47.Plugin({
          key: new _v47.PluginKey("pasteHandler"),
          props: {
            handlePaste: (_v0, _v1) => {
    ...
    _v49 = _v23.Mark.create({
      ...
      renderHTML({
        ...
        return ["u", (0, _v23.mergeAttributes)(this.options.HTMLAttributes, _v0), 0];
      },
      addCommands() {
        return {
          setUnderline: () => ({
    ...
    _v53 = _v23.Extension.create({
      name: "characterCount",
      addOptions: () => ({
        limit: _v15.RTF_STYLABLE_TEXT_DEFAULT_LIMIT
      }),
      addStorage: () => ({
        characters: () => 0
      }),
      ...
      addProseMirrorPlugins() {
        return [new _v47.Plugin({
          key: new _v47.PluginKey("characterCount"),
    ...
    _v54 = _v23.Extension.create({
      name: "no_new_line",
      addProseMirrorPlugins: () => [new _v47.Plugin({
        key: new _v47.PluginKey("eventHandler"),
        props: {
          handleKeyDown: (_v0, _v1) => {
            if (_v1.key === _v15.KEY_CODES.ENTER && !_v1.shiftKey) return !0;
          }
        }
      })]
    });
  _v0.s(["CharacterCount", 0, _v53, "Color", 0, _v50, "FontSize", 0, _v51, "NoNewLine", 0, _v54, "PasteHandler", 0, _v48, "TextAlign", 0, _v52, "Underline", 0, _v49], 916);
  let _v55 = (0, _v2.forwardRef)(({
    content: _v0,
    fontSize: _v1 = _v45.RTF_TEXT_SIZES_KEYS.regular,
    maxCharacter: _v2 = 0,
    ...
    let {
      ...
      _v11 = (0, _v16.useGlobalStore)(_v0 => _v0.setSideMenuType),
      _v12 = (0, _v46.useRtfStore)(_v0 => _v0.setRtfType),
      _v13 = (0, _v46.useRtfStore)(_v0 => _v0.setSelected),
      _v14 = (0, _v46.useRtfStore)(_v0 => _v0.setCallback),
      {
        editor: _v15,
        setEditor: _v16
      ...
      _v20 = (0, _v27.useEditor)({
        extensions: [_v28.default, _v24, _v25, _v49, _v50, _v26.default.configure({
          openOnClick: !1
        }), _v51, _v52.configure({
        ...
        content: `${_v29.default.sanitize(_v0, {
          ADD_ATTR: ["target"]
        })}`,
        onFocus: () => {
          _v5(), _v24();
      ...
      _v24 = (0, _v2.useCallback)(() => {
        _v11(_v45.SIDE_MENU_CONTENT.TEXT_RTF_STYLING), _v12("text"), _v16(_v20), _v13({
          textColor: "#FF00FE"
        }), _v14({
    ...
    return (0, _v30.useOutsideClick)({
      ...
      _v3 || _v20?.chain().selectAll().setFontSize(_v45.RTF_TEXT_SIZES.find(_v0 => _v0.key === _v1)?.value || "16px").run();
    }, [_v20, _v1, _v3]), (0, _v2.useEffect)(() => {
      _v8 === _v45.PAGE_TYPES.ADMIN && _v20?.setOptions({
        editable: !0
      });
      ...
      children: [(0, _v1.jsx)(_v42, {
        ...
        isFocused: _v21,
        editor: _v20,
        $showColorOnHover: _v8 === _v45.PAGE_TYPES.ADMIN,
        ...
        children: [_v2 - (_v20?.state.doc.textContent.length || 0), " ", _v17.default.Characters]
      })]
    });
  });
  _v0.s(["StylableText", 0, _v55], 0);
  var _v56 = _v0.i(0),
    _v57 = _v0.i(0),
    _v58 = _v0.i(0),
    _v59 = _v15;
  let _v60 = _v56.keyframes`
    0% {
        width: 0;
...
`,
    _v61 = (0, _v2.forwardRef)(({
      duration: _v0 = _v59.DEFAULT_COUNTDOWN_TIMER,
      ...
      return (0, _v2.useEffect)(() => (_v1 && _v7({
        ...
        children: [(0, _v1.jsx)(_v3.Box, {
          ...
          lineHeight: "20px",
          mr: "6px",
          children: _v17.default.VideoWillPlayIn(_v9)
        }), (0, _v1.jsx)(_v58.ArrowRight, {})]
      });
    });
  var _v62 = _v0.i(0);
  let _v63 = _v0 => (0, _v1.jsx)(_v4.Flex, {
    ...
    _v64 = _v0 => {
      let [_v1] = (0, _v62.useMediaQuery)("(max-width: 768px)");
      return (0, _v1.jsx)(_v4.Flex, {
        ...
        alignItems: _v1 || _v0.previewMode === _v15.PREVIEW_MODE.MOBILE ? "center" : "left" === _v0.align ? "flex-start" : "right" === _v0.align ? "flex-end" : "center",
        textAlign: _v1 || _v0.previewMode === _v15.PREVIEW_MODE.MOBILE ? "center" : _v0.align,
        sx: {
          a: {
  ...
  _v0.s(["Alignment", 0, _v64, "Logo", 0, _v65, "LogoLink", 0, _v66, "WrapperBox", 0, _v63], 0), _v0.s(["ConfirmationView", 0, () => {
    let _v0 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.logo),
      _v1 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.alignment),
      _v2 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.isEventDateSetToCalendar),
      _v3 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.confirmationPageDescription.tagsUnresolved || ""),
      _v4 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.confirmationPageDescription.tagsResolved || ""),
      _v5 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.confirmationPageTitle.tagsUnresolved || ""),
      _v6 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.confirmationPageTitle.tagsResolved || ""),
      _v7 = (0, _v16.useGlobalStore)(_v0 => _v0.entityType),
      _v8 = (0, _v16.useGlobalStore)(_v0 => _v0.entity.schedule),
      {
        patchLeadCapture: _v9
      } = (0, _v11.usePatchLeadCapture)(),
      {
      ...
      _v16 = (0, _v16.useGlobalStore)(_v0 => _v0.calendarLinks),
      {
        previewMode: _v17
      } = (0, _v2.useContext)(_v9.PreviewContext),
      {
        currentPageType: _v18
      } = (0, _v2.useContext)(_v8.CurrentPageContext),
      {
        isMiniaturePreview: _v19
      } = (0, _v9.usePreviewContext)(),
      _v20 = "title",
      _v21 = "description",
      _v22 = (0, _v2.useCallback)(_v0 => {
        _v18 !== _v15.PAGE_TYPES.REGISTRATION && (_v0 === _v20 && _v12.current?.getHTML() !== _v5 && _v9("confirmationPageTitle.tagsUnresolved", _v12.current?.getHTML()), _v0 === _v21 && _v13.current?.getHTML() !== _v3 && _v10("confirmationPageDescription.tagsUnresolved", _v13.current?.getHTML()));
      }, [_v3, _v5, _v18, _v9, _v10]);
    return (0, _v2.useEffect)(() => {
      if (_v18 === _v15.PAGE_TYPES.ADMIN) {
        let _v0 = _v14?.view.state.selection;
        _v12.current?.setHTML(_v5), _v0 && _v14?.chain().setTextSelection({
          from: _v0.from,
          to: _v0.to
        }).run();
      }
    }, [_v5, _v18]), (0, _v2.useEffect)(() => {
      _v18 === _v15.PAGE_TYPES.REGISTRATION && _v12.current?.setHTML(_v6);
    }, [_v6, _v18]), (0, _v2.useEffect)(() => {
      if (_v18 === _v15.PAGE_TYPES.ADMIN) {
        let _v0 = _v14?.view.state.selection;
        _v13.current?.setHTML(_v3), _v0 && _v14?.chain().setTextSelection({
          from: _v0.from,
          to: _v0.to
        }).run();
      }
    }, [_v3, _v18]), (0, _v2.useEffect)(() => {
      _v18 === _v15.PAGE_TYPES.REGISTRATION && _v13.current?.setHTML(_v4);
    }, [_v4, _v18]), (0, _v1.jsx)(_v64, {
      previewMode: _v17,
      onMouseDownCapture: _v0 => {
        _v0.target == _v0.currentTarget && (_v11(_v15.SIDE_MENU_CONTENT.SETTINGS), _v15(null));
      },
      align: _v1,
      isMiniaturePreview: _v19,
      children: (0, _v1.jsxs)(_v63, {
        pt: "3xl",
        pb: (0, _v6.rem)(98),
        children: [_v0.isActive && (0, _v1.jsx)(_v66, {
          onClick: () => {
            _v18 === _v15.PAGE_TYPES.ADMIN && _v11(_v15.SIDE_MENU_CONTENT.LOGO);
          },
          showColorOnHover: _v18 === _v15.PAGE_TYPES.ADMIN,
          variant: "minimal",
          ...(_v0.isLinkActive && (_v0.customLink?.length ?? 0) > 0 && _v18 === _v15.PAGE_TYPES.REGISTRATION ? {
            href: _v0.customLink || "",
            target: "_blank"
          } : {}),
          ...
          ref: _v12,
          saveChanges: () => _v22(_v20),
          onBlur: () => _v22(_v20),
          maxCharacter: _v15.RTF_CONFIRMATION_TITLE_TEXT_LIMIT,
          overRideFontSize: !0,
          content: _v18 === _v15.PAGE_TYPES.ADMIN ? _v5 : _v6
        }), (0, _v1.jsx)(_v3.Box, {
          px: "xs",
          children: (0, _v1.jsx)(_v21, {})
        }), (0, _v1.jsx)(_v55, {
          ref: _v13,
          saveChanges: () => _v22(_v21),
          onBlur: () => _v22(_v21),
          overRideFontSize: !0,
          content: _v18 === _v15.PAGE_TYPES.ADMIN ? _v3 : _v4
        }), _v2 && _v8 && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsx)(_v20.StylableNonEditText, {
            fieldName: _v15.NON_EDIT_FIELDS.ADD_TO_CALENDAR,
            children: (0, _v1.jsx)(_v3.Box, {
              as: "span",
              mb: (0, _v6.rem)(6),
              px: (0, _v6.rem)(5),
              ...
              borderColor: "transparent",
              onClick: () => {
                _v11(_v15.SIDE_MENU_CONTENT.SETTINGS);
              },
              children: _v17.default.AddToCalendar
            })
          }), (0, _v1.jsxs)(_v4.Flex, {
            gap: (0, _v6.rem)(32),
            justifyContent: _v17 === _v15.PREVIEW_MODE.MOBILE ? "center" : "left" === _v1 ? "flex-start" : "right" === _v1 ? "flex-end" : "center",
            border: `${(0, _v6.rem)(2)} solid`,
            borderColor: "transparent",
            px: (0, _v6.rem)(5),
            children: [(0, _v1.jsx)(_v5.Link, {
              cursor: "pointer",
              href: _v16?.google ?? void 0,
              target: "_blank",
              variant: "minimal",
              children: (0, _v1.jsx)(_v13, {})
            }), (0, _v1.jsx)(_v5.Link, {
              cursor: "pointer",
              href: _v16?.outlook ?? void 0,
              target: "_blank",
              variant: "minimal",
              children: (0, _v1.jsx)(_v14, {})
            }), (0, _v1.jsx)(_v5.Link, {
              cursor: "pointer",
              href: _v16?.ical ?? void 0,
              target: "_blank",
              variant: "minimal",
  ...
  async function _v72({
    ...
    return (0, _v71.measureLatency)("postLeadCaptureResourceIdLogin", "POST", async () => {
      let _v0 = await fetch(`${_v0}/lead_capture/${_v3}/${_v4}/login?${(0, _v68.searchQueryString)(_v5)}&fields=${_v1.map(_v68.intoSnakeCase).join(",")}`, {
        ..._v6,
        method: "POST",
  ...
  function _v75() {
    let {
      ...
      [_v5, _v6] = (0, _v70.useInternalState)();
    return [(0, _v2.useCallback)(async _v0 => {
      _v6({
        type: "REQUEST"
      });
      try {
        let _v0 = await _v0(`/lead_capture/${_v0.where.resourceType}/${_v0.where.resourceId}/login${(0, _v70.serializeQuery)(_v0)}`, _v72({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v69.default.env.STORYBOOK && (0, _v70.assignMswData)(_v75, {
    endpoint: "/lead_capture/:resourceType/:resourceId/login",
    method: "POST"
  }), _v0.s(["usePostLeadCaptureResourceIdLogin", 0, _v75], 0);
  var _v76 = _v0.i(0),
    _v77 = _v0.i(0),
    _v78 = _v0.i(0);
  let _v79 = (0, _v2.createContext)({
      features: {
        [_v15.FEATURES.CONFIRMATION_VIEW]: !0
      },
      setFeatures: () => void 0
    }),
  ...
  _v0.s(["FeatureFlowProvider", 0, ({
    ...
    let _v2 = (0, _v2.useMemo)(() => ({
      [_v15.FEATURES.CONFIRMATION_VIEW]: _v1 !== _v7.ENTITY_TYPE.SHOWCASE
    }), [_v1]);
  ...
  var _v81 = _v0.i(0);
  let _v82 = () => {
    let _v0 = (0, _v16.useGlobalStore)(_v0 => _v0.entityId),
      _v1 = (0, _v16.useGlobalStore)(_v0 => _v0.entityType),
      _v2 = (0, _v16.useGlobalStore)(_v0 => _v0.setLeadCaptureProperties),
      _v3 = (0, _v16.useGlobalStore)(_v0 => _v0.authRoomPassword),
      _v4 = (0, _v16.useGlobalStore)(_v0 => _v0.pageReferrer),
      [_v5, _v6] = (0, _v81.useGetLeadCaptureResourceIdFormLazy)(),
      _v7 = (0, _v2.useCallback)(_v0 => {
        if (_v1) {
          let _v0 = (0, _v77.getEntityCookiePassword)(_v0, _v1) ?? _v3;
          _v5({
            where: {
              resourceId: _v0,
    ...
    return (0, _v2.useEffect)(() => {
      ...
      !_v0 && _v1 && (_v2(_v15.PREVIEW_HTML_KEYS.confirmationPageTitle, _v1?.confirmationPageTitle), _v2(_v15.PREVIEW_HTML_KEYS.confirmationPageDescription, _v1?.confirmationPageDescription));
    }, [_v1, _v6, _v2]), {
  ...
  let _v89 = ({
    ...
    let {
      ...
      _v5 = (0, _v16.useGlobalStore)(_v0 => _v0.setSideMenuType),
      _v6 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.primaryButtonStyle),
      _v7 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.secondaryButtonStyle),
      {
        loginButtonText: _v8,
        ...
        type: _v14,
        style: _v15
      } = _v0 === _v15.BUTTON_ROLES.PRIMARY ? _v6 : _v7,
      [_v16, _v17] = (0, _v2.useState)(),
      _v18 = (0, _v88.useIsBokeh)();
    (0, _v2.useEffect)(() => {
      _v0 === _v15.BUTTON_ROLES.PRIMARY ? _v17(_v6) : _v17(_v7);
    }, [_v0]);
    let _v19 = (0, _v46.useRtfStore)(_v0 => _v0.setButtonRole),
      _v20 = (0, _v46.useRtfStore)(_v0 => _v0.setButtonTextType),
      _v21 = (0, _v46.useRtfStore)(_v0 => _v0.buttonLivePreview),
    ...
    return (0, _v2.useEffect)(() => {
      ...
      _v15?.includes(_v15.RTF_BUTTON_TEXT_STYLE_VALUE.BOLD) && (_v0.fontWeight = 700), _v15?.includes(_v15.RTF_BUTTON_TEXT_STYLE_VALUE.ITALIC) && (_v0.fontStyle = "italic"), _v15?.includes(_v15.RTF_BUTTON_TEXT_STYLE_VALUE.UNDERLINE) && (_v0.textDecoration = "underline"), _v25(_v0);
      ...
      _v14 === _v15.RTF_BUTTON_TYPES_VALUES.SOLID ? (delete _v0.border, _v0.backgroundColor = _v1) : (_v0.backgroundColor = "transparent", _v0.border = `1px solid ${_v1}`), _v23(_v0);
    }, [_v14, _v13, _v21, _v0, _v1]), (0, _v1.jsxs)(_v3.Box, {
      width: "100%",
      height: (0, _v6.rem)(40),
      position: "relative",
      role: "group",
      children: [_v4 === _v15.PAGE_TYPES.ADMIN && (0, _v1.jsx)(_v3.Box, {
        as: "span",
        position: "absolute",
        right: (0, _v6.rem)(2),
        zIndex: 1,
        ...
        children: (0, _v1.jsx)(_v85.Button, {
          ...
          variant: "secondary",
          onClick: () => {
            _v5(_v15.SIDE_MENU_CONTENT.BUTTON_RTF_STYLING), _v20(_v1), _v19(_v0);
          },
          children: _v17.default.Edit
        })
      }), (0, _v1.jsx)(_v3.Box, {
        as: "button",
        height: (0, _v6.rem)(40),
        ...
        children: _v2 ? (0, _v1.jsx)(_v86.Spinner, {
          ...
          children: (() => {
            ...
            if (_v0) return _v0;
            switch (_v1) {
              case _v15.BUTTON_TEXT_TYPE.BACK:
                return _v10;
              case _v15.BUTTON_TEXT_TYPE.NEXT:
                return _v11;
              case _v15.BUTTON_TEXT_TYPE.REGISTER:
                return _v9;
              case _v15.BUTTON_TEXT_TYPE.LOGIN:
                return _v8;
            }
            return "";
          })() || ""
...
`,
  ...
  let _v100 = ({
      ...
      }, [_v0, _v1]), (0, _v1.jsx)(_v99.Tooltip, {
        isDisabled: !_v8 || _v3,
        label: _v0,
        closeOnScroll: !0,
        fontSize: _v5,
      ...
      return (0, _v2.useEffect)(() => {
        ...
        children: (0, _v1.jsxs)(_v93.LightMode, {
          children: [(0, _v1.jsx)(_v104, {
            ...
            onKeyDown: _v0 => {
              _v0.key === _v15.KEY_CODES.ENTER && _v6?.(_v11 || "");
            },
            maxLength: _v15.REGISTRATION_FORM_MAX_CHARACTERS,
            onChange: _v0 => {
              (0, _v83.hasAutoFilled)(_v0) && _v16(_v0.target.value), _v12(_v0.target.value);
            },
            size: "sm",
            value: _v11,
            "aria-required": _v2,
            ...
            children: (0, _v1.jsxs)(_v92.HStack, {
              ...
              children: [(0, _v1.jsx)(_v100, {
                text: (0, _v98.translateFieldName)(_v1, _v15),
  ...
  var _v104 = (0, _v90.default)(_v32.Input).withConfig({
    displayName: "Input___StyledBokehInput",
    componentId: "sc-50fe83b1-0"
  })(_v0 => ({
    "&:focus + label, &:not(:placeholder-shown) + label": _v0.$_css
  }));
  _v0.s(["Input", 0, _v101], 0), _v0.i(0);
  var _v105 = _v0.i(0);
  let _v106 = () => {
    let _v0 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.privacyPolicyVersion || 1),
      _v1 = (0, _v16.useGlobalStore)(_v0 => _v0.entityType),
      _v2 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.privacyPolicyUrl),
      _v3 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.hasActiveCrmExportConnection),
      _v4 = (0, _v2.useMemo)(() => {
        switch (_v1) {
          case _v7.ENTITY_TYPE.VIDEO:
          case _v7.ENTITY_TYPE.SHOWCASE:
            return _v15.PRIVACY_POLICY_VERSION.V2;
      ...
      _v5 = (0, _v2.useCallback)(_v0 => (0, _v1.jsx)(_v5.Link, {
        href: _v2 || _v15.VIMEO_PRIVACY_POLICY_LINK,
        target: "_blank",
        rel: "noreferrer",
        children: _v0
      }), [_v2]),
      _v6 = (0, _v2.useCallback)(_v0 => (0, _v1.jsx)(_v5.Link, {
        href: _v15.VIMEO_TERMS_OF_SERVICE_LINK,
        target: "_blank",
        rel: "noreferrer",
        children: _v0
      }), []),
      _v7 = (0, _v2.useMemo)(() => _v2 ? _v3 ? (0, _v76.translate)({
      ...
      _v8 = (0, _v2.useMemo)(() => _v2 ? _v3 ? (0, _v76.translate)({
      ...
      _v9 = (0, _v2.useMemo)(() => {
        switch (_v4) {
          case _v15.PRIVACY_POLICY_VERSION.V1:
          ...
          case _v15.PRIVACY_POLICY_VERSION.V2:
            if (_v2) return _v3 ? (0, _v76.translate)({
  ...
  _v0.s(["usePrivacyPolicy", 0, _v106], 0);
  var _v107 = _v0.i(0),
    _v108 = _v0.i(0);
  let _v109 = (0, _v2.forwardRef)(({
    label: _v0,
    error: _v1 = !1,
    onChange: _v2,
    validator: _v3,
    ...
    let _v6 = (0, _v2.useRef)(null),
      _v7 = (0, _v2.useMemo)(() => (0, _v108.makeId)(10), []),
      [_v8, _v9] = (0, _v2.useState)(!1),
      [_v10, _v11] = (0, _v2.useState)(""),
      _v12 = (0, _v2.useRef)(null),
      _v13 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.primaryButtonStyle.buttonColor) || "rgba(0, 173, 239)",
      _v14 = _v0 => {
        let _v1 = _v3?.(_v0 ?? !1);
      ...
      children: [(0, _v1.jsx)(_v107.Center, {
        ...
        children: (0, _v1.jsxs)("label", {
          ...
          children: [(0, _v1.jsx)("input", {
            ...
            ref: _v6,
            onKeyDown: _v0 => {
              _v0.key === _v15.KEY_CODES.ENTER && _v6.current?.click();
            },
            onFocus: () => _v9(!0),
            onBlur: () => _v9(!1),
            onChange: _v0 => {
  ...
  _v0.s(["Checkbox", 0, _v109], 0);
  let _v110 = (0, _v2.forwardRef)(({
    checked: _v0,
    onChange: _v1,
    error: _v2
  }, _v3) => {
    let _v4 = (0, _v2.useRef)(null),
      ...
      _v7 = 2 === _v6 ? _v15.PENDO_DATA_ID.PRIVACY_POLICY_V2 : _v15.PENDO_DATA_ID.PRIVACY_POLICY_V1;
    return (() => {
      let _v0 = (0, _v16.useGlobalStore)(_v0 => _v0.entityId),
        _v1 = (0, _v16.useGlobalStore)(_v0 => _v0.entityType),
        {
      ...
      (0, _v2.useEffect)(() => {
        _v5 || _v6 || _v2 === _v15.PAGE_TYPES.ADMIN && _v1 === _v7.ENTITY_TYPE.EVENT && _v3({
          where: {
            resourceId: _v0,
            resourceType: _v7.ENTITY_TO_PATH_MAP[_v1]
          },
        ...
        _v105.PendoClient.updateOptions({
          visitor: {
      ...
      children: [(0, _v1.jsx)(_v109, {
        ...
        label: (0, _v1.jsx)(_v20.StylableNonEditText, {
          fieldName: _v15.NON_EDIT_FIELDS.PRIVACY_POLICY,
          children: (0, _v1.jsx)(_v3.Box, {
            fontSize: "body-sm",
            fontWeight: "normal",
        ...
        topOffset: 28,
        ref: _v4,
        error: _v17.default.OptingInIsRequired
      })]
    });
  });
  async function _v111({
    ...
    return (0, _v71.measureLatency)("getLeadCaptureResourceIdRegistrants", "GET", async () => {
      let _v0 = await fetch(`${_v0}/lead_capture/${_v2}/${_v3}/registrants?${(0, _v68.searchQueryString)(_v4)}&fields=${_v1.map(_v68.intoSnakeCase).join(",")}`, {
        ..._v5,
        method: "GET"
      });
      if (!_v0.ok) throw new _v68.NetworkError("A network error occurred", _v0.status, _v0);
  ...
  async function _v112({
    ...
    return (0, _v71.measureLatency)("putLeadCaptureResourceIdRegistrants", "PUT", async () => {
      let _v0 = await fetch(`${_v0}/lead_capture/${_v3}/${_v4}/registrants?${(0, _v68.searchQueryString)(_v5)}&fields=${_v1.map(_v68.intoSnakeCase).join(",")}`, {
        ..._v6,
        method: "PUT",
        body: JSON.stringify((0, _v68.deepSnakeCase)(_v2))
      });
  ...
  _v0.s(["default", 0, _v110], 0), _v0.s(["LoginView", 0, ({
    setLeadUuid: _v0
  }) => {
    let {
        patchLeadCapture: _v1
      } = (0, _v11.usePatchLeadCapture)(),
      _v2 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.logo),
      _v3 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.alignment),
      _v4 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.loginPageTitle.tagsResolved),
      _v5 = (0, _v16.useGlobalStore)(_v0 => _v0.leadCapture.loginPageTitle.tagsUnresolved) || "",
      _v6 = (0, _v16.useGlobalStore)(_v0 => _v0.setEmailAddressCached),
      _v7 = (0, _v16.useGlobalStore)(_v0 => _v0.emailAddressCached),
      _v8 = (0, _v16.useGlobalStore)(_v0 => _v0.entityType),
      _v9 = (0, _v16.useGlobalStore)(_v0 => _v0.entityId),
      {
        currentPageType: _v10
      } = (0, _v2.useContext)(_v8.CurrentPageContext),
      _v11 = (0, _v2.useRef)(null),
      _v12 = (0, _v16.useGlobalStore)(_v0 => _v0.setSideMenuType),
      {
        previewMode: _v13
      } = (0, _v2.useContext)(_v9.PreviewContext),
      _v14 = (0, _v2.useRef)(null),
      ...
      _v17 = (0, _v16.useGlobalStore)(_v0 => _v0.setCurrentSelectedFieldIndex),
      {
        setPreviewType: _v18
      } = (0, _v2.useContext)(_v9.PreviewContext),
      [_v19, _v20] = _v75(),
      _v21 = (0, _v67.useToast)(),
      _v22 = (0, _v16.useGlobalStore)(_v0 => _v0.authRoomPassword),
      _v23 = (0, _v16.useGlobalStore)(_v0 => _v0.pageReferrer),
      {
      ...
      _v36 = _v80(_v15.FEATURES.CONFIRMATION_VIEW),
      _v37 = (0, _v2.useCallback)(() => {
        _v14.current?.getHTML() !== _v5 && _v10 === _v15.PAGE_TYPES.ADMIN && _v1("loginPageTitle.tagsUnresolved", _v14.current?.getHTML());
      }, [_v10, _v5, _v1]),
      _v38 = async () => {
        let _v0 = _v11.current?.validate();
        if ((_v30(!_v31), _v28.current?.shakeError(), _v0) && !1 != _v31) {
          let _v0;
          if (_v10 === _v15.PAGE_TYPES.ADMIN) return void _v18(_v15.PREVIEW_TYPE.CONFIRMATION);
          _v0 = (0, _v77.getEntityCookiePassword)(_v9, _v8) ?? _v22, _v34(void 0), _v19({
            select: [],
            query: {
              ...(_v0 && {
                password: _v0
      ...
      _v39 = () => {
        _v18(_v15.PREVIEW_TYPE.FORM), _v17(0);
      };
    return (0, _v2.useEffect)(() => {
      let {
        loading: _v0,
      ...
      if (!_v0 && _v1) {
        if (_v36) _v24((0, _v78.getLastUuidFromUri)(_v1.uri));else {
          ...
          (0, _v77.setCookie)(_v9, _v0), _v0?.(_v0);
        }
        _v27(!0);
      }
      ...
      _v26 && !_v25.loading && _v25.data && _v0 && _v1 && ((0, _v77.setCookie)(_v9, _v1), _v0 && _v0(_v1), _v18(_v15.PREVIEW_TYPE.CONFIRMATION), _v17(0));
    }, [_v25, _v18, _v0, _v26, _v20, _v9]), (0, _v2.useEffect)(() => {
      if (_v10 === _v15.PAGE_TYPES.ADMIN) {
      ...
      _v10 === _v15.PAGE_TYPES.REGISTRATION && _v14.current?.setHTML(_v4);
      ...
      _v1 && !_v0 && _v1?.res?.json().then(_v0 => {
        switch ((0, _v68.deepCamelCase)(_v0).errorCode) {
          case _v15.LOGIN_ERROR_CODES.NOT_REGISTERED:
            _v34(_v17.default.RegisterToSignIn);
            break;
          case _v15.LOGIN_ERROR_CODES.INVALID_EMAIL:
            _v34(_v17.default.InvalidEmailAddress);
            break;
          default:
            _v21({
              title: _v17.default.LoginError,
              status: "error"
            });
        }
      });
    }, [_v20.error, _v25.error]), (0, _v1.jsx)(_v64, {
      previewMode: _v13,
      onMouseDownCapture: _v0 => {
        _v0.target == _v0.currentTarget && (_v12(_v15.SIDE_MENU_CONTENT.SETTINGS), _v16(null));
      },
      align: _v3,
      isMiniaturePreview: _v35,
      children: (0, _v1.jsxs)(_v63, {
        pt: "3xl",
        pb: (0, _v6.rem)(98),
        maxWidth: _v15.PREVIEW_FORM_FIELDS_WIDTH + 8,
        children: [_v2.isActive && (0, _v1.jsx)(_v66, {
          showColorOnHover: _v10 === _v15.PAGE_TYPES.ADMIN,
          variant: "minimal",
          ...(_v2.isLinkActive && (_v2.customLink?.length ?? 0) > 0 && _v10 === _v15.PAGE_TYPES.REGISTRATION ? {
            href: _v2.customLink || "",
            target: "_blank"
          } : {}),
          onClick: () => {
            _v10 === _v15.PAGE_TYPES.ADMIN && _v12(_v15.SIDE_MENU_CONTENT.LOGO);
          },
          children: (0, _v1.jsx)(_v65, {
            src: _v2.url
          })
          ...
          children: [(0, _v1.jsx)(_v55, {
            ...
            saveChanges: _v37,
            onBlur: _v37,
            content: _v10 === _v15.PAGE_TYPES.ADMIN ? _v5 : _v4,
            maxCharacter: _v15.RTF_STYLABLE_TEXT_DEFAULT_LIMIT,
            overRideFontSize: !0
          }), (0, _v1.jsx)(_v21, {}), (0, _v1.jsx)(_v101, {
            autoFocus: !0,
            validator: (0, _v83.getValidator)(_v15.FORM_FIELD_NAME_VALUES.EMAIL),
            ref: _v11,
            onBlur: _v0 => {
              _v6(_v0);
            },
            value: _v7,
            placeholder: _v15.FORM_FIELD_NAME_VALUES.EMAIL,
            ...
            children: (0, _v1.jsx)(_v89, {
              onClick: _v38,
              role: _v15.BUTTON_ROLES.PRIMARY,
              textType: _v15.BUTTON_TEXT_TYPE.LOGIN,
            ...
            mt: (0, _v6.rem)(10),
            children: (0, _v1.jsx)(_v20.StylableNonEditText, {
              fieldName: _v15.NON_EDIT_FIELDS.DO_NOT_HAVE_ACCOUNT,
              children: (0, _v1.jsx)(_v57.Text, {
                variant: "body-md",
                children: (0, _v76.translate)({
                  ...
                  replacements: {
                    LINK: _v0 => (0, _v1.jsx)(_v3.Box, {
                      ...
                      cursor: "pointer",
                      tabIndex: 0,
                      onKeyDown: _v0 => _v0.key === _v15.KEY_CODES.ENTER && _v18(_v15.PREVIEW_TYPE.FORM),
                      onClick: _v39,
                      children: _v0
                    })
                  },
  ...
  function _v115() {
    let {
      ...
      [_v4, _v5] = (0, _v70.useInternalState)();
    return [(0, _v2.useCallback)(async _v0 => {
      _v5({
        type: "REQUEST"
      });
  ...
  "true" === _v69.default.env.STORYBOOK && (0, _v70.assignMswData)(function (_v0, _v1) {
    ...
    return (0, _v113.default)(_v2 ? `/lead_capture/${_v2.where.resourceType}/${_v2.where.resourceId}/registrants${(0, _v70.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v111({
      ..._v2,
      headers: {
        ..._v2.headers,
        "Content-Type": "application/json",
    ...
    method: "GET"
  }), "true" === _v69.default.env.STORYBOOK && (0, _v70.assignMswData)(function () {
    let {
        mutate: _v0
      } = (0, _v73.useSWRConfig)(),
      {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/lead_capture/${_v0.where.resourceType}/${_v0.where.resourceId}/registrants${(0, _v70.serializeQuery)(_v0)}`, _v111({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    return (0, _v114.default)((_v0, _v1) => {
    ...
    endpoint: "/lead_capture/:resourceType/:resourceId/registrants",
    method: "GET"
  }), "true" === _v69.default.env.STORYBOOK && (0, _v70.assignMswData)(_v115, {
    endpoint: "/lead_capture/:resourceType/:resourceId/registrants",
    method: "PUT"
  }), _v0.s(["usePutLeadCaptureResourceIdRegistrants", 0, _v115], 0);
}