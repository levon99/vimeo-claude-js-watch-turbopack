{
  ...
  var _v1 = _v0.i(0),
    ...
    _v5 = _v0.i(0),
    _v6 = _v0.i(0);
  let _v7 = () => window.location.assign("/upgrade");
  _v0.s(["navigateToUpgrade", 0, _v7, "useReplaceWithModal", 0, function (_v0, _v1, _v2, _v3 = _v7, _v4) {
    ...
    let {
      ...
      return {
        triggerReplace: (0, _v2.useCallback)(() => _v4.current?.click(), []),
        replaceInput: (0, _v1.jsx)("input", {
          ...
          onChange: _v0 => {
            ...
            _v1 ? _v1(_v1[0], () => _v3(_v1, _v2)) : _v3(_v1, _v2);
          }
        })
      };
    }(_v0, _v1 ? (_v0, _v1) => _v6({
    ...
    return {
      triggerReplace: _v7,
      replaceInput: _v8,
      replaceModal: _v5 ? (0, _v1.jsx)(_v6.ReplaceModal, {
        onCancel: () => _v6(null),
        onConfirm: () => {
