{
  ...
  }), "titleCase", 0, _v0 => _v0.toLowerCase().charAt(0).toUpperCase() + _v0.toLowerCase().slice(1).toLowerCase(), "validateGroupsFilterParam", 0, _v0 => _v0 ? _v0.split(",").map(_v0 => _v0.trim()).filter(_v0 => /^\d+$/.test(_v0)) : [], "validateRolesFilterParam", 0, function (_v0, _v1) {
    if (!_v0) return;
