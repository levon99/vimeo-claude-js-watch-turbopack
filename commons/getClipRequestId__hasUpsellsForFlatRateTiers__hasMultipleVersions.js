{
  ...
  _v0.s(["FileUpload", 0, _v38], 0), _v0.s(["VersionList", 0, ({
    videoId: _v0,
    clipHash: _v1,
    ...
    let [_v21, _v22] = (0, _v3.useState)(!1),
      ...
      {
        addNewVersion: _v25,
        storeVersionList: _v26
      } = (0, _v19.useVersionsStore)(_v0 => ({
        addNewVersion: _v0.addNewVersion,
        storeVersionList: _v0.versionList
      })),
      _v27 = (0, _v31.videoIdFromUri)(_v26.at(0)?.uri),
      _v28 = !_v23 || _v11 < 2 || _v26.length > 0 && _v27 === _v0,
      {
        versions: _v29,
        canLoadMore: _v30,
        isLoading: _v31,
        isLoadingMoreVersion: _v32,
        loadMoreVersions: _v33
      } = (0, _v26.useGetVersionsHook)(_v0, _v28, _v14),
      _v34 = (0, _v20.useViewer)(),
      [_v35] = (0, _v27.useInfiniteScrollVersion)(_v30 || _v26.length < _v11, _v33),
      [_v36, _v37] = (0, _v3.useState)(null),
      [_v38, _v39] = (0, _v3.useState)(!1),
      {
        userQuota: _v40
      } = (0, _v28.useReplace)(_v0, _v14),
      {
        upload: _v41,
        uploads: _v42
      } = (0, _v18.useUploader)(),
      _v43 = (0, _v2.useRouter)(),
      _v44 = (0, _v3.useRef)(null),
      _v45 = (0, _v3.useRef)(null),
      _v46 = (0, _v3.useRef)(null),
      _v47 = (0, _v23.getVersionNumber)(_v9 || _v30.DEFAULT_VERSION_NUMBER),
      _v48 = _v29?.reduce((_v0, _v1) => Math.max(_v0, _v1.sequenceNumber?.toString().length ?? 0), 1) ?? 1,
      _v49 = _v30.MIN_WIDTH_FOR_SEQUENCE_NUMBER + _v48 * _v30.SEQUENCE_NUMBER_WIDTH_FOR_EACH_DIGIT,
      _v50 = _v14 ? !!_v15 : !_v4,
      _v51 = () => {
        _v44.current && (_v22(!1), _v44.current.click(), _v5 && (0, _v29.bpStartUploadVersion)({
          videoId: _v0,
          viewer: _v34,
          currentVersion: _v47,
          analyticsProps: _v5
      ...
      _v55 = (0, _v3.useCallback)(() => {
        0 != _v29.length && (0, _v14.getVideo)({
          headers: {
            Accept: _v30.API_ACCEPT_HEADER,
            Authorization: _v54 ? `jwt ${_v54}` : ""
          },
          baseUrl: _v53,
          where: {
            videoId: _v0
          ...
          (0, _v31.idFromUri)(_v29.at(0)?.uri) < _v1 && (0, _v15.getVideoVersion)({
            headers: {
              Accept: _v30.API_ACCEPT_HEADER,
              Authorization: _v54 ? `jwt ${_v54}` : ""
            },
      ...
      }, [_v25, _v53, _v54, _v29, _v0]);
    return ((0, _v3.useEffect)(() => {
      _v4 || _v6 ? _v4 && _v52.current && (_v52.current = !1, _v55()) : _v52.current = !0;
    }, [_v4, _v55, _v6]), (0, _v10.useOutsideClick)({
      enabled: _v21,
      ref: _v46,
      handler: _v0 => {
        _v45.current && _v0.target && (_v45.current == _v0.target || _v45.current?.contains(_v0.target)) || _v22(!1);
      }
    }), (0, _v3.useEffect)(() => {
      let _v0 = _v42.find(_v23.isUploadActiveOrComplete);
      _v0?.clipId && _v38 && (_v3 ? _v43.replace({
        pathname: `/manage/videos/${_v0?.clipId}`
      }) : (_v12?.(), _v39(!1), _v37(null)));
    }, [_v43, _v42, _v38, _v39, _v3, _v12]), (0, _v3.useEffect)(() => {
      _v39(!1), _v37(null);
    }, []), _v2) ? _v31 ? null : (0, _v1.jsx)(_v11.Text, {
      ...
      children: [(0, _v1.jsxs)(_v6.Menu, {
        ...
        children: [(0, _v1.jsx)(_v7.MenuButton, {
          ...
          children: (0, _v1.jsx)(_v1.Fragment, {
            children: _v11 < 2 ? (0, _v1.jsx)(_v22.EmptyVersionList, {
              isDisabled: !_v4,
              openFileUpload: _v51
            }) : (0, _v1.jsxs)(_v4.Box, {
              width: "440px",
              ...
              children: [(0, _v1.jsx)(_v4.Box, {
                ...
                p: "sm",
                pb: "0",
                children: (_v31 || _v6) && !_v32 ? (0, _v1.jsx)(_v25.VersionsSkeleton, {
                  width: `${_v49}px`
                }) : (0, _v1.jsxs)(_v9.MenuOptionGroup, {
                  defaultValue: _v47,
                  children: [_v50 && (0, _v1.jsx)(_v25.VersionSkeleton, {
                    width: `${_v49}px`
                  }), _v29?.map((_v0, _v1) => {
                    let _v2 = _v1 === _v29?.length - 1;
                    return _v0.isDeleted ? (0, _v1.jsx)(_v21.DeletedVersion, {
                      index: _v1,
                      isLastElement: _v2,
                      ...
                      sequenceNumberWidth: _v49
                    }, `${_v0.uri}-deleted`) : (0, _v1.jsx)(_v24.VersionListItem, {
                      uri: _v0.uri,
                      videoId: _v0,
                      clipHash: _v1,
                      reviewId: _v14,
        ...
        attemptReplace: (_v0, _v1) => {
          _v1 ? (_v37(_v0), _v7?.(!1)) : (_v7?.(!0), _v8?.(!0));
        },
        ref: _v44,
        videoId: _v0,
        quota: _v40,
        clipHash: _v1
      }, `file-upload-${_v36?.[0].name}-new-version`), (0, _v1.jsx)(_v32.ConfirmUploadModal, {
        onCancel: () => {
          _v38 || _v37(null);
        },
        onConfirm: () => void (_v36 && (_v39(!0), _v41(_v36, {
