{
  ...
  let _v3 = (0, _v1.createSlice)({
    ...
    _v12 = _v3.reducer;
  _v0.s(["addUploadAction", 0, _v4, "default", 0, _v12, "hasPendingUploadsSelector", 0, _v0 => _v0.uploadQueue.uploads.some(_v0 => _v0.status.status === _v2.UploadMediaStatus.QUEUED || _v0.status.status === _v2.UploadMediaStatus.PROGRESS || _v0.status.status === _v2.UploadMediaStatus.FETCHING_SOURCE), "isUploadsInProgressSelector", 0, _v0 => _v0.uploadQueue.uploads.some(_v0 => _v0.status.status === _v2.UploadMediaStatus.PROGRESS), "removeUploadAction", 0, _v11, "updateUploadHashAction", 0, _v10, "updateUploadIdAction", 0, _v9, "updateUploadProgressAction", 0, _v6, "updateUploadSourceAction", 0, _v8, "updateUploadStatusAction", 0, _v7, "uploadsSelector", 0, _v0 => _v0.uploadQueue.uploads]);
}