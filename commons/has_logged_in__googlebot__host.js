{
  ...
  var _v15 = _v0.i(0);
  let _v16 = new Set(Object.values(_v13)),
    _v17 = _v0 => _v0 && _v16.has(_v0) ? _v0 : "other",
    _v18 = async () => await _v3.default.getConfig(),
    _v19 = async _v0 => {
    ...
    _v21 = ["cookie", "crossroads-jwt", "crossroads-language", "user-agent"];
  ...
  async function _v24(_v0) {
    ...
    try {
      let _v0 = await fetch(`https://${_v2}/_next/viewer${_v23(_v0)}`, {
        headers: _v3
      });
  ...
  async function _v25(_v0) {
    ...
    try {
      let _v0 = await fetch(`https://${_v2}/_next/player_assets${_v23(_v0)}`, {
        headers: _v3
      });
      if (!_v0.ok) return null;
      let _v1 = await _v0.json();
  ...
  _v0.s(["withPageSetup", 0, function (_v0, _v1) {
    ...
    return "function" == typeof _v0 ? (_v2 = _v0, _v3 = _v1) : (_v3 = _v0, _v2 = () => ({
      ...
      try {
        let _v0,
          _v1 = (_v0 = _v0.req.headers["crossroads-language"] ?? _v0.locale ?? "en", (0, _v2.setLocale)(_v0), (_v0 => {
            try {
              var _v1, _v2, _v3;
              let _v0,
              ...
              _v15.metrics.counter("vimeo_nextjs_lang_parity_total", {
        ...
        if (!_v3?.requireLogin && !_v3?.capability && !_v3?.staffOnly) {
          ...
          let _v0 = _v3?.inlineViewer === "all" || _v3?.inlineViewer && _v4.jwt && !_v4(_v4.req) ? _v24(_v4) : null,
            ...
            _v3 = _v3?.inlineMagistoResources ? _v28(_v4) : null,
        ...
        if (_v3?.staffOnly || _v3?.capability) try {
          ...
          if (_v3?.capability && _v0.push(_v3.capability), _v6 = await (0, _v11.fetchAndFormatCapabilties)({
            jwt: _v4.jwt,
            capabilities: _v0,
            apiUrl: _v4.baseUrl,
            headers: _v4.headers
        ...
        let _v7 = _v3?.inlineViewer ? _v24(_v4) : null,
          ...
          _v10 = _v3?.inlineMagistoResources ? _v28(_v4) : null,
