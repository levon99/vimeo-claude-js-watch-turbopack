{
  ...
  function _v12(_v0, _v1) {
    if (void 0 === _v1) return _v0;
    let [_v2, _v3 = ""] = _v1.split("?"),
      _v4 = new URLSearchParams(_v3),
      _v5 = new URLSearchParams();
    if (_v4.forEach((_v0, _v1) => {
      "t_lp" !== _v1 && _v9.ATTRIBUTION_PARAM_NAMES.includes(_v1) && "" !== _v0 && _v5.set(_v1, _v0);
    }), 0 == [..._v5].length) return _v0;
    _v5.set("t_lp", `${_v2}?${_v5.toString()}`);
    let _v6 = _v5.toString(),
      _v7 = _v0.includes("?") ? "&" : "?",
      _v8 = `${_v0}${_v7}${_v6}`;
    return _v8.length > 0 ? _v0 : _v8;
  }
  let _v13 = new Set(Object.values(_v7.SUPPORTED_LANGS)),
    _v14 = _v0 => _v0 && _v13.has(_v0) ? _v0 : "other",
    _v15 = async () => await _v3.default.getConfig(),
    _v16 = async _v0 => {
      ...
      return Object.entries({
        "x-forwarded-for": (_v0 => {
          ...
          try {
            ...
            _v0 = _v5 ? 0 === _v1.length ? "no_xff" : _v1[_v1.length - 1] === _v5 ? "match" : "divergence" : "no_source", _v10.metrics.counter("vimeo_nextjs_client_ip_parity_total", {
              parity: _v0,
    ...
    _v18 = ["cookie", "crossroads-jwt", "crossroads-language", "user-agent"];
  ...
  async function _v21(_v0) {
    ...
    try {
      let _v0 = await fetch(`https://${_v2}/_next/viewer${_v20(_v0)}`, {
        headers: _v3
      });
  ...
  async function _v22(_v0) {
    ...
    try {
      let _v0 = await fetch(`https://${_v2}/_next/player_assets${_v20(_v0)}`, {
        headers: _v3
      });
      if (!_v0.ok) return null;
      let _v1 = await _v0.json();
  ...
  _v0.s(["withPageSetup", 0, function (_v0, _v1) {
    ...
    return "function" == typeof _v0 ? (_v2 = _v0, _v3 = _v1) : (_v3 = _v0, _v2 = () => ({
      ...
      let _v1 = _v1.default.hrtime.bigint(),
        ...
        _v8 = null,
        _v9 = (_v0, _v1, _v2) => {
          _v8 = _v0, _v10.metrics.histogram("vimeo_nextjs_ssr_setup_duration_seconds", {
            route: _v2,
            result: _v1
          }, _v2), _v10.metrics.histogram("vimeo_nextjs_http_request_duration_seconds", {
            route: _v2,
            method: _v3,
            status_code: _v0
          }, _v4());
      ...
      _v0.res?.once?.("finish", () => {
        ...
        _v0.startsWith("5") && _v0 !== _v8 && _v10.metrics.counter("vimeo_nextjs_http_request_errors_total", {
          route: _v2,
          method: _v3,
          status_code: _v0
        });
      ...
      let _v10 = _v0 => {
        ...
        _v11 = (_v0, _v1) => {
          let _v2 = _v1.split("?")[0],
            _v3 = _v6 ? 308 : 302;
          return _v10.metrics.counter("vimeo_nextjs_ssr_auth_redirect_total", {
            reason: _v0,
            destination: "/join" === _v2 ? "join" : "/log_in" === _v2 ? "log_in" : "custom"
          }), _v7(), _v9(String(_v3), "auth_redirect", _v4()), {
            redirect: {
              destination: _v1,
              statusCode: _v3
            }
      ...
      try {
        let _v0 = (_v0 => {
            ...
            try {
              ...
              _v10.metrics.counter("vimeo_nextjs_lang_parity_total", {
          ...
          _v2 = await _v15(),
          _v3 = await _v17(_v0, _v2),
          _v4 = _v0 => {
            let _v1 = _v3?.redirect;
            if ("function" != typeof _v1) return _v1 ?? _v12(_v0, _v0.resolvedUrl);
            try {
              return _v1(_v3) || _v12(_v0, _v0.resolvedUrl);
            } catch (_v0) {
              return console.warn("withPageSetup: redirect function threw; using fallback", _v0), _v12(_v0, _v0.resolvedUrl);
            }
          };
        if (!_v3?.requireLogin && !_v3?.capability && !_v3?.staffOnly) {
          _v12 = _v4();
          let _v0 = _v3?.inlineViewer === "all" || _v3?.inlineViewer && _v3.jwt && !(0, _v4.isLoggedOut)(_v3.req) ? _v21(_v3) : null,
            _v1 = _v3?.inlinePlayerAssets ? _v22(_v3) : null,
            _v2 = _v3?.inlineCreatePreloads && (0, _v4.isLoggedOut)(_v3.req) ? _v24(_v3) : null,
            _v3 = _v3?.inlineMagistoResources ? _v25(_v3) : null,
            _v4 = _v3?.inlineModbox && !(0, _v4.isLoggedOut)(_v3.req) ? _v23(_v3) : null,
            _v5 = await _v2(_v3),
            _v6 = _v0.res?.getHeader?.("Cache-Control");
          return "string" == typeof _v6 && _v6.includes("no-store") && !_v0.res?.getHeader?.(_v11.CDN_CC_MANAGED) && _v0.res.setHeader("CDN-Cache-Control", "no-store"), _v9(_v10(_v5), "success", _v12), _v4(_v5, {
            locale: _v0,
        ...
        let _v6 = _v3?.inlineViewer ? _v21(_v3) : null,
          _v7 = _v3?.inlinePlayerAssets ? _v22(_v3) : null,
          _v8 = _v3?.inlineCreatePreloads && (0, _v4.isLoggedOut)(_v3.req) ? _v24(_v3) : null,
          _v9 = _v3?.inlineMagistoResources ? _v25(_v3) : null,
          _v10 = _v3?.inlineModbox ? _v23(_v3) : null,
          _v11 = await _v2(_v3),
          _v12 = _v0.res?.getHeader?.("Cache-Control");
        return "string" == typeof _v12 && _v12.includes("no-store") && !_v0.res?.getHeader?.(_v11.CDN_CC_MANAGED) && _v0.res.setHeader("CDN-Cache-Control", "no-store"), _v9(_v10(_v11), "success", _v12), _v4(_v11, {
          locale: _v0,
          isChinaRestricted: _v1
        ...
        _v0.res?.headersSent || _v0.res?.removeHeader?.(_v11.CDN_CC_MANAGED), _v10.metrics.gaugeDec("vimeo_nextjs_http_requests_active");
      }
    };
  }]);
}