{
  ...
  _v0.s(["BackOnYourOwnModal", 0, ({
    ...
    let [_v4, _v5] = (0, _v2.useState)("merge"),
      ...
      {
        trackBackOnYourOwnDisplayed: _v10,
        trackBackOnYourOwnConfirmed: _v11,
        trackBackOnYourOwnHelpClicked: _v12
      } = (0, _v19.useContentSpaceTracking)(),
      _v13 = (0, _v2.useRef)(!1);
    (0, _v20.usePicoEffect)(() => {
      _v0 && _v10({
        trigger: "last_member_removed"
      });
    }, [_v0]);
    let _v14 = () => {
      ...
      _v15 = async () => {
        if (!_v13.current) {
          if (_v13.current = !0, _v11({
            choice: _v4
          }), "keep" === _v4) return void _v14();
          _v7(!0), _v9("");
          try {
            await (0, _v17.dropTeam)(_v2), _v3?.(), _v14();
          } catch {
            _v9(_v17.defaultError), _v13.current = !1;
          } finally {
            _v7(!1);
          }
        }
                  ...
                  children: [(0, _v1.jsxs)(_v7.HStack, {
                    ...
                    children: (0, _v1.jsxs)(_v12.Paragraph, {
                      ...
                      children: [(0, _v18.translate)({
                        ...
                        href: _v21.LIBRARY_MERGE_HELP_URL,
                        target: "_blank",
