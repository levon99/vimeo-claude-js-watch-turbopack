{
  ...
  let _v18 = "v_c_c",
    ...
    _v22 = _v3.default.createContext({
      ...
      showUpsellIfRequired: () => Promise.reject(Error("upsell context not initialized")),
      ...
      _v33 = (0, _v3.useCallback)(({
        ...
        switch (_v1 !== _v5.Context.CREATE_QUOTA_NOTIFICATION && (_v4 = void 0), _v1) {
          ...
          case _v5.Context.CUSTOMIZE:
            return _v30(_v2, _v4, _v5, _v6, _v7, _v8, _v9, _v0, !0, _v9.TEMPLATE_FREEMIUM_IMPRESSION_KEY).then(_v0 => (_v0.didShowUpsell && _v16(_v9.TEMPLATE_FREEMIUM_IMPRESSION_KEY), _v26(_v0, _v5, _v6, _v7, _v8, _v9))).catch(_v0 => (_v16(_v9.TEMPLATE_FREEMIUM_IMPRESSION_KEY), Promise.reject(_v0)));
          ...
          default:
            return Promise.reject(Error(`unknown upsell context: ${_v1}`));
        }
      }, [!1, _v27, _v26, _v30, _v12, _v28, _v31, _v6, _v23, _v32]),
      _v34 = (0, _v3.useCallback)(() => (_v18(_v0 => ({
        ..._v0,
        showUpsell: !1
      })), _v19.current?.reject("upsell dismissed")), []),
