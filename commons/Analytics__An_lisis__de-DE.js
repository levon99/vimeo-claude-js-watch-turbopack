{
  ...
  let _v40 = (0, _v14.rem)(212),
    ...
    _v85 = (0, _v19.translate)({
      ...
      dictionary: {
        es: {
          singular: "Enlace de revisión"
        },
        "de-DE": {
          singular: "Review-Link"
        },
        "fr-FR": {
          singular: "Lien de revue"
        },
        "ja-JP": {
          singular: "レビューリンク"
        },
    ...
    _v88 = (0, _v19.translate)({
      ...
      dictionary: {
        es: {
          singular: "Crear nuevo enlace de revisión"
        },
        "de-DE": {
          singular: "Neuen Review-Link erstellen"
        },
        "fr-FR": {
          singular: "Créer un nouveau lien de révision"
        },
        "ja-JP": {
          singular: "新しいレビューリンクを作成"
        },
        "ko-KR": {
          singular: "새 리뷰 링크 생성"
        },
        "pt-BR": {
          singular: "Criar novo link de revisão"
        },
        "zh-CN": {
          singular: "创建新的评审链接"
        }
    ...
    _v90 = (0, _v19.translate)({
      ...
      dictionary: {
        es: {
          singular: "Editar archivo"
        },
        "de-DE": {
          singular: "Datei bearbeiten"
        },
        "fr-FR": {
          singular: "Modifier le fichier"
        },
        "ja-JP": {
          singular: "ファイルを編集"
        },
  ...
  let _v101 = ({
    ...
    if (_v7) {
      ...
      return (0, _v1.jsx)(_v15.NestedMenuItem, {
        disabled: _v4,
        value: _v2,
        onClick: _v0 => {
    ...
    return (0, _v1.jsx)(_v96.MenuItem, {
      onClick: _v0 => {
        _v6?.(), _v3?.(), _v5 || _v0.preventDefault(), _v0.stopPropagation();
      },
      as: _v5 ? "a" : "button",
  ...
  _v0.s(["Action", 0, _v0 => {
    ...
    return _v1 ? (0, _v1.jsx)(_v99.Tooltip, {
      placement: "left",
      label: _v1,
    ...
    return (0, _v1.jsxs)(_v15.NestedMenu, {
      positioning: {
        placement: "right-start"
      },
      children: [(0, _v1.jsx)(_v15.NestedMenuTriggerItem, {
        children: _v4 ? (0, _v1.jsxs)(_v97.Flex, {
          align: "center",
          gap: "sm",
          justify: "space-between",
          width: "100%",
