{
  ...
  let _v46 = () => {
    ...
    _v47 = {
      "en-us": ["Player customization", "Restore a video", "Privacy and sharing", "Embed a video", "Uploading and processing"],
      de: ["Player-Anpassung", "Video wiederherstellen", "Datenschutz und Freigabe", "Ein Video einbetten", "Hochladen und Verarbeitung"],
      es: ["Personalización del reproductor", "Restaurar un video", "Privacidad y uso compartido", "Insertar un video", "Carga y procesamiento"],
      fr: ["Personnalisation du lecteur", "Restaurer une vidéo", "Confidentialité et partage", "Intégrer une vidéo", "Téléversement et traitement"],
      ja: ["プレーヤーのカスタマイズ", "動画を復元する", "プライバシーと共有", "動画を埋め込む", "アップロードと処理"],
      ko: ["플레이어 사용자 지정", "동영상 복원", "개인정보 보호 및 공유", "동영상 삽입", "업로드 및 처리"],
      "pt-br": ["Personalização do player", "Restaurar um vídeo", "Privacidade e compartilhamento", "Incorporar um vídeo", "Upload e processamento"],
      "zh-cn": ["播放器自定义", "恢复视频", "隐私和共享", "嵌入视频", "上传和处理"]
    },
    _v48 = () => {
      let {
          handleSearch: _v0,
