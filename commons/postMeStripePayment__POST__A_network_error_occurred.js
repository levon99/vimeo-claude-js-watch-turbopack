{
  ...
  async function _v5({
    ...
    return (0, _v3.measureLatency)("postMeStripePayment", "POST", async () => {
  ...
  function _v9() {
    ...
    return [(0, _v6.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me/stripe/payment${(0, _v2.serializeQuery)(_v0)}`, _v5({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v2.assignMswData)(_v9, {
    ...
    method: "POST"
  }), _v0.s(["usePostMeStripePayment", 0, _v9], 0);
}