{
  ...
  let _v37 = "unselected",
    _v38 = ({
      ...
      children: [(0, _v1.jsx)(_v4.ModalOverlay, {}), (0, _v1.jsxs)(_v5.ModalContent, {
        ...
        children: [(0, _v1.jsx)(_v7.ModalHeader, {
          children: _v0
        }), (0, _v1.jsx)(_v6.ModalCloseButton, {}), (0, _v1.jsxs)(_v8.ModalBody, {
          flex: "1 1 0%",
          overflow: "auto",
          children: [(0, _v1.jsx)(_v9.Text, {
            variant: "body-xl",
            ...
            mb: "200",
            children: _v1
          }), (0, _v1.jsx)(_v36.RadioGroup, {
            onChange: _v6,
            value: _v5,
            children: (0, _v1.jsx)(_v34.Stack, {
              spacing: 200,
              children: _v2.map(_v0 => (0, _v1.jsxs)(_v16.Box, {
  ...
  _v0.s(["REASON_UNSELECTED", 0, _v37, "ReportModal", 0, _v38], 0);
  let _v40 = [{
  ...
  async function _v45({
    ...
    return (0, _v43.measureLatency)("postVideoReport", "POST", async () => {
  ...
  function _v48() {
    ...
    return [(0, _v28.useCallback)(async _v0 => {
      _v6({
        type: "REQUEST"
      });
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/report${(0, _v42.serializeQuery)(_v0)}`, _v45({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v41.default.env.STORYBOOK && (0, _v42.assignMswData)(_v48, {
    ...
    let [_v4, _v5] = (0, _v28.useState)(_v37),
      _v6 = (0, _v20.translate)({
      ...
      _v8 = (0, _v29.useToast)(),
      {
        ...
        clipId: _v0,
        onFailure: (0, _v28.useCallback)(() => _v8({
          title: _v7,
          status: "error",
          icon: (0, _v1.jsx)(_v31.CircleExclamationFilled, {})
        }), [_v7, _v8]),
        onSuccess: (0, _v28.useCallback)(() => _v8({
          title: _v6,
          status: "success",
          icon: (0, _v1.jsx)(_v30.CircleCheckFilled, {})
        }), [_v6, _v8])
      }),
      _v11 = () => {
        _v5(_v37), _v2();
