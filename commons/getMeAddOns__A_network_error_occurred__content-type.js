{
  ...
  async function _v4({
    ...
    return (0, _v2.measureLatency)("getMeAddOns", "GET", async () => {
      let _v0 = await fetch(`${_v0}/me/add_ons?${(0, _v3.searchQueryString)(_v2)}&fields=${_v1.map(_v3.intoSnakeCase).join(",")}`, {
        ..._v3,
        method: "GET"
      });
  ...
  function _v10(_v0, _v1) {
    ...
    return (0, _v5.default)(_v2 ? `/me/add_ons${(0, _v7.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v4({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v7.assignMswData)(_v10, {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me/add_ons${(0, _v7.serializeQuery)(_v0)}`, _v4({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/me/add_ons",
    method: "GET"
  }), _v0.s(["useGetMeAddOns", 0, _v10], 0), _v0.s(["findBundleAddOn", 0, (_v0, _v1) => {
    let _v2 = (({
      bundleType: _v0,
      priceTier: _v1,
      periodicity: _v2
