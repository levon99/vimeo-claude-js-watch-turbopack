{
        ...
        if (!_v8.current) {
          ...
          try {
            ...
            if (_v0 instanceof _v6.NetworkError) try {
              _v1 = (_v0 => {
                if ((0, _v10.hasInvalidNameParameter)(_v0)) return "invalid_name";
  ...
  var _v14 = _v0.i(0),
    ...
    _v20 = _v0.i(0),
    _v21 = _v0.i(0);
  let _v22 = (_v0, _v1) => !!_v0 && !!_v1.user?.uri && _v0 === _v1.user.uri;
  _v0.s(["isCopyableVideoContent", 0, _v0 => "stock" !== _v0.type && "live" !== _v0.type && _v0.privacy?.view !== "ptv" && _v0.privacy?.view !== "ptvhide", "useCopyVideoFlow", 0, ({
    ...
    let _v1 = (0, _v14.useNotification)(),
      _v2 = (0, _v5.useViewer)(),
      _v3 = (0, _v15.usePageName)(),
      {
        open: _v4,
        close: _v5
      ...
      _v15 = (0, _v2.useCallback)(_v0 => {
        (0, _v21.isPerSeatSelfServeTier)(_v2?.user?.account) ? _v14(_v0) : window.location.assign((0, _v4.buildUpgradePlanUrl)({
          paywallTrigger: `${_v3}_copy_video_quota_limit_button`,
          paywallLocation: _v3,
          paywallFeature: _v0
        }));
      }, [_v14, _v3, _v2?.user?.account]),
      ...
      _v17 = (0, _v2.useCallback)(_v0 => {
        ...
        let _v2 = `/manage/videos/${(0, _v11.idFromUri)(_v0.uri)}`;
        _v1({
          content: (0, _v3.translate)({
            singular: 'Created "{COPIED_VIDEO_NAME}". {LINK}Open page{/LINK}',
            replacements: {
              COPIED_VIDEO_NAME: _v0.name,
              LINK: _v0 => (0, _v1.jsx)(_v17.LinkComponent, {
                href: _v2,
                children: _v0
              })
            },
      ...
      [_v18, {
        ...
        onFailure: (0, _v2.useCallback)(_v0 => {
          switch (_v0) {
            ...
            case "restricted_storage":
              if (_v12(), _v6 && !_v22(_v2?.user?.uri, _v6)) return void _v16();
              _v15("quota_count" === _v0 ? "quota" : "storage_limit");
              return;
            case "not_ready":
              _v12(), _v1({
                content: (0, _v3.translate)({
        ...
        }, [_v12, _v1, _v16, _v15, _v6, _v2?.user?.uri]),
        onSuccess: _v17
      }),
      _v20 = (0, _v2.useCallback)(_v0 => {
        ...
        if (_v2 || _v3) return _v22(_v2?.user?.uri, _v0) ? void _v15(_v1?.space?.unit === "video_size" ? "storage_limit" : "quota") : void _v16();
        _v7(_v0), _v9((0, _v20.buildCopyPrefilledTitle)(_v0.name ?? "")), _v11(void 0);
      }, [_v16, _v15, _v2?.user?.uri]),
      _v21 = (0, _v2.useCallback)(_v0 => {
        _v6 && _v18(_v6.uri, _v0);
      }, [_v18, _v6]);
    return {
      openCopyVideoModal: _v20,
      copyVideoModal: (0, _v1.jsx)(_v18.NameInputModal, {
        isOpen: !!_v6,
        isLoading: _v19,
