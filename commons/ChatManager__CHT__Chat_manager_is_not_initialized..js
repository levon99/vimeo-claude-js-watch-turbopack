{
  ...
  class _v19 extends _v15.UnsubscribingContextManager {
    ...
    context = {
      ...
      [_v9.EChatType.PUBLIC]: _v19.createNewChatDescriptor(),
      [_v9.EChatType.BACKSTAGE]: _v19.createNewChatDescriptor(),
      isEnabled: null,
      enabledAt: null,
    ...
    async onChatApplicationReady({
      ...
      if (this.firebase = _v0, this.isModuleActive) {
        ...
        }), this.publicChatBuffer = new _v14.InMemoryBuffer(_v19.createBufferConfig(this, "publicChatBuffer", _v9.EChatType.PUBLIC));
  ...
  (0, _v1._)([(0, _v2.OnSignal)(_v18.ELiveRealtimeSignal.FIREBASE_INTERACTION_APP_READY)], _v19.prototype, "onChatApplicationReady", null), (0, _v1._)([(0, _v2.OnSignal)(_v18.ELiveSignal.INTERACTION_SESSION_LOGOUT)], _v19.prototype, "onInteractionSessionLogout", null);
}