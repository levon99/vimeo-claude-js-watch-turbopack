{
  ...
  _v0.s(["DEFAULT_EXPIRY_DAYS", 0, 7, "EXPIRY_SOON_DAYS", 0, 3, "MAX_EXPIRY_DAYS", 0, 365, "MS_PER_DAY", 0, 0, "appendDuration", 0, _v3, "formatExpiryDuration", 0, function (_v0) {
    if (!_v0) return "";
  ...
  }, "getRemainingDays", 0, _v2, "resolveDefaultExpiry", 0, function (_v0) {
    let _v1 = null !== _v0.prefDays ? _v0.prefDays : _v0.orionDays,
      _v2 = _v1 > 0 ? Math.min(_v1, 365) : 0;
    return {
      intervalDays: _v2,
      hasExpiration: _v2 > 0
    };
