{
          ...
          children: (0, _v1.jsxs)(_v8.VStack, {
            ...
            children: [(0, _v1.jsxs)(_v8.VStack, {
              ...
              children: [(0, _v1.jsx)(_v7.Text, {
                ...
                alignItems: "start",
                width: "100%",
                children: (0, _v18.getFeatures)(_v1).map((_v0, _v1) => (0, _v1.jsx)(_v16.FeatureRow, {
                  ..._v0
                }, `row${_v1}`))
              })]
  ...
  _v0.s(["ActivatedScreen", 0, _v22, "ReverseTrialPaywall", 0, function ({
    trialDays: _v0,
    paywallTracking: _v1,
    onComplete: _v2,
    onActivated: _v3,
    ...
    let _v17 = async () => {
      _v13(_v19);
      try {
        await _v7(_v0), _v15(_v19), _v6(!0), _v3?.();
      } catch (_v0) {
        _v14({
          ..._v19,
          source: "network",
