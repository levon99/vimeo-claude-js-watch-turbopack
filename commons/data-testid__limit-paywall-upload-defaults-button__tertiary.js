  ...
  function _v26({
    ...
    return (0, _v1.jsxs)(_v4.Box, {
      ...
      children: [(0, _v1.jsxs)(_v6.Flex, {
        ...
        type: "button",
        onClick: _v3,
        direction: _v7 ? "column" : void 0,
        alignItems: _v7 ? void 0 : "center",
        gap: _v7 ? "sm" : "md",
        padding: "md",
        width: "100%",
        height: _v7 ? void 0 : "64px",
        minHeight: _v7 ? "64px" : void 0,
        ...
        bg: _v2 ? _v6 : "surface",
        _hover: {
          bg: _v2 ? _v6 : "input-fill-hover"
        },
        transition: "background-color 0.15s ease, border-color 0.15s ease",
        sx: {
          width: "100% !important"
        },
        children: [_v7 ? (0, _v1.jsx)(_v6.Flex, {
          alignItems: "center",
          gap: "md",
          width: "100%",
          children: _v8
