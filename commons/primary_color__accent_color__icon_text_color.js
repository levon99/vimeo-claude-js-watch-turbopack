{
  ...
  _v0.s(["useVideoManageTracking", 0, () => {
    ...
    return {
      ...
      trackVideoManageLanguagesDisplayed: _v14,
      trackVideoManageSubtitlesGenerationStarted: _v15,
      trackVideoManageSubtitlesUploaded: _v16,
      trackVideoManageLanguagesAddActionClicked: _v17,
      trackVideoManageLanguagesOverflowActionClicked: _v18,
      trackVideoManageInteractivityDisplayed: _v19,
      trackVideoManageInteractivityFeatureOpened: _v20,
      trackVideoManageInteractivityChapterAdded: _v21,
      trackVideoManageInteractivityChapterSaved: _v22,
      trackVideoManageInteractivityRegistrationToggled: _v23,
      trackVideoManageInteractivityRegistrationCustomizeClicked: _v24,
      trackVideoManageInteractivityRegistrationManageRegistrantsClicked: _v25,
      trackVideoManageInteractivityCardAdded: _v28,
      trackVideoManageInteractivityCardImageAdded: _v29,
      trackVideoManageInteractivityEndScreenSourceChanged: _v30,
      trackVideoManageInteractivityVideoRatingSaved: _v26,
      trackVideoManageInteractivityVideoRatingTypeChanged: _v27,
      trackVideoManageInteractivityCardSaved: _v31,
      trackVideoManageInteractivityEndScreenSaved: _v32,
      trackVideoManageEditingActionClicked: _v33,
      trackVideoManageGifMakerCreateClicked: _v34,
      trackVideoManageGifMakerCreated: _v35,
      trackVideoManageGifMakerDeleted: _v36,
      trackVideoManageGifMakerShareActionClicked: _v37,
      trackVideoManageVimeoAiPanelDisplayed: _v38,
      trackVideoManageVimeoAiFeatureClicked: _v39,
      trackVideoManageVimeoAiSettingsClicked: _v40,
      trackVideoManageVimeoAiPanelClosed: _v41,
      trackVideoManageVimeoAiVideoDetailsShown: _v42,
      trackVideoManageVimeoAiVideoDetailsSaved: _v43,
      trackVideoManageVimeoAiVideoDetailsCopied: _v44,
      trackVideoManageVimeoAiChaptersShown: _v45,
      trackVideoManageVimeoAiChaptersChapterClicked: _v46,
      trackVideoManageVimeoAiChaptersSaved: _v47,
      trackVideoManageVimeoAiHighlightsShown: _v48,
      trackVideoManageVimeoAiHighlightsHighlightClicked: _v49,
      trackVideoManageVimeoAiHighlightsEdited: _v50,
      trackVideoManageVimeoAiHighlightsSaved: _v51,
      trackVideoManageVimeoAiHighlightsShared: _v52,
      trackVideoManageVimeoAiAskAiShown: _v53,
      trackVideoManageVimeoAiAskAiQuestionAsked: _v54,
      trackVideoManageVimeoAiAskAiAnswerShown: _v55,
      trackVideoManageVimeoAiAskAiMomentPlayed: _v56,
      trackVideoManageVimeoAiTranslateSettingsShown: _v57,
      trackVideoManageVimeoAiTranslateSaved: _v58,
      trackVideoManageVimeoAiUpsellTriggered: _v59,
      trackVideoManageVimeoAiUpsellImpression: _v60,
      trackVideoManageVimeoAiUpsellContactSalesClicked: _v61,
      trackVideoManageLanguagesTrackToggled: _v62,
      trackVideoManageLanguagesTrackEdited: _v63,
      trackVideoManageLanguagesTrackRetranscribeClicked: _v64,
      trackVideoManageInteractivityRegistrationFormTabSwitched: _v65,
      trackVideoManageInteractivityRegistrationFormPresetChanged: _v66,
      trackVideoManageInteractivityRegistrationFormConnectProviders: _v67,
      trackVideoManageInteractivityRegistrationFormPlacementChanged: _v68,
      trackVideoManageInteractivityRegistrationFormSettingToggled: _v69,
      trackVideoManageInteractivityRegistrationFormSectionSwitched: _v70,
      trackVideoManageInteractivityRegistrationFormFieldAdded: _v71,
      trackVideoManageInteractivityRegistrationFormHiddenFieldAdded: _v72,
      trackVideoManageInteractivityRegistrationFormPrivacyPolicyChanged: _v73,
      trackVideoManageInteractivityRegistrationFormAppearanceChanged: _v74,
      trackVideoManageInteractivityRegistrationFormPreviewTypeChanged: _v75,
      trackVideoManageInteractivityRegistrationFormPreviewDeviceChanged: _v76,
