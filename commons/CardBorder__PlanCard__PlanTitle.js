{
  ...
  _v0.s(["CardBorder", () => _v37, "PlanCard", () => _v41, "PlanTitle", () => _v39, "default", () => _v42], 0);
  var _v1 = _v0.i(0),
    _v2 = _v0.i(0),
    _v3 = _v0.i(0),
    _v4 = _v0.i(0),
  ...
  let _v35 = ({
    ...
    _v36 = new Set(["starter", "standard", "advanced"]),
    _v37 = ({
      purchaseStatus: _v0 = "",
      showBadge: _v1 = !1,
    ...
    _v41 = ({
      ...
      let {
        ...
        _v18 = (0, _v3.useContext)(_v24.PlansDataContext),
        _v19 = (0, _v3.useContext)(_v23.OverridesContext),
        {
          cardSurface: _v20,
          compact: _v21
        } = _v19,
        {
          isFlatRateData: _v22,
          isSolutionData: _v23,
          isRepackagingData: _v24,
          downgradeEnabled: _v25,
          effectiveTier: _v26,
          upcomingTier: _v27
        } = _v18,
        _v28 = _v17.entitlements?.params?.videoStoragePeriodicQuota || _v17.entitlements?.params?.videoStorageQuotaCap,
        _v29 = _v17.entitlements?.params?.videoStorageQuotaPeriod,
        ...
        _v38 = (_v37 || _v33) && _v24,
        _v39 = _v38 ? .7 : 1,
        _v40 = (0, _v28.useBundleCtaIntercept)(_v15),
        _v41 = (0, _v28.useBundleOfferSelector)(_v0 => _v0.isBundleActive),
        _v42 = (0, _v28.useBundleOfferSelector)(_v0 => _v0.isEnabled),
        _v43 = (0, _v28.useBundleOfferSelector)(_v0 => _v0.bundleType),
        _v44 = (0, _v28.useBundleOfferSelector)(_v0 => _v0.price),
        _v45 = (_v11 ?? _v36).has(_v15) && _v42 && null !== _v43 && (!_v12 || "available" === _v36),
        _v46 = (0, _v22.getPlanCardPresentation)(_v20, _v21),
          ...
          children: (0, _v1.jsxs)(_v4.Box, {
            ...
            children: [(0, _v1.jsxs)(_v4.Box, {
              ...
              children: [(0, _v1.jsxs)(_v39, {
                ...
                opacity: _v38 ? .5 : 1,
                children: "free" === _v15 ? _v9 ? _v9() : (0, _v1.jsx)(_v32.default, {
                  location: "vertical"
              ...
              opacity: _v39,
              children: [_v49 && (0, _v1.jsx)(_v15.default, {
                planData: _v0,
                showYearly: _v2
              }), (0, _v1.jsx)(_v16.default, {
                planData: _v0,
                quotaPeriod: _v29,
                periodicQuota: "free" === _v15 && null !== _v28 ? _v28 : _v17.entitlements?.params?.videoStoragePeriodicQuota || 0,
                planView: _v6
              })]
            })]
          })
        }), !_v5 && _v46.showComparisonLink && (0, _v1.jsx)(_v30, {})]
      });
    },
    _v42 = ({
      showYearly: _v0,
      ...
      let _v17 = (0, _v3.useContext)(_v23.OverridesContext),
        {
          cardSurface: _v18,
          compact: _v19
        } = _v17,
        _v20 = (0, _v22.getPlanCardPresentation)(_v18, _v19),
        {
          plansData: _v21,
          isRepackagingData: _v22,
          hideFreePlan: _v23,
          hideIndividualPlans: _v24
        } = (0, _v3.useContext)(_v24.PlansDataContext),
        _v25 = (0, _v3.useRef)(null),
        {
          shouldReorder: _v26,
          isResolving: _v27
        } = (0, _v25.useColdStoragePlanReorder)(),
        {
          settings: _v28
        ...
        _v32 = (0, _v3.useMemo)(() => _v31 ? _v17?.plans ? _v31.filter(_v0 => _v17.plans?.includes(_v0.tier)) : _v17?.excludedPlans ? _v31.filter(_v0 => !_v17.excludedPlans?.includes(_v0.tier)) : _v5 ? _v31 : _v31.length > _v20.maxVerticalCards ? _v31.slice(0, -1) : _v31 : [], [_v31, _v17, _v5]),
        _v33 = (0, _v3.useMemo)(() => {
          if (!_v21 || !_v22) return [];
          let _v0 = _v21.some(_v0 => "core" === _v0.tier);
          return _v21.REPACKAGING_INDIVIDUAL_VIEW_TIERS.reduce((_v0, _v1) => {
            if ((_v23 || _v0) && "free" === _v1) return _v0;
        ...
        _v37 = (0, _v3.useCallback)(() => {
          ...
          let _v3 = _v22 ? `[data-panel="${_v6}"] .card-section-container` : ".card-section-container",
            _v4 = new Map(),
      ...
      let _v38 = (0, _v3.useCallback)(_v0 => {
        ...
        }, _v0.name)), [_v3, _v20.condensed, _v1, _v5, _v4, _v0, _v10, _v11, _v12, _v13, _v14, _v15, _v16]);
      if (!_v21 || _v27 && !_v22 && !_v5) return null;
      if (_v22 && _v7) {
        ...
        return _v5 ? (0, _v1.jsx)(_v4.Box, {
          ...
          children: (0, _v1.jsxs)(_v4.Box, {
            ...
            width: "100%",
            ref: _v25,
            children: [_v39(_v36, _v6), _v9 && (0, _v1.jsx)(_v35, {
          ...
          children: (0, _v1.jsx)(_v4.Box, {
            ...
            children: (0, _v1.jsxs)(_v4.Box, {
              ...
              children: [(0, _v1.jsxs)(_v4.Box, {
                ...
                children: [_v39(_v33, "individual"), _v9 && (0, _v1.jsx)(_v35, {
                  targetView: "business",
                  onSwitch: _v7,
                  isMobileBreakpoint: _v5
                })]
      ...
      return _v32.length ? (0, _v1.jsxs)(_v4.Box, {
        ...
        children: [(0, _v1.jsx)(_v4.Box, {
          ...
          ref: _v25,
          children: _v39(_v32)
        }), _v31 && _v31.length > _v20.maxVerticalCards && !_v17?.plans && !_v17?.excludedPlans?.includes(_v31[_v31.length - 1].tier) && !_v5 && (0, _v1.jsx)(_v4.Box, {
          margin: "0 auto",
          maxWidth: "1440px",
