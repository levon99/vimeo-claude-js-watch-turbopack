{
  ...
  async function _v5({
    ...
    return (0, _v3.measureLatency)("getUserMemberListsStarredItems", "GET", async () => {
      let _v0 = await fetch(`${_v0}/users/${_v2}/members/${_v3}/lists/starred/items?${(0, _v4.searchQueryString)(_v4)}&fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v5,
        method: "GET"
      });
  ...
  async function _v6({
    ...
    return (0, _v3.measureLatency)("postUserMemberListsStarredItems", "POST", async () => {
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v2.assignMswData)(function (_v0, _v1) {
    ...
    return (0, _v8.default)(_v2 ? `/users/${_v2.where.userId}/members/${_v2.where.teamMemberId}/lists/starred/items${(0, _v2.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v5({
      ..._v2,
      headers: {
        ..._v2.headers,
        "Content-Type": "application/json",
    ...
    endpoint: "/users/:userId/members/:teamMemberId/lists/starred/items",
    method: "GET"
    ...
    return [(0, _v7.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/users/${_v0.where.userId}/members/${_v0.where.teamMemberId}/lists/starred/items${(0, _v2.serializeQuery)(_v0)}`, _v5({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/users/:userId/members/:teamMemberId/lists/starred/items",
    method: "POST"
  }), _v0.s(["useGetUserMemberListsStarredItemsInfinite", 0, _v12, "usePostUserMemberListsStarredItems", 0, _v13], 0);
}