{
  ...
  function _v58() {
    ...
    let _v27 = (0, _v2.useCallback)(_v0 => {
      ...
      _v25.current = !0, _v9.current?.seekTo(_v4), _v13(_v4), _v6(_v4);
    }, [_v14, _v10, _v6, _v9]);
    (0, _v2.useEffect)(() => {
      if (!_v26) return;
      let _v0 = _v0 => _v27(_v0);
      return document.addEventListener("keydown", _v0, !0), () => document.removeEventListener("keydown", _v0, !0);
    }, [_v26, _v27]), (0, _v2.useEffect)(() => {
      if (!_v26) return;
      _v9.current = _v26;
      let _v0 = () => {
        _v26._overrideControlbarBehavior(!0), _v26._setControlbarVisibility(!1), _v26._setEmbedSettings({
          title: 0,
          byline: 0,
          portrait: 0,
          like: 0,
      ...
      _v26.ready(() => {
        _v0(), _v15(_v26.duration), _v22(_v26.config?.request?.thumb_preview ?? null), _v26.on("durationchange", _v0 => _v15(_v0.duration)), _v26.on("play", () => {
          _v24.current || (_v6(null), _v8(!1));
        }), _v26.on("pause", _v0 => {
          _v24.current || _v25.current || _v6(_v0.seconds);
        }), _v26.on("timeupdate", _v0 => {
          _v16.current || _v25.current || _v13(_v0.seconds);
        });
        let _v0 = () => {
          if (_v0(), _v15(_v26.duration), _v22(_v26.config?.request?.thumb_preview ?? null), _v24.current = !1, !_v25.current) {
            let _v0 = _v11.current;
            null !== _v0 && (_v26.seekTo(_v0), _v6(_v0), _v13(_v0));
          }
        };
        _v26.play().then(() => {
          _v26.pause(), _v0();
    ...
    }, [_v26, _v9, _v6, _v8]), (0, _v2.useEffect)(() => () => {
      _v6(null);
    }, [_v6]);
    let _v28 = _v21 ? Math.ceil(_v21.frames / _v21.columns) : 0,
      _v29 = _v55.reduce((_v0, _v1, _v2) => Math.abs(_v1 * _v14 - _v12) < Math.abs(_v55[_v0] * _v14 - _v12) ? _v2 : _v0, 0);
      ...
      children: _v2 ? (0, _v1.jsx)(_v7.Flex, {
        ...
        children: [(0, _v1.jsxs)(_v3.Box, {
          ...
          children: [(0, _v1.jsxs)(_v52.Slider, {
            ...
            overflow: "visible",
            onChange: _v0 => {
              _v16.current = !0, _v25.current = !0, _v13(_v0);
              let _v1 = Date.now();
              _v1 - _v19.current >= 33 && (_v19.current = _v1, _v9.current?.seekTo(_v0));
            },
            onChangeEnd: _v0 => {
              _v16.current = !1, _v25.current = !0, _v9.current?.seekTo(_v0), _v6(_v0);
            },
            onKeyDown: _v0 => _v27(_v0),
            ...
            children: _v55.map((_v0, _v1) => {
              ...
              return (0, _v1.jsx)(_v3.Box, {
                ...
                style: {
                  ...
                  backgroundSize: `${100 * _v21.columns}% ${100 * _v28}%`,
                  backgroundPosition: `${_v5}% ${_v28 <= 1 ? 0 : _v4 / (_v28 - 1) * 100}%`,
                  aspectRatio: _v4,
                  outline: "none",
                  ...(_v1 === _v29 && {
                    zIndex: 1,
                ...
                children: _v1 === _v29 && (0, _v1.jsx)(_v3.Box, {
                  position: "absolute",
                  inset: 0,
                  borderRadius: "sm",
                  pointerEvents: "none",
