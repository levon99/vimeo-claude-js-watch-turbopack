{
  ...
  let _v17 = ({
    ...
    let _v1 = (0, _v16.getTranslations)(),
      _v2 = [{
        title: _v1.AuditLogs,
        description: _v1.AuditLogsMenuDescription,
        href: _v0 ? _v15.WORKSPACE_SETTINGS_ROUTES.AUDIT_LOGS : _v15.ORGANIZATION_SETTINGS_ROUTES.AUDIT_LOGS,
        testId: "audit-logs-link"
      }, ...(_v0 ? [{
        title: _v1.DataRetentionPolicies,
        description: _v1.DataRetentionPoliciesDescription,
        href: _v15.WORKSPACE_SETTINGS_ROUTES.DATA_RETENTION,
        testId: "data-retention-link"
      }, {
        title: _v1.ClipExtension,
        description: _v1.ClipExtensionDescription,
        href: _v15.WORKSPACE_SETTINGS_ROUTES.CLIP_EXTENSION,
        testId: "clip-extension-link"
      }, {
        title: _v1.HistoryAndRecovery,
        description: _v1.HistoryAndRecoveryDescription,
        href: _v15.WORKSPACE_SETTINGS_ROUTES.HISTORY_AND_RECOVERY,
        testId: "history-recovery-link"
      }, {
        title: _v1.LegalHolds,
        description: _v1.LegalHoldsDescription,
        href: _v15.WORKSPACE_SETTINGS_ROUTES.LEGAL_HOLDS,
        testId: "legal-holds-link"
      }, {
        title: _v1.DeactivatedFolders,
        description: _v1.DeactivatedFoldersMenuDescription,
        href: _v15.WORKSPACE_SETTINGS_ROUTES.DEACTIVATED_FOLDERS,
        testId: "deactivated-folders-link"
      }] : [])];
    return (0, _v1.jsx)(_v13.TeamSettingsPageCategory, {
      title: _v1.ActivityAndDataRetention,
      children: _v2.map(({
        title: _v0,
        description: _v1,
        href: _v2,
        testId: _v3
      }) => (0, _v1.jsx)(_v14.TeamSettingsPageOptionContainer, {
  ...
  let _v29 = ({
    ...
    let _v1,
      ...
      } = (_v1 = (0, _v28.useViewer)(), _v2 = (0, _v2.useMemo)(() => (0, _v25.buildTeamBpContextFromTeamUser)(_v1?.teamUser), [_v1?.teamUser]), {
        sendOpenFederatedSearchManageEvent: () => {
          let _v0 = (0, _v22.default)();
          (0, _v27.sendBpEventWithContexts)("vimeo.open_federated_search_manage", {
            ...(0, _v23.buildActionBpContext)({
              action_type: "click",
              feature: null
            }),
      ...
      _v4 = (0, _v16.getTranslations)();
    return (0, _v1.jsx)(_v13.TeamSettingsPageCategory, {
      title: _v4.API,
      children: (0, _v1.jsxs)(_v14.TeamSettingsPageOptionContainer, {
        children: [(0, _v1.jsxs)(_v8.Flex, {
          justifyContent: "space-between",
          alignItems: "center",
          gap: "75",
        ...
        }), !_v0 && (0, _v1.jsx)(_v18.Alert, {
          size: "sm",
          marginTop: "200",
          children: (0, _v1.jsx)(_v19.AlertDescription, {
            marginTop: "50",
  ...
  let _v33 = ({
    ...
    _v34 = ({
      ...
      let _v1 = (0, _v16.getTranslations)(),
        ...
        } = (0, _v30.useCapability)(["canAccessOrganizationSettings"], _v0);
      return _v2 ? (0, _v1.jsx)(_v18.Alert, {
        size: "sm",
        marginBottom: 15,
        children: (0, _v1.jsx)(_v19.AlertDescription, {
          mt: "1",
          children: _v1.SecurityFeaturesLikeSSO(_v15.ORGANIZATION_SETTINGS_ROUTES.SECURITY_AND_DATA)
        })
      }) : null;
    },
    _v35 = ({
      ...
      let _v2 = (0, _v16.getTranslations)(),
        {
          capabilities: {
            teamAllowedIpsEnabled: _v3
          }
        } = (0, _v30.useCapability)(["teamAllowedIpsEnabled"], _v1),
        _v4 = (0, _v2.useMemo)(() => [{
          title: _v2.SingleSignOn,
          description: _v2.ManageYourOrganizationSSO,
          url: _v15.ORGANIZATION_SETTINGS_ROUTES.SSO,
          isEnabled: !0
        }, {
          title: _v2.Allowlist,
          description: _v2.AllowlistDescription,
          url: _v15.ORGANIZATION_SETTINGS_ROUTES.ALLOWLIST,
          isEnabled: !!_v3
        }], [_v2.Allowlist, _v2.AllowlistDescription, _v2.ManageYourOrganizationSSO, _v2.SingleSignOn, _v3]);
      return (0, _v1.jsxs)(_v13.TeamSettingsPageCategory, {
        title: _v2.Authentication,
        children: [_v4.map(_v0 => _v0.isEnabled && (0, _v1.jsx)(_v14.TeamSettingsPageOptionContainer, {
          children: (0, _v1.jsxs)(_v8.Flex, {
            gap: "xl",
            width: "100%",
            justifyContent: "space-between",
  ...
  let _v49 = ({
    ...
    let _v4 = (0, _v16.getTranslations)(),
      _v5 = (0, _v28.useViewer)(),
      _v6 = _v5?.teamUser,
      ...
      } = (0, _v30.useCapability)(["hasMultipleReviewLinks", "hasEnterprise", "hasCanUseOverlayWatermarking"], _v7),
      {
        data: _v11
      } = (({
        isWorkspacePage: _v0,
    ...
    return (0, _v2.useEffect)(() => {
    ...
    }, [_v11]), (0, _v1.jsxs)(_v13.TeamSettingsPageCategory, {
      title: _v4.PrivacyAndAccess,
      children: [_v8 && _v9 && (0, _v1.jsx)(_v14.TeamSettingsPageOptionContainer, {
        children: (0, _v1.jsxs)(_v8.Flex, {
          gap: "xl",
          width: "100%",
          justifyContent: "space-between",
        ...
        children: (0, _v1.jsxs)(_v8.Flex, {
          ...
          children: [(0, _v1.jsxs)(_v3.Box, {
            ...
            href: _v0 ? _v15.WORKSPACE_SETTINGS_ROUTES.PRIVACY_RESTRICTIONS : _v15.ORGANIZATION_SETTINGS_ROUTES.PRIVACY_RESTRICTIONS,
            children: (0, _v1.jsx)(_v10.IconButton, {
              as: "span",
      ...
      }), !_v8 && (0, _v1.jsx)(_v14.TeamSettingsPageOptionContainer, {
        children: (0, _v1.jsxs)(_v8.Flex, {
          gap: "xl",
          width: "100%",
          justifyContent: "space-between",
          ...
          children: [(0, _v1.jsxs)(_v3.Box, {
            ...
            href: _v0 ? _v15.WORKSPACE_SETTINGS_ROUTES.REVIEW_PAGE_SETTINGS : _v15.ORGANIZATION_SETTINGS_ROUTES.REVIEW_PAGE_SETTINGS,
            children: (0, _v1.jsx)(_v10.IconButton, {
              as: "span",
      ...
      }), _v3 && _v10 && (0, _v1.jsx)(_v14.TeamSettingsPageOptionContainer, {
  ...
  let _v53 = () => {
    ...
    return (0, _v1.jsxs)(_v1.Fragment, {
      children: [(0, _v1.jsx)(_v13.TeamSettingsPageCategory, {
        title: _v3.Registration,
        children: (0, _v1.jsx)(_v14.TeamSettingsPageOptionContainer, {
          children: (0, _v1.jsxs)(_v8.Flex, {
            gap: "xl",
            width: "100%",
            justifyContent: "space-between",
  ...
  _v0.s(["SecurityAndData", 0, ({
    ...
    let _v4 = (0, _v16.getTranslations)(),
      _v5 = (0, _v2.useContext)(_v6.ViewerContext),
      _v6 = _v5?.user?.id === _v5?.teamUser?.ownerId || _v5?.teamUser?.permissionLevel === _v15.PERMISSION_LEVELS.OWNER;
    return (0, _v1.jsxs)(_v3.Box, {
      maxW: _v5.SETTING_PAGES_MAX_WIDTH,
      width: "100%",
      margin: "0 auto",
      children: [(0, _v1.jsx)(_v4.SettingsPageContentHeader, {
        title: _v4.SecurityAndData
      }), (0, _v1.jsx)(_v33, {
        organizationUuid: _v1,
        organizationInternalId: _v2,
        isWorkspaceSettingsPage: _v0,
        currentUserId: _v5?.user?.id
      }), (0, _v1.jsx)(_v17, {
        isWorkspaceSettingsPage: _v0
      }), (0, _v1.jsx)(_v49, {
        isWorkspaceSettingsPage: _v0,
