{
  ...
  _v0.s(["GoogleTagManager", 0, function ({
    ...
    let _v1 = (0, _v3.useMemo)(() => _v7(_v0), [_v0]);
  ...
  }, "getInitialGTMDataLayer", 0, _v7, "sendGTMEvent", 0, function (_v0, _v1) {
    (0, _v2.sendGTMEvent)(_v0, _v1 || _v5);
  }], 0);
  var _v8 = _v0.i(0);
  let _v9 = "backend_signup_completed";
  _v0.s(["useBackendSignupTracking", 0, () => {
    let _v0 = (0, _v8.usePico)();
    (0, _v3.useEffect)(() => {
      if (null === _v0) return;
      let _v0 = document.cookie.split(";").find(_v0 => _v0.trim().startsWith(`${_v9}=`));
      if (!_v0) return;
      let [_v1, _v2] = _v0.trim().slice(_v9.length + 1).split("|");
      _v0.track("signup_completed", {
        registration_source: _v1,
        marketing_opt_in: "1" === _v2
      });
      let _v3 = window.location.hostname.split(".").slice(-2).join(".");
      document.cookie = `${_v9}=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/; domain=${_v3}`;
    }, [_v0]);
  }, "useSignupTracking", 0, () => {
    let _v0 = (0, _v8.usePico)();
    return {
      trackSignupCompleted: (0, _v3.useCallback)((_v0, _v1) => {
