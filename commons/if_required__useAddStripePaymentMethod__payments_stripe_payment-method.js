{
  ...
  let _v17 = (_v0, _v1) => ({
    ...
    _v20 = _v0 => "string" == typeof _v0 && _v0.length > 0;
      ...
      let _v0 = async () => {
        if (!_v3 && !_v13.current && _v2?.xsrft) {
          ...
          try {
            ...
            if (!_v0.ok) return void _v15("stripe_config", "stripe_config_request_failed");
            let _v1 = await _v0.json();
            if (!("object" == typeof _v1 && null !== _v1 && _v20(_v1.currency) && _v20(_v1.publishableKey) && _v20(_v1.paymentMethodConfigId))) return void _v15("stripe_config", "stripe_config_response_invalid");
            _v8(_v1.currency), _v4(_v1.publishableKey), _v6(_v1.paymentMethodConfigId);
          } catch {
            _v15("stripe_config", "stripe_config_request_failed");
          }
        }
      };
      _v0 === _v14.PaymentFormTypes.TYPE_STRIPE && _v0();
    }, [_v0, _v3, _v15, _v2?.xsrft]), (0, _v3.useEffect)(() => {
      _v3 && !_v11 && _v12((0, _v2.loadStripe)(_v3).catch(() => (_v15("stripe_js", "stripe_js_load_failed"), null)));
    }, [_v3, _v15, _v11]), [_v11 && _v7 && _v3 && _v5 ? {
      currency: _v7,
      publishableKey: _v3,
        ...
        try {
          ...
          if (_v3?.message) {
            _v2({
              ...
              source: "stripe",
              stripeErrorCode: _v3.code,
              errorResponse: {
                formErrorCode: _v3.code ?? "",
          ...
          let _v4 = await fetch("/payments/stripe/payment", {
            method: "POST",
            credentials: "include",
            headers: {
              "Content-type": "application/json",
          ...
          if (!_v4.ok) {
            _v2({
              ...
              errorResponse: {
                ...
                formErrorMessage: `Stripe payment request failed (HTTP ${_v4.status}).`
              },
              checkoutTracking: _v23()
            });
            return;
          ...
          let _v7 = _v17(_v0, _v3.billingAddress);
          if ("payment" === _v5) {
            let _v0 = await _v17({
              clientSecret: _v6,
              ..._v7
            });
            _v1 = _v0.paymentIntent, _v2 = _v0.error;
          } else {
            let _v0 = await _v18({
              clientSecret: _v6,
              ..._v7
            });
            _v0 = _v0.setupIntent, _v2 = _v0.error;
          }
          let _v8 = _v1 || _v0;
          if (_v2?.message) {
            _v2({
              ...
              selectedPaymentMethod: void 0,
              source: "stripe",
              stripeErrorCode: _v2.decline_code ?? _v2.code,
              errorResponse: {
                formErrorCode: _v2.decline_code ?? _v2.code ?? "",
                formErrorMessage: _v2.message
              },
              checkoutTracking: _v23()
            });
            return;
          ...
          _v2({
            ...
            source: "stripe",
            errorResponse: {
              formErrorCode: "stripe_unexpected_error",
              formErrorMessage: _v0 instanceof Error ? _v0.message : "Unknown Stripe error."
            },
            checkoutTracking: _v23()
          });
        }
