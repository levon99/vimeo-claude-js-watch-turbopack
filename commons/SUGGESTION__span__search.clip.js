{
  ...
  _v2.linkForRecentSearchRedirect = function (_v0) {
    ...
    var _v3;
    return (null == (_v3 = _v1[0]) ? void 0 : _v3.searchField) === _v7.WidgetName.template ? _v9(_v0) : _v2 === _v7.WidgetQualifier.in ? "" === _v0.replace(_v2 + ":", "") ? "/search/library?filter_type=folder" : _v10(_v0, _v1) : _v2 === _v7.WidgetQualifier.command ? _v0 ? "/search/library?q=" + encodeURIComponent(_v0) : "/search/library" : _v10(_v0, _v1);
  ...
  _v2.getTemplateUri = function (_v0) {
    ...
    if ("/" === _v1 || "/home" === _v1) {
      var _v2 = parseInt(_v8.getLocalStorageItem(_v7.OMNISEARCH_CSAT_KEY) || "0", 10);
      ++_v2 <= _v7.MAX_VISITS_TO_COUNT && (_v6.GoogleTagManager.init(null != (_v0 = window._gtm) ? _v0 : []), _v6.GoogleTagManager.addData({
        omnisearch_csat: _v2
      }), _v8.setLocalStorageItem(_v7.OMNISEARCH_CSAT_KEY, _v2.toString()));
    }
    ...
    if ("/" === _v1 || "/home" === _v1) {
      var _v2 = parseInt(_v8.getLocalStorageItem(_v7.OMNISEARCH_CSAT_KEY) || "0", 10),
        _v3 = parseInt(_v8.getLocalStorageItem("vls_csat") || "0", 10);
    ...
    _v8.setLocalStorageItem("omnisearch_action", _v0);
  }, _v2.getLastUserAction = function (_v0) {
    return (_v0 ? _v8.getLocalStorageItem("vls_action") : _v8.getLocalStorageItem("omnisearch_action")) || "";
    ...
    var _v13 = _v8.getLocalStorageItem("search_type") || "";
    ...
    if (Number.isInteger(_v0)) return _v8.setLocalStorageItem(_v7.SEARCH_PRECISION, _v0.toString()), _v0;
    var _v1 = parseInt(_v8.getLocalStorageItem(_v7.SEARCH_PRECISION) || "", 10);
