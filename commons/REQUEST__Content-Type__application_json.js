{
  ...
  function _v7() {
    ...
    return [(0, _v4.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me/orders/subscriptions/${_v0.where.subscriptionId}${(0, _v2.serializeQuery)(_v0)}`, (0, _v3.postMeOrdersSubscription)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v2.assignMswData)(_v7, {
    ...
    method: "POST"
  }), _v0.s(["usePostMeOrdersSubscription", 0, _v7]);
}