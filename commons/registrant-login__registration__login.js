{
  ...
  _v0.s(["InteractionToolsRouter", 0, function ({
    ...
    if ((0, _v3.useEffect)(() => {
      _v3 || _v5 || _v7(!!(_v4?.isCreator && !_v6?.interaction?.feature?.isManagementDisabled));
    }, [_v6?.interaction?.feature?.isManagementDisabled, _v3, _v5, _v4?.isCreator, _v7]), _v3) return (0, _v1.jsx)(_v5.BlockingLoadingWrapper, {
      id: _v0,
      className: _v1,
