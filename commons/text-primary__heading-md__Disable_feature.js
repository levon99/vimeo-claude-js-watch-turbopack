{
  ...
  let _v23 = ({
    ...
    onCancel: _v1,
    onConfirm: _v2
  }) => (0, _v1.jsxs)(_v16.Modal, {
    isOpen: !0,
    onClose: _v1,
    children: [(0, _v1.jsx)(_v21.ModalOverlay, {}), (0, _v1.jsxs)(_v18.ModalContent, {
      borderRadius: "md",
      children: [(0, _v1.jsx)(_v20.ModalHeader, {
        ...
        children: (0, _v22.translate)({
          singular: "Disable {feature}?",
          replacements: {
            feature: _v0
          },
          dictionary: {
            es: {
              singular: "¿Desactivar {feature}?"
            },
            "de-DE": {
              singular: "{feature} deaktivieren?"
            },
            "fr-FR": {
              singular: "Désactiver {feature} ?"
            },
            "ja-JP": {
              singular: "{feature}を無効にしますか？"
            },
            "ko-KR": {
              singular: "{feature}을(를) 비활성화하시겠습니까?"
            },
            "pt-BR": {
              singular: "Desativar {feature}?"
            },
            "zh-CN": {
              singular: "禁用 {feature}?"
            }
        ...
        children: (0, _v22.translate)({
          singular: "Any member granted individual access beyond their role permissions will lose access until the feature is re-enabled.",
          dictionary: {
            es: {
              singular: "Cualquier miembro al que se le haya concedido acceso individual más allá de los permisos de su rol perderá el acceso hasta que la función vuelva a habilitarse."
            },
            "de-DE": {
              singular: "Mitglieder, denen individueller Zugriff gewährt wurde, der über die Berechtigungen ihrer Rolle hinausgeht, verlieren den Zugriff, bis die Funktion wieder aktiviert ist."
            },
            "fr-FR": {
              singular: "Tout membre à qui un accès individuel a été accordé au-delà des autorisations de son rôle perdra l'accès jusqu'à ce que la fonctionnalité soit réactivée."
            },
            "ja-JP": {
              singular: "ロールの権限を超えて個別にアクセス権が付与されたメンバーは、その機能が再度有効化されるまでアクセスできなくなります。"
            },
            "ko-KR": {
              singular: "역할 권한을 초과하여 개별적으로 접근 권한을 부여받은 구성원은 해당 기능이 다시 활성화될 때까지 접근 권한을 잃게 됩니다."
            },
            "pt-BR": {
              singular: "Qualquer membro a quem for concedido acesso individual além das permissões da sua função perderá o acesso até que o recurso seja reativado."
            },
            "zh-CN": {
              singular: "凡被授予超出其角色权限的单独访问权限的成员，在该功能重新启用之前将失去访问权限。"
            }
          }
        })
      }), (0, _v1.jsx)(_v9.Divider, {
        borderColor: "stroke",
        marginTop: "lg"
      }), (0, _v1.jsxs)(_v19.ModalFooter, {
        border: "0",
        padding: "lg",
  ...
  let _v27 = ({
    ...
    return (0, _v1.jsx)(_v8.Box, {
      width: (0, _v26.rem)(240),
      children: (0, _v1.jsx)(_v24.Select, {
        variant: "withCheck",
        size: "md",
        items: _v4,
        ...
        withPortal: !0,
        disabled: _v3,
        children: _v0 => (0, _v1.jsx)(_v24.SelectItem, {
          children: (0, _v1.jsx)(_v2.Flex, {
            ...
            children: (0, _v1.jsxs)(_v8.Box, {
              textAlign: "left",
              children: [(0, _v1.jsx)(_v24.SelectItemText, {
                children: _v0.label
              }), (0, _v1.jsx)(_v25.Text, {
                variant: "body-sm",
    ...
    _v56 = () => ({
      ...
      settingControls: {
        ...
        enableTranslationsFailureEmail: {
          title: (0, _v22.translate)("Translation failure notifications"),
          description: (0, _v22.translate)("Send an email notification to the user who triggered a translation when it fails")
        },
        ...
        videoAskAi: {
          title: (0, _v22.translate)("Video Ask AI"),
          description: (0, _v22.translate)({
      ...
      settingTooltips: {
        ...
        enableLibrarySmartSearch: (0, _v22.translate)({
      ...
      notifications: {
        ...
        askAiAnalyticsDataNotFound: (0, _v22.translate)({
      ...
      AiTranslationHeader: (0, _v22.translate)({
      ...
      AiTranslationToggleActive: (0, _v22.translate)({
      ...
      AiTranslationToggleInactive: (0, _v22.translate)({
      ...
      ModalSaveButton: (0, _v22.translate)({
        singular: "Save",
        dictionary: {
          es: {
            singular: "Guardar"
      ...
      ModalCancelButton: (0, _v22.translate)({
        singular: "Cancel",
        dictionary: {
          es: {
            singular: "Cancelar"
      ...
      TranslationHeader: (0, _v22.translate)({
      ...
      SomethingWentWrong: (0, _v22.translate)({
      ...
      TranslationInputPlaceHolder: (0, _v22.translate)({
    ...
    _v99 = ({
      ...
      return (0, _v1.jsxs)(_v1.Fragment, {
        children: [_v8.map(_v0 => {
          ...
          featureName: _v6.label,
          onCancel: () => _v7(null),
          onConfirm: () => {
            _v3(_v6.key, !1, _v6.type), _v7(null);
          }
        })]
      });
    };
