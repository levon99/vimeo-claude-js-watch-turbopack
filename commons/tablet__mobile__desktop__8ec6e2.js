{
  ...
  function _v115(_v0, _v1) {
    ...
    return (0, _v74.default)(_v2 ? `/users/${_v2.where.userId}/bulk_actions/${_v2.where.batchId}${(0, _v69.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v114({
      ..._v2,
      headers: {
        ..._v2.headers,
        "Content-Type": "application/json",
  ...
  "true" === _v68.default.env.STORYBOOK && (0, _v69.assignMswData)(_v115, {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/users/${_v0.where.userId}/bulk_actions/${_v0.where.batchId}${(0, _v69.serializeQuery)(_v0)}`, _v114({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  let _v116 = _v0 => "completed" === _v0 || "completed_with_errors" === _v0 || "timeout" === _v0,
    _v117 = (0, _v111.default)(() => _v0.A(0).then(_v0 => _v0.BulkPrivacyModal), {
      loadableGenerated: {
        modules: [0]
      }
    }),
    _v118 = (0, _v112.create)(_v0 => ({
      modalProps: null,
    ...
    _v119 = ({
      ...
      let _v1,
        ...
        _v6,
        _v7,
        _v8 = _v118(_v0 => _v0.removeActiveBatch),
        _v9 = (0, _v31.useToast)({
      ...
      return _v1 = _v0?.batchId, _v2 = _v0?.userId, _v3 = (0, _v2.useRef)(_v10), _v4 = (0, _v2.useRef)(_v11), _v5 = (0, _v2.useRef)(0), _v6 = (0, _v2.useRef)(!1), (0, _v2.useEffect)(() => {
        ...
        refreshInterval: _v0 => {
          let _v1 = _v0?.status;
          return !_v0 || _v5.current >= 60 || _v116(_v1) ? 0 : 0;
        },
        revalidateOnFocus: !1,
        shouldRetryOnError: !1,
        onSuccess: _v0 => {
          if (_v116(_v0?.status)) return void (!_v6.current && (_v6.current = !0, _v3.current?.(_v0)));
  ...
  _v0.s(["BulkPrivacyModalHost", 0, () => {
    let _v0 = _v118(_v0 => _v0.modalProps),
      _v1 = _v118(_v0 => _v0.closeBulkPrivacyModal),
      _v2 = _v118(_v0 => _v0.activeBatches),
      _v3 = _v118(_v0 => _v0.addActiveBatch);
    return (0, _v1.jsxs)(_v1.Fragment, {
      children: [_v0 && (0, _v1.jsx)(_v117, {
        ..._v0,
        isOpen: !!_v0,
        onClose: _v1,
        onSubmitAccepted: _v3
      }), _v2.map(_v0 => (0, _v1.jsx)(_v119, {
        batch: _v0
      }, _v0.batchId))]
    });
  }, "useBulkPrivacyModal", 0, () => ({
    openBulkPrivacyModal: _v118(_v0 => _v0.openBulkPrivacyModal),
    closeBulkPrivacyModal: _v118(_v0 => _v0.closeBulkPrivacyModal)
  })], 0);
  var _v120 = _v0.i(0);
  let _v121 = {
    A: "accordion",
  ...
  _v0.s(["useEnableFolderBulkPrivacy", 0, () => {
    let {
      ...
      _v1 = _v121[_v0?.bulk_privacy_modal_variant ?? "hidden"] ?? "hidden",
