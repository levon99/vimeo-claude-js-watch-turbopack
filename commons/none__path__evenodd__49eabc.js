{
  ...
  _v0.s(["VideoMenu", 0, function ({
    ...
    let _v18 = (0, _v5.rem)(24),
      ...
      _v24 = (0, _v67.useRegistrationRequiredToast)(),
      {
      ...
      _v38 = (0, _v43.idFromUri)(_v37),
      _v39 = _v33?.connections?.versions?.currentUri?.split("/").pop(),
      {
        downloadConfig: _v40
      } = (0, _v26.useReviewLinkVideoDownloads)((0, _v43.idFromUri)(_v37), _v27, Number(_v39), !_v28, {
      ...
      _v47 = (0, _v53.useManageShareAction)({
        canEdit: _v46,
        entityUri: _v37,
      ...
      _v49 = !!_v42.hasMultipleReviewLinks && !_v42.hasProhibitMultipleReviewLinks,
      {
        ...
        getReviewPageUrl: (0, _v2.useCallback)(_v0 => (0, _v43.getVideoReviewPageUrl)(_v0, (0, _v43.idFromUri)(_v37)), [_v37])
      }),
      ...
      _v60 = _v32 && (0, _v71.getAnalyticsPageLinkForVideo)(_v32),
      ...
      _v66 = (0, _v62.useUpdateVideoPrivacyCache)(),
      {
        open: _v67
      ...
      _v76 = (0, _v2.useCallback)(_v0 => {
        _v21 !== _v50.PAGE.ELIHP && _v74({
          clipId: String((0, _v43.idFromUri)(_v37)),
      ...
      _v84 = (0, _v70.useActivityCenterStore)(_v0 => _v0.handleNewTranslationJob),
      {
      ...
      } = (0, _v64.useAddToShowcaseModal)(),
      {
        ...
        let {
          setModalState: _v0
        } = (0, _v2.useContext)(_v68.ThumbnailChangeModalDispatch);
        return {
      ...
      _v90 = (0, _v2.useCallback)(() => {
        _v64?.(_v37, "VL_grid_view_overflow"), _v40.BPAnalyticsV2.openVideoShare({
      ...
      _v94 = (0, _v2.useCallback)(() => {
        _v76("privacy"), _v72({
          ...
          videoName: _v0.name,
          currentPrivacy: _v73(_v0.privacy),
      ...
      _v98 = _v44({
        onFailure: () => {
          _v68({
            ...
            content: _v69.deleteVideoFailed
          });
        },
        onSuccess: () => {
          _v68({
            ...
            content: _v69.deleteVideoSuccess
          }), _v69(), _v10?.();
        }
      }),
      ...
      _v100 = _v51(),
      _v101 = (0, _v58.useReviewLinkCopiedToast)(),
      _v102 = (0, _v57.useCreateAndCopyVideoReviewLink)((0, _v2.useCallback)((_v0, _v1) => _v101(() => _v97("CREATE_REVIEW_LINK_MODAL", _v1)), [_v101, _v97])),
      ...
      _v105 = !!_v104?.bi_expiring_links_ux_enabled,
      {
        ...
        replaceInput: _v107,
        replaceModal: _v108
      } = (0, _v34.useReplaceWithModal)(_v38, !!_v104?.new_replace_feature, _v0.metadata?.connections?.versions?.hasInteractive, _v34.navigateToUpgrade, (0, _v43.idFromUri)(_v0.user.uri)),
      _v109 = !!_v104?.enable_review_adoption_v2,
      _v110 = (0, _v66.useCreateAndCopySharingLink)("context_menu", _v0, () => _v20({
      ...
      }, [_v76, _v0, _v31, _v26, _v21, _v110, _v13, _v19?.teamUser, _v1]),
      {
        isOpen: _v113,
        onOpen: _v114,
        onClose: _v115
      } = (0, _v6.useDisclosure)(),
      _v116 = (0, _v36.useCopyReviewLink)((0, _v43.idFromUri)(_v37), _v37),
      _v117 = (0, _v25.useCanUpSell)(),
      _v118 = (0, _v24.selectReviewLinkUriToCopy)(_v0.reviewLinks, _v117),
      {
        trackReviewLinkPromptDisplayed: _v119,
        trackReviewLinkPromptActionClicked: _v120
      } = (0, _v18.useMaximizeReviewAdoptionTracking)(),
      {
        hasSeenReviewLinkPrompt: _v121,
        markReviewLinkPromptSeen: _v122
      } = (0, _v37.useReviewLinkPromptSeen)(),
      _v123 = (0, _v2.useCallback)(() => {
        _v105 && _v46 ? _v112() : _v111((0, _v28.default)(_v62));
      }, [_v105, _v46, _v112, _v62, _v111]),
      _v124 = (0, _v2.useCallback)(() => {
        _v121 ? _v123() : (_v122(), _v119({
          surface: "video_menu",
          clipId: String((0, _v43.idFromUri)(_v37))
        }), _v114());
      }, [_v121, _v123, _v122, _v119, _v37, _v114]),
      ...
      }, [_v120, _v37, _v115, _v116, _v118]),
      _v127 = (0, _v2.useCallback)(() => {
        if (_v76("copy_review_link"), _v40.BPAnalyticsV2.clickActionCopyReviewPageLink({
          location: _v13.location,
          element: _v13.element,
          teamUser: _v19?.teamUser,
          folder: _v1,
        ...
        let _v0 = (0, _v43.idFromUri)(_v37);
        _v53 ? _v101(_v118 ? () => _v97("CREATE_REVIEW_LINK_MODAL", _v118) : void 0) : _v102(_v0, _v37);
      }, [_v2, _v91, _v0, _v37, _v53, _v118, _v102, _v101, _v97, _v1, _v19?.teamUser, _v13, _v42.hasMultipleReviewLinks, _v76]),
      _v128 = (0, _v2.useCallback)(() => {
        _v76("copy_embed_code"), _v103(_v69.embedCodeCopySuccess), _v40.BPAnalyticsV2.clickCopyVideoEmbedCode({
          location: _v13.location,
          element: _v13.element,
          teamUser: _v19?.teamUser,
          folder: _v1,
    ...
    return isNaN((0, _v43.idFromUri)(_v37)) ? (0, _v1.jsx)(_v1.Fragment, {}) : _v0.isColdStorage ? (0, _v1.jsxs)(_v21.ActionsMenu, {
      ...
      children: [(0, _v1.jsx)(_v22.VideoMenu, {
        ...
        onCopyVideoEmbedCode: _v128,
        reviewPageLink: _v53,
        canCopyReviewPageLink: _v51,
        onCopyReviewPageLink: _v127,
        onClickReviewPage: () => {
          _v76("open_review_page"), (0, _v39.sendClickReviewLinkEvent)({
        ...
        onClickAnalyticsPage: () => {
          _v76("analytics"), (0, _v39.sendClickAnalyticsLinkEvent)({
            location: _v14.location,
            page: _v21,
            target_path: _v60 ?? ""
          }), _v8?.();
        ...
        onClickChangeThumbnail: () => {
          _v76("change_thumbnail"), _v89({
            clipId: (0, _v43.idFromUri)(_v37),
            showChooseExisting: !0,
            onSaveSuccess: () => _v1 ? _v85(_v1.uri) : _v86()
          });
        },
        onCopyLinkAsync: _v0.metadata?.hasMandatoryEmailCapture ? () => _v24(_v0) : _v109 ? _v124 : _v105 && _v46 ? _v112 : void 0,
        canEdit: _v46,
        canReplace: _v57,
        onReplace: _v106,
        canShare: _v56,
        ...
        handleTranslateVideo: () => {
          _v76("translate"), (0, _v31.sendBpEventWithContexts)("vimeo.select_translate_bulk", {
            ...
            clipItems: [{
              videoId: String((0, _v43.idFromUri)(_v37)),
        ...
        onAddToShowcase: _v130,
        canAddVideoRating: _v46,
        onAddVideoRating: _v129,
        onMoreInfo: () => {
          _v76("video_info"), (0, _v39.sendOpenSidePanelEvent)({
            page: _v21,
            location: "video_card_menu"
          }), _v11?.();
        },
        ...
        isOpen: _v113,
        onClose: _v115,
        onCopyReviewLink: _v126,
        onCopyRegularLink: _v125,
