{
  ...
  async function _v23(_v0) {
    ...
    try {
      if (_v10) _v0.log.info("Processing auto-login with admin vimeo user"), await _v28(_v0, {
        type: _v11.ADMIN
      });else if (_v11) _v0.log.info("Processing auto-login with vimeo user"), await _v28(_v0, {
        type: _v11.VIMEO
      });else if (_v16) {
      ...
      } else _v12 ? (_v0.log.info("Processing auto-login with registrant user"), await _v28(_v0, {
  ...
  let _v24 = ["user", "firebase.config", "firebase.app_name", "firebase.jwt", "chat_proxy.url", "chat_proxy.jwt", "chat_proxy.exp", "room_id", "room_hash", "room_type", "metadata.connections.chat_history", "metadata.connections.questions_history", "metadata.connections.polls_history", "metadata.misc"];
  async function _v25(_v0, _v1) {
    let _v2 = function (_v0, _v1) {
      let {
          ...
          roomInjectedAuthToken: _v5
        } = _v0.context,
        _v6 = _v5 || _v1.roomSavedUserAuthToken,
        _v7 = _v14();
      return {
        authType: _v1.type,
        roomDisplayName: _v1.roomDisplayName,
        roomGuestCode: _v1.roomGuestCode,
        roomEmail: _v1.roomEmail,
        ...(_v4 ? {
          roomUnlistedHash: encodeURIComponent(_v4)
        } : {}),
        ...(_v2 ? {
          roomPassword: encodeURIComponent(_v2)
        } : {}),
        ...(_v3 ? {
          roomHashedPassword: encodeURIComponent(_v3)
        } : {}),
        ...(_v1.roomRegistrantUuid ? {
          roomRegistrantUuid: _v1.roomRegistrantUuid
        } : {}),
        ...(_v6 ? {
          roomJwtToken: _v6
        } : {}),
    ...
    return _v0.assertIsInitialized(), (0, _v6.postInteractionRoomAuth)({
  ...
  async function _v26(_v0) {
    ...
    if (!_v1) throw new _v15.LiveError("Cannot refresh interaction credentials before an authorization attempt.", {
      code: _v10.ELiveErrorCode.INITIALIZATION
    });
    let _v2 = await _v25(_v0, _v1);
    return _v27(_v0, _v2, _v1), _v2;
  }
  function _v27(_v0, _v1, _v2) {
    ...
    _v0.setContext({
      lastAuthParams: {
        ..._v2,
        roomSavedUserAuthToken: _v3.jwt
      }
    });
    let {
      sessionId: _v4
    } = _v0.context;
    _v0.log.info("Save user auth prefs to localstorage:", _v8.localStorageConfig.INTERACTION.SAVED_USER_AUTH_PREFERENCES(_v4), {
      roomId: _v1.roomId,
      displayName: _v1.user.displayName,
      authToken: _v3
    }), (0, _v17.setLocalStorageItem)(_v8.localStorageConfig.INTERACTION.SAVED_USER_AUTH_PREFERENCES(_v4), {
      roomId: _v1.roomId,
      displayName: _v1.user.displayName,
      authToken: _v3
    });
  ...
  async function _v28(_v0, {
    ...
    try {
      ...
      let _v1 = await _v25(_v0, _v0);
      _v0.log.info("Credentials ready:", _v1), _v0.setContext({
        roomUser: _v0.context.roomUser.asReady(_v1.user)
      }), _v0.log.info("Credentials user auth token:", _v1.user.authToken), _v27(_v0, _v1, _v0), _v0.emitSignal({
  ...
  async function _v30(_v0, _v1, _v2 = _v6.ECredentialsType.PASSWORD) {
    let {
      sessionId: _v3,
      sessionType: _v4,
      roomPassword: _v5,
  ...
  async function _v31(_v0) {
    ...
    try {
      ...
      let _v1 = (0, _v16.inline)(() => _v0?.settings.privacy !== _v12.PASSWORD ? _v23(_v0) : _v5 ? _v30(_v0, _v5) : _v6 ? _v30(_v0, _v6, _v6.ECredentialsType.HASHED_PASSWORD) : Promise.resolve());
      await _v1.finally(() => {
  ...
  class _v32 extends _v3.ContextManager {
    context = {
    ...
    async authorizeInteractionUser(_v0) {
      return (0, _v21.withLiveErrorTracking)(() => _v28(this, _v0), {
        category: _v20.ELiveErrorCategory.INTERACTION,
        method: "authorizeInteractionUser"
      });
    }
    async refreshCredentials() {
      return (0, _v21.withLiveErrorTracking)(() => _v26(this), {
        category: _v20.ELiveErrorCategory.INTERACTION,
        method: "refreshCredentials"
      });
    }
    async logoutInteractionUser() {
      return (0, _v21.withLiveErrorTracking)(() => _v29(this), {
        category: _v20.ELiveErrorCategory.INTERACTION,
    ...
    async checkPasswordAuth(_v0, _v1) {
      return (0, _v21.withLiveErrorTracking)(() => _v30(this, _v0, _v1), {
        category: _v20.ELiveErrorCategory.INTERACTION,
        method: "checkPasswordAuth"
      });
    }
  }
  _v0.s(["InteractionSessionManager", 0, _v32], 0);
}