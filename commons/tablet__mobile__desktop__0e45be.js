{
  ...
  function _v90({
    ...
    let _v8 = (0, _v2.useMemo)(() => {
      ...
      _v9 = [{
        ...
        labelIcon: (0, _v1.jsx)(_v12.Flex, {
          alignItems: "center",
          children: (0, _v1.jsx)(_v86.Tooltip, {
            label: _v8,
            placement: "top",
            children: (0, _v1.jsx)(_v11.Box, {
              ...
              ml: (0, _v15.rem)(4),
              display: "inline-flex",
              children: (0, _v1.jsx)(_v89.InfoCircle, {
    ...
    return (0, _v1.jsxs)(_v11.Box, {
      children: [!_v1 || _v6 < _v1 && (0, _v1.jsx)(_v87.Alert, {
        display: "flex",
        alignItems: "center",
        mb: (0, _v15.rem)(8),
        status: "error",
  ...
  var _v91 = _v0.i(0),
    ...
    _v93 = _v0.i(0),
    _v94 = _v0.i(0);
  let _v95 = (0, _v2.createContext)(null),
    _v96 = ({
      children: _v0
    }) => {
      let _v1 = (0, _v29.useViewer)(),
        {
          capabilities: _v2
        } = (0, _v93.useCapability)(["hasOriginalTranslationsAccents"], _v1?.teamUser?.ownerId),
        {
          data: _v3,
          isLoading: _v4
        } = (0, _v94.useGetVideosTranslationsLanguages)({
          query: {
            type: "accents"
          },
      ...
      return (0, _v1.jsx)(_v95.Provider, {
        value: _v7,
        children: _v0
      });
    },
    _v97 = () => {
      let _v0 = (0, _v2.useContext)(_v95);
    ...
    _v98 = ({
      ...
      return _v2 ? "dubbing" === _v2 ? _v4 ? (0, _v1.jsx)(_v11.Box, {
        pt: (0, _v15.rem)(8),
        children: (0, _v1.jsx)(_v91.LanguageSelectList, {
          availableLanguages: _v4,
          selectedLanguages: _v0,
          onChange: _v0 => {
        ...
        children: (0, _v1.jsx)(_v92.Select, {
          ...
          children: _v0 => {
            ...
            return (0, _v1.jsx)(_v92.SelectItem, {
              ...
              children: (0, _v1.jsx)(_v92.SelectItemText, {
                children: _v0.label
              })
            });
          }
  ...
  let _v100 = ({
    ...
    return _v1 && _v4.push({
      ...
      children: [(0, _v1.jsx)(_v17.Text, {
        ...
        mb: (0, _v15.rem)(16),
        children: _v42
      }), (0, _v1.jsx)(_v92.Select, {
        id: "translation-type-select",
        value: _v3 ? [_v3] : [],
        items: _v4,
        onValueChange: _v0 => _v0(_v0.value[0]),
        placeholder: _v37,
        children: _v0 => (0, _v1.jsx)(_v92.SelectItem, {
          display: "flex",
          children: (0, _v1.jsxs)(_v99.VStack, {
  ...
  function _v101({
    ...
    return (0, _v1.jsxs)(_v11.Box, {
      children: [_v4 && (0, _v1.jsx)(_v87.Alert, {
        display: "flex",
        alignItems: "center",
        mb: (0, _v15.rem)(8),
        status: "error",
  ...
  function _v102({
    ...
    let {
        ...
        let [_v0, {
            ...
            loading: _v2,
            error: _v3
          }] = (0, _v84.useGetUserProjectItemsDeepLazy)(),
          [_v4, {
            data: _v5,
            loading: _v6,
            error: _v7
  ...
  _v0.s(["deleteUserAiBatchsession", 0, _v104, "getUserAiBatchsession", 0, _v103, "patchUserAiBatchsession", 0, _v105], 0), "true" === _v68.default.env.STORYBOOK && (0, _v69.assignMswData)(function (_v0, _v1) {
    let _v2 = "function" == typeof _v0 ? _v0() : _v0,
      {
        baseUrl: _v3,
        jwt: _v4,
    ...
    return (0, _v74.default)(_v2 ? `/users/${_v2.where.userId}/ai/batchsessions/${_v2.where.batchsessionId}${(0, _v69.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v103({
      ..._v2,
      headers: {
        ..._v2.headers,
        "Content-Type": "application/json",
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/users/${_v0.where.userId}/ai/batchsessions/${_v0.where.batchsessionId}${(0, _v69.serializeQuery)(_v0)}`, _v103({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/users/:userId/ai/batchsessions/:batchsessionId",
    method: "DELETE"
  }), "true" === _v68.default.env.STORYBOOK && (0, _v69.assignMswData)(_v106, {
    endpoint: "/users/:userId/ai/batchsessions/:batchsessionId",
    method: "PATCH"
  });
  let _v107 = ({
  ...
  _v0.s(["BulkAiModalProvider", 0, ({
    ...
    return (0, _v1.jsxs)(_v108.Provider, {
      value: {
        setModalContextState: _v3,
        openCancelJobModal: _v10
      },
      children: [_v0, _v8 && (0, _v1.jsx)(_v109, {
        isModalOpen: _v8,
  ...
  var _v110 = _v0.i(0),
    _v111 = _v0.i(0);
  let _v112 = (0, _v110.default)(() => _v0.A(0).then(_v0 => _v0.BulkPrivacyModal), {
      loadableGenerated: {
        modules: [0]
      }
    }),
    _v113 = (0, _v111.create)(_v0 => ({
      modalProps: null,
  ...
  _v0.s(["BulkPrivacyModalHost", 0, () => {
    let _v0 = _v113(_v0 => _v0.modalProps),
      _v1 = _v113(_v0 => _v0.closeBulkPrivacyModal);
    return _v0 ? (0, _v1.jsx)(_v112, {
      ..._v0,
      isOpen: !!_v0,
      onClose: _v1
    }) : null;
  }, "useBulkPrivacyModal", 0, () => ({
    openBulkPrivacyModal: _v113(_v0 => _v0.openBulkPrivacyModal),
    closeBulkPrivacyModal: _v113(_v0 => _v0.closeBulkPrivacyModal)
  })], 0);
  var _v114 = _v0.i(0);
  let _v115 = {
    A: "accordion",
  ...
  _v0.s(["useEnableFolderBulkPrivacy", 0, () => {
    let {
        settings: _v0
      } = (0, _v114.useOrionSettings)(),
      _v1 = _v115[_v0?.bulk_privacy_modal_variant ?? "hidden"] ?? "hidden",
