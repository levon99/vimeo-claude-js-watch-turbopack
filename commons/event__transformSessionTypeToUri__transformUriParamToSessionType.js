{
  ...
  _v0.s(["transformSessionTypeToUri", 0, _v3, "transformUriParamToSessionType", 0, function (_v0) {
  ...
  let _v5 = {
    ...
    USER: {
      DEFAULT_LOGO_URL: (_v0, _v1) => `${_v1.environmentConfig.IS_DEV ? _v5.CDN.DEV : _v5.CDN.PROD}/portrait/defaults-blue_${_v0}x${_v1 ?? _v0}.png`
    },
    PATH: {
      CLIP_VIEWER_PAGE: _v0 => `/${_v0}`,
      CLIP_SETTINGS_PAGE: (_v0, _v1 = {}) => `/manage/videos/${_v0}${_v1.trim ? "/trim" : ""}`,
      CLIP_BROADCASTER_PAGE: (_v0, _v1 = null) => `/manage/videos/${_v0}/registration${(0, _v4.encodeQueryObjectAsString)(_v1)}`,
      ...
      BROADCASTER_PAGE: (_v0, _v1, _v2 = null) => `/live/broadcaster/${_v3(_v0)}/${_v1}${(0, _v4.encodeQueryObjectAsString)(_v2)}`,
      RTMP_PAGE: (_v0, _v1, _v2 = null) => `/live/rtmp/${_v3(_v0)}/${_v1}${(0, _v4.encodeQueryObjectAsString)(_v2)}`,
      EVENT_VIEWER_PAGE: (_v0, _v1 = null) => `${window.location.origin}/event/${_v0}${_v1 ? "/" + _v1 : ""}`,
      INTERACTION_TOOLS_PAGE: (_v0, _v1, _v2 = null) => `/live/interaction_tools/${_v3(_v0)}/${_v1}${(0, _v4.encodeQueryObjectAsString)(_v2)}`,
      COMPLETED_PAGE: (_v0, _v1, _v2 = null) => `/live/completed/${_v3(_v0)}/${_v1}${(0, _v4.encodeQueryObjectAsString)(_v2)}`,
    ...
    VIDEOTHUMB: {
      ...
      URL_AT_RATIO_FOR_ID: (_v0, _v1, _v2 = 16 / 9, _v3) => `${_v1.environmentConfig.IS_COM || _v3 ? _v5.CDN.PROD : _v5.CDN.DEV}/video/${_v0}_${Math.floor(_v1 * _v2)}x${Math.floor(_v1)}`
    },
    SUPPORT: {
