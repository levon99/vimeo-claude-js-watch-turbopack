{
  ...
  async function _v5({
    ...
    return (0, _v3.measureLatency)("postMeOrders", "POST", async () => {
      let _v0 = await fetch(`${_v0}/me/orders?fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v3,
        method: "POST",
  ...
  function _v9() {
    ...
    return [(0, _v6.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me/orders${(0, _v2.serializeQuery)(_v0)}`, _v5({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
