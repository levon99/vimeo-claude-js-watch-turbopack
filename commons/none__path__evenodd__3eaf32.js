  ...
  _v0.s(["VideoMenu", 0, function ({
    ...
    let _v18 = (0, _v5.rem)(24),
      ...
      } = _v0,
      {
        triggerReplace: _v37,
        replaceInput: _v38
      } = (0, _v29.useReplaceUpload)((0, _v43.idFromUri)(_v36)),
      _v39 = _v32?.connections?.versions?.currentUri?.split("/").pop(),
      {
        downloadConfig: _v40
      } = (0, _v26.useReviewLinkVideoDownloads)((0, _v43.idFromUri)(_v36), _v26, Number(_v39), !_v27, {
      ...
      _v60 = _v31 && (0, _v70.getAnalyticsPageLinkForVideo)(_v31),
      ...
      }, [_v21, _v74, _v36, _v0.parentProject?.isPrivateToUser]),
      {
      ...
      _v84 = (0, _v69.useActivityCenterStore)(_v0 => _v0.handleNewTranslationJob),
      {
      ...
      _v90 = (0, _v2.useCallback)(() => {
        _v64?.(_v36, "VL_grid_view_overflow"), _v40.BPAnalyticsV2.openVideoShare({
      ...
      _v95 = (0, _v2.useCallback)(() => {
        (_v76("share"), _v92) ? _v93() : _v4 ? _v91("video_share") : _v90();
      }, [_v90, _v4, _v92, _v91, _v93, _v76]),
      _v96 = () => {
        _v1 ? _v85(_v1.uri) : _v86();
      },
      _v97 = (0, _v2.useCallback)((_v0, _v1) => {
        _v64?.(_v36, "VL_grid_view_overflow", _v0, _v1, _v96);
      }, [_v64, _v36]),
      _v98 = _v44({
        onFailure: () => {
          _v68({
      ...
      _v106 = !!_v104?.enable_review_adoption_v2,
      _v107 = (0, _v66.useCreateAndCopySharingLink)("context_menu", _v0, () => _v20({
      ...
      }, [_v76, _v0, _v30, _v25, _v21, _v107, _v13, _v19?.teamUser, _v1]),
      {
        isOpen: _v110,
        onOpen: _v111,
        onClose: _v112
      } = (0, _v6.useDisclosure)(),
      _v113 = (0, _v36.useCopyReviewLink)((0, _v43.idFromUri)(_v36), _v36),
      _v114 = (0, _v25.useCanUpSell)(),
      _v115 = (0, _v24.selectReviewLinkUriToCopy)(_v0.reviewLinks, _v114),
      {
        trackReviewLinkPromptDisplayed: _v116,
        trackReviewLinkPromptActionClicked: _v117
      } = (0, _v18.useMaximizeReviewAdoptionTracking)(),
      {
        hasSeenReviewLinkPrompt: _v118,
        markReviewLinkPromptSeen: _v119
      } = (0, _v37.useReviewLinkPromptSeen)(),
      _v120 = (0, _v2.useCallback)(() => {
        _v105 && _v46 ? _v109() : _v108((0, _v28.default)(_v62));
      }, [_v105, _v46, _v109, _v62, _v108]),
      _v121 = (0, _v2.useCallback)(() => {
        _v118 ? _v120() : (_v119(), _v116({
          surface: "video_menu",
          clipId: String((0, _v43.idFromUri)(_v36))
        }), _v111());
      }, [_v118, _v120, _v119, _v116, _v36, _v111]),
      ...
      _v124 = (0, _v2.useCallback)(() => {
        ...
        _v53 ? _v101(_v115 ? () => _v97("CREATE_REVIEW_LINK_MODAL", _v115) : void 0) : _v102(_v0, _v36);
      }, [_v2, _v91, _v0, _v36, _v53, _v115, _v102, _v101, _v97, _v1, _v19?.teamUser, _v13, _v42.hasMultipleReviewLinks, _v76]),
      _v125 = (0, _v2.useCallback)(() => {
        _v76("copy_embed_code"), _v103(_v68.embedCodeCopySuccess), _v40.BPAnalyticsV2.clickCopyVideoEmbedCode({
          location: _v13.location,
          element: _v13.element,
          teamUser: _v19?.teamUser,
          folder: _v1,
      ...
      }, [_v76, _v82, _v36, _v0, _v48, _v1, _v83, _v85, _v86]),
    ...
    return isNaN((0, _v43.idFromUri)(_v36)) ? (0, _v1.jsx)(_v1.Fragment, {}) : _v0.isColdStorage ? (0, _v1.jsxs)(_v21.ActionsMenu, {
      ...
      children: [(0, _v1.jsx)(_v22.VideoMenu, {
        ...
        onCopyVideoEmbedCode: _v125,
        reviewPageLink: _v53,
        canCopyReviewPageLink: _v51,
        onCopyReviewPageLink: _v124,
        onClickReviewPage: () => {
        ...
        onCopyLinkAsync: _v106 ? _v121 : _v105 && _v46 ? _v109 : void 0,
        canEdit: _v46,
        canReplace: _v57,
        onReplace: _v37,
        canShare: _v56,
        ...
        handleTranslateVideo: () => {
          _v76("translate"), (0, _v32.sendBpEventWithContexts)("vimeo.select_translate_bulk", {
            ...(0, _v34.buildActionBpContext)({
              action_type: "click",
              feature: null
            }),
            ...
            ...(0, _v31.buildWebBpContext)({
              page_name: "video_library"
            }),
            ...(0, _v33.buildTeamBpContextFromTeamUser)(_v19?.teamUser)
          }, 1, {
            value: String(1),
        ...
        onAddToShowcase: _v127,
        canAddVideoRating: _v46,
        onAddVideoRating: _v126,
        onMoreInfo: () => {
        ...
        isOpen: _v110,
        onClose: _v112,
        onCopyReviewLink: _v123,
        onCopyRegularLink: _v122,
