{
  ...
  _v0.s(["PlansComparisonPaywallModal", 0, function ({
    ...
    let _v9,
      ...
      _v28 = (0, _v2.useRef)(_v24),
      _v29 = (0, _v2.useRef)(_v27);
    (0, _v2.useEffect)(() => {
      _v28.current = _v24, _v29.current = _v27;
    }), (0, _v2.useEffect)(() => {
      _v0 && _v28.current(_v29.current);
    }, [_v0]);
    let _v30 = () => {
        _v25(_v27), _v8("manual");
      },
      _v31 = (0, _v18.translate)({
        singular: "Join Vimeo",
        dictionary: {
          es: {
        ...
        children: [(0, _v1.jsx)(_v9.ModalCloseButton, {
          ...
          children: (0, _v1.jsxs)(_v6.Flex, {
            ...
            children: [(0, _v1.jsxs)(_v6.Flex, {
              ...
              children: [(0, _v1.jsx)(_v15.Text, {
                variant: {
                  base: "heading-lg",
                  md: _v32 ? "heading-xl" : "heading-2xl"
                },
                whiteSpace: "nowrap",
                children: _v31
              }), (0, _v1.jsx)(_v4.Box, {
          ...
          children: [(0, _v1.jsx)(_v4.Box, {
            ...
            children: [(0, _v1.jsxs)(_v6.Flex, {
              ...
              borderStyle: "solid",
              cursor: "pointer",
              bg: _v14 ? "var(--vimeo-colors-vimeoBlue-50)" : "surface",
              _hover: {
                bg: _v14 ? "var(--vimeo-colors-vimeoBlue-50)" : "input-fill-hover"
              },
              transition: "background-color 0.15s ease, border-color 0.15s ease",
              sx: {
                width: "100% !important"
