{
  ...
  var _v61 = _v0.i(0),
    ...
    _v65 = _v0.i(0),
    _v66 = _v0.i(0);
  let _v67 = "video-library:wayfinder-side-nav-open",
    _v68 = (_v0, _v1) => _v1 ? `${_v67}:${_v0}:${_v1}` : `${_v67}:${_v0}`,
    _v69 = (_v0, _v1) => {
      if (!_v0) return;
      let _v2 = window.localStorage.getItem(_v68(_v0, _v1));
  ...
  let _v76 = ({
      ...
      let _v11 = (0, _v75.useWayfinderPageName)(),
        _v12 = (0, _v74.useSideNavUpgradeClick)();
      return (0, _v1.jsx)(_v77, {
        type: _v72.PlayerType.BarebonePlayer,
        assetUrls: _v8,
        children: (0, _v1.jsx)(_v73.WayfinderSideNav, {
          isOpen: _v0,
          isMobile: _v1,
          onClose: _v2,
          onResize: _v3,
    ...
    _v77 = ({
      ...
      assetUrls: _v1,
      type: _v2
    }) => _v1 ? (0, _v1.jsx)(_v71.PlayerContextProvider, {
      assetUrls: _v1,
      type: _v2,
      children: _v0
    }) : _v0,
    _v78 = (0, _v2.default)(async () => ({
  ...
  _v0.s(["VideoLibraryLayout", 0, ({
    ...
    let _v10,
      ...
      _v26 = (!!_v24.canGenerateClipTranslation || _v25) && !!_v24.canPerformBulkTranslations,
      {
        ...
        let _v2 = (0, _v62.useWindowSize)(),
          _v3 = (0, _v4.useContext)(_v64.ViewerContext),
          {
            settings: _v4
          } = (0, _v17.useOrionSettings)(),
          _v5 = !!(_v4.enable_new_sidebar && _v1),
          _v6 = _v5 ? _v1 : void 0,
          [_v7, _v8] = (0, _v61.useGetUserPreferencesLazy)(),
          _v9 = (0, _v65.usePageName)() !== _v66.PAGE.SEARCH,
          [_v10, _v11] = (0, _v4.useState)(_v2.width >= _v63.BreakPoints.lg && !!_v9 && (_v69(_v3?.user?.id, _v6) ?? !0)),
          [_v12] = (0, _v61.usePatchUserPreferences)(),
          _v13 = _v2.width >= _v63.BreakPoints.md;
        (0, _v4.useEffect)(() => {
          _v2.width <= _v63.BreakPoints.sm && _v11(!1);
        }, [_v2]), (0, _v4.useEffect)(() => {
          if (!_v5 && _v13 && _v9 && !_v0) {
            let _v0 = _v8?.data?.wsns;
            if ("boolean" == typeof _v0 && (_v11(_v0), _v3?.user?.id)) try {
              window.localStorage.setItem(_v68(_v3.user.id), _v0 ? "true" : "false");
            } catch (_v0) {}
          }
        }, [_v8?.data, _v0, _v5]), (0, _v4.useEffect)(() => {
          if (!_v3?.user?.id) return;
          let _v0 = _v69(_v3.user.id, _v6);
        ...
        let _v14 = (0, _v4.useCallback)(() => {
            ...
            try {
              window.localStorage.setItem(_v68(_v3.user.id, _v6), _v0 ? "true" : "false");
            } catch (_v0) {}
            _v11(_v0);
          }, [_v3, _v10, _v13, _v12, _v5, _v6]),
          _v15 = !!(_v4.enable_new_sidebar && _v2.width > _v63.BreakPoints.lg),
          _v16 = _v15 && !_v10;
        return {
          isOpen: _v10,
        ...
        children: (0, _v1.jsx)(_v21.AnalyticsEventProvider, {
          ...
          children: (0, _v1.jsx)(_v52, {
            children: (0, _v1.jsxs)(_v18.OmnisearchContextProvider, {
              children: [(0, _v1.jsx)(_v57.StarredItemsProvider, {
                children: (0, _v1.jsx)(_v55.TransferFileModalProvider, {
                  children: (0, _v1.jsx)(_v54.ReviewModalProvider, {
                    children: (0, _v1.jsx)(_v58.VideoLibraryLayoutContext.Provider, {
                      value: {
                        isSideNavOpen: !!_v27,
                      ...
                      children: (0, _v1.jsxs)(_v10.Flex, {
                        ...
                        children: [_v38 && (0, _v1.jsx)(_v23.NewSidebarIntroContext.Provider, {
                          value: _v66,
                          children: _v63.enable_new_sidebar && "library" === _v4 ? (0, _v1.jsx)(_v70.SecondarySideNav, {
                            isOpen: !!_v27,
                            isMobile: _v15,
                            collapsed: _v29,
                            onClose: _v28,
