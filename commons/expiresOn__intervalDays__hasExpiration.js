{
  ...
  let _v12 = (_v0, _v1, _v2) => {
    ...
    _v8.current = _v6;
    let _v9 = (0, _v8.useCopyVideoLinkToast)(),
      _v10 = (0, _v1.useRef)(_v9);
    _v10.current = _v9;
    let _v11 = (0, _v1.useRef)(_v1);
    _v11.current = _v1;
    let _v12 = (0, _v11.default)(),
    ...
    return (0, _v1.useEffect)(() => {
      if (_v4?.url && _v17.current) {
        ...
        if (_v13.current("sharing_link"), (0, _v5.default)(_v0)) {
          let _v0 = _v4.expiresOn ?? null,
            _v1 = _v4.intervalDays ?? 0,
            _v2 = _v4 && _v0 ? (0, _v10.formatExpiryDuration)(_v0) : void 0,
            _v3 = _v4 && _v0 && _v1 && (0, _v10.getRemainingDays)(_v0) <= _v10.EXPIRY_SOON_DAYS ? () => _v16.current(_v1, _v1) : void 0;
          if (_v2) {
