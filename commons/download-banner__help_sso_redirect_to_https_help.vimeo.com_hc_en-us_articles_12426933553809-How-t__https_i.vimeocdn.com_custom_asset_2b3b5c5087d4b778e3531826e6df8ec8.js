{
  ...
  function _v77({
    ...
    return (0, _v1.jsxs)(_v43.Flex, {
      ...
      children: [(0, _v1.jsx)(_v71.Image, {
        ...
        variant: "primary",
        "aria-label": "download",
        rightIcon: (0, _v1.jsx)(_v72.ArrowToBottom, {}),
        onClick: _v9,
        sx: {
          [`@container banner (max-width: ${(0, _v44.rem)(600)})`]: {
  ...
  let _v82 = (0, _v5.forwardRef)(function ({
    ...
    return (0, _v81.useVideoSourceSync)(_v9, _v2), (0, _v1.jsxs)(_v80.Box, {
      ...
      children: [(0, _v1.jsx)("video", {
        ...
        alignItems: "center",
        sx: _v68.FULL_WIDTH_ABSOLUTE_STYLE,
        children: _v5
      })]
    });
  });
  ...
  function _v109({
    ...
    studioContext: {
      ...
      previewLanguage: _v3,
      studioActions: _v4
    } = (0, _v12.useManager)(_v64.StudioManager)
  }) {
    let {
        primaryLanguage: _v5,
        secondaryLanguages: _v6,
      ...
      _v3 = (0, _v5.useMemo)(() => {
        switch (_v0) {
          case _v27.EIngestStatus.STREAMING:
            return _v1 ? _v67.LIVE_LAYOUT_COLOR : _v67.INCOMING_LAYOUT_COLOR;
          case _v27.EIngestStatus.PROVISION_REQUESTED:
          case _v27.EIngestStatus.PROVISION_READY:
            return _v1 ? _v67.WARNING_LAYOUT_COLOR : _v67.INCOMING_LAYOUT_COLOR;
          default:
            return _v67.NONE_LAYOUT_COLOR;
        }
      }, [_v0, _v1]);
    return (0, _v1.jsx)(_v69.Paragraph, {
      position: "absolute",
      left: (0, _v44.rem)(12),
      top: (0, _v44.rem)(12),
      size: "xs",
      ...
      userSelect: "none",
      fontWeight: "bold",
      zIndex: _v60.graphicsConfig.GRAPHICS_POSITIONING.Z_INDEX.SCENE_LABEL,
      children: _v2
    });
  }
  var _v111 = _v0.i(0);
  ...
  function _v117({
    ...
    let _v5 = (0, _v116.useDurationTimer)({
      ...
      _v6 = function () {
        let {
          ...
          [_v4, _v5] = (0, _v65.inline)(() => Number.isFinite(_v3) && Number.isFinite(_v2) ? [_v3, _v2] : Number.isFinite(_v0.videoHeight) && Number.isFinite(_v0.videoWidth) && _v1?.value?.owner?.capabilities?.hasUhdStreaming ? [_v0.videoHeight, _v0.videoWidth] : [0, 0]);
    ...
    return (0, _v1.jsxs)(_v43.Flex, {
      ...
      gap: (0, _v44.rem)(8),
      zIndex: _v60.graphicsConfig.GRAPHICS_POSITIONING.Z_INDEX.SCENE_LABEL,
      children: [(0, _v1.jsxs)(_v54.Center, {
  ...
  function _v120({
    ...
    let _v6 = (0, _v22.useIsVpaas)(),
      _v7 = !!(_v4?.app?.uri && _v62.vimeoConfig.STREAMYARD_APP_URIS.includes(_v4.app.uri)),
      _v8 = !!(_v4 && (null === _v2 || _v3.isRtcMode) && !_v6),
      [_v9, _v10] = (0, _v5.useState)(() => !(0, _v66.getFromLocalStorage)(_v61.localStorageConfig.MARKETING.HOW_GO_LIVE_NOTICE)),
      _v11 = (0, _v5.useCallback)(() => {
        (0, _v66.setLocalStorageItem)(_v61.localStorageConfig.MARKETING.HOW_GO_LIVE_NOTICE, !0), _v10(!1);
      }, []),
      _v12 = _v3.isSessionUnavailable || _v3.isSessionReady && _v3.isRtcMode,
      _v13 = (0, _v65.inline)(() => _v3.isSessionUnknown || _v12 && _v5 ? (0, _v1.jsx)(_v59.BokehSkeleton, {
        ...
        width: "100%",
        maxWidth: (0, _v44.rem)(_v60.graphicsConfig.RTMP_PREVIEW.MAX_WIDTH),
        children: [_v9 && !_v7 ? (0, _v1.jsx)(_v55.Alert, {
          onClose: _v11,
          width: "auto",
          alignItems: "center",
          paddingY: (0, _v44.rem)(8),
          children: (0, _v1.jsx)(_v56.AlertDescription, {
            children: _v58.translations.connectEncoderHelper
          })
          ...
          borderColor: "stroke",
          sx: _v68.STRICT_16BY9_BOX_STYLE,
          children: (0, _v1.jsx)(_v54.Center, {
            sx: _v68.FULL_WIDTH_ABSOLUTE_STYLE,
            ...
            children: (0, _v1.jsxs)(_v43.Flex, {
              ...
              children: [_v7 ? (0, _v1.jsx)(_v119, {
                ...
                size: "md",
                children: _v7 ? _v58.translations.connectedToStreamYardTitle : _v58.translations.connectEncoder
              }), (0, _v1.jsx)(_v53.Text, {
                id: (0, _v50.createDomName)(_v0, "connect-description"),
                className: (0, _v50.createDomName)(_v1, "connect-description"),
                color: "text-secondary",
                variant: "body-md",
                children: _v7 ? _v58.translations.connectedToStreamYardDescription : _v58.translations.connectEncoderDescription
              })]
            })
          })
        ...
        children: (0, _v1.jsx)(_v43.Flex, {
          ...
          children: (0, _v1.jsx)(_v43.Flex, {
            ...
            children: (0, _v1.jsx)(_v52.Header, {
              ...
              size: "md",
              color: "white",
              children: _v58.translations.eventEnded
            })
          })
        })
      ...
      children: [(0, _v1.jsx)(_v192.RightPanelHeader, {
        ...
        children: (0, _v1.jsx)(_v43.Flex, {
          ...
          children: _v3 ? (0, _v1.jsxs)(_v1.Fragment, {
            ...
            description: _v58.translations.turnOnChatToEngageWithYourAudience,
            onButtonClick: _v12
          })
        })
      })]
      ...
      return (0, _v1.jsxs)(_v43.Flex, {
        ...
        children: [(0, _v1.jsx)(_v52.Header, {
          ...
          children: [(0, _v1.jsx)(_v69.Paragraph, {
            ...
            borderRadius: "subtle",
            border: "none",
            children: _v3 ? _v58.translations.connected : _v58.translations.unknown
          })]
        }), (0, _v1.jsxs)(_v43.Flex, {
          justifyContent: "space-between",
          gap: (0, _v44.rem)(8),
          ...
          children: [(0, _v1.jsx)(_v69.Paragraph, {
            ...
            borderRadius: "subtle",
            border: "none",
            children: _v4 ? _v58.translations.connected : _v58.translations.notAvailable
          })]
        })]
      });
    });
  ...
  function _v221({
    ...
    return (0, _v1.jsxs)(_v43.Flex, {
      ...
      children: [(0, _v1.jsxs)(_v43.Flex, {
        ...
        marginTop: (0, _v44.rem)(8),
        onClick: _v12,
        children: _v10 ? _v58.translations.hideAdvancedAnalytics : _v58.translations.showAdvancedAnalytics
      })]
    });
  }
