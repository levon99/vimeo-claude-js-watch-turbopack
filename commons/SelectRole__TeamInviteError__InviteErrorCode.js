{
  ...
  let _v7 = (_v0, _v1 = !1) => ({
    email: "",
    isEmailValid: !0,
    role: _v1 ? _v5 : _v0 ? _v3.TeamUserPermissionLevel.Viewer : _v3.TeamUserPermissionLevel.Admin
  });
  _v0.s(["InviteErrorCode", 0, {
    AlreadyInvited: 0,
    AlreadyJoined: 0,
    MemberLimitReached: 0,
    SeatLimitReached: 0
  }, "MAX_INVITE_COUNT", 0, 10, "MAX_SINGLE_SEAT_INVITE_COUNT", 0, 200, "SelectRole", 0, _v5, "TOAST_OOPS", 0, "TOAST_OOPS", "emptyInvite", 0, _v7, "filterInvitesWithEmails", 0, _v0 => _v0.filter(_v0 => !!_v0.email), "generateRandomHash", 0, () => Date.now().toString(36), "getInitialPendingInvites", 0, (_v0, _v1) => Array(Math.min(_v0, 3)).fill(_v7(_v1)), "getValidatedEmails", 0, _v0 => _v0.map((_v0, _v1) => {
    if (!_v0.email) return {
      ..._v0,
      isEmailValid: !0
    };
    ...
    return Promise.all(_v0.filter(_v0 => _v0.email.toLowerCase() !== _v5?.toLowerCase()).map(async _v0 => {
      ...
      try {
        ...
        if (!_v0.ok) {
          let _v0;
          _v1.BigPictureClient.sendEvent(new _v1.Event("onboarding.team_invites_email_error", 1, {
            product: "Onboarding",
            path: window.location.pathname,
            location: "onboarding"
          }));
  ...
  }, "isTeamInviteError", 0, _v0 => _v0 instanceof Error && "TeamInviteError" === _v0.name, "isTestUser", 0, _v0 => !!/^.*\+idt617@vimeo\.com$/.exec(_v0), "setInviteCountInStorage", 0, _v0 => {
  ...
  _v0.s(["sendBigPictureBackEvent", 0, (_v0, _v1) => {
    ...
    try {
      let _v0 = new _v1.Event("vimeo.change_team_member_role", 2, {
        ...
        location: _v9,
        feature: _v9,
        old_role: _v0 === _v5 ? null : _v0.toLowerCase(),
