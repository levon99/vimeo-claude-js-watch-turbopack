{
  ...
  _v0.s(["VideoMenu", 0, function ({
    ...
    let _v18 = (0, _v5.rem)(24),
      ...
      _v23 = (0, _v63.useCopyVideoLinkToast)(),
      {
      ...
      _v60 = _v31 && (0, _v68.getAnalyticsPageLinkForVideo)(_v31),
      ...
      _v82 = (0, _v67.useActivityCenterStore)(_v0 => _v0.handleNewTranslationJob),
      {
      ...
      } = (0, _v62.useAddToShowcaseModal)(),
      {
        openThumbnailModal: _v87
      } = (() => {
        let {
          setModalState: _v0
        } = (0, _v2.useContext)(_v65.ThumbnailChangeModalDispatch);
        return {
      ...
      _v95 = _v44({
        onFailure: () => {
          _v66({
            ...
            content: _v66.deleteVideoFailed
          });
        },
        onSuccess: () => {
          _v66({
            ...
            content: _v66.deleteVideoSuccess
          }), _v67(), _v10?.();
        }
      }),
      ...
      _v97 = _v51(),
      _v98 = (0, _v58.useReviewLinkCopiedToast)(),
      _v99 = (0, _v57.useCreateAndCopyVideoReviewLink)((0, _v2.useCallback)((_v0, _v1) => _v98(() => _v94("CREATE_REVIEW_LINK_MODAL", _v1)), [_v98, _v94])),
      ...
      _v103 = !!_v101?.enable_review_adoption_v2,
      _v104 = (0, _v64.useCreateAndCopySharingLink)("context_menu", _v0, () => _v20({
      ...
      _v106 = (0, _v2.useCallback)(() => {
        ...
        let _v0 = (0, _v43.idFromUri)(_v0?.uri),
          ...
          _v2 = `${_v30}${_v1}`;
        _v104(_v0, _v1, _v2), _v40.BPAnalyticsV2.copyVideoShareLink({
          location: _v13.location,
          element: _v13.element,
          teamUser: _v19?.teamUser,
          folder: _v1,
      ...
      }, [_v74, _v0, _v30, _v25, _v21, _v104, _v13, _v19?.teamUser, _v1]),
      {
        isOpen: _v107,
        onOpen: _v108,
        onClose: _v109
      } = (0, _v6.useDisclosure)(),
      _v110 = (0, _v36.useCopyReviewLink)((0, _v43.idFromUri)(_v36), _v36),
      _v111 = (0, _v25.useCanUpSell)(),
      _v112 = (0, _v24.selectReviewLinkUriToCopy)(_v0.reviewLinks, _v111),
      {
        trackReviewLinkPromptDisplayed: _v113,
        trackReviewLinkPromptActionClicked: _v114
      } = (0, _v18.useMaximizeReviewAdoptionTracking)(),
      {
        hasSeenReviewLinkPrompt: _v115,
        markReviewLinkPromptSeen: _v116
      } = (0, _v37.useReviewLinkPromptSeen)(),
      _v117 = (0, _v2.useCallback)(() => {
        _v102 && _v46 ? _v106() : _v105((0, _v28.default)(_v62));
      }, [_v102, _v46, _v106, _v62, _v105]),
      _v118 = (0, _v2.useCallback)(() => {
        _v115 ? _v117() : (_v116(), _v113({
          surface: "video_menu",
          clipId: String((0, _v43.idFromUri)(_v36))
        }), _v108());
      }, [_v115, _v117, _v116, _v113, _v36, _v108]),
      ...
      }, [_v114, _v36, _v109, _v110, _v112]),
      _v121 = (0, _v2.useCallback)(() => {
        if (_v74("copy_review_link"), _v40.BPAnalyticsV2.clickActionCopyReviewPageLink({
          location: _v13.location,
          element: _v13.element,
          teamUser: _v19?.teamUser,
          folder: _v1,
        ...
        _v53 ? _v98(_v112 ? () => _v94("CREATE_REVIEW_LINK_MODAL", _v112) : void 0) : _v99(_v0, _v36);
      }, [_v2, _v89, _v0, _v36, _v53, _v112, _v99, _v98, _v94, _v1, _v19?.teamUser, _v13, _v42.hasMultipleReviewLinks, _v74]),
      _v122 = (0, _v2.useCallback)(() => {
        _v74("copy_embed_code"), _v100(_v66.embedCodeCopySuccess), _v40.BPAnalyticsV2.clickCopyVideoEmbedCode({
          location: _v13.location,
          element: _v13.element,
          teamUser: _v19?.teamUser,
          folder: _v1,
    ...
    return isNaN((0, _v43.idFromUri)(_v36)) ? (0, _v1.jsx)(_v1.Fragment, {}) : _v0.isColdStorage ? (0, _v1.jsxs)(_v21.ActionsMenu, {
      ...
      children: [(0, _v1.jsx)(_v22.VideoMenu, {
        ...
        onCopyVideoEmbedCode: _v122,
        reviewPageLink: _v53,
        canCopyReviewPageLink: _v51,
        onCopyReviewPageLink: _v121,
        onClickReviewPage: () => {
          _v74("open_review_page"), (0, _v39.sendClickReviewLinkEvent)({
        ...
        onClickAnalyticsPage: () => {
          _v74("analytics"), (0, _v39.sendClickAnalyticsLinkEvent)({
            location: _v14.location,
            page: _v21,
            target_path: _v60 ?? ""
          }), _v8?.();
        ...
        onCopyLinkAsync: _v103 ? _v118 : _v102 && _v46 ? _v106 : void 0,
        canEdit: _v46,
        canReplace: _v57,
        onReplace: _v37,
        canShare: _v56,
        ...
        handleTranslateVideo: () => {
          _v74("translate"), (0, _v32.sendBpEventWithContexts)("vimeo.select_translate_bulk", {
        ...
        onAddToShowcase: _v124,
        canAddVideoRating: _v46,
        onAddVideoRating: _v123,
        onMoreInfo: () => {
          _v74("video_info"), (0, _v39.sendOpenSidePanelEvent)({
            page: _v21,
            location: "video_card_menu"
          }), _v11?.();
        },
        ...
        onCopyVideo: _v16 && !_v0.disabledProperties?.duplicate && (0, _v61.isCopyableVideoContent)(_v0) ? () => {
          _v74("make_copy"), _v16();
        } : void 0,
        ...
        isOpen: _v107,
        onClose: _v109,
        onCopyReviewLink: _v120,
        onCopyRegularLink: _v119,
