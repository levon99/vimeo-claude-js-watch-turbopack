{
  ...
  var _v7 = _v0.i(0);
  let _v8 = (_v0, _v1, _v2) => globalThis.__metrics?.histogram(_v0, _v1, _v2),
    _v9 = (_v0, _v1) => globalThis.__metrics?.counter(_v0, _v1),
    _v10 = async () => await _v3.default.getConfig(),
    _v11 = ["cookie", "crossroads-jwt", "crossroads-language", "crossroads-logged-out", "user-agent"];
  ...
  async function _v15(_v0) {
    ...
    try {
      let _v0 = await fetch(`https://${_v1}/_next/magisto_resources`, {
        headers: _v2
      });
      if (!_v0.ok) return null;
      let _v1 = await _v0.json();
      ...
      return console.warn("withPageSetup: failed to fetch magisto resources", _v0), null;
    }
  }
  _v0.s(["withPageSetup", 0, function (_v0, _v1) {
    ...
    return "function" == typeof _v0 ? (_v2 = _v0, _v3 = _v1) : (_v3 = _v0, _v2 = () => ({
      ...
      let _v1 = _v1.default.hrtime.bigint(),
        ...
        _v5 = (_v0, _v1, _v2) => {
          _v8("vimeo_nextjs_ssr_setup_duration_seconds", {
            route: _v2,
            result: _v1
          }, _v2), _v8("vimeo_nextjs_http_request_duration_seconds", {
            route: _v2,
            method: _v3,
            status_code: _v0
          }, _v4());
        ...
        _v7 = (_v0, _v1) => (_v9("vimeo_nextjs_ssr_auth_redirect_total", {
          reason: _v0,
      ...
      try {
        ...
        if (!_v3?.requireLogin && !_v3?.capability && !_v3?.staffOnly) {
          _v8 = _v4();
          let _v0 = _v3?.inlineViewer === "all" || _v3?.inlineViewer && _v5.jwt && !_v4(_v5.req) ? _v12(_v5) : null,
            _v1 = _v3?.inlinePlayerAssets ? _v13(_v5) : null,
            _v2 = _v3?.inlineCreatePreloads && _v4(_v5.req) ? _v14(_v5) : null,
            _v3 = _v3?.inlineMagistoResources ? _v15(_v5) : null,
            _v4 = await _v2(_v5),
            _v5 = "redirect" in _v4 ? _v6(_v4.redirect) : "notFound" in _v4 ? "404" : "200";
          return _v5(_v5, "success", _v8), _v4(_v4, {
            locale: _v3
          }, _v0 ? await _v0 : null, _v1 ? await _v1 : null, _v2 ? await _v2 : null, _v3 ? await _v3 : null);
        }
        if (_v4(_v5.req)) {
        ...
        if (_v3?.staffOnly || _v3?.capability) try {
          ...
          if (_v3?.capability && _v0.push(_v3.capability), _v6 = await (0, _v7.fetchAndFormatCapabilties)({
            jwt: _v5.jwt,
            capabilities: _v0,
            apiUrl: _v5.baseUrl,
            headers: _v5.headers
          ...
          if (_v3?.capability && !1 === _v6[_v3.capability]) {
            if (console.log("capability: User is missing capabilities"), _v3?.redirect) return _v9("vimeo_nextjs_ssr_auth_redirect_total", {
        ...
        let _v7 = _v3?.inlineViewer ? _v12(_v5) : null,
          _v8 = _v3?.inlinePlayerAssets ? _v13(_v5) : null,
          _v9 = _v3?.inlineCreatePreloads && _v4(_v5.req) ? _v14(_v5) : null,
          _v10 = _v3?.inlineMagistoResources ? _v15(_v5) : null,
          _v11 = await _v2(_v5),
          _v12 = "redirect" in _v11 ? _v6(_v11.redirect) : "notFound" in _v11 ? "404" : "200";
        return _v5(_v12, "success", _v8), _v4(_v11, {
          locale: _v3
        }, _v7 ? await _v7 : null, _v8 ? await _v8 : null, _v9 ? await _v9 : null, _v10 ? await _v10 : null);
      } catch (_v0) {
