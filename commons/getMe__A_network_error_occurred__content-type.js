{
  ...
  async function _v5({
    ...
    return (0, _v3.measureLatency)("getMe", "GET", async () => {
      let _v0 = await fetch(`${_v0}/me?fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v2,
        method: "GET"
      });
  ...
  async function _v6({
    ...
    return (0, _v3.measureLatency)("deleteMe", "DELETE", async () => {
      let _v0 = await fetch(`${_v0}/me`, {
        ..._v1,
        method: "DELETE"
      });
      if (!_v0.ok) throw new _v4.NetworkError("A network error occurred", _v0.status, _v0);
  ...
  async function _v7({
    ...
    return (0, _v3.measureLatency)("patchMe", "PATCH", async () => {
      let _v0 = await fetch(`${_v0}/me?fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v3,
        method: "PATCH",
  ...
  function _v12(_v0, _v1) {
    ...
    return (0, _v9.default)(_v2 ? `/me${(0, _v2.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v5({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  function _v13() {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me${(0, _v2.serializeQuery)(_v0)}`, _v5({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  function _v14() {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me${(0, _v2.serializeQuery)(_v0)}`, _v7({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v2.assignMswData)(_v12, {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/me${(0, _v2.serializeQuery)(_v0)}`, _v6({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/me",
    method: "PATCH"
  }), _v0.s(["useGetMe", 0, _v12, "useGetMeLazy", 0, _v13, "usePatchMe", 0, _v14], 0);
}