{
  ...
  _v0.s(["deepDecodeURIComponent", 0, function (_v0) {
  ...
  var _v1,
    _v2 = _v0.i(0),
    _v3 = _v0.i(0),
    _v4 = ((_v1 = {}).TRANSFER_NOT_REQUESTED = "not_requested", _v1.TRANSFER_IN_PROGRESS = "in_progress", _v1.TRANSFER_COMPLETED = "completed", _v1.TRANSFER_FAILED = "failed", _v1);
  let _v5 = 0;
  _v0.s(["TransferStatus", () => _v4, "useManagedUserTransferStatus", 0, function (_v0, _v1, _v2, _v3) {
    let [_v4, _v5] = (0, _v2.useState)("not_requested"),
    ...
    let [_v8, {
        ...
        error: _v10,
        loading: _v11
      }] = (0, _v3.useLazyQuery)(`/apps/${_v0}/managed_users/${_v1}`),
      _v12 = (0, _v2.useRef)(void 0);
    return (0, _v2.useEffect)(() => (_v6 && (_v3 ? _v12.current = setInterval(() => {
      _v8({
        variables: {
  ...
  function _v8(_v0, _v1) {
    let _v2,
      ...
      _v4 = function (_v0) {
        ...
        let _v2 = _v1.match(_v7);
        if (_v2) {
          let _v0 = _v2[0].toLowerCase();
          if (!_v6.includes(_v0)) throw Error(`Unsupported link protocol: ${_v0}`);
  ...
  _v0.s(["httpBuildQuery", 0, _v0 => {
    ...
    return _v1.join("&");
  }, "transformLink", 0, _v8, "tryTransformLink", 0, function (_v0, _v1) {
    try {
      return _v8(_v0, _v1);
    } catch {
      return;
