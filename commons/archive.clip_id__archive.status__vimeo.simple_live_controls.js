    ...
    let {
      ...
      }, [_v18, _v30, _v31, _v7]),
      {
        ...
        let _v34 = (0, _v10.useScope)(),
          ...
          {
            data: _v62
          } = (0, _v24.useGetUser)(() => _v52 && _v61 ? {
            select: ["aiCreditsQuota"],
            where: {
              userId: _v52
            }
          } : null),
          _v63 = _v62?.aiCreditsQuota?.remaining ?? 0,
          _v64 = _v55 && _v33.value?.autoCcTranslationEnabled && _v33.value?.autoCcTranslationLanguages ? _v33.value.autoCcTranslationLanguages.length : 0,
          _v65 = (_v54 && !_v33.value?.unlimitedAutoCc ? _v67.AUTO_CC_CREDITS_PER_MINUTE : 0) + _v67.AUTO_CC_TRANSLATION_CREDITS_PER_MINUTE * _v64,
          _v66 = !!(!_v57 && _v56 && _v33.value?.autoCcEnabled && _v65 > 0 && _v63 < _v65),
          _v67 = !!(_v54 && _v57 && _v33.value?.autoCcEnabled && !_v59),
          _v68 = !_v5.canStream || _v51 || _v9 || _v17 || _v20 || _v47 || _v15 && _v40 || _v18 && _v41 || _v11 && !_v16 || _v12 && !_v16 || _v13 && !_v16 || _v60 && !_v16 || _v66 && !_v16 || _v67 && !_v16,
          _v69 = !(_v51 || _v42 || _v15 && _v41) && _v19 && !_v35,
          _v70 = _v6?.settingsLink?.uri,
          _v71 = _v46 ? "secondary" : "primary",
          _v72 = (0, _v95.inline)(() => {
            if (_v51 || _v16) ;else if (_v11) return _v49;else if (_v12) return _v54.translations.noStreamTimeRemaining;else if (_v13) return _v54.translations.tooManyEventsCreated;else if (_v18 && _v41) return _v54.translations.goLiveFromYourEncoder;else if (_v60) return _v54.translations.autoCCLanguageRequired;else if (_v67) return _v54.translations.missingPaymentMethodForCaptions;else if (_v66) return _v54.translations.insufficientAiCreditsForCaptions;
            return "";
          }),
          ...
          _v77 = (0, _v11.useCallback)(async () => {
            _v70 ? (_v73.Logger.getGlobal().info("Redirect to specify start time:", _v70), _v34.emitSignal({
            ...
            })) : _v73.Logger.getGlobal().info("Tried to open link, but it is not set:", _v70);
          }, [_v70, _v34]);
        if (_v16 && (!_v45 || _v41)) return {
          isButtonLoading: _v51,
          buttonTooltipLabel: _v72,
          isButtonDisabled: _v68,
          buttonSettingsLink: _v70,
          buttonHasDropdown: !1,
        ...
        return _v45 && _v40 ? {
          ...
          buttonTooltipLabel: _v72,
          buttonIsScheduleEnabled: _v44,
          buttonHasDropdown: _v22 !== _v7.ERecordState.PLAYING && _v69,
