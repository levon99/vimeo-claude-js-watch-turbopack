{
  ...
  _v0.s(["default", 0, function (_v0, _v1) {
    return _v2.default.memo(function (_v0) {
      ...
      let {
        ...
        _v11 = (0, _v27.useSectionStore)((0, _v10.useShallow)(_v0 => _v0.setSelectedSection)),
        _v12 = (0, _v26.isDataLoaded)({
          leadCaptureUri: _v9,
          entityUri: _v10
        });
      ((_v0, _v1) => {
        ...
        let _v3 = (0, _v19.useGlobalStore)(_v0 => _v0.setLeadCapture),
          ...
          _v7 = (0, _v19.useGlobalStore)(_v0 => _v0.authRoomPassword),
          _v8 = (0, _v19.useGlobalStore)(_v0 => _v0.pageReferrer),
          _v9 = `500,${window.innerWidth}`,
          {
            pageType: _v10,
            skip: _v11 = !1
          } = _v2 || {},
          [_v12, _v13] = (0, _v21.useGetLeadCaptureResourceIdFormLazy)(),
          [_v14, _v15] = (0, _v21.usePostLeadCaptureResourceIdForm)(),
          {
            initializeIdUsingCidAsKey: _v16
          } = (0, _v23.useCidToIdMapping)(),
          _v17 = (0, _v19.useGlobalStore)(_v0 => _v0.refreshLeadCaptureDataCounter);
        ((_v0 = _v22.ENTITY_TYPE.EVENT, _v1) => {
          ...
          if (_v0 && !_v11) {
            let _v0 = (0, _v15.getCookie)(_v1),
              _v1 = (0, _v15.getEntityCookiePassword)(_v1, _v0) ?? _v7;
            _v12({
              where: {
                resourceId: _v1,
          ...
          if (_v10 === _v25.PAGE_TYPES.ADMIN && _v0) {
            let {
                called: _v0,
                error: _v1,
                loading: _v2
          ...
          if ((_v13.called || _v15.called) && _v4(_v0), _v1) {
            let {
              calendarLinks: _v0,
              ..._v1
            } = _v1;
            ...
            _v0 && _v5(_v0), _v2.logo = (0, _v26.responseTransformer)("logo", _v2.logo), _v2.background = (0, _v26.responseTransformer)("background", _v2.background), _v2.customFields = (0, _v26.formatFields)(_v2.customFields), _v2.hiddenFields = (0, _v26.formatFields)(_v2.hiddenFields), _v3(_v2), _v16(_v25.RESPONSE_KEYS_MAP.customFields, _v2.customFields), _v16(_v25.RESPONSE_KEYS_MAP.hiddenFields, _v2.hiddenFields);
          }
        }, [_v15, _v13]);
      })(_v1, _v2, {
        pageType: _v1,
  ...
  _v0.s(["default", 0, function (_v0, _v1) {
    return _v2.default.memo(function (_v0) {
      ...
      return !(0, _v26.isDataLoaded)({
        leadCaptureUri: _v7,
        entityUri: _v8
      }) || !_v2 && _v5 && _v6 <= 1 ? (0, _v1.jsx)(_v28.Center, {
        width: _v1?.width || "100%",
        height: _v1?.height || "100vh",
        children: (0, _v1.jsx)(_v29.Spinner, {})
      }) : _v3 ? (0, _v1.jsx)(_v31.ErrorPage, {
        error: new _v30.ResourceNotFoundError()
      }) : _v4 && _v1 === _v25.PAGE_TYPES.ADMIN ? (0, _v1.jsx)(_v31.ErrorPage, {
        error: new _v30.ForbiddenError()
      }) : (0, _v1.jsx)(_v0, {
        ..._v0
      });
    });
