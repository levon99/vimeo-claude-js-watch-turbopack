{
  ...
  Object.keys(_v44), _v0.s(["ProductTileView", 0, ({
    productId: _v0,
    size: _v1,
    logoScale: _v2 = .75,
    borderRadius: _v3 = (0, _v28.rem)(16.05)
  }) => {
    let {
        background: _v4,
        foreground: _v5
      } = _v43[_v0],
      _v6 = (0, _v28.rem)(_v1 * (1 - _v2) / 2);
    return (0, _v22.jsx)(_v23.Flex, {
      width: (0, _v28.rem)(_v1),
      height: (0, _v28.rem)(_v1),
      background: _v4,
      borderRadius: _v3,
      padding: _v6,
      alignItems: "center",
      ...
      children: ((_v0, _v1) => {
        ...
        color: _v5,
        fontWeight: "medium",
        children: _v42.PRODUCT_NAMES[_v0]
      })
    });
  }], 0);
}