{
  ...
  async function _v12(_v0) {
    ...
    try {
      ...
      _v0.log.error("Failed to fetch session information:", _v0), _v0.emitSignal({
  ...
  class _v20 extends _v2.ContextManager {
    ...
    joinGuestSession() {
      return (0, _v10.withLiveErrorTracking)(() => {
        this.log.info("Joining guest session"), this.setContext({
          isJoined: !0
        }), this.emitSignal({
    ...
    leaveGuestSession() {
      return (0, _v10.withLiveErrorTracking)(() => {
        this.log.info("Leaving guest session"), this.setContext({
          isJoined: !1
        }), this.emitSignal({
