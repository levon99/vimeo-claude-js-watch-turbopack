{
  ...
  var _v8 = "true" === _v4.default.env.I18N_TEMPLATE,
    _v9 = _v0.r(0),
    _v10 = _v0.r(0),
    _v11 = _v0.r(0),
    _v12 = _v0.r(0),
    _v13 = function (_v0) {
      ...
      return _v0.dictionary && _v0.dictionary[_v2] ? _v0.dictionary[_v2] : _v14[_v2] && _v14[_v2][_v0.singular] ? _v14[_v2][_v0.singular] : _v0;
    },
    _v14 = {};
  ...
  var _v15 = function (_v0, _v1) {
      ...
      if ("{" === _v3[0] && "}" === _v3[_v3.length - 1]) {
        ...
        if ("function" == typeof (_v2 = _v1[_v5])) {
          ...
          -1 === _v6 ? _v2 = _v2() : (_v2 = _v2(_v15(_v4.slice(0, _v6), _v1)), _v4 = _v4.slice(_v6 + 1));
        }
      }
      switch (typeof _v2) {
        case "undefined":
      ...
      for (var _v2 = {}, _v3 = 0, _v4 = Object.entries(_v0.replacements); _v3 < _v4.length; _v3++) {
        ...
        if ("function" == typeof _v7) {
          var _v8 = _v1.includes("{/" + _v6 + "}"),
            _v9 = _v8 ? _v7(_v16) : _v7();
          if ("string" != typeof _v9 && (_v9 = _v9.renderToStaticMarkup(_v12.createElement(_v10.ThemeProvider, {
            theme: _v11.themes.light
          }, _v9))), _v8) {
            var _v10 = _v9.split(_v16);
            _v2[_v6] = _v10[0], _v2["/" + _v6] = _v10[1];
          } else _v2[_v6] = _v9;
        } else _v2[_v6] = _v7;
      }
      return "{{t " + _v5.Buffer.from(JSON.stringify(_v6(_v6({}, _v0), {
        replacements: _v2
      }))).toString("base64") + " t}}";
    },
    _v18 = function (_v0) {
      if (_v8) return _v17(_v0);
      var _v1 = _v13(_v0),
        _v2 = _v1.singular;
      _v0.hasOwnProperty("count") && 1 !== _v0.count && _v1.plural && (_v2 = _v1.plural);
      var _v3 = _v2.split(/({[\w\/]+})/g);
      return _v0.replacements ? _v15(_v3, _v0.replacements) : (_v3.length > 1 && console.warn("Attempting to translate tokenized phrase without providing replacements:\n" + _v2), _v2);
    };
  _v2.translate = function (_v0) {
    return "string" == typeof _v0 ? _v18({
      singular: _v0
    }) : _v18(_v0);
  };
}