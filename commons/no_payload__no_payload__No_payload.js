    ...
    _v37 = {
      ...
      DeleteTeamMemberComplete: (_v0, _v1) => {
        ...
        return {
          ...
          teamInfo: {
            ..._v0.teamInfo,
            currentTeamSize: Math.max(0, _v0.teamInfo.currentTeamSize - 1)
          }
        };
      },
    ...
    _v44 = ({
      ...
      let {
          capabilities: {
            ...
            hasWebinarViewerAnonymizationEnabled: _v57,
            hasLiveSubscription: _v58,
            hasManageTeamBillingSettingsPage: _v59,
            haveMoreAdminTeamMembers: _v60,
            hasPerSeatPricingModelTeamMember: _v61,
            hasPersonalTeamFolderAdminAccess: _v62,
            hasPlus: _v63,
            hasPro: _v64,
            hasTeamMembersFilter: _v65,
            hasViewTeamMemberActivityUpsell: _v66,
            hasViewReviewPagePrivacyTeamSetting: _v67,
            hasSessionControl: _v68,
            hasContentSpaceEnabled: _v69,
            hasTeamAllowedIpsEnabled: _v70,
            hasMultipleReviewLinks: _v71,
            hasCanUseOverlayWatermarking: _v72
          },
          loading: _v73
        } = (0, _v8.useCapability)(["canAddTeamMembers", "canEnableEnterpriseCustomDomain", "canLmsExport", "canManageBillingOnsite", "canSeeAiSettings", "canShowSsoGroups", "canUsePaymentsService", "canViewSsoTeamSettings", "canViewTeamMemberActivity", "canViewTeamMemberTopLevelPermissions", "canViewTeamMemberTopLevelPermissionsUpsell", "createLiveEvents", "hasDrmSetting", "hasBusiness", "hasContributorPlusEnabled", "hasDataRetention", "hasEnterprise", "hasLegalHoldsActive", "hasWebinarViewerAnonymizationEnabled", "hasLiveSubscription", "hasManageTeamBillingSettingsPage", "haveMoreAdminTeamMembers", "hasPerSeatPricingModelTeamMember", "hasPersonalTeamFolderAdminAccess", "hasPlus", "hasPro", "hasTeamMembersFilter", "hasViewTeamMemberActivityUpsell", "hasViewReviewPagePrivacyTeamSetting", "hasSessionControl", "hasContentSpaceEnabled", "hasTeamAllowedIpsEnabled", "hasMultipleReviewLinks", "hasCanUseOverlayWatermarking"], _v13),
        _v74 = (_v61 ? _v14 : _v12) || _v12,
        _v75 = !_v73 && !_v9 && (!_v61 || !_v7),
        _v76 = (0, _v3.useMemo)(() => !_v75 || (_v61 ? !!_v8 && _v10 + _v34.OWNER + _v18.currentUnassignedSeatCount < _v74 : !!(_v10 < _v12 || _v55)), [_v10, _v55, _v61, _v8, _v75, _v12, _v18.currentUnassignedSeatCount, _v74]);
      (0, _v3.useEffect)(() => {
        _v23({
          canAddTeamMembers: _v39,
          canEnableEnterpriseCustomDomain: _v40,
      ...
      }, [_v39, _v40, _v41, _v42, _v43, _v44, _v45, _v46, _v47, _v48, _v49, _v50, _v52, _v53, _v54, _v55, _v56, _v57, _v58, _v59, _v60, _v61, _v62, _v63, _v64, _v65, _v66, _v67, _v73, _v68, _v69, _v70, _v71, _v72]);
      let {
        paymentMethods: _v77
      } = (0, _v16.usePaymentMethods)({
        canFetchPaymentMethods: !!(_v16 && _v17 === _v35.TeamRole.Owner && _v59),
        canUsePaymentsService: !!_v45,
        ownerId: _v16
      });
      (0, _v3.useEffect)(() => {
        ...
        _v16 && _v17 === _v35.TeamRole.Owner && _v59 && _v32({
          select: ["uploadQuota"],
          where: {
            userId: _v16
          }
        });
      }, [_v16, _v59]), (0, _v3.useEffect)(() => {
        _v18.tier && _v36({
      ...
      let _v78 = (0, _v19.useWindowSize)().width <= _v20.BreakPoints.sm,
        {
          isOpen: _v79,
          collapsed: _v80,
          toggle: _v81,
          ...
          children: [(0, _v1.jsx)(_v22.WayfinderSideNav, {
            ...
            children: (0, _v1.jsxs)(_v6.Box, {
              ...
              children: [(0, _v1.jsx)(_v11.DefaultNavigation, {
                setIsSideNavActive: _v78 ? _v82 : void 0,
                isSideNavActive: _v79,
                hasSideNavLayout: !_v78,
                searchContentAlignment: _v1
              }), (0, _v1.jsxs)(_v6.Box, {
                width: "100%",
                ...
                }), _v75 && _v38 && !_v76 && _v18.tier !== _v35.Tier.CustomSelfServe && (0, _v1.jsx)(_v6.Box, {
                  mb: "300",
