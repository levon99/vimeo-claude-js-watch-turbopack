{
  ...
  async function _v7({
    ...
    return (0, _v5.measureLatency)("postVideoVersionRestore", "POST", async () => {
      let _v0 = await fetch(`${_v0}/videos/${_v2}/versions/${_v3}/restore?fields=${_v1.map(_v6.intoSnakeCase).join(",")}`, {
        ..._v4,
        method: "POST"
      });
  ...
  function _v10() {
    ...
    return [(0, _v1.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/versions/${_v0.where.versionId}/restore${(0, _v4.serializeQuery)(_v0)}`, _v7({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  var _v11 = _v0.i(0),
    _v12 = _v0.i(0),
    _v13 = _v0.i(0);
  let _v14 = (0, _v12.create)()((0, _v13.devtools)((_v0, _v1) => ({
    versionList: [],
    addVersions: _v0 => {
      _v0(_v0 => _v0?.at(-1)?.uri == _v0?.versionList?.at(-1)?.uri ? _v0 : {
        versionList: [..._v0.versionList, ..._v0]
      });
    },
    addNewVersion: _v0 => {
      _v0(_v0 => {
        if (!_v0) return _v0;
        let _v1 = [..._v0.versionList],
          _v2 = _v1?.find(_v0 => _v0.active);
        return _v2 && _v0.active && (_v2.active = !1), _v1.unshift(_v0), {
          versionList: _v1
        };
      });
    },
    deleteVersion: _v0 => {
      let _v1 = [..._v1().versionList],
        _v2 = _v1.find(_v0 => _v0.uri === _v0);
      _v2 && (_v2.isDeleted = !0, _v0({
        versionList: _v1
      }));
    },
    resetVersions: () => _v0({
  ...
  _v0.s(["useVersionsStore", 0, _v14], 0);
  var _v15 = _v0.i(0),
    _v16 = _v0.i(0);
  _v0.s(["useRestoreVersion", 0, () => {
    ...
    return (0, _v1.useEffect)(() => {
      _v7 && _v2.length > 0 && (0, _v16.idFromUri)(_v2[0].uri) < (0, _v16.idFromUri)(_v7.uri) && _v1(_v7);
      ...
      restoreVersion: (_v0, _v1) => _v3({
        ...
        headers: {
          Accept: _v15.API_ACCEPT_HEADER
        },
        select: _v15.VIDEO_VERSION_FIELDS
      }),
