{
  ...
  _v0.s(["PrimaryNavItem", 0, ({
    ...
    if ("icons" === _v1) {
      let _v0 = !!_v0.href;
      return (0, _v1.jsx)(_v12.Tooltip, {
        label: _v0.label,
        placement: "right",
        children: (0, _v1.jsx)(_v6.IconButton, {
          as: _v0 ? _v11.default : "button",
          ...(_v0 ? {
            href: _v0.href,
          ...
          variant: "tertiary",
          size: "sm",
          backgroundColor: _v0.active ? "lightBlueAlpha.300" : void 0,
          onClick: _v0.onClick,
          "data-id": _v0.dataId
        })
      });
    ...
    return (0, _v1.jsx)(_v4.Box, {
      as: "li",
      listStyleType: "none",
      children: (0, _v1.jsx)(_v10.MenuItem, {
        icon: _v0.icon,
        iconSize: _v14,
        iconMarginRight: _v15,
        borderRadius: _v16,
        paddingX: _v17,
        label: _v0.label,
        href: _v0.href,
