{
  ...
  function _v4({
    ...
    return {
      canCreateReviewLink: _v0 && _v5 < _v2.MAX_REVIEW_LINKS && (!_v3 || 0 === _v5),
  ...
  _v0.s(["getReviewLinkMenuState", 0, _v4, "useReviewLinkMenuState", 0, function ({
    hasReviewLinkCapabilities: _v0,
    hasMultipleReviewLinks: _v1,
    reviewLinks: _v2,
    getReviewPageUrl: _v3
  }) {
    let _v4 = (0, _v3.useCanUpSell)();
