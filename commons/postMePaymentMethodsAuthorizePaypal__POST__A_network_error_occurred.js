{
  ...
  _v0.s(["useAuthorizePaypal", 0, () => {
    let {
      ...
      } = (0, _v18.useStateContext)(),
      {
        settings: _v13
      } = (0, _v12.useOrionSettings)(),
      _v14 = _v13.use_juno_billing,
      _v15 = _v9 && (0, _v17.isCreatorProductTier)(_v9),
      [_v16, _v17] = _v10(),
      _v18 = (0, _v1.useRouter)(),
      {
        trackCheckoutFailed: _v19
      } = (0, _v13.useCheckoutTracking)(_v12),
      _v20 = (0, _v17.getCheckoutPeriodicity)(_v1?.isCreatorProduct, _v10, _v7),
      _v21 = (0, _v2.useRef)(!1);
    return (0, _v2.useEffect)(function () {
      if (_v17.error) {
        let _v0 = (0, _v11.getErrorMessage)(_v11.ERROR_TYPE.PAYPAL_CONNECTION);
        _v0({
          type: _v16.ActionTypes.PAYMENT_ALERT,
          payload: {
            status: "error",
            message: _v0
          }
      ...
      let _v0 = (({
        ...
        postCheckoutUrl: _v14.postCheckoutUrl.read(),
        productName: _v1?.name,
        subscriptionId: _v3?.id,
        token: _v18.query?.token,
        useJunoBilling: _v14,
        userEntity: _v6 ? _v15.USER_ENTITY_BUSINESS : _v15.USER_ENTITY_PERSONAL
      });
      _v16({
        variables: {
    ...
    return [({
      ...
      let _v1 = (({
          ...
          let _v3 = _v2 && !(0, _v17.isPayPalToken)(_v2) ? `&token=${_v2}&mwru=${_v1}` : "",
