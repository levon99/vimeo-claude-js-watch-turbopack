{
  ...
  function _v37() {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/pictures/${_v0.where.pictureId}${(0, _v33.serializeQuery)(_v0)}`, (0, _v34.deleteVideoPicture)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  function _v38() {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/pictures/${_v0.where.pictureId}${(0, _v33.serializeQuery)(_v0)}`, (0, _v34.patchVideoPicture)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v32.default.env.STORYBOOK && (0, _v33.assignMswData)(function (_v0, _v1) {
    ...
    return (0, _v35.default)(_v2 ? `/videos/${_v2.where.videoId}/pictures/${_v2.where.pictureId}${(0, _v33.serializeQuery)(_v2)}` : () => null, _v2 ? () => (0, _v34.getVideoPicture)({
      ..._v2,
      headers: {
        ..._v2.headers,
        "Content-Type": "application/json",
    ...
    method: "GET"
  }), "true" === _v32.default.env.STORYBOOK && (0, _v33.assignMswData)(function () {
    let {
        mutate: _v0
      } = (0, _v36.useSWRConfig)(),
      {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/pictures/${_v0.where.pictureId}${(0, _v33.serializeQuery)(_v0)}`, (0, _v34.getVideoPicture)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/videos/:videoId/pictures/:pictureId",
    method: "GET"
  }), "true" === _v32.default.env.STORYBOOK && (0, _v33.assignMswData)(_v37, {
    endpoint: "/videos/:videoId/pictures/:pictureId",
    method: "DELETE"
  }), "true" === _v32.default.env.STORYBOOK && (0, _v33.assignMswData)(_v38, {
    endpoint: "/videos/:videoId/pictures/:pictureId",
    method: "PATCH"
  }), _v0.s(["useDeleteVideoPicture", 0, _v37, "usePatchVideoPicture", 0, _v38], 0);
  var _v39 = _v0.i(0),
    _v40 = _v0.i(0);
  let _v41 = "image/png,image/x-png,image/jpeg,image/webp",
    _v42 = "image/png,image/x-png,image/jpeg,image/webp,.jpg,.jpeg,.png,.webp";
  function _v43(_v0) {
    return !!(_v0?.configUrl && !1 !== _v0.isPlayable);
  }
  _v0.s(["THUMBNAIL_HEIGHT", 0, 360, "THUMBNAIL_SUPPORTED_IMAGE_INPUTS", 0, _v42, "THUMBNAIL_SUPPORTED_IMAGE_MIME", 0, _v41, "THUMBNAIL_WIDTH", 0, 640], 0);
  let _v44 = (0, _v2.createContext)(null);
  function _v45({
    clipId: _v0,
    onSaveSuccess: _v1,
    onClose: _v2,
    ...
    let _v4,
      ...
      }),
      {
        ...
        refreshInterval: _v0 => {
          let _v1 = _v0?.data ?? [];
          if (_v43(_v1.find(_v0 => _v0.active))) return 0;
      ...
      _v38 = async _v0 => {
        let _v1 = _v0[0];
        if (!_v1 || !_v41.split(",").includes(_v1.type)) return;
        ...
        let _v3 = null;
        try {
          let _v0 = await (0, _v30.postVideoPictures)({
            select: ["link", "uri"],
            where: {
              videoId: _v0
            },
    ...
    return (0, _v1.jsx)(_v44.Provider, {
      value: {
        clipId: _v0,
        videoFps: _v30,
        clipConfigUrl: _v31,
  ...
  function _v47() {
    ...
    return _v1 ? (0, _v1.jsx)(_v28.TabPanel, {
      children: (0, _v1.jsx)(_v7.Flex, {
        justifyContent: "center",
        paddingY: "lg",
        children: (0, _v1.jsx)(_v27.Spinner, {})
      })
    }) : _v0.length ? (0, _v1.jsx)(_v28.TabPanel, {
  ...
  function _v58() {
    ...
    let _v24 = (0, _v2.useCallback)(_v0 => {
    ...
    (0, _v2.useEffect)(() => {
      ...
      _v23.ready(() => {
        _v0(), _v23.on("durationchange", _v0 => _v15(_v0.duration)), _v23.on("play", () => {
          _v6(null), _v8(!1);
        }), _v23.on("pause", _v0 => _v6(_v0.seconds)), _v23.on("timeupdate", _v0 => {
          _v16.current || _v13(_v0.seconds);
        }), _v23.play().then(() => {
          _v23.pause(), _v0(), _v15(_v23.duration), _v22(_v23.config?.request?.thumb_preview ?? null);
          let _v0 = _v11.current;
          null !== _v0 && (_v23.seekTo(_v0), _v6(_v0), _v13(_v0));
        });
      });
    }, [_v23, _v9, _v6, _v8]), (0, _v2.useEffect)(() => () => {
      _v6(null);
    }, [_v6]);
    let _v25 = _v21 ? Math.ceil(_v21.frames / _v21.columns) : 0,
      _v26 = _v55.reduce((_v0, _v1, _v2) => Math.abs(_v1 * _v14 - _v12) < Math.abs(_v55[_v0] * _v14 - _v12) ? _v2 : _v0, 0);
    return (0, _v1.jsx)(_v28.TabPanel, {
      children: _v2 ? (0, _v1.jsx)(_v7.Flex, {
        ...
        children: [(0, _v1.jsxs)(_v3.Box, {
          ...
          children: [(0, _v1.jsxs)(_v51.Slider, {
            min: 0,
            max: _v14,
            step: .001,
            value: _v12,
            ...
            onKeyDown: _v0 => _v24(_v0),
            children: [(0, _v1.jsx)(_v52.SliderTrack, {
              children: (0, _v1.jsx)(_v52.SliderFilledTrack, {})
            }), (0, _v1.jsx)(_v52.SliderThumb, {})]
            ...
            children: _v55.map((_v0, _v1) => {
              ...
              return (0, _v1.jsx)(_v3.Box, {
                ...
                style: {
                  ...
                  backgroundSize: `${100 * _v21.columns}% ${100 * _v25}%`,
                  backgroundPosition: `${_v5}% ${_v25 <= 1 ? 0 : _v4 / (_v25 - 1) * 100}%`,
                  aspectRatio: _v4,
                  outline: "none",
                  ...(_v1 === _v26 && {
                    zIndex: 1,
                ...
                children: _v1 === _v26 && (0, _v1.jsx)(_v3.Box, {
                  position: "absolute",
                  inset: 0,
                  borderRadius: "sm",
                  pointerEvents: "none",
          ...
          }), _v7 && (0, _v1.jsx)(_v48.Alert, {
            status: "error",
            children: (0, _v1.jsx)(_v49.AlertDescription, {
              fontSize: "body-sm",
              children: (0, _v23.translate)({
  ...
  function _v60() {
    ...
    return (0, _v1.jsx)(_v28.TabPanel, {
      children: (0, _v1.jsxs)(_v7.Flex, {
        ...
        gap: "md",
        paddingY: "lg",
        children: [_v1 ? (0, _v1.jsx)(_v27.Spinner, {
          size: "xl"
        ...
        children: [(0, _v1.jsxs)(_v13.ModalHeader, {
          ...
          children: (0, _v1.jsxs)(_v16.Tabs, {
            ...
            children: [(0, _v1.jsx)(_v3.Box, {
              ...
              children: [(0, _v1.jsx)(_v58, {}), (0, _v1.jsx)(_v60, {}), _v1 ? (0, _v1.jsx)(_v47, {}) : null]
            })]
          })
  ...
  _v0.s(["ThumbnailChangeModal", 0, function ({
    ...
    return _v2 ? (0, _v1.jsx)(_v24.PlayerContextProvider, {
      assetUrls: (0, _v22.getPlayerAssetUrls)(),
      type: _v25.PlayerType.VimeoPlayer,
