{
  ...
  function _v18({
    ...
    if (!_v4) return _v17.has(_v0) || (console.warn(`Eppo flag "${_v0}" not found in configuration. Check that the flag is enabled in Eppo UI.`), _v17.add(_v0)), {
      assignment: _v3
    };
  ...
  function _v19({
    ...
    let _v6 = (0, _v1.useViewer)(),
      {
        isInitialized: _v7
      } = _v16({
        flagsConfiguration: _v6?.eppoConfig?.flags,
        bypassInitialization: _v5
      }),
      _v8 = _v20();
    if (_v5 || !_v7 || !_v6?.eppoConfig?.flags) return {
      assignment: _v3,
      isEppoSDKInitialized: _v7
    };
    let {
      assignment: _v9
    } = _v18({
      ...
      bigPictureOverrides: _v2,
      defaultAssignment: _v3,
      assignmentType: _v6.eppoConfig.flags[_v0]?.variationType ?? _v4
    });
    return {
      assignment: _v9,
      isEppoSDKInitialized: _v7
  ...
  function _v20() {
    ...
    return _v0 ? {
      cuid: _v0.user?.id,
      vuid: _v0.vuid,
      is_free: !_v0.user?.capabilities?.hasPaid,
      is_enterprise: _v0.user?.capabilities?.hasEnterprise,
      is_staff: _v0.user?.badge?.type === "staff",
      device_type: _v21(),
      language: _v0.locale,
  ...
  }, "useEppoAssignment", 0, _v19, "useGetEppoAssignment", 0, function () {
    let _v0 = (0, _v1.useViewer)(),
      {
        isInitialized: _v1
      } = _v16({
        flagsConfiguration: _v0?.eppoConfig?.flags
      }),
      _v2 = _v20();
    return {
      getEppoAssignment: function (_v0) {
        return _v1 && _v0?.eppoConfig?.flags ? _v18({
          ..._v0,
          subject: {
            ..._v0.subject,
            additionalData: {
              ..._v2,
              ..._v0.subject.additionalData
            }
          },
          assignmentType: _v0.eppoConfig.flags[_v0.flagKey]?.variationType ?? _v0.assignmentType
        }) : {
          assignment: _v0.defaultAssignment
        };
      },
      isEppoSDKInitialized: _v1
    };
  }, "useVuidEppoAssignment", 0, function ({
    additionalData: _v0,
    disabled: _v1 = !1,
    ..._v2
  }) {
