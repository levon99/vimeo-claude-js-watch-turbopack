{
  ...
  var _v1 = _v0.i(0),
    ...
    _v9 = _v0.i(0),
    _v10 = _v0.i(0);
  let _v11 = (0, _v2.createContext)(null);
  _v0.s(["QuestionsDataContextProvider", 0, ({
    ...
    let [_v3, _v4] = (0, _v2.useState)(!1),
      ...
      _v11 = (0, _v10.useContainerDataStore)(_v0 => _v0.videoId),
      _v12 = (0, _v7.getPasswordHashFromCookie)(_v1),
      _v13 = (0, _v9.useGetVideoSignature)(_v11),
      {
        baseUrl: _v14,
        jwt: _v15
      } = (0, _v4.useGctlConfig)(),
      ...
      }, [_v14, _v2, _v12, _v15, _v1, _v13]),
      {
        ...
        revalidateOnFocus: !1,
        onSuccess: _v0 => {
          _v5 || _v6(!0), _v0?.status === "PRCS" || _v0?.status === "INIT" ? _v7 || (_v8(!0), _v4(!0)) : _v0?.status === "DONE" ? (_v8(!1), _v4(!1)) : _v0?.status === "FAILED" || _v0?.status === "INVALID" || _v0?.status === "NOT_FOUND" ? (_v8(!1), _v4(!1), _v10(Error(_v8.aiUnavailableForThisVideo))) : _v0?.status !== "NONE_EXISTING" || _v7 || _v16();
        },
        onError: _v0 => {
