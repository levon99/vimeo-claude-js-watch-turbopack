  ...
  let _v4 = async _v0 => {
    try {
      ...
      let _v1 = await (0, _v2.getWorkspace)({
          select: ["displayName", "metadata.connections.org", "metadata.interactions", "uri", "internalId"],
          where: {
        ...
        _v3 = _v1?.metadata?.connections?.org?.internalId;
      if (!_v1 || !_v1.uri || !_v3 || _v2 !== _v1.uri) return {
        notFound: !0
      };
      return {
        props: {
