{
  ...
  let _v10 = ["transcript_status_does_not_exist", "transcript_status_no_speech", "transcript_status_failed", "transcript_status_language_not_supported", "transcript_status_exceeds_maximum_duration", "video_transcript_too_short", "video_too_short", "transcript_ready_but_not_english"],
    _v11 = _v0 => null != _v0 && _v10.includes(_v0);
  _v0.s(["copyToClipBoard", 0, function (_v0) {
    ...
    switch (_v0) {
      ...
      case "ai_not_available":
        return _v6.aiUnavailableForThisVideo;
    ...
    summaryDisabled: _v0 = !1,
    summaryDisabledReason: _v1,
    isActivationInProgress: _v2 = !1,
    isTranscriptingLoading: _v3 = !1,
    activationProcessingReason: _v4,
    transcriptionInProgressReason: _v5,
    fallbackReason: _v6
  }) => _v0 && _v1 && !_v11(_v1) ? _v1 : _v2 ? _v4 : _v3 ? _v5 : _v6, "getVideoRequestId", 0, (_v0, _v1) => _v1 ? `${_v0}:${_v1}` : _v0.toString(), "handleError", 0, _v8, "isClipInterractionsLimitError", 0, _v9, "isMetadataActionDisabled", 0, ({
    summaryDisabled: _v0 = !1,
    summaryDisabledReason: _v1,
    isTranscriptingLoading: _v2 = !1
  }) => !(!_v0 || _v11(_v1)) || _v2, "secondsToDisplay", 0, _v0 => {
