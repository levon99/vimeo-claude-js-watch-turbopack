{
  ...
  function _v95({
    ...
    let [_v5, _v6] = (0, _v13.useState)(_v0),
      ...
      _v26 = (0, _v13.useEffectEvent)(async _v0 => {
      ...
      _v27 = _v18 ?? _v22,
      _v28 = _v20 || _v24 || null != _v27;
    (0, _v13.useEffect)(() => {
      _v27 && _v26(_v27.id);
    }, [_v27]);
    let _v29 = _v19 ?? _v23,
      _v30 = (0, _v13.useRef)(null),
      _v31 = (0, _v13.useEffectEvent)(_v0 => _v25(_v0));
    (0, _v13.useEffect)(() => {
      null !== _v29 && _v30.current !== _v29 && (_v30.current = _v29, _v31(_v29));
    }, [_v29]);
    let _v32 = (0, _v13.useMemo)(() => null !== _v9 ? URL.createObjectURL(_v9.file) : null, [_v9]);
    (0, _v13.useEffect)(() => () => {
      null !== _v32 && URL.revokeObjectURL(_v32);
        ...
        children: [(0, _v1.jsx)(_v35.ModalHeader, {
          ...
          children: (0, _v1.jsxs)(_v7.Flex, {
            ...
            children: [(0, _v1.jsxs)(_v7.Flex, {
              ...
              children: [(0, _v1.jsx)(_v7.Flex, {
                ...
                children: (0, _v1.jsxs)(_v15.FormControl, {
                  ...
                  children: [(0, _v1.jsx)(_v16.FormLabel, {
                    ...
                    isInvalid: _v7,
                    maxLength: 120,
                    onChange: _v0 => _v33("name", _v0.target.value),
                ...
                children: [(0, _v1.jsx)(_v16.FormLabel, {
                  ...
                  id: "speaker-role",
                  maxLength: 120,
                  onChange: _v0 => _v33("role", _v0.target.value),
                  placeholder: (0, _v10.translate)({
                    singular: "Add role",
                    dictionary: {
                      es: {
                ...
                children: [(0, _v1.jsx)(_v16.FormLabel, {
                  ...
                  onChange: _v0 => _v33("description", _v0.target.value),
                  placeholder: (0, _v10.translate)({
              ...
              children: [(0, _v1.jsx)(_v9.Text, {
                ...
                thumbnailUrl: _v32 ?? _v5.picture?.baseLink
              })]
            })]
          })
        }), (0, _v1.jsxs)(_v34.ModalFooter, {
          ...
          children: [(0, _v1.jsx)(_v14.Button, {
            ...
            onClick: () => {
              ...
              if ("edit" === _v2) {
                let _v0 = _v0.id;
                return null == _v0 ? void _v25(null) : void _v21({
                  select: ["id"],
                  where: {
                    personProfileId: _v0
                  },
  ...
  let _v96 = ({
    ...
    _v99 = ["id", "personProfile.id", "personProfile.name", "personProfile.role", "personProfile.description", "personProfile.pictures.baseLink", "personProfile.avatarCrop"];
  function _v100({
    isOpen: _v0,
    onClose: _v1,
    eventId: _v2
    ...
    let _v3 = _v2 > 0,
      ...
      _v16 = (0, _v13.useMemo)(() => _v12?.flatMap(_v0 => _v0.data), [_v12]),
      _v17 = _v12?.[_v12.length - 1]?.paging.next != null,
      {
        data: _v18,
        mutate: _v19
      ...
      _v20 = (0, _v13.useMemo)(() => {
        let _v0 = new Map();
        return _v18?.data.forEach(_v0 => {
          _v0.set(_v0.personProfile.id, _v0.id);
        }), _v0;
      }, [_v18]),
      _v21 = (0, _v13.useMemo)(() => _v18?.data.map(_v0 => _v0.personProfile) ?? [], [_v18]),
      _v22 = (0, _v13.useMemo)(() => _v16?.filter(_v0 => !_v20.has(_v0.id)) ?? [], [_v16, _v20]),
      _v23 = _v18?.total ?? _v21.length,
      _v24 = _v23 >= 25,
      _v25 = _v0 => null === _v0 ? void 0 : _v21.find(_v0 => _v0.id === _v0) ?? _v16?.find(_v0 => _v0.id === _v0),
      _v26 = _v25(_v8),
      _v27 = _v25(_v10),
      [_v28] = (0, _v21.usePostLiveEventSpeakerProfiles)(),
      [_v29] = _v59(),
      [_v30] = _v65(),
      [_v31, _v32] = (0, _v13.useState)(new Set()),
      [_v33, _v34] = (0, _v13.useState)(new Set()),
      _v35 = (_v0, _v1) => {
        if (!_v3 || _v31.has(_v0)) return;
        let _v2 = null !== _v1;
        !_v2 && _v24 ? _v5({
          title: (0, _v10.translate)({
        ...
        }) : (_v32(_v0 => new Set(_v0).add(_v0)), (_v2 ? _v29({
          where: {
            liveEventId: _v2,
      ...
      _v36 = () => {
        _v7(null), _v9(null), _v11(null), _v1();
      },
      _v37 = _v0 => {
        _v9(null), _v7(_v0);
      },
    ...
    return (0, _v1.jsxs)(_v1.Fragment, {
      children: [(0, _v1.jsxs)(_v31.Modal, {
        ...
        children: [(0, _v1.jsx)(_v36.ModalOverlay, {}), (0, _v1.jsxs)(_v33.ModalContent, {
          ...
          children: [(0, _v1.jsxs)(_v35.ModalHeader, {
            ...
            children: [(0, _v1.jsx)(_v25.Alert, {
              ...
              isAddDisabled: _v24,
              onAddClick: () => _v37("visible"),
              children: _v21.map(_v0 => (0, _v1.jsx)(_v102, {
                profile: _v0,
                attachedSpeakerId: _v20.get(_v0.id) ?? null,
                onOpenEditSpeakerModal: _v38,
                onToggleAddedToEvent: _v35,
                onSetDeleteCandidateId: _v39,
                isAtSpeakerLimit: _v24,
                isDeleting: _v33.has(_v0.id),
                isToggling: _v31.has(_v0.id)
              }, _v0.id))
            }), (0, _v1.jsx)(_v101, {
              title: (0, _v10.translate)({
              ...
              onAddClick: () => _v37("available"),
              children: _v22.map(_v0 => (0, _v1.jsx)(_v102, {
                profile: _v0,
        ...
        onSaved: _v0 => {
          if (_v14(), _v3 && "visible" === _v6) {
            if (_v24) return void _v5({
              title: (0, _v10.translate)({
      ...
      }, "add-speaker-modal") : null, _v26 ? (0, _v1.jsx)(_v95, {
        initialSpeaker: {
          id: _v26.id,
          name: _v26.name,
          role: _v26.role || "",
          description: _v26.description || "",
          picture: _v26.pictures,
          avatarCrop: _v26.avatarCrop
        },
        isOpen: null !== _v26,
        mode: "edit",
        onClose: () => {
        ...
        onSaved: () => _v14()
      }, `edit-speaker-modal-${_v26.id}`) : null, _v27 ? (0, _v1.jsx)(_v96, {
        title: (0, _v10.translate)({
        ...
        onCancel: () => _v11(null),
        onConfirm: () => {
          null !== _v10 && (_v33.has(_v10) || (_v34(_v0 => new Set(_v0).add(_v10)), _v30({
            where: {
      ...
      return (0, _v1.jsxs)(_v44.Tr, {
        children: [(0, _v1.jsx)(_v40.Td, {
          ...
          children: (0, _v1.jsxs)(_v7.Flex, {
            ...
            gap: (0, _v8.rem)(16),
            minWidth: 0,
            children: [_v11 ? (0, _v1.jsx)(_v27.Box, {
          ...
          children: (0, _v1.jsxs)(_v7.Flex, {
            ...
            children: [(0, _v1.jsx)(_v43.Tooltip, {
              ...
              children: (0, _v1.jsx)(_v29.IconButton, {
                "aria-label": _v10,
                icon: _v8 ? (0, _v1.jsx)(_v52.EyeShut, {}) : (0, _v1.jsx)(_v53.Eye, {}),
                isDisabled: _v9,
                isLoading: _v7,
