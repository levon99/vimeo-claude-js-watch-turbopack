{
  ...
  let _v20 = "shared-render-storyboard",
    _v21 = "shared-save-storyboard",
    _v22 = "shared-save-interactive",
    _v23 = "shared-publish-interactive",
    _v24 = "shared-save-overlay-as-template",
    _v25 = (0, _v1.createApi)({
    ...
    {
      useLazyFetchStoryboardQuery: _v26,
      useLazyInitStoryboardQuery: _v27,
      useLazyInitStoryboardFromClipQuery: _v28,
      useSaveStoryboardMutation: _v29,
      useRenderStoryboardMutation: _v30,
      usePublishInteractiveStoryboardMutation: _v31,
      useDuplicateStoryboardSourcesMutation: _v32
    } = _v25,
    _v33 = (0, _v9.createSelector)(_v0 => _v0, _v0 => ({
      renderStoryboard: _v25.endpoints.renderStoryboard.select(_v20)(_v0),
      saveStoryboard: _v25.endpoints.saveStoryboard.select(_v21)(_v0),
      saveOverlayStoryboard: _v25.endpoints.saveStoryboard.select(_v24)(_v0),
      saveInteractive: _v25.endpoints.saveStoryboard.select(_v22)(_v0),
      publishInteractiveStoryboard: _v25.endpoints.publishInteractiveStoryboard.select(_v23)(_v0)
    })),
    _v34 = (0, _v9.createSelector)(_v33, ({
      renderStoryboard: _v0,
      publishInteractiveStoryboard: _v1
    }) => _v1.isSuccess || _v0.isSuccess),
    _v35 = (0, _v9.createSelector)(_v33, ({
      renderStoryboard: _v0,
      saveStoryboard: _v1
    }) => _v0.isLoading || _v1.isLoading),
    _v36 = (0, _v9.createSelector)(_v0 => _v0, _v0 => {
      let {
  ...
  _v0.s(["SHARED_PUBLISH_INTERACTIVE_KEY", 0, _v23, "SHARED_RENDER_STORYBOARD_KEY", 0, _v20, "SHARED_SAVE_INTERACTIVE_KEY", 0, _v22, "SHARED_SAVE_OVERLAY_AS_TEMPLATE_KEY", 0, _v24, "SHARED_SAVE_STORYBOARD_KEY", 0, _v21, "isStoryboardSavedSelector", 0, _v34, "isStoryboardSavingOrSavedSelector", 0, _v36, "isStoryboardSavingSelector", 0, _v35, "storyboardApi", 0, _v25, "useDuplicateStoryboardSourcesMutation", 0, _v32, "useLazyFetchStoryboardQuery", 0, _v26, "useLazyInitStoryboardFromClipQuery", 0, _v28, "useLazyInitStoryboardQuery", 0, _v27, "usePublishInteractiveStoryboardMutation", 0, _v31, "useRenderStoryboardMutation", 0, _v30, "useSaveStoryboardMutation", 0, _v29], 0);
}