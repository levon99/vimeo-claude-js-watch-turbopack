{
  ...
  async function _v112({
    ...
    return (0, _v70.measureLatency)("getUserBulkAction", "GET", async () => {
  ...
  let _v114 = _v0 => "completed" === _v0 || "completed_with_errors" === _v0,
