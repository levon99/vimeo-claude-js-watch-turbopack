{
  ...
  let _v4 = {
    ...
    LOCAL_MEDIA: {
      ...
      OPTIMIZATION_MODE: (0, _v3.getLiveConfigValue)(_v1.localStorageConfig.MEDIA.STREAM_OPTIMIZATION_MODE, "motion"),
    ...
    DUAL_STREAM: {
      ...
      CONFIG: {
        ...
        bitrate: (0, _v3.getLiveConfigValue)(_v1.localStorageConfig.MEDIA.LOW_STREAM_BITRATE, 950)
      },
