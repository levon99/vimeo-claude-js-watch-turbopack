{
  ...
  _v0.s(["PasswordInput", 0, ({
    ...
    let _v13 = (0, _v15.useToast)(),
      _v14 = (0, _v4.useRef)(_v13),
      [_v15, _v16] = (0, _v4.useState)(_v0 ?? _v1 ?? ""),
    ...
    let _v23 = (0, _v4.useCallback)(_v0 => {
        _v8?.(_v0), _v16(_v0.target.value), "" !== _v0.target.value && _v18(!1);
      }, [_v8]),
      _v24 = (0, _v4.useCallback)(() => {
        _v20(!0), _v9?.(!0, _v22.current);
      }, [_v9]),
      _v25 = (0, _v4.useCallback)(_v0 => {
        _v20(!1), _v9 && _v21.current && !_v21.current.contains(_v0.relatedTarget) && setTimeout(() => {
          _v9(!1, _v22.current);
        }, 200);
      }, [_v9]),
      _v26 = (0, _v16.translate)({
        singular: "Save",
        dictionary: {
          es: {
            singular: "Guardar"
      ...
      _v29 = (0, _v4.useCallback)(async _v0 => {
        let _v1, _v2;
        _v0.preventDefault(), _v0.stopPropagation();
        let _v3 = _v0.currentTarget.querySelector("input").value;
        (_v1 = _v3, _v2 = _v2, _v1 && _v1.trim().length > 0 && _v1.trim().length <= _v2) ? (await _v11?.(_v3), _v9?.(!1, _v22.current)) : _v18(!0);
      }, [_v2, _v11, _v9]),
      _v30 = _v15 === _v0 && _v15?.trim().length > 0,
      _v31 = (0, _v16.translate)({
        singular: "Copy",
        dictionary: {
          es: {
            singular: "Copiar"
      ...
      _v32 = (0, _v4.useCallback)(async () => {
        let _v0 = await _v24(_v15);
        _v0 || (_v0 = (0, _v17.default)(_v15));
        let _v1 = _v0 ? (0, _v16.translate)({
          ...
          _v2 = "password-copy";
        _v14.current.isActive(_v2) || _v14.current({
          title: _v1,
          id: _v2,
          ...(!_v0 && {
            variant: "warning"
      ...
      _v33 = (0, _v4.useRef)(_v10);
    (0, _v4.useEffect)(() => () => void _v33.current?.(_v22.current), []);
    let _v34 = "u" > typeof navigator && /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator.vendor) ? _v23 : _v12.Password;
      ...
      children: [(0, _v1.jsx)(_v9.FormLabel, {
        ...
        children: [(0, _v1.jsxs)(_v10.InputGroup, {
          children: [(0, _v1.jsx)(_v34, {
            ...
            onFocus: _v24,
            ..._v12
          }), !_v7 && (0, _v1.jsx)(_v11.InputRightElement, {
            width: _v28 + 88,
            pointerEvents: "none",
            hidden: _v5,
            children: (0, _v1.jsx)(_v5.Button, {
              ...
              children: _v30 ? _v31 : _v26
            })
          })]
        }), (0, _v1.jsx)(_v2.AnimatePresence, {
          children: (_v19 || _v17) && (0, _v1.jsxs)(_v6.Flex, {
            as: _v3.motion.div,
            initial: {
              height: 0,
              opacity: 0
            ...
            alignItems: "center",
            children: [_v17 && (0, _v1.jsx)(_v8.FormErrorMessage, {
              variant: "error",
              fontSize: "body-sm",
              lineHeight: "body-sm",
              mt: "0",
