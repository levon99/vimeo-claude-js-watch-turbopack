{
  ...
  var _v1 = _v0.i(0),
    ...
    _v4 = _v0.i(0);
  let _v5 = () => ({
    baseUrl: _v4.ApiCredentialsStore.getState().baseUrl,
    headers: {
      ..._v4.ApiCredentialsStore.getState().getApiHeaders()
    }
  });
  var _v6 = _v0.i(0);
  let _v7 = "PAUSING",
  ...
  let _v10 = (0, _v1.create)()((0, _v2.devtools)((_v0, _v1) => ({
    isVisible: !1,
    inProgressJobs: [],
    doneJobs: [],
    isInitialLoad: !0,
      ...
      if (_v1?.isTriggeredByUser || !(_v2 - _v1().lastFetchTimestamp < 0)) {
        ...
        try {
          ...
          let _v1 = (await (0, _v3.getUserAiBatchsessions)({
            ...
            _v3 = _v1.filter(_v0 => _v0.status === _v8 || _v0.status === _v7),
  ...
  _v0.s(["useActivityCenterStore", 0, _v10], 0);
}