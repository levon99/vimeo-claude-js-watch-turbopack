{
  ...
  _v0.s(["useSendManagedInvite", 0, _v35], 0);
  let _v36 = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
  function _v37({
    isOpen: _v0,
    onClose: _v1,
    ...
    let _v3 = (0, _v4.useViewer)(),
      ...
      _v12 = _v36.test(_v8.trim()),
      _v13 = (0, _v2.useMemo)(() => {
        let _v0 = _v3?.user?.id;
        return void 0 === _v0 ? "" : `${window.location.origin}${(0, _v33.getManagedAccountsAcceptPath)(_v0)}?s=link`;
      }, [_v3?.user?.id]),
      ...
      _v15 = (0, _v2.useCallback)(async () => {
        ...
        _v0 || (_v0 = (0, _v32.default)(_v13)), _v0 ? (_v2(), _v7(), _v4({
          status: "success",
          title: (0, _v18.translate)({
                ...
                children: [(0, _v1.jsx)(_v14.Text, {
                  ...
                  children: [(0, _v1.jsx)(_v26.Input, {
                    ...
                    children: (0, _v1.jsx)(_v5.Button, {
                      size: "sm",
                      variant: "secondary",
                      leftIcon: (0, _v1.jsx)(_v31.CopyPortrait, {
                        boxSize: "2xs"
                      }),
                      isDisabled: !_v13,
                      onClick: _v15,
  ...
  function _v39({
    ...
    let _v2 = (0, _v4.useViewer)(),
      {
        setHasInvited: _v3
      } = (0, _v38.useHasInvitedFlag)(_v2?.user?.id),
      {
  ...
  _v0.s(["ManagedAccountsInviteFlow", 0, _v39], 0);
  var _v40 = _v0.i(0);
  function _v41({
    isOpen: _v0,
    onClose: _v1,
  ...
  _v0.s(["PromoPopup", 0, _v41], 0);
  var _v42 = _v0.i(0),
    _v43 = _v0.i(0);
  _v0.s(["ManagedAccountsPromo", 0, function () {
    let _v0 = (0, _v43.usePromoEligibility)(),
      {
        canShow: _v1,
        markShown: _v2
      } = (0, _v42.usePromoCooldown)(),
      {
        trackPromoShown: _v3
      } = (0, _v3.useManagedAccountsTracking)(),
