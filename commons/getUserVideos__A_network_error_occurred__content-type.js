{
  ...
  async function _v5({
    ...
    return (0, _v3.measureLatency)("getUserVideos", "GET", async () => {
      let _v0 = await fetch(`${_v0}/users/${_v2}/videos?${(0, _v4.searchQueryString)(_v3)}&fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v4,
        method: "GET"
      });
  ...
  async function _v6({
    ...
    return (0, _v3.measureLatency)("postUserVideos", "POST", async () => {
      let _v0 = await fetch(`${_v0}/users/${_v3}/videos?fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v4,
        method: "POST",
  ...
  async function _v7({
    ...
    return (0, _v3.measureLatency)("deleteUserVideos", "DELETE", async () => {
      let _v0 = await fetch(`${_v0}/users/${_v2}/videos?${(0, _v4.searchQueryString)(_v3)}`, {
        ..._v4,
        method: "DELETE",
  ...
  _v0.s(["deleteUserVideos", 0, _v7, "getUserVideos", 0, _v5, "postUserVideos", 0, _v6], 0);
  var _v8 = _v0.i(0),
    _v9 = _v0.i(0),
    _v10 = _v0.i(0),
    _v11 = _v0.i(0),
  ...
  function _v13(_v0, _v1) {
    ...
    return (0, _v9.default)(_v2 ? `/users/${_v2.where.userId}/videos${(0, _v2.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v5({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  function _v14() {
    ...
    return [(0, _v8.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/users/${_v0.where.userId}/videos${(0, _v2.serializeQuery)(_v0)}`, _v5({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v2.assignMswData)(_v13, {
    ...
    endpoint: "/users/:userId/videos",
    method: "DELETE"
  }), _v0.s(["useDeleteUserVideos", 0, _v16, "useGetUserVideos", 0, _v13, "useGetUserVideosInfinite", 0, _v15, "useGetUserVideosLazy", 0, _v14], 0);
}