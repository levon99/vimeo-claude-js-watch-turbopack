{
  ...
  function _v36() {
    let {
      ...
      [_v5, _v6] = (0, _v32.useInternalState)();
    return [(0, _v2.useCallback)(async _v0 => {
      _v6({
        type: "REQUEST"
      });
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/pictures/${_v0.where.pictureId}${(0, _v32.serializeQuery)(_v0)}`, (0, _v33.deleteVideoPicture)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  function _v37() {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/pictures/${_v0.where.pictureId}${(0, _v32.serializeQuery)(_v0)}`, (0, _v33.patchVideoPicture)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
  ...
  "true" === _v31.default.env.STORYBOOK && (0, _v32.assignMswData)(function (_v0, _v1) {
    ...
    return (0, _v34.default)(_v2 ? `/videos/${_v2.where.videoId}/pictures/${_v2.where.pictureId}${(0, _v32.serializeQuery)(_v2)}` : () => null, _v2 ? () => (0, _v33.getVideoPicture)({
      ..._v2,
      headers: {
        ..._v2.headers,
        "Content-Type": "application/json",
    ...
    method: "GET"
  }), "true" === _v31.default.env.STORYBOOK && (0, _v32.assignMswData)(function () {
    let {
        mutate: _v0
      } = (0, _v35.useSWRConfig)(),
      {
    ...
    return [(0, _v2.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/pictures/${_v0.where.pictureId}${(0, _v32.serializeQuery)(_v0)}`, (0, _v33.getVideoPicture)({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/videos/:videoId/pictures/:pictureId",
    method: "GET"
  }), "true" === _v31.default.env.STORYBOOK && (0, _v32.assignMswData)(_v36, {
    endpoint: "/videos/:videoId/pictures/:pictureId",
    method: "DELETE"
  }), "true" === _v31.default.env.STORYBOOK && (0, _v32.assignMswData)(_v37, {
    endpoint: "/videos/:videoId/pictures/:pictureId",
    method: "PATCH"
  }), _v0.s(["useDeleteVideoPicture", 0, _v36, "usePatchVideoPicture", 0, _v37], 0);
  var _v38 = _v0.i(0),
    _v39 = _v0.i(0);
  let _v40 = "image/png,image/x-png,image/jpeg,image/webp",
    _v41 = "image/png,image/x-png,image/jpeg,image/webp,.jpg,.jpeg,.png,.webp";
  _v0.s(["THUMBNAIL_HEIGHT", 0, 360, "THUMBNAIL_SUPPORTED_IMAGE_INPUTS", 0, _v41, "THUMBNAIL_SUPPORTED_IMAGE_MIME", 0, _v40, "THUMBNAIL_WIDTH", 0, 640], 0);
  let _v42 = (0, _v2.createContext)(null);
  function _v43({
    clipId: _v0,
    onSaveSuccess: _v1,
    onClose: _v2,
    ...
    let _v4,
      ...
      _v36 = async _v0 => {
        let _v1 = _v0[0];
        if (!_v1 || !_v40.split(",").includes(_v1.type)) return;
    ...
    return (0, _v1.jsx)(_v42.Provider, {
      value: {
        clipId: _v0,
        videoFps: _v29,
        clipConfigUrl: _v30,
  ...
  var _v46 = _v0.i(0),
    ...
    _v51 = _v0.i(0),
    _v52 = _v0.i(0);
  let _v53 = [.05, .15, .25, .35, .45, .55, .65, .75, .85, .95];
  ...
  function _v56() {
    let {
      ...
      {
        player: _v21
      } = (0, _v52.usePlayer)(_v15, _v0, !!_v1, _v1 ?? "", !1);
    (0, _v2.useEffect)(() => {
      _v16.current = _v10;
    }, [_v10]);
    ...
    let _v23 = _v19 ? Math.ceil(_v19.frames / _v19.columns) : 0,
      _v24 = _v53.reduce((_v0, _v1, _v2) => Math.abs(_v1 * _v12 - _v10) < Math.abs(_v53[_v0] * _v12 - _v10) ? _v2 : _v0, 0);
      ...
      children: _v1 ? (0, _v1.jsxs)(_v3.Box, {
        ...
        children: [(0, _v1.jsxs)(_v3.Box, {
          ...
          children: [(0, _v1.jsx)("div", {
            ...
            }), (0, _v1.jsxs)(_v48.Badge, {
              position: "absolute",
              size: "sm",
              fontWeight: "500",
              bottom: (0, _v51.rem)(8),
              right: (0, _v51.rem)(8),
              children: [_v54(_v10, _v18), " / ", _v54(_v12, _v18)]
            })]
          })]
        }), !!_v12 && (0, _v1.jsxs)(_v1.Fragment, {
          children: [(0, _v1.jsxs)(_v49.Slider, {
            min: 0,
            max: _v12,
            step: .001,
            value: _v10,
            ...
            children: [(0, _v1.jsx)(_v50.SliderTrack, {
              children: (0, _v1.jsx)(_v50.SliderFilledTrack, {})
            }), (0, _v1.jsx)(_v50.SliderThumb, {})]
          }), null !== _v19 && (0, _v1.jsx)(_v3.Box, {
            display: "flex",
            children: _v53.map((_v0, _v1) => {
              ...
              return (0, _v1.jsx)(_v3.Box, {
                ...
                borderRightRadius: _v1 === _v53.length - 1 ? "sm" : void 0,
                overflow: "hidden",
                style: {
            ...
            children: [(0, _v1.jsx)(_v19.Text, {
              ...
              children: [(0, _v1.jsx)(_v7.Flex, {
                ...
                alignItems: "center",
                children: ["←", "→"].map(_v0 => (0, _v1.jsx)(_v55, {
                  children: _v0
                }, _v0))
              }), (0, _v1.jsx)(_v19.Text, {
                variant: "body-xs",
          ...
          }), _v5 && (0, _v1.jsx)(_v46.Alert, {
            status: "error",
            children: (0, _v1.jsx)(_v47.AlertDescription, {
              fontSize: "body-sm",
              children: (0, _v22.translate)({
    ...
    return (0, _v1.jsx)(_v27.TabPanel, {
      children: (0, _v1.jsxs)(_v7.Flex, {
        ...
        children: [_v1 ? (0, _v1.jsx)(_v26.Spinner, {
          ...
          children: [(0, _v1.jsx)(_v57.Upload, {
            boxSize: "md"
          }), (0, _v1.jsx)(_v19.Text, {
            variant: "heading-md",
        ...
        children: [(0, _v1.jsxs)(_v13.ModalHeader, {
          ...
          children: (0, _v1.jsxs)(_v16.Tabs, {
            ...
            children: [(0, _v1.jsx)(_v3.Box, {
              ...
              children: [(0, _v1.jsx)(_v56, {}), (0, _v1.jsx)(_v58, {}), _v1 ? (0, _v1.jsx)(_v45, {}) : null]
            })]
          })
