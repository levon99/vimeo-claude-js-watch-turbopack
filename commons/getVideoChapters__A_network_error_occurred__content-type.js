{
  ...
  async function _v5({
    ...
    return (0, _v3.measureLatency)("getVideoChapters", "GET", async () => {
      let _v0 = await fetch(`${_v0}/videos/${_v2}/chapters?${(0, _v4.searchQueryString)(_v3)}&fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v4,
        method: "GET"
      });
  ...
  async function _v6({
    ...
    return (0, _v3.measureLatency)("postVideoChapters", "POST", async () => {
      let _v0 = await fetch(`${_v0}/videos/${_v3}/chapters?fields=${_v1.map(_v4.intoSnakeCase).join(",")}`, {
        ..._v4,
        method: "POST",
  ...
  function _v12(_v0, _v1) {
    ...
    return (0, _v8.default)(_v2 ? `/videos/${_v2.where.videoId}/chapters${(0, _v2.serializeQuery)(_v2)}` : () => null, _v2 ? () => _v5({
      ..._v2,
      headers: {
        ..._v2.headers,
  ...
  "true" === _v1.default.env.STORYBOOK && (0, _v2.assignMswData)(_v12, {
    endpoint: "/videos/:videoId/chapters",
    method: "GET"
    ...
    return [(0, _v7.useCallback)(async _v0 => {
      ...
      try {
        let _v0 = await _v0(`/videos/${_v0.where.videoId}/chapters${(0, _v2.serializeQuery)(_v0)}`, _v5({
          ..._v0,
          baseUrl: _v1,
          headers: {
            ..._v0.headers,
    ...
    endpoint: "/videos/:videoId/chapters",
    method: "POST"
  }), _v0.s(["useGetVideoChapters", 0, _v12, "useGetVideoChaptersInfinite", 0, _v13, "usePostVideoChapters", 0, _v14], 0);
}