{
  ...
  let _v9 = {
    ...
    _v10 = _v0 => ({
      embed_only: (0, _v1.jsx)(_v2.Code, {
        boxSize: _v0
      }),
      disable: (0, _v1.jsx)(_v2.Code, {
        boxSize: _v0
      }),
      anybody: (0, _v1.jsx)(_v3.Globe, {
        boxSize: _v0
      }),
      nobody: (0, _v1.jsx)(_v6.Lock, {
        boxSize: _v0
      }),
      password: (0, _v1.jsx)(_v4.LockPassword, {
        boxSize: _v0
      }),
      unlisted: (0, _v1.jsx)(_v5.LinkSecurityLock, {
        boxSize: _v0
      }),
      team: (0, _v1.jsx)(_v7.Building, {
        boxSize: _v0
      })
    });
  _v0.s(["NEW_DESCRIPTIONS", 0, _v9, "getNewPrivacyCopy", 0, (_v0, _v1, _v2) => _v0 => ({
    ..._v0,
    title: "team" === _v0.privacy ? !_v1 && _v2 ? (0, _v8.translate)({
    ...
    }) : "embed_only" === _v0.privacy || "disable" === _v0.privacy ? (0, _v8.translate)({
      singular: "Embed only",
      dictionary: {
        es: {
    ...
    description: "team" === _v0.privacy ? !_v1 && _v2 ? (0, _v8.translate)({
    ...
    }) : _v9[_v0.privacy] ?? _v0.description,
    icon: _v10(_v0)[_v0.privacy] ?? _v0.icon
  }), "newIcons", 0, _v10]);
}