{
  ...
  let _v20 = ({
    ...
    let _v10 = (0, _v2.useRef)(null),
      _v11 = (0, _v11.default)(_v0 => {
        _v3(_v0.target.value.trim());
      }, 500);
    return (0, _v19.default)([_v7], () => {
      _v4 && !_v2 && _v1();
    }, null, [_v2, _v4]), (0, _v1.jsx)(_v4.Box, {
      padding: "md",
      ref: _v8,
      children: _v4 ? (0, _v1.jsx)(_v18.SearchComments, {
        ...
        children: [(0, _v1.jsx)(_v3.Flex, {
          ...
          children: [(0, _v1.jsx)(_v15.Tooltip, {
            ...
            children: (0, _v1.jsx)(_v13.IconButton, {
              size: "sm",
              variant: "tertiary",
              icon: (0, _v1.jsx)(_v16.SearchMagnifierFilled, {}),
            ...
            children: (0, _v1.jsx)(_v13.IconButton, {
              size: "sm",
              variant: "tertiary",
              icon: (0, _v1.jsx)(_v17.DownloadImport, {}),
              "aria-label": (0, _v8.translate)({
                singular: "Download",
                dictionary: {
                  es: {
  ...
  let _v25 = ({
    ...
    children: (0, _v1.jsx)(_v22.DrawerContent, {
      sx: {
    ...
    width: (0, _v23.rem)(_v24.COMMENTS_PANEL_WIDTH),
    marginLeft: "lg",
    children: _v0
  }) : null;
  var _v26 = _v0.i(0),
  ...
  let _v36 = ({
    ...
    children: [(0, _v1.jsx)(_v27.ModalOverlay, {}), (0, _v1.jsxs)(_v31.ModalContent, {
      children: [(0, _v1.jsx)(_v28.ModalHeader, {
        ...
        children: _v3 > 0 && (0, _v1.jsx)(_v34.Alert, {
          size: "sm",
          marginBottom: "10px",
  ...
  _v0.s(["CommentsPanel", 0, ({
    ...
    let [_v15, _v16] = (0, _v2.useState)(!1),
      ...
      [_v21, _v22] = (0, _v7.useSortPreference)(_v20, "comments-container-sort"),
      [_v23, _v24] = (0, _v2.useState)(""),
      [_v25, _v26] = (0, _v2.useState)(!1),
      {
        reviewId: _v27
      } = (0, _v2.useContext)(_v38.ReviewLinkContext),
      {
        videoData: _v28
      } = (0, _v37.useVideoData)(_v1, _v27),
      {
        trackReviewCommentPosted: _v29,
        trackReviewCommentReactionAdded: _v30,
        trackReviewCommentReactionRemoved: _v31
      } = (0, _v9.useReviewTracking)(),
      _v32 = (0, _v2.useCallback)(() => {
        let _v0 = (0, _v39.idFromUri)(_v28?.user?.uri);
        return {
          reviewId: _v27 ?? "",
          clipId: _v1,
          clipOwnerId: _v0 ? _v0.toString() : null
        };
      }, [_v27, _v1, _v28?.user?.uri]),
      _v33 = (0, _v2.useCallback)(() => {
        _v29(_v32());
      }, [_v32, _v29]),
      _v34 = (0, _v2.useCallback)((_v0, _v1) => {
        _v30({
          ..._v32(),
      ...
      _v36 = _v2 ? `${_v1}:${_v2}` : _v1,
      _v37 = _v2.default.useRef(null),
      _v38 = _v6 ? 10 : _v24.COMMENTS_PANEL_DESKTOP_VERTICAL_SPACING,
      [_v39, _v40] = (0, _v2.useState)(0),
      _v41 = `calc(100vh - ${_v6 ? _v7 : "0"}px - ${_v24.VERSION_PAGE_HEADER_HEIGHT + _v39 + _v38}px )`,
      _v42 = (0, _v2.useCallback)(() => {
        _v24(""), _v26(!1);
      }, [_v24, _v26]),
      _v43 = (0, _v2.useCallback)(_v0 => {
        null !== _v0 && _v39 !== _v0.clientHeight && _v40(_v0.clientHeight);
      }, [_v39]),
      ...
      _v45 = (0, _v2.useCallback)(() => {
        if (!_v1 || !_v27) return;
        let _v0 = (0, _v39.getReviewPasswordHashFromCookie)(_v27),
          _v1 = new URLSearchParams({
            format: "csv",
            source: "collaborator"
          });
        _v1.set("review_id", _v27), _v0 && _v1.set("password", _v0);
        let _v2 = `/videos/${_v1}/comments/export?${_v1.toString()}`;
        window.location.assign(_v2), _v16(!1);
      }, [_v1, _v27]),
      _v46 = (0, _v2.useCallback)((_v0, _v1) => {
        _v1 || _v18(_v0);
      }, [_v18]);
      ...
      children: [(0, _v1.jsxs)(_v3.Flex, {
        ...
        children: [(0, _v1.jsx)(_v4.Box, {
          children: (0, _v1.jsx)(_v20, {
            searchCommentQuery: _v23,
            setSearchCommentQuery: _v24,
            searchInputRef: _v37,
            showCommentSearchBar: _v25,
            onSearchClick: _v44,
            onCloseSearch: _v42,
            closeDrawer: _v5,
            panelHeaderRef: _v43,
          ...
          children: (0, _v1.jsx)(_v5.CommentsContainer, {
            ...
            videoVersionUri: _v4,
            targetApiVersion: _v24.TARGET_API_VERSION,
            isPreviousVersion: _v12,
            reviewId: _v27,
            ...
            commentTimeCode: _v13,
            pausePlayer: _v14,
            setCommentsCount: _v46,
            onCommentPosted: _v33,
            onCommentReactionAdded: _v34,
            onCommentReactionRemoved: _v35,
            defaultSort: _v20,
            sort: _v21,
            setSort: _v22
          })
