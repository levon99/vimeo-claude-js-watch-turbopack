{
  ...
  _v0.s(["CommentsPanel", 0, ({
    ...
    showComments: _v7,
    analyticsProps: _v8,
    showResolvedComments: _v9 = !0,
    isPreviousVersion: _v10,
    accountlessCommentRedesignEnabled: _v11 = !1,
    ...
    let [_v14, _v15] = (0, _v2.useState)(!1),
      ...
      _v27 = _v1 ? `${_v0}:${_v1}` : _v0,
      _v28 = _v2.default.useRef(null),
      _v29 = _v5 ? 10 : 48,
      [_v30, _v31] = (0, _v2.useState)(0),
      _v32 = `calc(100vh - ${_v5 ? _v6 : "0"}px - ${_v23.VERSION_PAGE_HEADER_HEIGHT + _v30 + _v29}px )`,
      ...
      _v36 = (0, _v2.useCallback)(() => {
        ...
        let _v2 = `/videos/${_v0}/comments/export?${_v1.toString()}`;
      ...
      children: [(0, _v1.jsxs)(_v3.Flex, {
        ...
        children: [(0, _v1.jsx)(_v4.Box, {
          ...
          children: (0, _v1.jsx)(_v5.CommentsContainer, {
            ...
            isPreviousVersion: _v10,
            reviewId: _v23,
            showResolvedComments: _v9,
            canInsertTimecode: !0,
            commentTimeCode: _v12,
            pausePlayer: _v13,
            setCommentsCount: _v37,
            accountlessCommentRedesignEnabled: _v11,
