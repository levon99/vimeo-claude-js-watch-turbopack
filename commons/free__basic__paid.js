{
  ...
  function _v7(_v0, _v1) {
    ...
    return /^\/search/.test(_v2) ? "search" : /^\/staff_picks/.test(_v2) ? "staff_picks" : /^\/categories/.test(_v2) ? "category_page" : /^\/watch\/?$/.test(_v2) ? "watchpage" : /^\/analytics(\/|$)/.test(_v2) || /^\/manage\/organization\/analytics(\/|$)/.test(_v2) ? "analytics" : /^\/manage\/team(\/|$)/.test(_v2) ? "manage_team" : /^\/manage\/workspace(\/|$)/.test(_v2) ? "manage_workspace" : /^\/manage\/organization(\/|$)/.test(_v2) ? "manage_organization" : "/" === _v2 || /^\/home\/?$/.test(_v2) ? "homepage" : /^\/create\/edit(\/|$)/.test(_v2) ? "editor" : /^\/shared-with-me(\/|$)/.test(_v2) ? "shared_with_me" : /^\/my-feed(\/|$)/.test(_v2) ? "feed" : /^\/recently-deleted(\/|$)/.test(_v2) ? "recently_deleted" : /^\/channels\/staffpicks(\/|$)/.test(_v2) ? "staff_picks" : /^\/apps(\/|$)/.test(_v2) ? "app_center" : /^\/library\/events(\/|$)/.test(_v2) ? "live_events" : /^\/library\/event_series(\/|$)/.test(_v2) ? "event_series" : /^\/library\/showcases(\/|$)/.test(_v2) ? "showcases" : /^\/user\/[^/]+\/folder\//.test(_v2) ? _v3 ? "my_library" : "team_library" : /^\/library(\/|$)/.test(_v2) ? _v1?.is_team_user == null ? "unknown" : _v1.is_team_user ? "team_library" : "my_library" : /^\/\d+(?:\/[0-9a-fA-F]+)?\/?$/.test(_v2) || /^\/video\/\d+(?:\/[0-9a-fA-F]+)?\/?$/.test(_v2) || /^\/share\/[^/]+\/?$/.test(_v2) ? "clip_page" : /^\/[^/]+\/?$/.test(_v2) ? "user_profile" : "unknown";
  }
  function _v8() {
